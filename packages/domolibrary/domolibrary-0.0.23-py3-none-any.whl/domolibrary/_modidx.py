...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'domolibrary.classes.DomoAccount': { 'domolibrary.classes.DomoAccount.AccountConfig': ( 'classes/domoaccount.html#accountconfig',
            ...
            'domolibrary.classes.DomoDataset': { 'domolibrary.classes.DomoDataset.DatasetSchema_Types': ( 'classes/domodataset.html#datasetschema_types',
                                                 ...
                                                 'domolibrary.classes.DomoDataset.DomoDataset_DeleteDataset_Error': ( 'classes/domodataset.html#domodataset_deletedataset_error',
                                                                                                                      'domolibrary/classes/DomoDataset.py'),
                                                 'domolibrary.classes.DomoDataset.DomoDataset_DeleteDataset_Error.__init__': ( 'classes/domodataset.html#domodataset_deletedataset_error.__init__',
                                                                                                                               'domolibrary/classes/DomoDataset.py'),
            ...
            'domolibrary.routes.bootstrap': { 'domolibrary.routes.bootstrap.GetBootstrap_InvalidAuthMethod': ( 'routes/bootstrap.html#getbootstrap_invalidauthmethod',
                                              ...
                                              'domolibrary.routes.bootstrap.get_bootstrap_pages': ( 'routes/bootstrap.html#get_bootstrap_pages',
                                                                                                    'domolibrary/routes/bootstrap.py')},
            'domolibrary.routes.datacenter': { 'domolibrary.routes.datacenter.Datacenter_Enum': ( 'routes/datacenter_routes.html#datacenter_enum',
                                                                                                  'domolibrary/routes/datacenter.py'),
                                               'domolibrary.routes.datacenter.Dataflow_Type_Filter_Enum': ( 'routes/datacenter_routes.html#dataflow_type_filter_enum',
                                                                                                            'domolibrary/routes/datacenter.py'),
                                               'domolibrary.routes.datacenter.generate_search_datacenter_account_body': ( 'routes/datacenter_routes.html#generate_search_datacenter_account_body',
                                                                                                                          'domolibrary/routes/datacenter.py'),
                                               'domolibrary.routes.datacenter.generate_search_datacenter_body': ( 'routes/datacenter_routes.html#generate_search_datacenter_body',
                                                                                                                  'domolibrary/routes/datacenter.py'),
                                               'domolibrary.routes.datacenter.get_lineage_upstream': ( 'routes/datacenter_routes.html#get_lineage_upstream',
                                                                                                       'domolibrary/routes/datacenter.py'),
                                               'domolibrary.routes.datacenter.search_datacenter': ( 'routes/datacenter_routes.html#search_datacenter',
                                                                                                    'domolibrary/routes/datacenter.py')},
            'domolibrary.routes.dataflow_routes': { 'domolibrary.routes.dataflow_routes.get_dataflow_by_id': ( 'routes/dataflow.html#get_dataflow_by_id',
                                                                                                               'domolibrary/routes/dataflow_routes.py')},
            'domolibrary.routes.dataset': { 'domolibrary.routes.dataset.DatasetNotFoundError': ( 'routes/dataset.html#datasetnotfounderror',
                                            ...
                                            'domolibrary.routes.dataset.upload_dataset_stage_3': ( 'routes/dataset.html#upload_dataset_stage_3',
                                                                                                   'domolibrary/routes/dataset.py')},
            'domolibrary.routes.group': { 'domolibrary.routes.group.create_group': ( 'routes/group.html#create_group',
