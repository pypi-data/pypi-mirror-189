...
try:
    ...
    warnings.warn(
        "Could not determine magic-cta-pipe version; this indicates a broken installation."
        " Install magic-cta-pipe from PyPI, a local git repository or using "
        " pip install git+https://github.com/cta-observatory/magic-cta-pipe@VERSION "
