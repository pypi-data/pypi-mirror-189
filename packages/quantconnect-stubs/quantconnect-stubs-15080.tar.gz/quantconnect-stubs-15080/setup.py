...
setup(
    ...
    install_requires=["pandas>=1.4.4", "matplotlib>=3.5.3"],
    packages=[
        "AlgorithmImports",
        "clr",
        "Internal",
    ...
    package_data={
        ...
        "QuantConnect.Securities.CryptoFuture": ["*.py", "*.pyi"],
        ...
        "System.Collections.Frozen": ["*.py", "*.pyi"],
        ...
        "System.Runtime.Intrinsics.Wasm": ["*.py", "*.pyi"],
