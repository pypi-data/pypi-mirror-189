...
class CMMCAssessmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_cmmc_assessments_endpoint = _Endpoint(
            settings={
                'response_type': (CmmcResponseGet,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ],
                'endpoint_path': '/api/cmmc-assessments',
                'operation_id': 'get_cmmc_assessments',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_cmmc_assessments(
        ...
        **kwargs
        ...
        kwargs['since_date'] = \
            since_date
        return self.get_cmmc_assessments_endpoint.call_with_http_info(**kwargs)
