...
class PACApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_system_pac_endpoint = _Endpoint(
            settings={
                'response_type': (PacResponsePost,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ],
                'endpoint_path': '/api/systems/{systemId}/approval/pac',
                'operation_id': 'add_system_pac',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_system_pac_endpoint = _Endpoint(
            settings={
                'response_type': (PacResponseGet,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
    ...
    def add_system_pac(
        ...
        **kwargs
        ...
        Adds a Package Approval Chain (PAC) for given `systemId` path parameter  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.add_system_pac(system_id, pac_request_post_body, async_req=True)
        >>> result = thread.get()

        Args:
            system_id (int): **System Id**: The unique system record identifier.
            pac_request_post_body (PacRequestPostBody): Add system package to PAC for review
        ...
        kwargs['system_id'] = \
            system_id
        kwargs['pac_request_post_body'] = \
            pac_request_post_body
        return self.add_system_pac_endpoint.call_with_http_info(**kwargs)
    ...
    def get_system_pac(
        ...
        **kwargs
        ...
        Returns the location of a system's package in the Package Approval Chain (PAC) for matching `systemId` path parameter  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['system_id'] = \
            system_id
        return self.get_system_pac_endpoint.call_with_http_info(**kwargs)
