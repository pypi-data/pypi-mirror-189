...
class ContainersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_container_sans_by_system_id_endpoint = _Endpoint(
            settings={
                'response_type': (ContainersResponsePost,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ],
                'endpoint_path': '/api/systems/{systemId}/container-scan-results',
                'operation_id': 'add_container_sans_by_system_id',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'system_id': 'path',
                    'containers_request_post_body': 'body',
                },
    ...
    def add_container_sans_by_system_id(
        ...
        **kwargs
        ...
        Add containers and their scan results in the assets module for a system `systemId`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.add_container_sans_by_system_id(system_id, containers_request_post_body, async_req=True)
        >>> result = thread.get()

        Args:
            system_id (int): **System Id**: The unique system record identifier.
            containers_request_post_body (ContainersRequestPostBody): Add containers and their scan results
        ...
        kwargs['system_id'] = \
            system_id
        kwargs['containers_request_post_body'] = \
            containers_request_post_body
        return self.add_container_sans_by_system_id_endpoint.call_with_http_info(**kwargs)
