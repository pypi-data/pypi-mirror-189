...
class ControlsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_system_controls_endpoint = _Endpoint(
            settings={
                'response_type': (ControlsResponseGet,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ],
                'endpoint_path': '/api/systems/{systemId}/controls',
                'operation_id': 'get_system_controls',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_control_by_system_id_endpoint = _Endpoint(
            settings={
                'response_type': (ControlsResponsePut,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ...
                'endpoint_path': '/api/systems/{systemId}/controls',
                'operation_id': 'update_control_by_system_id',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'system_id': 'path',
                    'controls_request_put_body': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_system_controls(
        ...
        **kwargs
        ...
        >>> thread = api.get_system_controls(system_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            acronyms (str): **Acronym**: The system acronym(s) being queried (single value or comma delimited values).. [optional] if omitted the server will use the default value of "PM-6"
        ...
        kwargs['system_id'] = \
            system_id
        return self.get_system_controls_endpoint.call_with_http_info(**kwargs)
    ...
    def update_control_by_system_id(
        ...
        **kwargs
        ...
        >>> thread = api.update_control_by_system_id(system_id, controls_request_put_body, async_req=True)
        >>> result = thread.get()

        Args:
            system_id (int): **System Id**: The unique system record identifier.
            controls_request_put_body (ControlsRequestPutBody): Update an existing control by Id
        ...
        kwargs['system_id'] = \
            system_id
        kwargs['controls_request_put_body'] = \
            controls_request_put_body
        return self.update_control_by_system_id_endpoint.call_with_http_info(**kwargs)
