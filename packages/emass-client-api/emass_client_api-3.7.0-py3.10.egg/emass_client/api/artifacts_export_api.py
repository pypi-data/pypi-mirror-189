...
class ArtifactsExportApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_system_artifacts_export_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/systems/{systemId}/artifacts-export',
                'operation_id': 'get_system_artifacts_export',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_system_artifacts_export(
        ...
        **kwargs
        ...
        >>> thread = api.get_system_artifacts_export(system_id, filename, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            compress (bool): **Compress File**: Determines if returned file is compressed.. [optional] if omitted the server will use the default value of True
        ...
        kwargs['filename'] = \
            filename
        return self.get_system_artifacts_export_endpoint.call_with_http_info(**kwargs)
