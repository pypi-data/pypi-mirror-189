...
class StaticCodeScansApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_static_code_scans_by_system_id_endpoint = _Endpoint(
            settings={
                'response_type': (StaticCodeResponsePost,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ],
                'endpoint_path': '/api/systems/{systemId}/static-code-scans',
                'operation_id': 'add_static_code_scans_by_system_id',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'system_id': 'path',
                    'static_code_request_post_body': 'body',
                },
    ...
    def add_static_code_scans_by_system_id(
        ...
        **kwargs
        ...
        Args:
            ...
            static_code_request_post_body (StaticCodeRequestPostBody): Add static code scans or Clear static code scans
        ...
        kwargs['system_id'] = \
            system_id
        kwargs['static_code_request_post_body'] = \
            static_code_request_post_body
        return self.add_static_code_scans_by_system_id_endpoint.call_with_http_info(**kwargs)
