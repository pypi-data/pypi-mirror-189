...
class CACApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_system_cac_endpoint = _Endpoint(
            settings={
                'response_type': (CacResponsePost,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ],
                'endpoint_path': '/api/systems/{systemId}/approval/cac',
                'operation_id': 'add_system_cac',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_system_cac_endpoint = _Endpoint(
            settings={
                'response_type': (CacResponseGet,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
    ...
    def add_system_cac(
        ...
        **kwargs
        ...
        >>> thread = api.add_system_cac(system_id, cac_request_post_body, async_req=True)
        >>> result = thread.get()

        Args:
            system_id (int): **System Id**: The unique system record identifier.
            cac_request_post_body (CacRequestPostBody): Add control(s) to second role of CAC
        ...
        kwargs['system_id'] = \
            system_id
        kwargs['cac_request_post_body'] = \
            cac_request_post_body
        return self.add_system_cac_endpoint.call_with_http_info(**kwargs)
    ...
    def get_system_cac(
        ...
        **kwargs
        ...
        >>> thread = api.get_system_cac(system_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['system_id'] = \
            system_id
        return self.get_system_cac_endpoint.call_with_http_info(**kwargs)
