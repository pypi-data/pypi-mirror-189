...
class WorkflowDefinitionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_workflow_definitions_endpoint = _Endpoint(
            settings={
                'response_type': (WorkflowDefinitionResponseGet,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ],
                'endpoint_path': '/api/workflows/definitions',
    ...
    def get_workflow_definitions(
        ...
        **kwargs
        ...
        >>> thread = api.get_workflow_definitions(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            include_inactive (bool): **Include Inactive**: If no value is specified, the default returns false to not include outdated workflow definitions.. [optional] if omitted the server will use the default value of True
        ...
        return self.get_workflow_definitions_endpoint.call_with_http_info(**kwargs)
