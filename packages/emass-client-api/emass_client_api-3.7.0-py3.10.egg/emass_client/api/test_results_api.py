...
class TestResultsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_test_results_by_system_id_endpoint = _Endpoint(
            settings={
                'response_type': (TestResultsResponsePost,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ],
                'endpoint_path': '/api/systems/{systemId}/test-results',
                'operation_id': 'add_test_results_by_system_id',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'system_id',
                    'test_results_request_post_body',
                ],
                'required': [
                    'system_id',
                    'test_results_request_post_body',
            ...
            root_map={
                ...
                'location_map': {
                    'system_id': 'path',
                    'test_results_request_post_body': 'body',
                },
        ...
        self.get_system_test_results_endpoint = _Endpoint(
            settings={
                'response_type': (TestResultsResponseGet,),
                'auth': [
                    'apiKey',
                    'mockType',
                    'userId'
                ...
                'endpoint_path': '/api/systems/{systemId}/test-results',
                'operation_id': 'get_system_test_results',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def add_test_results_by_system_id(
        ...
        **kwargs
        ...
        >>> thread = api.add_test_results_by_system_id(system_id, test_results_request_post_body, async_req=True)
        >>> result = thread.get()

        Args:
            system_id (int): **System Id**: The unique system record identifier.
            test_results_request_post_body (TestResultsRequestPostBody): Add test results to a system (systemId)
        ...
        kwargs['system_id'] = \
            system_id
        kwargs['test_results_request_post_body'] = \
            test_results_request_post_body
        return self.add_test_results_by_system_id_endpoint.call_with_http_info(**kwargs)
    ...
    def get_system_test_results(
        ...
        **kwargs
        ...
        >>> thread = api.get_system_test_results(system_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            latest_only (bool): **Latest Results Only**: Indicates that only the latest test resultes are retrieved (single or comma separated).. [optional] if omitted the server will use the default value of True
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['system_id'] = \
            system_id
        return self.get_system_test_results_endpoint.call_with_http_info(**kwargs)
