...
from emass_client import rest
from emass_client.configuration import Configuration
from emass_client.exceptions import ApiTypeError, ApiValueError, ApiException
from emass_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_artifacts_by_system_id  # this is an instance of the class Endpoint
        api_instance.add_artifacts_by_system_id()  # this invokes api_instance.add_artifacts_by_system_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_artifacts_by_system_id.callable or self.callable in this class
