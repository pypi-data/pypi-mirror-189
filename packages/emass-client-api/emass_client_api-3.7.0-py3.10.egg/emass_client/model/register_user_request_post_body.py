...
class RegisterUserRequestPostBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_uid, *args, **kwargs):  # noqa: E501
        """RegisterUserRequestPostBody - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_uid, *args, **kwargs):  # noqa: E501
        """RegisterUserRequestPostBody - a model defined in OpenAPI
