...
class Response500Meta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """Response500Meta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (int): [optional] if omitted the server will use the default value of 500  # noqa: E501
            error_message (str): [optional] if omitted the server will use the default value of "Server encountered an unexpected condition which prevented it from fulfilling the request"  # noqa: E501
        """
