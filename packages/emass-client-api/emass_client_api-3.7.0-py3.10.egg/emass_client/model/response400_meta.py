...
class Response400Meta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """Response400Meta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (int): [optional] if omitted the server will use the default value of 400  # noqa: E501
            error_message (str): [optional] if omitted the server will use the default value of "Request could not be understood by the server due to incorrect syntax or an unexpected format"  # noqa: E501
        """
