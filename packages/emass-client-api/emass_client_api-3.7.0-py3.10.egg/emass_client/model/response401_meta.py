...
class Response401Meta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """Response401Meta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (int): [optional] if omitted the server will use the default value of 401  # noqa: E501
            error_message (str): [optional] if omitted the server will use the default value of "Request has failed to provide suitable authentication from the client"  # noqa: E501
        """
