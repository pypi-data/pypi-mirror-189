...
class MilestonesRequiredPut(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, milestone_id, description, scheduled_completion_date, *args, **kwargs):  # noqa: E501
        """MilestonesRequiredPut - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, milestone_id, description, scheduled_completion_date, *args, **kwargs):  # noqa: E501
        """MilestonesRequiredPut - a model defined in OpenAPI
