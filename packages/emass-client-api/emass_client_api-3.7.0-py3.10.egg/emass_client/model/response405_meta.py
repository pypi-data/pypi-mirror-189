...
class Response405Meta(ModelNormal):
    ...
    validations = {
        ('code',): {
            'inclusive_maximum': 405,
            'inclusive_minimum': 405,
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """Response405Meta - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (int): [optional] if omitted the server will use the default value of 405  # noqa: E501
            error_message (str): [optional] if omitted the server will use the default value of "Request was made with a verb (GET, POST, etc.) that is not permitted for the endpoint"  # noqa: E501
        """
