...
class MilestonesRequiredPost(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, scheduled_completion_date, *args, **kwargs):  # noqa: E501
        """MilestonesRequiredPost - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, scheduled_completion_date, *args, **kwargs):  # noqa: E501
        """MilestonesRequiredPost - a model defined in OpenAPI
