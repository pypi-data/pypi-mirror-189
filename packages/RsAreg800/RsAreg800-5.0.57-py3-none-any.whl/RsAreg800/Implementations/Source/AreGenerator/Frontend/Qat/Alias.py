...
class AliasCls:
	...
	def set(self, areg_fe_alias: str, qatFrontent=repcap.QatFrontent.Default) -> None:
		...
		Snippet: driver.source.areGenerator.frontend.qat.alias.set(areg_fe_alias = '1', qatFrontent = repcap.QatFrontent.Default) \n
		No command help available \n
			:param areg_fe_alias: string
