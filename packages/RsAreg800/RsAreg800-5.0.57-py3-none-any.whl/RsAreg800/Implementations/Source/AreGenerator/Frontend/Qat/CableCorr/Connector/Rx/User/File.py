...
class FileCls:
	...
	def set(self, areg_cable_cor_fil: str, qatFrontent=repcap.QatFrontent.Default, connector=repcap.Connector.Default, rxIndex=repcap.RxIndex.Default) -> None:
		...
		Snippet: driver.source.areGenerator.frontend.qat.cableCorr.connector.rx.user.file.set(areg_cable_cor_fil = '1', qatFrontent = repcap.QatFrontent.Default, connector = repcap.Connector.Default, rxIndex = repcap.RxIndex.Default) \n
