...
class AreGeneratorCls:
	"""AreGenerator commands group definition. 151 total commands, 14 Subgroups, 0 group commands"""
	...
	@property
	def channel(self):
		"""channel commands group. 5 Sub-classes, 4 commands."""
	...
	@property
	def dlogging(self):
		"""dlogging commands group. 0 Sub-classes, 9 commands."""
	...
	@property
	def frontend(self):
		"""frontend commands group. 3 Sub-classes, 0 commands."""
	...
	@property
	def object(self):
		"""object commands group. 7 Sub-classes, 0 commands."""
	...
	@property
	def osetup(self):
		"""osetup commands group. 3 Sub-classes, 7 commands."""
	...
	@property
	def units(self):
		"""units commands group. 0 Sub-classes, 7 commands."""
