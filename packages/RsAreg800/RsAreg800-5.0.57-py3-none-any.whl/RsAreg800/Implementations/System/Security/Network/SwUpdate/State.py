...
class StateCls:
	...
	def set(self, sec_pass_word: str, sw_update_state: bool) -> None:
		...
		Snippet: driver.system.security.network.swUpdate.state.set(sec_pass_word = '1', sw_update_state = False) \n
		No command help available \n
			:param sec_pass_word: No help available
			:param sw_update_state: No help available
		"""
	...
	def get(self) -> bool:
		...
		No command help available \n
			:return: sw_update_state: No help available"""
