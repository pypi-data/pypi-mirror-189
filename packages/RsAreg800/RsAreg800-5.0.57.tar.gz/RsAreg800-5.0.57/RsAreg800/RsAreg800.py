...
class RsAreg800:
	"""533 total commands, 18 Subgroups, 0 group commands"""
	_driver_options = "SupportedInstrModels = AREG, SupportedIdnPatterns = AREG, SimulationIdnString = 'Rohde&Schwarz,AREG800A,100001,5.0.57.0004'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '5.0.57.0004'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.0.57.0004'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsAreg800 version failed. Current version: '5.0.57.0004', minimum required version: '{min_version}'")
	...
	def calibration(self):
		"""calibration commands group. 7 Sub-classes, 2 commands."""
	...
	@property
	def display(self):
		"""display commands group. 6 Sub-classes, 3 commands."""
	...
	@property
	def system(self):
		"""system commands group. 34 Sub-classes, 28 commands."""
	...
	@property
	def test(self):
		"""test commands group. 7 Sub-classes, 4 commands."""
