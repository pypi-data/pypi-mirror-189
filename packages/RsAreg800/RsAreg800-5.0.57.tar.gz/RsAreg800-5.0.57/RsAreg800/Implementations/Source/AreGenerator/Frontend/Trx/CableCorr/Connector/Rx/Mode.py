...
class ModeCls:
	...
	def set(self, areg_cabel_cor_mod: enums.AregCableCorrSour, trxFrontent=repcap.TrxFrontent.Default, connector=repcap.Connector.Default, rxIndex=repcap.RxIndex.Default) -> None:
		...
		Snippet: driver.source.areGenerator.frontend.trx.cableCorr.connector.rx.mode.set(areg_cabel_cor_mod = enums.AregCableCorrSour.S2P, trxFrontent = repcap.TrxFrontent.Default, connector = repcap.Connector.Default, rxIndex = repcap.RxIndex.Default) \n
