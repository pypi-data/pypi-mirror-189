...
class StateCls:
	...
	def set(self, sec_pass_word: str, smb_state: bool) -> None:
		...
		Snippet: driver.system.security.network.smb.state.set(sec_pass_word = '1', smb_state = False) \n
		No command help available \n
			:param sec_pass_word: No help available
			:param smb_state: No help available
		"""
	...
	def get(self) -> bool:
		...
		No command help available \n
			:return: smb_state: No help available"""
