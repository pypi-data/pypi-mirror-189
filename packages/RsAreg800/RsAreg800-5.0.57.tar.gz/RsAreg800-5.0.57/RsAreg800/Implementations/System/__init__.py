...
class SystemCls:
	"""System commands group definition. 202 total commands, 34 Subgroups, 28 group commands"""
	...
	def communicate(self):
		"""communicate commands group. 9 Sub-classes, 0 commands."""
	...
	def get_iresponse(self) -> str:
		...
		specific command set is disabled, i.e. the SCPI command method RsAreg800.System.iresponse is discarded. \n
	...
	def get_oresponse(self) -> str:
		...
		command set is disabled, i.e. the SCPI command method RsAreg800.System.oresponse is discarded. \n
	...
	def set_oresponse(self, oresponse: str) -> None:
		"""SCPI: SYSTem:ORESponse \n
		Snippet: driver.system.set_oresponse(oresponse = '1') \n
		Defines the user defined response string for *OPT. Note: While working in an emulation mode, the instrument's specific
		command set is disabled, i.e. the SCPI command method RsAreg800.System.oresponse is discarded. \n
	...
	def recall(self, path_name: str) -> None:
		"""SCPI: SYSTem:RCL \n
		Snippet: driver.system.recall(path_name = '1') \n
		Loads a file with previously saved R&S AREG800A settings. Loads the selected file with previously saved R&S AREG800A
	...
	def save(self, path_name: str) -> None:
		"""SCPI: SYSTem:SAV \n
		Snippet: driver.system.save(path_name = '1') \n
		Saves the current R&S AREG800A settings into a file with defined filename and into a specified directory.
