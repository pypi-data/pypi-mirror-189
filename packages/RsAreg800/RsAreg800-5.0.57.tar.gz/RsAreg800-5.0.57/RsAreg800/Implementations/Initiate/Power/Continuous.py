...
class ContinuousCls:
	...
	def set(self, continuous: bool, channel=repcap.Channel.Default) -> None:
		...
		state enhances the measurement performance during remote control. The remote measurement is triggered with method
		RsAreg800.Read.Power.get_) . This command also returns the measurement results. The local state is not affected,
