...
class CreateFolder(object):
    ...
    def __init__(self, path=None, name=None, local_vars_configuration=None):  # noqa: E501
        """CreateFolder - a model defined in OpenAPI"
        
        :param path:  Path of the created folder (required)
        :type path: str
        :param name:  Name of the created folder (required)
        :type name: str
    ...
    @property
    def path(self):
        """Gets the path of this CreateFolder.  # noqa: E501

        Path of the created folder  # noqa: E501

        :return: The path of this CreateFolder.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this CreateFolder.

        Path of the created folder  # noqa: E501

        :param path: The path of this CreateFolder.  # noqa: E501
        :type path: str
        """
    ...
    def name(self):
        ...
        Name of the created folder  # noqa: E501
    ...
    def name(self, name):
        ...
        if (self.local_vars_configuration.client_side_validation and
                name is not None and not re.search(r'^[A-Za-z0-9_-]+[A-Za-z0-9 _-]*$', name)):  # noqa: E501
