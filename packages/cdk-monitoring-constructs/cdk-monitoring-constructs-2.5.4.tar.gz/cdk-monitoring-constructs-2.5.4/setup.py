    ...
    """
{
    ...
    "package_data": {
        "cdk_monitoring_constructs._jsii": [
            "cdk-monitoring-constructs@2.5.4.jsii.tgz"
        ],
        "cdk_monitoring_constructs": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-apigatewayv2-alpha>=2.60.0.a0, <3.0.0",
        "aws-cdk.aws-redshift-alpha>=2.60.0.a0, <3.0.0",
        "aws-cdk.aws-synthetics-alpha>=2.60.0.a0, <3.0.0",
