...
def get_total_occurrence_times_by_keywords(total_qs_ls, search_field_ls, keywords, get_frequence=True, topK=5, rank_field_name=None, rank__gte=None, search_weight_ls=None):
    """
    # 关键词次数统计
    ...
    rank__gte = rank__gte if rank__gte is not None else 0.01
