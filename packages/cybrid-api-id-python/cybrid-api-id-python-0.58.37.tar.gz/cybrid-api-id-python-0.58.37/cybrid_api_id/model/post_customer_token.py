...
from cybrid_api_id.exceptions import ApiAttributeError



class PostCustomerToken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, customer_guid, scopes, *args, **kwargs):  # noqa: E501
        """PostCustomerToken - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, customer_guid, scopes, *args, **kwargs):  # noqa: E501
        """PostCustomerToken - a model defined in OpenAPI
