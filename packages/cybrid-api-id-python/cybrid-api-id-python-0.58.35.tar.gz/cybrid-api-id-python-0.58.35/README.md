...
*CustomerTokensIdpApi* | [**create_customer_token**](docs/CustomerTokensIdpApi.md#create_customer_token) | **POST** /api/customer_tokens | Create customer access token
...
## Documentation For Models
 ...
 - [PostCustomerToken](docs/PostCustomerToken.md)
