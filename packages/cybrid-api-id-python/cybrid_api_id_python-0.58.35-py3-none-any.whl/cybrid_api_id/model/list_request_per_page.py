...
class ListRequestPerPage(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ListRequestPerPage - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): The number of entities per page to return..  # noqa: E501

        Keyword Args:
            value (int): The number of entities per page to return..  # noqa: E501
