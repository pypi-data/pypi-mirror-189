...
from cybrid_api_id.exceptions import ApiValueError
...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://id.demo.cybrid.app" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("cybrid_api_id")
