...
class ApplicationWithSecretAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, secret, *args, **kwargs):  # noqa: E501
        """ApplicationWithSecretAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, secret, *args, **kwargs):  # noqa: E501
        """ApplicationWithSecretAllOf - a model defined in OpenAPI
