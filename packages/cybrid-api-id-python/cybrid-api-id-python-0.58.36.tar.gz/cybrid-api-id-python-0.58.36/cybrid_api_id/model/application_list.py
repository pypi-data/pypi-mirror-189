...
class ApplicationList(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """ApplicationList - a model defined in OpenAPI
