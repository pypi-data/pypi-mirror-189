...
class ListRequestPage(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ListRequestPage - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): The page index to retrieve..  # noqa: E501

        Keyword Args:
            value (int): The page index to retrieve..  # noqa: E501
