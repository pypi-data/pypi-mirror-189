    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_zmk_iam_lambdabasicrole_module",
        "cdk_cloudformation_zmk_iam_lambdabasicrole_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_zmk_iam_lambdabasicrole_module._jsii": [
            "zmk-iam-lambdabasicrole-module@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_zmk_iam_lambdabasicrole_module": [
            "py.typed"
        ]
