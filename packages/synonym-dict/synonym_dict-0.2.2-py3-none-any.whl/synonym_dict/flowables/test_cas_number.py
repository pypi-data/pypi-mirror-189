...
class CasNumberTest(unittest.TestCase):
    ...
    def test_defective_cas(self):
        defective = '0091-20-2'
        other_defective = '091-20-2'
        c = CasNumber(defective)
        self.assertIn(defective, list(c.terms))
        self.assertNotIn(other_defective, list(c.terms))
    ...
    def test_pad_input(self):
        ...
        self.assertSetEqual(set(g.terms), co2_set | {'00124+38+9'})  # defective entry is recognized
