.. Copy of https://docutils.sourceforge.io/docs/user/rst/quickstart.txt
...
want text \*surrounded by asterisks* to **not** be italicized, then
...
**enumerated** lists (numbers, letters or roman numerals; quickref__)
  ...
  comfortable with.  All of the following forms are recognized::
