...
class MetricsManager(Manager):
    ...
    def create(
        ...
        Arguments:
            ...
            update_if_exists: if the metric exists and this is true, update the current metric and return, else raise an error if the metric already exists
    ...
    def log(
        ...
        Arguments:
            ...
            update_if_exists: if the metric value exists and this is true, update the current metric value and return, else raise an error if the metric value already exists
        Returns:
