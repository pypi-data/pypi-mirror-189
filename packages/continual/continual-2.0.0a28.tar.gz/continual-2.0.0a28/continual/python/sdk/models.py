...
class ModelManager(Manager):
    ...
    def create(
        ...
        Arguments:
            ...
            update_if_exists: If True, and the model exists it will be updated with the new description
                        and display name.
    ...
    def list(
        ...
        Examples:
            ...
            >>> [model.id for model in run.models.list(page_size=3, latest=False)]
