...
class EnvironmentManager(Manager):
    ...
    def create(
        ...
        Arguments:
            ...
            update_if_exists: If True and the environment already exists, return the existing
        ...
        Examples:
            ...
            >>> env = proj.environments.create(id="example")) # update_if_exists is True by default
            >>> env = proj.environments.create(id="example", update_if_exists=False) # Raises an error
