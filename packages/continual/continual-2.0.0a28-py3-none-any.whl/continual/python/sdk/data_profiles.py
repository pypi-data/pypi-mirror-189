...
class DataProfilesManager(Manager):
    ...
    def create(
        ...
        Arguments:
            ...
            update_if_exists: If True, and the data profile exists it will be updated with the new description
        ...
        req = management_pb2.CreateDataProfileRequest(
            ...
            data_profile=DataProfile(
                dataset_stats=dataset_stats, tags=tags, run=self.run_name
            ).to_proto(),
            data_profile_id=id,
