...
setuptools.setup(
    ...
    description="Una librería Python para extraer y manipular los diferentes datos de los resultados de las búsquedas de Google",
    packages=setuptools.find_packages(),
    long_description=local_file('README.md').read(),
    long_description_content_type="text/markdown",
    url="https://twitter.com/seo_torch",
    classifiers=[
