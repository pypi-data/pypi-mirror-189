...
class JDBCConnection(BaseConnection):
    ...
    def _get_result_file_name(self):
        ...
        result_file_name = self.connection_alias + self.query
    ...
    def _build_query_settings_file(self):
        ...
        jars_path = self._get_all_jar_files() if self.import_all_jars_files else self.credential["jar"]
        ...
        query_settings = {
            ...
            "connectionCredentials": self.credential
        }
