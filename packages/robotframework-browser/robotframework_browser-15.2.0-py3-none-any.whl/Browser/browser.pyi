...
class Browser(DynamicCore):
    ...
    def __init__(self, *deprecated_pos_args, auto_closing_level: AutoClosingLevel = AutoClosingLevel.TEST, enable_playwright_debug: bool = False, enable_presenter_mode: typing.Union[HighLightElement, bool] = False, external_browser_executable: typing.Optional[typing.Dict[SupportedBrowsers, str]] = None, jsextension: typing.Optional[str] = None, playwright_process_port: typing.Optional[int] = None, retry_assertions_for: timedelta = timedelta(seconds=1.0), run_on_failure: str = 'Take Screenshot  fail-screenshot-{index}', selector_prefix: typing.Optional[str] = None, show_keyword_call_banner: typing.Optional[bool] = None, strict: bool = True, timeout: timedelta = timedelta(seconds=10.0), plugins: typing.Optional[str] = None): ...
    ...
    def click(self, selector: str, button: MouseButton = MouseButton.left, clickCount: int = 1, delay: typing.Optional[datetime.timedelta] = None, position_x: typing.Optional[float] = None, position_y: typing.Optional[float] = None, force: bool = False, noWaitAfter: bool = False, *modifiers: KeyboardModifier): ...
    ...
    def local_storage_get_item(self, key: str, assertion_operator: typing.Optional[assertionengine.assertion_engine.AssertionOperator] = None, assertion_expected: typing.Optional[typing.Any] = None, message: typing.Optional[str] = None): ...
    ...
    def new_browser(self, browser: SupportedBrowsers = SupportedBrowsers.chromium, headless: bool = True, *deprecated_pos_args, args: typing.Optional[typing.List[str]] = None, channel: typing.Optional[str] = None, devtools: bool = False, downloadsPath: typing.Optional[str] = None, env: typing.Optional[typing.Dict] = None, executablePath: typing.Optional[str] = None, handleSIGHUP: bool = True, handleSIGINT: bool = True, handleSIGTERM: bool = True, ignoreDefaultArgs: typing.Optional[typing.List[str]] = None, proxy: typing.Optional[Proxy] = None, slowMo: timedelta = timedelta(seconds=0.0), timeout: timedelta = timedelta(seconds=30.0)): ...
    def new_context(self, *deprecated_pos_args, acceptDownloads: bool = True, bypassCSP: bool = False, colorScheme: typing.Optional[ColorScheme] = None, defaultBrowserType: typing.Optional[SupportedBrowsers] = None, deviceScaleFactor: typing.Optional[float] = None, extraHTTPHeaders: typing.Optional[typing.Dict[str, str]] = None, forcedColors: ForcedColors = ForcedColors.none, geolocation: typing.Optional[GeoLocation] = None, hasTouch: typing.Optional[bool] = None, hideRfBrowser: bool = False, httpCredentials: typing.Optional[HttpCredentials] = None, ignoreHTTPSErrors: bool = False, isMobile: typing.Optional[bool] = None, javaScriptEnabled: bool = True, locale: typing.Optional[str] = None, offline: bool = False, permissions: typing.Optional[typing.List[Permission]] = None, recordHar: typing.Optional[RecordHar] = None, recordVideo: typing.Optional[RecordVideo] = None, reducedMotion: ReduceMotion = ReduceMotion.no_preference, screen: typing.Optional[typing.Dict[str, int]] = None, storageState: typing.Optional[str] = None, timezoneId: typing.Optional[str] = None, tracing: typing.Optional[str] = None, userAgent: typing.Optional[str] = None, viewport: typing.Optional[ViewportDimensions] = {'width': 1280, 'height': 720}): ...
    def new_page(self, url: typing.Optional[str] = None): ...
    def new_persistent_context(self, userDataDir: str = '', browser: SupportedBrowsers = SupportedBrowsers.chromium, headless: bool = True, *deprecated_pos_args, acceptDownloads: bool = True, args: typing.Optional[typing.List[str]] = None, bypassCSP: bool = False, channel: typing.Optional[str] = None, colorScheme: typing.Optional[ColorScheme] = None, defaultBrowserType: typing.Optional[SupportedBrowsers] = None, deviceScaleFactor: typing.Optional[float] = None, devtools: bool = False, downloadsPath: typing.Optional[str] = None, env: typing.Optional[typing.Dict] = None, executablePath: typing.Optional[str] = None, extraHTTPHeaders: typing.Optional[typing.Dict[str, str]] = None, forcedColors: ForcedColors = ForcedColors.none, geolocation: typing.Optional[GeoLocation] = None, handleSIGHUP: bool = True, handleSIGINT: bool = True, handleSIGTERM: bool = True, hasTouch: typing.Optional[bool] = None, hideRfBrowser: bool = False, httpCredentials: typing.Optional[HttpCredentials] = None, ignoreDefaultArgs: typing.Optional[typing.List[str]] = None, ignoreHTTPSErrors: bool = False, isMobile: typing.Optional[bool] = None, javaScriptEnabled: bool = True, locale: typing.Optional[str] = None, offline: bool = False, permissions: typing.Optional[typing.List[Permission]] = None, proxy: typing.Optional[Proxy] = None, recordHar: typing.Optional[RecordHar] = None, recordVideo: typing.Optional[RecordVideo] = None, reducedMotion: ReduceMotion = ReduceMotion.no_preference, screen: typing.Optional[typing.Dict[str, int]] = None, slowMo: timedelta = timedelta(seconds=0.0), storageState: typing.Optional[str] = None, timeout: timedelta = timedelta(seconds=30.0), timezoneId: typing.Optional[str] = None, tracing: typing.Optional[str] = None, url: typing.Optional[str] = None, userAgent: typing.Optional[str] = None, viewport: typing.Optional[ViewportDimensions] = {'width': 1280, 'height': 720}): ...
    ...
    def session_storage_get_item(self, key: str, assertion_operator: typing.Optional[assertionengine.assertion_engine.AssertionOperator] = None, assertion_expected: typing.Optional[typing.Any] = None): ...
    ...
    def take_screenshot(self, filename: str = 'robotframework-browser-screenshot-{index}', selector: typing.Optional[str] = None, fullPage: bool = False, fileType: ScreenshotFileTypes = ScreenshotFileTypes.png, quality: typing.Optional[int] = None, timeout: typing.Optional[datetime.timedelta] = None, crop: typing.Optional[BoundingBox] = None, disableAnimations: bool = False, mask: typing.Union[typing.List[str], str] = '', omitBackground: bool = False): ...
    ...
    def wait_for_navigation(self, url: str, timeout: typing.Optional[datetime.timedelta] = None, wait_until: PageLoadStates = PageLoadStates.load): ...
    def wait_for_request(self, matcher: str = '', timeout: typing.Optional[datetime.timedelta] = None): ...
    def wait_for_response(self, matcher: str = '', timeout: typing.Optional[datetime.timedelta] = None): ...
