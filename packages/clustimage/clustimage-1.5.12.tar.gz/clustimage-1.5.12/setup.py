...
setuptools.setup(
     install_requires=['ismember', 'pypickle', 'pca', 'distfit', 'clusteval', 'colourmap', 'numpy', 'pandas', 'tqdm', 'scikit-learn', 'matplotlib', 'scikit-image', 'scipy', 'opencv-python', 'imagehash', 'scatterd>=1.1.2', 'requests', 'umap-learn'],
     python_requires='>=3',
     name='clustimage',
     version=new_version,
