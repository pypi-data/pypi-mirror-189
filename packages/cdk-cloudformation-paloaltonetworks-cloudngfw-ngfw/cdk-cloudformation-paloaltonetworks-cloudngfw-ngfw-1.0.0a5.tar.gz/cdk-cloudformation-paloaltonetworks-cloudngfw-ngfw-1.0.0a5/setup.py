    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_paloaltonetworks_cloudngfw_ngfw",
        "cdk_cloudformation_paloaltonetworks_cloudngfw_ngfw._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_paloaltonetworks_cloudngfw_ngfw._jsii": [
            "paloaltonetworks-cloudngfw-ngfw@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_paloaltonetworks_cloudngfw_ngfw": [
            "py.typed"
        ]
