    ...
    def __init__(
        ...
        **kwargs
        ...
        (self.app, self.proxy, self.enc,
            ...
            self.check_session, self.api_client) = (app, proxy, Encryption(session),
        ...
        if (app == 'rubx'):
            ...
            try:
                open(f'{session}.sty', 'r')
            except FileNotFoundError:
                open(f'{session}.sty', 'w').write(session)
        ...
        while 1:
            ...
            try:
                for res in [ws.recv()]:
                    ...
                    elif round(count / 2) == 60:
                        self.__connector(ws, '1')
                        count: int = 0

                    if str(res).__len__() != 33:
