...
'''
parse message text to markdown and html
'''
...
class Metas(object):
    ...
    def __init__(self, text: str, user_ids,
                 action: bool = True, *args, **kwargs) -> (None):
        
        
        '''
        to metadata parser - bold, italic, mono, strike and mention for message text
        
        return data an tuple to main text dont enity and client data
        '''
...
class Tags(object):
    ...
    def __init__(self, text: str, *args) -> (dict):
        ...
        '''
        for mention [tag] text message with `@`
