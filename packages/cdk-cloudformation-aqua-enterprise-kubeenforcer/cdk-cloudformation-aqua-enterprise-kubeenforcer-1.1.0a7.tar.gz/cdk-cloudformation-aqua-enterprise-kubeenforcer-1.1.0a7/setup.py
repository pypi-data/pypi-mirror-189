    ...
    """
{
    ...
    "license": "Apache-2.0",
    "url": "https://github.com/aquasecurity/aqua-helm.git",
    ...
    "packages": [
        "cdk_cloudformation_aqua_enterprise_kubeenforcer",
        "cdk_cloudformation_aqua_enterprise_kubeenforcer._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_aqua_enterprise_kubeenforcer._jsii": [
            "aqua-enterprise-kubeenforcer@1.1.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_aqua_enterprise_kubeenforcer": [
            "py.typed"
        ]
