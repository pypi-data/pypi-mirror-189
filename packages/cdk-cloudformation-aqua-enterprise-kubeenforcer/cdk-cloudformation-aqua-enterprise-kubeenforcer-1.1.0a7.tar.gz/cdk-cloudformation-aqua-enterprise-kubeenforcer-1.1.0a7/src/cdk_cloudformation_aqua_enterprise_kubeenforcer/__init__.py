...
> AWS CDK [L1 construct](https://docs.aws.amazon.com/cdk/latest/guide/constructs.html) and data structures for the [AWS CloudFormation Registry](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html) type `Aqua::Enterprise::KubeEnforcer` v1.1.0.
...
This library is auto-generated and published to all supported programming languages by the [cdklabs/cdk-cloudformation](https://github.com/cdklabs/cdk-cloudformation) project based on the API schema published for `Aqua::Enterprise::KubeEnforcer`.
...
class CfnKubeEnforcer(
    _aws_cdk_ceddda9d.CfnResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdk-cloudformation/aqua-enterprise-kubeenforcer.CfnKubeEnforcer",
):
    ...
    def __init__(
        ...
        *,
        ...
        vpc_configuration: typing.Optional[typing.Union["CfnKubeEnforcerPropsVpcConfiguration", typing.Dict[builtins.str, typing.Any]]] = None,
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__11f49e4af6eb1768c19ea4edea6250dd28159ba144953b228841357f818a905b)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = CfnKubeEnforcerProps(
    ...
    def props(self) -> "CfnKubeEnforcerProps":
        '''Resource props.'''
        return typing.cast("CfnKubeEnforcerProps", jsii.get(self, "props"))


@jsii.data_type(
    jsii_type="@cdk-cloudformation/aqua-enterprise-kubeenforcer.CfnKubeEnforcerProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnKubeEnforcerProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(vpc_configuration, dict):
            vpc_configuration = CfnKubeEnforcerPropsVpcConfiguration(**vpc_configuration)
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7210bbc11d5b77dd769d1a6c060b28d505f30b1592ff6cedf394e949c37ca47b)
    ...
    def vpc_configuration(
        self,
    ) -> typing.Optional["CfnKubeEnforcerPropsVpcConfiguration"]:
        '''For network connectivity to Cluster inside VPC.

        :schema: CfnKubeEnforcerProps#VPCConfiguration
        '''
        result = self._values.get("vpc_configuration")
        return typing.cast(typing.Optional["CfnKubeEnforcerPropsVpcConfiguration"], result)
    ...
    def __repr__(self) -> str:
        return "CfnKubeEnforcerProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@cdk-cloudformation/aqua-enterprise-kubeenforcer.CfnKubeEnforcerPropsVpcConfiguration",
    jsii_struct_bases=[],
    name_mapping={"security_group_ids": "securityGroupIds", "subnet_ids": "subnetIds"},
)
class CfnKubeEnforcerPropsVpcConfiguration:
    def __init__(
        self,
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__001aea7f14367c9ec8543fcb839ba1271364271bfa10419bc9350c468101dd39)
    ...
    def __repr__(self) -> str:
        return "CfnKubeEnforcerPropsVpcConfiguration(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
__all__ = [
    "CfnKubeEnforcer",
    "CfnKubeEnforcerProps",
    "CfnKubeEnforcerPropsVpcConfiguration",
]

publication.publish()

def _typecheckingstub__11f49e4af6eb1768c19ea4edea6250dd28159ba144953b228841357f818a905b(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    cluster_id: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__7210bbc11d5b77dd769d1a6c060b28d505f30b1592ff6cedf394e949c37ca47b(
    *,
    cluster_id: typing.Optional[builtins.str] = None,
    kube_config: typing.Optional[builtins.str] = None,
    name: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__001aea7f14367c9ec8543fcb839ba1271364271bfa10419bc9350c468101dd39(
    *,
    security_group_ids: typing.Optional[typing.Sequence[builtins.str]] = None,
    subnet_ids: typing.Optional[typing.Sequence[builtins.str]] = None,
) -> None:
