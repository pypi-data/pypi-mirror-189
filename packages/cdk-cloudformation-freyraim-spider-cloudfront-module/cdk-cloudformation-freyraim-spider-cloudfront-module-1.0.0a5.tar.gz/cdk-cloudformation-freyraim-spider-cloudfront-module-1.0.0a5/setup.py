    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_freyraim_spider_cloudfront_module",
        "cdk_cloudformation_freyraim_spider_cloudfront_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_freyraim_spider_cloudfront_module._jsii": [
            "freyraim-spider-cloudfront-module@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_freyraim_spider_cloudfront_module": [
            "py.typed"
        ]
