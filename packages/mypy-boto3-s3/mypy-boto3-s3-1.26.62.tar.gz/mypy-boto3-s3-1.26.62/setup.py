"""
Setup script for mypy-boto3-s3.
"""
...
setup(
    ...
    description=(
        "Type annotations for boto3.S3 1.26.62 service generated with mypy-boto3-builder 7.12.3"
    ),
    classifiers=[
    ...
    package_data={"mypy_boto3_s3": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
