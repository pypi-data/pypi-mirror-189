...
class Spectrum:
    ...
    def overall_a_weighted_level(self):
        ...
        return AcousticWeights.la(self.pressures_decibels, self.frequencies)
    ...
    def calculate_engineering_unit_scale_factor(self, calibration_level: float = 94, calibration_frequency=1000):
        ...
        elif self.fractional_octave_bandwidth != 3:
            raise ValueError("This analysis must be accomplished on a one-third-octave spectrum")
        elif self.start_fractional_octave_frequency != 10:
            raise ValueError("Until the algorithm is adjusted, this analysis requires the spectrum to be defined "
                             "starting at 10 Hz")
