    ...
    def downloadDataTask(self, task, split=["train","valid","test","challenge"], verbose=True, password="SoccerNet"):
        ...
        if task == "calibration-2023":
            ...
            for s in split:
                if s == "challenge":
                    self.downloadGames(files=["1_baidu_soccer_embeddings.npy",
                                              "2_baidu_soccer_embeddings.npy"], split=split)
                else:
                    self.downloadGames(files=["1_baidu_soccer_embeddings.npy",
                                              "2_baidu_soccer_embeddings.npy", "Labels-v2.json"], split=split)
            ...
            for s in split:
                if s == "challenge":
                    self.downloadGames(files=["1_baidu_soccer_embeddings.npy",
                                              "2_baidu_soccer_embeddings.npy"], split=split, task="caption")
                else:
                    self.downloadGames(files=["1_baidu_soccer_embeddings.npy",
                                              "2_baidu_soccer_embeddings.npy", "Labels-caption.json"], split=split, task="caption")
            self.LocalDirectory = os.path.dirname(self.LocalDirectory)
        # 2022 and Before
