    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_awsqs_iridium_cloudconnectqs_module",
        "cdk_cloudformation_awsqs_iridium_cloudconnectqs_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_awsqs_iridium_cloudconnectqs_module._jsii": [
            "awsqs-iridium-cloudconnectqs-module@1.1.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_awsqs_iridium_cloudconnectqs_module": [
            "py.typed"
        ]
