...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(39884);

const handler = async (req, res)=>{
    const query = new URLSearchParams(req.query);
    const result = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_0__/* ["default"].apiUrl */ .Z.apiUrl}verify-where?dgid=${query?.get("dgid")}&whereExpr=${query?.get("where")}`, {
        next: {
            revalidate: 0
        }
    });
...
var __webpack_exports__ = (__webpack_exec__(60869));
