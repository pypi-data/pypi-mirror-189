...
class Connection(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            oauth2_primary (bool, requaried): oauth2 | api_key
    ...
    def _build_session(self, attempt=0):
    ...
    def _login(self, oauth2_primary, password=None, api_key=None, attempt=0):
    ...
    def _login_with_api_key(self, api_key=None, isError=False, attempt=0):
    ...
    def _login_with_oauth2(self, password, attempt=0):
    ...
    def file_request(
        self, url, file_path, data, read_type="rb", method="post", **kwargs
    ):
