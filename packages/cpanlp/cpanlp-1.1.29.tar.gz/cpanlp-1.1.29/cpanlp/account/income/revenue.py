...
class Sale(Goods):
    accounts = []
    def __init__(self, quarter=None, amount=None, growth_rate=None, year=None,customer=None,goods=None, fair_value=None,market_price=None, supply=None, demand=None, quantity=None, unit_price=None,date=None):
