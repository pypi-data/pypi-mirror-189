...
[![PyPI - Python Version](https://img.shields.io/static/v1?label=pypi&message=v1.1.19&color=blue)](https://pypi.org/project/cpanlp/)
...
## MODULE 主要模块:
- [x] **Abnormal 异象**：`Winner Curse赢者诅咒`，`Bubble 泡沫`
...
- [x] **Scheme 图示**：`Ponzi Scheme庞氏骗局`，`ESOP员工持股计划`
