...
conf = ncbi.datasets.openapi.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.ncbi.nlm.nih.gov/datasets/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ncbi.datasets.openapi")
    ...
    def auth_settings(self):
        ...
        if 'ApiKeyAuthHeader' in self.api_key:
            auth['ApiKeyAuthHeader'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'api-key',
                'value': self.get_api_key_with_prefix(
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.ncbi.nlm.nih.gov/datasets/v1",
                'description': "No description provided",
            },
            {
                'url': "https://dev.ncbi.nlm.nih.gov/datasets/v1",
                'description': "No description provided",
            }
        ]
