...
from ncbi.datasets.openapi import rest
from ncbi.datasets.openapi.configuration import Configuration
from ncbi.datasets.openapi.exceptions import ApiTypeError, ApiValueError, ApiException
from ncbi.datasets.openapi.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/14.11.2/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GeneApi()
        api_instance.download_gene_package  # this is an instance of the class Endpoint
        api_instance.download_gene_package()  # this invokes api_instance.download_gene_package.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.download_gene_package.callable or self.callable in this class
