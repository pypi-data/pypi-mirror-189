    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_awsqs_checkpoint_cloudguardqs_module",
        "cdk_cloudformation_awsqs_checkpoint_cloudguardqs_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_awsqs_checkpoint_cloudguardqs_module._jsii": [
            "awsqs-checkpoint-cloudguardqs-module@1.1.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_awsqs_checkpoint_cloudguardqs_module": [
            "py.typed"
        ]
