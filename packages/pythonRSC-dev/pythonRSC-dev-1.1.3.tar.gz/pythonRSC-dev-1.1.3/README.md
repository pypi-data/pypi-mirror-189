...
``pythonRSCdev run microcode.txt``
...
``pythonRSCdev assemble microcode.txt -o output.txt``
...
``pythonRSCdev debug microcode.txt``
...
``pythonRSCdev run microcode.txt -cfg pdf`` or ``pythonRSC debug microcode.txt -cfg png``
...
![image](https://user-images.githubusercontent.com/74928681/215964784-7da7ec39-37eb-4e04-92a4-53f999d3b3f7.png)
