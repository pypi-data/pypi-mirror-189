/*! For license information please see d3414619.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[79578],{27849:(e,t,r)=>{r(39841);var i=r(50856);r(28426);class n extends(customElements.get("app-header-layout")){static get template(){return i.d`
    ...
    `}},{kind:"method",key:"updated",value:function(e){x($(r.prototype),"updated",this).call(this,e),!this._tip&&e.has("hass")&&(this._tip=((e,t)=>{const r=[];let n=[{content:e.localize("ui.panel.config.tips.join","forums",i.dy`<a
          href="https://community.home-assistant.io"
          target="_blank"
          rel="noreferrer"
          >Forums</a
        >`,"twitter",i.dy`<a
          href=${(0,h.R)(e,"/twitter")}
          target="_blank"
          rel="noreferrer"
          >Twitter</a
        >`,"discord",i.dy`<a
          href=${(0,h.R)(e,"/join-chat")}
          target="_blank"
          rel="noreferrer"
          >Chat</a
        >`,"blog",i.dy`<a
...
//# sourceMappingURL=d3414619.js.map