class InvalidAppClassException(Exception):
    def __init__(self, app) -> None:
        super().__init__('{app} is invalid app. SDK supports Fast API and Flask'.format(app=app))


class InvalidAppDescriptorException(Exception):
    def __init__(self, message) -> None:
        super().__init__('invalid descriptor. {message}'.format(message=message))
