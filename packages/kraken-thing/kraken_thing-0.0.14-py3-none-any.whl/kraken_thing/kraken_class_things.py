...
from kraken_thing.libraries.class_small_db import Small_db 
...
class Things:
    ...
    def __init__(self):
        ...
        self.api_url = 'https://engine.krknapi.com'
    ...
    def api_post(self):
        ...
        try:
            r = requests.post(self.api_url + '/api', headers=headers, data=data)
