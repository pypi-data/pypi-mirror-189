...
class CartArray(object):
    ...
    def __len__(self) -> "std::array< double,6 >::size_type":
        return _l_master.CartArray___len__(self)

    def __getslice__(self, i: "std::array< double,6 >::difference_type", j: "std::array< double,6 >::difference_type") -> "std::array< double,6 > *":
        return _l_master.CartArray___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _l_master.CartArray___setslice__(self, *args)

    def __delslice__(self, i: "std::array< double,6 >::difference_type", j: "std::array< double,6 >::difference_type") -> "void":
        return _l_master.CartArray___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _l_master.CartArray___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::array< double,6 >::value_type const &":
    ...
    def size(self) -> "std::array< double,6 >::size_type":
        return _l_master.CartArray_size(self)

    def swap(self, v: "CartArray") -> "void":
        return _l_master.CartArray_swap(self, v)

    def begin(self) -> "std::array< double,6 >::iterator":
        return _l_master.CartArray_begin(self)

    def end(self) -> "std::array< double,6 >::iterator":
        return _l_master.CartArray_end(self)

    def rbegin(self) -> "std::array< double,6 >::reverse_iterator":
        return _l_master.CartArray_rbegin(self)

    def rend(self) -> "std::array< double,6 >::reverse_iterator":
        return _l_master.CartArray_rend(self)

    def front(self) -> "std::array< double,6 >::value_type const &":
        return _l_master.CartArray_front(self)

    def back(self) -> "std::array< double,6 >::value_type const &":
        return _l_master.CartArray_back(self)

    def fill(self, u: "std::array< double,6 >::value_type const &") -> "void":
...
class CartesianPose(object):
    ...
    def swap(self, v: "CartesianPose") -> "void":
...
class BSVector(object):
    ...
    def __len__(self) -> "std::vector< std::tuple< bool,std::string > >::size_type":
        return _l_master.BSVector___len__(self)

    def __getslice__(self, i: "std::vector< std::tuple< bool,std::string > >::difference_type", j: "std::vector< std::tuple< bool,std::string > >::difference_type") -> "std::vector< std::tuple< bool,std::string >,std::allocator< std::tuple< bool,std::string > > > *":
        return _l_master.BSVector___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _l_master.BSVector___setslice__(self, *args)

    def __delslice__(self, i: "std::vector< std::tuple< bool,std::string > >::difference_type", j: "std::vector< std::tuple< bool,std::string > >::difference_type") -> "void":
        return _l_master.BSVector___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _l_master.BSVector___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< std::tuple< bool,std::string > >::value_type const &":
        return _l_master.BSVector___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        return _l_master.BSVector___setitem__(self, *args)

    def pop(self) -> "std::vector< std::tuple< bool,std::string > >::value_type":
        return _l_master.BSVector_pop(self)

    def append(self, x: "TupleBS") -> "void":
        return _l_master.BSVector_append(self, x)

    def empty(self) -> "bool":
        return _l_master.BSVector_empty(self)

    def size(self) -> "std::vector< std::tuple< bool,std::string > >::size_type":
        return _l_master.BSVector_size(self)

    def swap(self, v: "BSVector") -> "void":
        return _l_master.BSVector_swap(self, v)

    def begin(self) -> "std::vector< std::tuple< bool,std::string > >::iterator":
        return _l_master.BSVector_begin(self)

    def end(self) -> "std::vector< std::tuple< bool,std::string > >::iterator":
        return _l_master.BSVector_end(self)

    def rbegin(self) -> "std::vector< std::tuple< bool,std::string > >::reverse_iterator":
        return _l_master.BSVector_rbegin(self)

    def rend(self) -> "std::vector< std::tuple< bool,std::string > >::reverse_iterator":
        return _l_master.BSVector_rend(self)

    def clear(self) -> "void":
        return _l_master.BSVector_clear(self)

    def get_allocator(self) -> "std::vector< std::tuple< bool,std::string > >::allocator_type":
        return _l_master.BSVector_get_allocator(self)

    def pop_back(self) -> "void":
        return _l_master.BSVector_pop_back(self)

    def erase(self, *args) -> "std::vector< std::tuple< bool,std::string > >::iterator":
        return _l_master.BSVector_erase(self, *args)

    def __init__(self, *args):
        _l_master.BSVector_swiginit(self, _l_master.new_BSVector(*args))

    def push_back(self, x: "TupleBS") -> "void":
        return _l_master.BSVector_push_back(self, x)

    def front(self) -> "std::vector< std::tuple< bool,std::string > >::value_type const &":
        return _l_master.BSVector_front(self)

    def back(self) -> "std::vector< std::tuple< bool,std::string > >::value_type const &":
        return _l_master.BSVector_back(self)

    def assign(self, n: "std::vector< std::tuple< bool,std::string > >::size_type", x: "TupleBS") -> "void":
    ...
    def reserve(self, n: "std::vector< std::tuple< bool,std::string > >::size_type") -> "void":
        return _l_master.BSVector_reserve(self, n)

    def capacity(self) -> "std::vector< std::tuple< bool,std::string > >::size_type":
...
class Robot(object):
    ...
    def __init__(self, ip: "std::string", simulator: "bool"=False):
        r"""
        构造Robot对象.
    ...
    def call(self, method: "std::string const &", params: "std::string const &") -> "std::tuple< int,std::string >":
        r"""
        示例代码:
    ...
    def teach_mode(self) -> "void":
        r"""进入示教模式."""
        return _l_master.Robot_teach_mode(self)

    def end_teach_mode(self) -> "void":
        r"""退出示教模式."""
    ...
    def towardj(self, joint_positions: "DoubleVector", a: "double", v: "double", t: "double", r: "double") -> "int":
        r"""
        示例代码:
    ...
    def move_pvat(self, p: "DoubleVector", v: "DoubleVector", a: "DoubleVector", t: "double") -> "void":
        r"""
        伺服运动PVAT
    ...
    def get_running_motion(self) -> "unsigned int":
        r"""查询当前正在运动的MotionId(无运动时返回上次MotionId)."""
        return _l_master.Robot_get_running_motion(self)

    def get_motion_state(self, id: "unsigned int") -> "std::string":
        r"""
        查询指定MotionId的运动状态.
    ...
    def get_actual_joint_positions(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        获取机械臂关节当前反馈位置
    ...
    def get_target_joint_positions(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        获取机械臂关节当前控制位置
    ...
    def get_actual_joint_speed(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        获取机械臂关节当前反馈速度
    ...
    def get_target_joint_speed(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        获取机械臂关节当前控制力矩
    ...
    def get_actual_tcp_pose(self) -> "lebai::l_master::CartesianPose":
        r"""
    ...
    def get_target_tcp_pose(self) -> "lebai::l_master::CartesianPose":
        r"""
    ...
    def get_joint_temp(self, joint_index: "unsigned int") -> "double":
        r"""
        获取单个关节温度
    ...
    def get_actual_joint_torques(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        获取机械臂关节当前反馈力矩
    ...
    def get_target_joint_torques(self) -> "std::vector< double,std::allocator< double > >":
        r"""
        获取机械臂关节当前控制力矩
    ...
    def set_do(self, device: "std::string", pin: "unsigned int", value: "unsigned int") -> "void":
        r"""
        设置数字输出
        :type device: string
    ...
    def get_do(self, device: "std::string", pin: "unsigned int") -> "unsigned int":
        r"""
        获取数字输出
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def get_dos(self, device: "std::string", pin: "unsigned int", num: "unsigned int") -> "std::vector< unsigned int,std::allocator< unsigned int > >":
        r"""
        获取多个数字输出
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def get_di(self, device: "std::string", pin: "unsigned int") -> "unsigned int":
        r"""
        获取数字输入
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def get_dis(self, device: "std::string", pin: "unsigned int", num: "unsigned int") -> "std::vector< unsigned int,std::allocator< unsigned int > >":
        r"""
        获取多个数字输入
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def set_ao(self, device: "std::string", pin: "unsigned int", value: "double") -> "void":
        r"""
        设置模拟输出
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def get_ao(self, device: "std::string", pin: "unsigned int") -> "double":
        r"""
        获取模拟输出
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def get_aos(self, device: "std::string", pin: "unsigned int", num: "unsigned int") -> "std::vector< double,std::allocator< double > >":
        r"""
        获取多个模拟输出
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def get_ai(self, device: "std::string", pin: "unsigned int") -> "double":
        r"""
        获取模拟输入
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def get_ais(self, device: "std::string", pin: "unsigned int", num: "unsigned int") -> "std::vector< double,std::allocator< double > >":
        r"""
        获取多个模拟输入
        :type device: string
        :param device: 设备类型，以字符串形式传入，包括 `ROBOT`, `FLANGE`, `EXTRA`, `SHOULDER`, `FLANGE_BTN`
    ...
    def set_dio(self, pin: "unsigned int", value: "bool") -> "bool":
        r"""
        设置数字端口输出值
        :type pin: int
        ...
        """
        return _l_master.Robot_set_dio(self, pin, value)

    def set_dio_mode(self, pin: "unsigned int", value: "bool") -> "bool":
        r"""
        设置数字端口模式
        :type pin: int
        :param pin:: 端口号，从 0 开始
        ...
        :return: 返回是否成功
        """
        return _l_master.Robot_set_dio_mode(self, pin, value)

    def get_dios(self, pin: "unsigned int", count: "unsigned int") -> "std::vector< bool,std::allocator< bool > >":
        r"""
        获取数字端口输出值
        :type pin: int
        :param pin:: 端口号，从 0 开始
        ...
        """
        return _l_master.Robot_get_dios(self, pin, count)

    def get_dios_mode(self, pin: "unsigned int", count: "unsigned int") -> "std::vector< bool,std::allocator< bool > >":
        r"""
        获取数字端口模式
        :type pin: int
        :param pin:: 端口号，从 0 开始
        ...
        """
        return _l_master.Robot_get_dios_mode(self, pin, count)

    def set_claw(self, force: "double", amplitude: "double") -> "void":
        r"""
    ...
    def get_claw(self) -> "std::tuple< double,double,bool >":
        r"""
        获取夹爪当前数据
    ...
    def set_led(self, mode: "unsigned int", speed: "unsigned int", color: "UintVector") -> "void":
        r"""
        设置LED灯状态.
    ...
    def set_voice(self, voice: "unsigned int", volume: "unsigned int") -> "void":
        r"""
        设置声音
    ...
    def set_fan(self, status: "unsigned int") -> "void":
        r"""
        开关风扇
    ...
    def set_signal(self, index: "unsigned int", value: "int") -> "void":
        r"""
        设置信号量
    ...
    def get_signal(self, index: "unsigned int") -> "int":
        r"""
        获取信号量
    ...
    def add_signal(self, index: "unsigned int", value: "int") -> "void":
        r"""
        增加指定下标的信号量值，该操作是原子的.
    ...
    def start_task(self, *args) -> "unsigned int":
        r"""
        *Overload 1:*
    ...
    def load_task_list(self) -> "std::vector< unsigned int,std::allocator< unsigned int > >":
        r"""查询任务列表"""
        return _l_master.Robot_load_task_list(self)

    def pause_task(self, id: "unsigned int", time: "unsigned long", wait: "bool") -> "void":
        r"""
        暂停任务与运动
    ...
    def resume_task(self, id: "unsigned int") -> "void":
        r"""
        恢复任务与运动
    ...
    def cancel_task(self, id: "unsigned int") -> "void":
        r"""
        取消任务与运动.
    ...
    def get_task_state(self, id: "unsigned int") -> "std::string":
        r"""
        获取任务状态.
        ...
        :param id: 任务的ID.
        """
        return _l_master.Robot_get_task_state(self, id)

    def kinematics_forward(self, joint_positions: "DoubleVector") -> "lebai::l_master::KinematicsForwardResp":
        r"""
    ...
    def kinematics_inverse(self, *args) -> "lebai::l_master::KinematicsInverseResp":
        r"""
    ...
    def pose_times(self, a: "CartesianPose", b: "CartesianPose") -> "lebai::l_master::CartesianPose":
        r"""
    ...
    def pose_inverse(self, _in: "CartesianPose") -> "lebai::l_master::CartesianPose":
        r"""
    ...
    def save_file(self, dir: "std::string const &", name: "std::string const &", is_dir: "bool", data: "std::string const &") -> "void":
        r"""
        保存文件（以字节形式）.
    ...
    def rename_file(self, from_dir: "std::string const &", from_name: "std::string const &", to_dir: "std::string const &", to_name: "std::string const &") -> "void":
        r"""
        重命名文件
    ...
    def load_file(self, dir: "std::string const &", name: "std::string const &") -> "std::tuple< bool,std::string >":
        r"""
        查询文件
    ...
    def load_file_list(self, dir: "std::string const &", prefix: "std::string const &", suffix: "std::string const &") -> "std::vector< std::tuple< bool,std::string >,std::allocator< std::tuple< bool,std::string > > >":
        r"""
        查询文件列表.
    ...
    def set_tcp(self, tcp: "CartArray") -> "void":
        r"""
        将文件从文件系统中压缩到zip文件.
    ...
    def get_tcp(self) -> "std::array< double,6 >":
        r"""
        获取当前机器人工具中心点设置.
    ...
    def set_velocity_factor(self, factor: "int") -> "void":
        r"""
        设置速度因子.
    ...
    def set_payload(self, mass: "double", cog: "CartesianPose") -> "void":
        r"""
        设置机器人末端负载.
    ...
    def get_payload(self) -> "std::tuple< double,std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > > >":
        r"""
        获取末端负载设置.
    ...
    def set_gravity(self, gravity: "CartesianPose") -> "void":
        r"""
        设置机器人重力加速度方向.
    ...
    def get_gravity(self) -> "std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > >":
        r"""
        获取机器人重力加速度的方向.
    ...
    def load_tcp(self, *args) -> "lebai::l_master::CartesianPose":
        r"""
        从资源库加载tcp.
    ...
    def write_single_coil(self, device: "std::string", addr: "std::string", value: "bool") -> "void":
        r"""
        写单个线圈.
    ...
    def wirte_multiple_coils(self, device: "std::string", addr: "std::string", values: "BVector") -> "void":
        r"""
        写多个线圈
    ...
    def read_coils(self, device: "std::string", addr: "std::string", num: "unsigned int") -> "std::vector< bool,std::allocator< bool > >":
        r"""
        读线圈
    ...
    def read_discrete_inputs(self, device: "std::string", addr: "std::string", num: "unsigned int") -> "std::vector< bool,std::allocator< bool > >":
        r"""
        读离散输入
    ...
    def write_single_register(self, device: "std::string", addr: "std::string", value: "unsigned int") -> "void":
        r"""
        写单个寄存器
    ...
    def write_multiple_registers(self, device: "std::string", addr: "std::string", values: "UintVector") -> "void":
        r"""
        写多个寄存器
    ...
    def read_holding_registers(self, device: "std::string", addr: "std::string", num: "unsigned int") -> "std::vector< unsigned int,std::allocator< unsigned int > >":
        r"""
        读保持寄存器
    ...
    def read_input_registers(self, device: "std::string", addr: "std::string", num: "unsigned int") -> "std::vector< unsigned int,std::allocator< unsigned int > >":
        r"""
        读输入寄存器
