...
class VispTestingParameters:
    ...
    visp_lamp_high_pass_filter_width_px: WavelengthParameter = WavelengthParameter(
        values=(5, 5, 300, 1)
    )
    visp_gain_hairline_fraction: float = 0.8
    ...
    visp_polcal_num_spatial_bins: int = 3
    visp_polcal_num_spectral_bins: int = 1
