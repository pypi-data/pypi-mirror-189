...
class V1CloudSpace(object):
    ...
    def __init__(self,
                 ...
                 code_config: 'V1CloudSpaceInstanceConfig' = None,
                 created_at: 'datetime' = None,
                 id: 'str' = None,
                 image_status: 'V1ImageState' = None,
                 is_cloudspace_private: 'bool' = None,
                 is_code_private: 'bool' = None,
                 mount_paths: 'list[V1MountPath]' = None,
                 name: 'str' = None,
                 project_id: 'str' = None,
    ...
    @property
    def mount_paths(self) -> 'list[V1MountPath]':
        """Gets the mount_paths of this V1CloudSpace.  # noqa: E501


        :return: The mount_paths of this V1CloudSpace.  # noqa: E501
        :rtype: list[V1MountPath]
        """
        return self._mount_paths

    @mount_paths.setter
    def mount_paths(self, mount_paths: 'list[V1MountPath]'):
        """Sets the mount_paths of this V1CloudSpace.


        :param mount_paths: The mount_paths of this V1CloudSpace.  # noqa: E501
        :type: list[V1MountPath]
        """
