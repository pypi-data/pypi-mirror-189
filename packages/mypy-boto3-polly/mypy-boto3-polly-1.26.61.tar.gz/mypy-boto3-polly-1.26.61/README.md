...
- Install `boto3-stubs[polly]` in your environment:
...
Install `boto3-stubs-lite[polly]` in your environment:
...
- Install `boto3-stubs[polly]` with services you use in your environment:
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_polly/)
