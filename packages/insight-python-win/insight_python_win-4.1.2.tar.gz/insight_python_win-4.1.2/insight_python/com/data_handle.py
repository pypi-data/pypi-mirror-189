...
from .interface.mdc_query_handledata_class import query_response_handle
    ...
    def OnPlaybackMarketData(self, marketdatajson):
        try:
            ...
            # MD_KLINE:实时数据只提供15S和1MIN K线
                    ...
                    == EMarketDataType.MD_KLINE_1MIN:
                result = playback_kline_handle(marketdatajson)
                if result:
                    self.marketservice.on_playback_kline(result)
