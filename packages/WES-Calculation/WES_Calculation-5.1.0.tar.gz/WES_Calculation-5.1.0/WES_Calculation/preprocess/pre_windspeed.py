...
LastEditTime : 2023-02-01 13:40:50
LastEditors  : BDFD
Description  : 
...
def pre_windspeed(original_input):
    ...
    if o2 == 1:
        ...
        input_X = None
        input_Rg = None
        function_input.update({"zw":12, "Xlat":None, "X":None, "Rg":None})
    ...
    function_input.update({"beta":21, "atm":3, "Ta":20, "zt":20, "Tw":16, "Taa":6.667, "wdu":10, "zu":50})
