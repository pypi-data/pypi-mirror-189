...
class UpdateSmsNotification(object):
    ...
    def __init__(self, description=None, body=None, recipients=None, local_vars_configuration=None):  # noqa: E501
        """UpdateSmsNotification - a model defined in OpenAPI"
    ...
    def description(self):
        """Gets the description of this UpdateSmsNotification.  # noqa: E501

        The summary of the services provided by the notification  # noqa: E501

        :return: The description of this UpdateSmsNotification.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this UpdateSmsNotification.

        The summary of the services provided by the notification  # noqa: E501

        :param description: The description of this UpdateSmsNotification.  # noqa: E501
        :type description: str
        """
    ...
    @property
    def body(self):
        """Gets the body of this UpdateSmsNotification.  # noqa: E501

        The body of the SMS  # noqa: E501

        :return: The body of this UpdateSmsNotification.  # noqa: E501
        :rtype: str
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this UpdateSmsNotification.

        The body of the SMS  # noqa: E501

        :param body: The body of this UpdateSmsNotification.  # noqa: E501
        :type body: str
        """
    ...
    @property
    def recipients(self):
        """Gets the recipients of this UpdateSmsNotification.  # noqa: E501

        The phone numbers to which the SMS will be sent to (E.164 format)  # noqa: E501

        :return: The recipients of this UpdateSmsNotification.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def recipients(self, recipients):
        """Sets the recipients of this UpdateSmsNotification.

        The phone numbers to which the SMS will be sent to (E.164 format)  # noqa: E501

        :param recipients: The recipients of this UpdateSmsNotification.  # noqa: E501
        :type recipients: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSmsNotification):
            return False
