...
from mxdevtool import TimeDateGrid_Dates, TimeDateGrid_Equal, TimeDateGrid_Times, TimeDateGrid_Custom
...
class ScenarioBuilder:
    ...
    def reset(self):
        ...
        d['timegrid'] = mx.TimeDateGrid_Equal(mx.Date_todaysDate(), 10, 12).toDict()
...
class Scenario:
    def __init__(self, models: mx.ProcessModelVector, calcs: mx.ProcessValueVector, corr: mx.Matrix, timegrid: mx.TimeDateGrid, rsg: mx.core_Rsg, filename: str, isMomentMatching: bool = False):
