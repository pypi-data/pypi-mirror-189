...
class Libor(mx.core_LiborCalc):
    def __init__(self, name: str, ir_pv: mx.ProcessValue, iborIndex: mx.IborIndex, fixing=None):
        self._ir_pv = ir_pv
        ...
        mx.core_LiborCalc.__init__(self, name, ir_pv, iborIndex, fixing_conv)


class SwapRate(mx.core_SwapRateCalc):
    def __init__(self, name: str, ir_pv: mx.ProcessValue, swapIndex: mx.SwapIndex, fixing=None):
        self._ir_pv = ir_pv
        ...
        mx.core_SwapRateCalc.__init__(self, name, ir_pv, swapIndex, fixing_conv)
