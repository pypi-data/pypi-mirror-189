...
class FireStorage(Uploader):
  ...
  class Poster(UploaderPoster):
    ...
    def __init__(self, file: Union[IO, str], folder_id: str = None, server_id: int = None, ppass='', dpass='', thumbnail="normal", top =  '1', jqueryupload_1 =  '1', max_size =  '2147483648', max_sized =  '2', max_size_photo_1 =  '15728640', max_size_photod =  '15', max_size_photo_2 =  '150', max_count =  '20', max_count_photo =  '150', jqueryupload_2 =  '1', eid =  '', qst =  '', comments =  '', comment =  '', arc =  '', zips =  '', file_queue =  '1', pc =  '1', exp =  '1' ):
      self._file = file
