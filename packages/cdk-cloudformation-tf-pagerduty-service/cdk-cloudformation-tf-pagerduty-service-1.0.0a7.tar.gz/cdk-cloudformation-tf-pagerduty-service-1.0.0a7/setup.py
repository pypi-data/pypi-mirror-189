    ...
    """
{
    ...
    "license": "Apache-2.0",
    "url": "https://github.com/iann0036/cfn-tf-custom-types/blob/docs/resources/pagerduty/TF-PagerDuty-Service/docs/README.md",
    ...
    "packages": [
        "cdk_cloudformation_tf_pagerduty_service",
        "cdk_cloudformation_tf_pagerduty_service._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_tf_pagerduty_service._jsii": [
            "tf-pagerduty-service@1.0.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_tf_pagerduty_service": [
            "py.typed"
        ]
