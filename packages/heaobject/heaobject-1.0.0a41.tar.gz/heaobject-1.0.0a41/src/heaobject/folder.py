...
from .aws import S3URIMixin, S3StorageClassMixin
...
class AWSS3Folder(S3URIMixin, Folder, S3StorageClassMixin):
    """
...
class AWSS3Item(Item, S3StorageClassMixin, S3URIMixin):
    """
