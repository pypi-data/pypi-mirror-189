...
# Maps an aggregation proto to its respective simple string name used to create the output feature column name.
...
def create_aggregate_features(
    ...
    feature_function = AGGREGATION_FUNCTION_STR_TO_ENUM[feature_aggregation.function.lower()]
