...
def data_type_to_column_type(data_type: DataType) -> column_type_pb2.ColumnType:
    if isinstance(data_type, StringType):
        return column_type_pb2.ColumnType.COLUMN_TYPE_STRING
    elif isinstance(data_type, (Int64Type, Int32Type)):
        return column_type_pb2.ColumnType.COLUMN_TYPE_INT64
    elif isinstance(data_type, Float64Type):
        return column_type_pb2.ColumnType.COLUMN_TYPE_DOUBLE
    elif isinstance(data_type, BoolType):
        return column_type_pb2.ColumnType.COLUMN_TYPE_BOOL
    elif isinstance(data_type, TimestampType):
        return column_type_pb2.ColumnType.COLUMN_TYPE_DERIVE_FROM_DATA_TYPE
    else:
