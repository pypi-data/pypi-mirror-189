...
def Broken(arr, fre, ticks, EXPORT, labels, figsize, vertical, broken, legend, color):
    fig, (ax1, ax2) = plt.subplots(2, 1, sharex=True, height_ratios=[broken[2], 1-broken[2]], figsize=figsize)
    fig.subplots_adjust(hspace=0.0)
    ax1.plot(arr,fre.T,color='%s'%color,linewidth=0.8,linestyle='-')
    ax2.plot(arr,fre.T,color='%s'%color,linewidth=0.8,linestyle='-')
    ...
    ax2.legend(legend, frameon=False, prop={'size':'medium'}, loc='upper right')
...
def Nobroken(arr, fre, ticks, EXPORT, labels, figsize, vertical, legend, color):
    ...
    plt.plot(arr,fre.T,color='%s'%color,linewidth=0.8,linestyle='-')
...
def BrokenWd(arr, fre, ticks, EXPORT, labels, figsize, vertical, broken, darr, dele, elements, width_ratios, legend, color):
    fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, height_ratios=[broken[2], 1-broken[2]], width_ratios=[1-width_ratios, width_ratios], figsize=figsize)
    fig.subplots_adjust(wspace=0.0, hspace=0.0)
    ax1.plot(arr,fre.T,color='%s'%color,linewidth=0.8,linestyle='-')
    ax3.plot(arr,fre.T,color='%s'%color,linewidth=0.8,linestyle='-')
    ...
    ax3.legend(legend, frameon=False, prop={'size':'small'}, loc='upper right')
    ax4.legend(elements, frameon=False, prop={'size':'x-small'}, loc='upper right')
    ...
    ax4.set_xlabel('Density of states', labelpad=0, style='italic', size='x-small')
    plt.suptitle('Frequency (THz)', rotation=90, x=0.06, y=0.6, size='medium')
    kwargs = dict(marker=[(-1, -1), (1, 1)], markersize=6,
                  linestyle='', color='k', mec='k', mew=1, clip_on=False)
    ax1.plot([0, 1], [0.02, 0.02], transform=ax1.transAxes, **kwargs)
...
def NobrokenWd(arr, fre, ticks, EXPORT, labels, figsize, vertical, darr, dele, elements, width_ratios, legend, color):
    ...
    ax1.legend(legend, frameon=False, prop={'size':'small'}, loc='upper right')
    ax2.legend(elements, frameon=False, prop={'size':'x-small'}, loc='upper right')
    ...
    ax2.set_xlabel('Density of states', labelpad=0, style='italic', size='x-small')
