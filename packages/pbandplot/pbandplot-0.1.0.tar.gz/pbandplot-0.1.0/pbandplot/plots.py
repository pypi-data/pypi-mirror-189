...
def Broken(arr, fre, ticks, EXPORT, labels, figsize, vertical, broken, legend, color):
    ...
    ax1.legend(legend, frameon=False, prop={'size':'medium'}, loc='upper right')
...
def BrokenWd(arr, fre, ticks, EXPORT, labels, figsize, vertical, broken, darr, dele, elements, width_ratios, legend, color):
    ...
    ax2.legend(elements, title='Density of states', title_fontproperties={'style':'italic','size':'x-small'}, frameon=False, prop={'size':'x-small'}, loc='upper right')
