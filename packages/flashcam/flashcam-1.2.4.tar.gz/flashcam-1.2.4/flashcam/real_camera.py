...
class Camera(BaseCamera):
    ...
    def init_cam(  ):
        ...
        if len(vids)>0:
            ...
            print(f"i... setting RESOLUTION: {w} x {h} and PIXELFORMAT {fourcc}")
    ...
    def frames( ):
        ...
        while (vidnum is None) or (vidnum == -1):
            cap, vidnum = camera.init_cam(  ) # can return None,None
            ...
            if ret: #********************************************************* operations
                ...
                if senh.add_frame(frame):  # it is a proper image....
                    ...
                    if (threshold>0) :
                        ...
                        senh.setbox(MODE_DM, senh.MODE) #---push UP to avoid DetMot
