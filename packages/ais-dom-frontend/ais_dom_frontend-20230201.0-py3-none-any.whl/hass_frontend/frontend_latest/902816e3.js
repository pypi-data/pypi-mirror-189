/*! For license information please see 902816e3.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[28922],{89194:(e,t,i)=>{i(10994),i(65660),i(70019);var r=i(9672),o=i(50856);(0,r.k)({_template:o.d`
    <style>
      :host {
...
`;!function(e,t,i,r){var o=l();if(r)for(var n=0;n<r.length;n++)o=r[n](o);var s=t((function(e){o.initializeInstanceElements(e,a.elements)}),i),a=o.decorateClass(function(e){for(var t=[],i=function(e){return"method"===e.kind&&e.key===n.key&&e.placement===n.placement},r=0;r<e.length;r++){var o,n=e[r];if("method"===n.kind&&(o=t.find(i)))if(p(n.descriptor)||p(o.descriptor)){if(h(n)||h(o))throw new ReferenceError("Duplicated methods ("+n.key+") can't be decorated.");o.descriptor=n.descriptor}else{if(h(n)){if(h(o))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+n.key+").");o.decorators=n.decorators}d(n,o)}else t.push(n)}return t}(s.d.map(c)),e);o.initializeClassElements(s.F,a.elements),o.runClassFinishers(s.F,a.finishers)}([(0,s.Mo)("ha-dialog")],(function(e,t){class i extends t{constructor(...t){super(...t),e(this)}}return{F:i,d:[{kind:"field",key:a.gA,value:void 0},{kind:"method",key:"scrollToPos",value:function(e,t){var i;null===(i=this.contentElement)||void 0===i||i.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return n.dy`<slot name="heading"> ${y(g(i.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"method",key:"firstUpdated",value:function(){y(g(i.prototype),"firstUpdated",this).call(this),this.suppressDefaultPressSelector=[this.suppressDefaultPressSelector,b].join(", ")}},{kind:"field",static:!0,key:"styles",value:()=>[o.W,n.iv`
    ...
    `}},{kind:"method",key:"_unsupportedDialog",value:async function(){await(0,m.Ys)(this,{title:this.hass.localize("ui.dialogs.unsupported.title"),text:r.dy`${this.hass.localize("ui.dialogs.unsupported.description")}
        ...
        <ul>
          ${this._resolutionInfo.unsupported.map((e=>r.dy`
              <li>
                <a
                  href=${(0,v.R)(this.hass,z[e]||`/more-info/unsupported/${e}`)}
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        <ul>
          ${this._resolutionInfo.unhealthy.map((e=>r.dy`
              <li>
                <a
                  href=${(0,v.R)(this.hass,A[e]||`/more-info/unhealthy/${e}`)}
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            `))}
        </ul>`})}},{kind:"method",key:"_getSections",value:function(){const e=[];if(this._systemInfo){const t=Object.keys(this._systemInfo).sort(S);for(const i of t){const t=this._systemInfo[i],o=[];for(const e of Object.keys(t.info)){let n;if(t.info[e]&&"object"==typeof t.info[e]){const i=t.info[e];"pending"===i.type?n=r.dy`
          ...
          `)}"homeassistant"!==i&&e.push(r.dy`
              <div class="card-header">
                <h3>${(0,u.Lh)(this.hass.localize,i)}</h3>
                ${t.manage_url?r.dy`
    ...
    `]}]}}),r.oi)}))}}]);
//# sourceMappingURL=902816e3.js.map