...
`;!function(e,t,r,i){var o=d();if(i)for(var n=0;n<i.length;n++)o=i[n](o);var a=t((function(e){o.initializeInstanceElements(e,s.elements)}),r),s=o.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===n.key&&e.placement===n.placement},i=0;i<e.length;i++){var o,n=e[i];if("method"===n.kind&&(o=t.find(r)))if(f(n.descriptor)||f(o.descriptor)){if(p(n)||p(o))throw new ReferenceError("Duplicated methods ("+n.key+") can't be decorated.");o.descriptor=n.descriptor}else{if(p(n)){if(p(o))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+n.key+").");o.decorators=n.decorators}c(n,o)}else t.push(n)}return t}(a.d.map(l)),e);o.initializeClassElements(a.F,s.elements),o.runClassFinishers(a.F,s.finishers)}([(0,a.Mo)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"field",key:s.gA,value:void 0},{kind:"method",key:"scrollToPos",value:function(e,t){var r;null===(r=this.contentElement)||void 0===r||r.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return n.dy`<slot name="heading"> ${g(b(r.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"method",key:"firstUpdated",value:function(){g(b(r.prototype),"firstUpdated",this).call(this),this.suppressDefaultPressSelector=[this.suppressDefaultPressSelector,y].join(", ")}},{kind:"field",static:!0,key:"styles",value:()=>[o.W,n.iv`
      ...
      >
        <div slot="heading">
          <ha-header-bar>
            ...
            ></ha-icon-button>
            <a
              href=${(0,l.R)(this.hass,"/docs/assist/")}
              slot="actionItems"
              target="_blank"
          ...
          <div class="messages-container" id="scroll-container">
            ...
            ${this.results?i.dy`
                  <div class="message user">
                    <span
                      class=${(0,n.$)({interimTranscript:!this.results.final})}
    ...
    `:i.dy``}},{kind:"method",key:"firstUpdated",value:function(e){var t,i;b(x(r.prototype),"updated",this).call(this,e),this._conversation=[{who:"hass",text:this.hass.localize("ui.dialogs.voice_command.how_can_i_help")}],t=this.hass,i=this.hass.language,t.callWS({type:"conversation/prepare",language:i})}},{kind:"method",key:"updated",value:function(e){b(x(r.prototype),"updated",this).call(this,e),(e.has("_conversation")||e.has("results"))&&this._scrollMessagesBottom()}},{kind:"method",key:"_addMessage",value:function(e){this._conversation=[...this._conversation,e]}},{kind:"method",key:"_handleKeyUp",value:function(e){const t=e.target;13===e.keyCode&&t.value&&(this._processText(t.value),t.value="",this._showSendButton=!1)}},{kind:"method",key:"_handleInput",value:function(e){const t=e.target.value;t&&!this._showSendButton?this._showSendButton=!0:!t&&this._showSendButton&&(this._showSendButton=!1)}},{kind:"method",key:"_handleSendMessage",value:function(){this._messageInput.value&&(this._processText(this._messageInput.value),this._messageInput.value="",this._showSendButton=!1)}},{kind:"method",key:"_initRecognition",value:function(){this.recognition=new s,this.recognition.interimResults=!0,this.recognition.lang=this.hass.language,this.recognition.continuous=!1,this.recognition.addEventListener("start",(()=>{this.results={final:!1,transcript:""}})),this.recognition.addEventListener("nomatch",(()=>{this._addMessage({who:"user",text:`<${this.hass.localize("ui.dialogs.voice_command.did_not_understand")}>`,error:!0})})),this.recognition.addEventListener("error",(e=>{if(console.error("Error recognizing text",e),this.recognition.abort(),"aborted"!==e.error&&"no-speech"!==e.error){const e=this.results&&this.results.transcript?this.results.transcript:`<${this.hass.localize("ui.dialogs.voice_command.did_not_hear")}>`;this._addMessage({who:"user",text:e,error:!0})}this.results=null})),this.recognition.addEventListener("end",(()=>{if(null==this.results)return;const e=this.results.transcript;this.results=null,e?this._processText(e):this._addMessage({who:"user",text:`<${this.hass.localize("ui.dialogs.voice_command.did_not_hear")}>`,error:!0})})),this.recognition.addEventListener("result",(e=>{const t=e.results[0];this.results={transcript:t[0].transcript,final:t.isFinal}}))}},{kind:"method",key:"_processText",value:async function(e){this.recognition&&this.recognition.abort(),this._addMessage({who:"user",text:e});const t={who:"hass",text:"…"};this._addMessage(t);try{var r;const i=await((e,t,r,i)=>e.callWS({type:"conversation/process",text:t,conversation_id:r,language:i}))(this.hass,e,this._conversationId,this.hass.language);this._conversationId=i.conversation_id;const o=null===(r=i.response.speech)||void 0===r?void 0:r.plain;t.text=o?o.speech:"<silence>",this.requestUpdate("_conversation")}catch{t.text=this.hass.localize("ui.dialogs.voice_command.error"),t.error=!0,this.requestUpdate("_conversation")}}},{kind:"method",key:"_toggleListening",value:function(){this.results?this._stopListening():this._startListening()}},{kind:"method",key:"_stopListening",value:function(){this.recognition&&this.recognition.stop()}},{kind:"method",key:"_startListening",value:function(){this.recognition||this._initRecognition(),this.results||(this.results={transcript:"",final:!1},this.recognition.start())}},{kind:"method",key:"_scrollMessagesBottom",value:function(){this._scrollContainer.scrollTo(0,99999)}},{kind:"method",key:"_computeMessageClasses",value:function(e){return`message ${e.who} ${e.error?" error":""}`}},{kind:"get",static:!0,key:"styles",value:function(){return[d.yu,i.iv`
