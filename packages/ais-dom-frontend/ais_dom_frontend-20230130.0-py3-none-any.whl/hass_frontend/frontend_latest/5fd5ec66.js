      ...
      >
        <mwc-list>
          ...
          <mwc-list-item hasmeta twoline @click=${this._blank}>
            ...
            <span slot="secondary">
              ${this.hass.localize("ui.panel.config.automation.dialog_new.start_empty_description")}
            </span>
            <ha-icon-next slot="meta"></ha-icon-next>
          </mwc-list-item>
        </mwc-list>
      </ha-dialog>
    `:i.dy``}},{kind:"method",key:"_blueprintPicked",value:async function(e){this.closeDialog(),(0,s.Ip)({use_blueprint:{path:e.detail.value}})}},{kind:"method",key:"_blueprint",value:async function(){this.shadowRoot.querySelector("ha-blueprint-picker").open()}},{kind:"method",key:"_blank",value:async function(){this.closeDialog(),(0,s.Ip)()}},{kind:"get",static:!0,key:"styles",value:function(){return[l.Qx,l.yu,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=5fd5ec66.js.map