...
# Optimizer options
FORM.append(
    Form(display_ifs=[only_for_tf_and_keras])
    ...
    .append(
        SelectControl(
            ...
            [
                ...
                SelectOption('nadam_optimizer', 'NADAM Optimizer'),
                SelectOption('rectified_adam_optimizer', 'Rectified ADAM Optimizer'),
                SelectOption('yogi_optimizer', 'Yogi Optimizer'),
            ],
        )
    )
)
...
FORM.append(ToggleControl('balance', "Class balancing", default_value=False, protobuf_setter_fn=add_class_balancing))
FORM.append(
    InputControl(
        'dataset.margin_crop',
        ...
        .append(
            ...
            .append(
                SelectControl(
                    ...
                    [
                        SelectOption('v1', 'More color & BBoxes vertical translate transformations'),
                        SelectOption('v3', 'More contrast & vertical translate transformations')
                    ],
                    display_ifs=[view_detection]
                )
            )
            .append(
                SelectControl(
                    ...
                    "Choose a policy version:",
                    [
                        SelectOption('v4', 'Original AutoAugment policy'),
                    ],
                    display_ifs=[view_classif_tagging]
                )
            )
