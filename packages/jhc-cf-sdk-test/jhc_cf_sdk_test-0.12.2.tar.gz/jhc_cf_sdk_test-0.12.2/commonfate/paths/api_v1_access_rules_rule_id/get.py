...
SchemaFor200ResponseBodyApplicationJson = RequestAccessRule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_get_access_rule_oapg(
        self,
...
class UserGetAccessRule(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def user_get_access_rule(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def user_get_access_rule(
        ...
        return self._user_get_access_rule_oapg(
