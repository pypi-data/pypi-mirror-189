...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'refresh': typing.Union[RefreshSchema, bool, ],
    },
    total=False
)
...
request_query_refresh = api_client.QueryParameter(
    name="refresh",
...
ArgIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'providerId': typing.Union[ProviderIdSchema, str, ],
        'argId': typing.Union[ArgIdSchema, str, ],
    }
)
...
request_path_provider_id = api_client.PathParameter(
    name="providerId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProviderIdSchema,
    required=True,
)
request_path_arg_id = api_client.PathParameter(
    name="argId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ArgIdSchema,
    required=True,
