...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["users", "next", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["users", "next", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_get_access_rule_approvers_oapg(
        self,
...
class UserGetAccessRuleApprovers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def user_get_access_rule_approvers(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def user_get_access_rule_approvers(
        ...
        return self._user_get_access_rule_approvers_oapg(
