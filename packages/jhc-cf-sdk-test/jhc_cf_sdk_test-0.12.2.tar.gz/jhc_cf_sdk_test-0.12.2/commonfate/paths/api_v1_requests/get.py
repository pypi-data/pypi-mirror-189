...
class StatusSchema(
    ...
    def PENDING(cls):
        return cls("PENDING")
ReviewerSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'reviewer': typing.Union[ReviewerSchema, bool, ],
...
request_query_reviewer = api_client.QueryParameter(
    name="reviewer",
    style=api_client.ParameterStyle.FORM,
...
class SchemaFor200ResponseBodyApplicationJson(
        ...
        class properties:
            ...
            class requests(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Request']:
                        return Request
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Request'], typing.List['Request']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["requests", "next", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["requests", "next", ], str]):
...
class UserListRequests(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def user_list_requests(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def user_list_requests(
        ...
        return self._user_list_requests_oapg(
