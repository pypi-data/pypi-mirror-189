...
# Path params
StepIndexSchema = schemas.IntSchema
ProvidersetupIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'stepIndex': typing.Union[StepIndexSchema, decimal.Decimal, int, ],
...
request_path_step_index = api_client.PathParameter(
    name="stepIndex",
...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["complete", "configValues", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["complete", "configValues", ], str]):
        return super().get_item_oapg(name)
...
SchemaFor200ResponseBodyApplicationJson = ProviderSetup
