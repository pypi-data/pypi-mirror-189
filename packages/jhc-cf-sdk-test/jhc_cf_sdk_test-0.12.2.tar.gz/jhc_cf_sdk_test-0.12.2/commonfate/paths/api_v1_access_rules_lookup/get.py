...
class TypeSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "commonfate/aws-sso": "COMMONFATE_AWSSSO",
        }
    
    @schemas.classproperty
    def COMMONFATE_AWSSSO(cls):
        return cls("commonfate/aws-sso")
PermissionSetArnLabelSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'permissionSetArn.label': typing.Union[PermissionSetArnLabelSchema, str, ],
...
request_query_permission_set_arn_label = api_client.QueryParameter(
    name="permissionSetArn.label",
    style=api_client.ParameterStyle.FORM,
    schema=PermissionSetArnLabelSchema,
    explode=True,
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['LookupAccessRule']:
            return LookupAccessRule

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['LookupAccessRule'], typing.List['LookupAccessRule']],
    ...
    def __getitem__(self, i: int) -> 'LookupAccessRule':
...
class BaseApi(api_client.Api):
    ...
    def _access_rule_lookup_oapg(
        ...
        for parameter in (
            request_query_type,
            request_query_permission_set_arn_label,
