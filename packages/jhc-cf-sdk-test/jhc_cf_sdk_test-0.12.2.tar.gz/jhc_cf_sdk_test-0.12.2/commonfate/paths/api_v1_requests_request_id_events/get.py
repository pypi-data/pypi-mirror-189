...
class SchemaFor200ResponseBodyApplicationJson(
        ...
        class properties:
            ...
            class events(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RequestEvent']:
                        return RequestEvent
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RequestEvent'], typing.List['RequestEvent']],
                ...
                def __getitem__(self, i: int) -> 'RequestEvent':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["events", "next", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["events", "next", ], str]):
