...
class TestApiV1AdminAccessRulesRuleIdVersions(ApiTestMixin, unittest.TestCase):
    """
    ApiV1AdminAccessRulesRuleIdVersions unit test stubs
        Get Access Rule version history  # noqa: E501
    """
