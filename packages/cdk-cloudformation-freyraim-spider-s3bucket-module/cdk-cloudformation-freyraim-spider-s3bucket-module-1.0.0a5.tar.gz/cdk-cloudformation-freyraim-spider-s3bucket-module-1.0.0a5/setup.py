    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_freyraim_spider_s3bucket_module",
        "cdk_cloudformation_freyraim_spider_s3bucket_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_freyraim_spider_s3bucket_module._jsii": [
            "freyraim-spider-s3bucket-module@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_freyraim_spider_s3bucket_module": [
            "py.typed"
        ]
