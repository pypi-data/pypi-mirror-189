...
from typing import TextIO, TypeAlias, Any
...
class Odb:
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.static_data_dir: str = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "static")

        self.odb_file: str = kwargs.get("odb_file", "")
        self.hdf_file: str = kwargs.get("hdf_file", "")

        self.results_dir: str = self.make_results_dir()
    ...
    def make_results_dir(self) -> str:
        results_dir: str = os.path.join(self.cwd, "results")
    ...
    def odb_to_hdf(self, hdf_file_path: str) -> None:
        ...
        odb_to_npz_script_path: str = os.path.join(self.static_data_dir, "odb_to_npz.py")
    ...
    def process_hdf(self) -> None:
        ...
        with Pool() as pool:
            ...
            results: pd.DataFrame = pool.starmap(read_node_data, data)
