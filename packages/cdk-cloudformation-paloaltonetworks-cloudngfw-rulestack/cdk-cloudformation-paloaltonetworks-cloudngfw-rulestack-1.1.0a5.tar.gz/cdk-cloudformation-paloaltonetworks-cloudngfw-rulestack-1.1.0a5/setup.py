    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_paloaltonetworks_cloudngfw_rulestack",
        "cdk_cloudformation_paloaltonetworks_cloudngfw_rulestack._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_paloaltonetworks_cloudngfw_rulestack._jsii": [
            "paloaltonetworks-cloudngfw-rulestack@1.1.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_paloaltonetworks_cloudngfw_rulestack": [
            "py.typed"
        ]
