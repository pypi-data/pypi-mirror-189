...
from classe.HttpReq.nutsFetchGet import nutsFetchGet
...
class OrganizationMethods:
    ...
    def getVendor(self, did):
        ...
        getDIDdoc = nutsFetchGet(f'http://{internal_node_ip}:{internal_node_port}/internal/vdr/v1/did/{did}')
    ...
    def getTrusted(self, did):
        ...
        getTrustedOrganizations = nutsFetchGet(
            f'http://{internal_node_ip}:{internal_node_port}/internal/vcr/v2/verifier/NutsOrganizationCredential/trusted')
    ...
    def getNutsCommService(self, did):
        getServiceForVendor = nutsFetchGet(f'http://{internal_node_ip}:{internal_node_port}/internal/vdr/v1/did/{did}')
    ...
    def eOverdracht_Type(self, did):
        GETeOverdrachtReceiver = nutsFetchGet(f'http://{internal_node_ip}:{internal_node_port}/internal/vdr/v1/did/{did}')
