...
class ErrorSearchResponseData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project, error, *args, **kwargs):  # noqa: E501
        """ErrorSearchResponseData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, project, error, *args, **kwargs):  # noqa: E501
        """ErrorSearchResponseData - a model defined in OpenAPI
