...
class ProjectSummaryResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project, total_participants, total_samples, total_sequences, cram_seqr_stats, batch_sequence_stats, participants, participant_keys, sample_keys, sequence_keys, seqr_links, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, project, total_participants, total_samples, total_sequences, cram_seqr_stats, batch_sequence_stats, participants, participant_keys, sample_keys, sequence_keys, seqr_links, *args, **kwargs):  # noqa: E501
        """ProjectSummaryResponse - a model defined in OpenAPI
