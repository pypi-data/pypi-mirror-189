    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_jfrog_xray_ec2instance_module",
        "cdk_cloudformation_jfrog_xray_ec2instance_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_jfrog_xray_ec2instance_module._jsii": [
            "jfrog-xray-ec2instance-module@1.6.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_jfrog_xray_ec2instance_module": [
            "py.typed"
        ]
