...
if sys.version_info < (3, 6):
    sys.exit("Error: pyre-check-nightly only runs on Python 3.6 and above.")
...
def main() -> None:
    ...
    run(
        package_name="pyre-check-nightly",
        package_version="0.0.101675599018",
        module_name="pyre_check",
        runtime_dependencies=json.loads(r"""["click>=8.0", "dataclasses-json", "intervaltree", "libcst", "psutil", "pyre-extensions>=0.0.29", "tabulate", "testslide>=2.7.0", "typing_extensions"]"""),
        long_description=long_description,
    )
