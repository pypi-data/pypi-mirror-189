...
class _SuffixTreeParser:  # (beam.DoFn):
    ...
    def process(self, record: Dict):  # -> Generator[Tuple[int, bytes]]?
...
try:
    ...
    class SuffixTreeParser(beam.DoFn, _SuffixTreeParser):
        pass

    class SuffixTreeMerge(beam.CombineFn, _SuffixTreeMerge):
        pass
