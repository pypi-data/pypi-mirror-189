...
def test_cpuawkward_IndexedArray64_flatten_nextcarry_64_1():
    tocarry = [123, 123, 123]
...
def test_cpuawkward_IndexedArray64_flatten_nextcarry_64_2():
    tocarry = [123, 123, 123]
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
...
def test_cpuawkward_IndexedArray64_flatten_nextcarry_64_3():
    tocarry = [123]
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
...
def test_cpuawkward_IndexedArray64_flatten_nextcarry_64_4():
    tocarry = [123]
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
...
def test_cpuawkward_IndexedArray64_flatten_nextcarry_64_5():
    tocarry = [123, 123, 123]
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
