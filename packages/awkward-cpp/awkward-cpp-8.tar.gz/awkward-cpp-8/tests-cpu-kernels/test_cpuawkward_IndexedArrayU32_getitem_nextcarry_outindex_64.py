...
def test_cpuawkward_IndexedArrayU32_getitem_nextcarry_outindex_64_1():
    tocarry = [123, 123, 123]
...
def test_cpuawkward_IndexedArrayU32_getitem_nextcarry_outindex_64_2():
    tocarry = [123]
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
    toindex = [123]
    toindex = (ctypes.c_uint32*len(toindex))(*toindex)
...
def test_cpuawkward_IndexedArrayU32_getitem_nextcarry_outindex_64_3():
    tocarry = [123, 123, 123]
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
    toindex = [123, 123, 123]
    toindex = (ctypes.c_uint32*len(toindex))(*toindex)
