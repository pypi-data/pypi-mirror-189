...
def test_cpuawkward_UnionArray_fillindex_to64_from64_1():
...
def test_cpuawkward_UnionArray_fillindex_to64_from64_2():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    toindexoffset = 3
...
def test_cpuawkward_UnionArray_fillindex_to64_from64_3():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    toindexoffset = 3
...
def test_cpuawkward_UnionArray_fillindex_to64_from64_4():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    toindexoffset = 3
...
def test_cpuawkward_UnionArray_fillindex_to64_from64_5():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    toindexoffset = 3
