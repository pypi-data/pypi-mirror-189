...
def test_cpuawkward_ListOffsetArray32_compact_offsets_64_1():
...
def test_cpuawkward_ListOffsetArray32_compact_offsets_64_2():
    tooffsets = [123, 123, 123, 123]
    tooffsets = (ctypes.c_int64*len(tooffsets))(*tooffsets)
...
def test_cpuawkward_ListOffsetArray32_compact_offsets_64_3():
    tooffsets = [123, 123, 123, 123]
    tooffsets = (ctypes.c_int64*len(tooffsets))(*tooffsets)
...
def test_cpuawkward_ListOffsetArray32_compact_offsets_64_4():
    tooffsets = [123, 123, 123, 123]
    tooffsets = (ctypes.c_int64*len(tooffsets))(*tooffsets)
...
def test_cpuawkward_ListOffsetArray32_compact_offsets_64_5():
    tooffsets = [123, 123, 123, 123]
    tooffsets = (ctypes.c_int64*len(tooffsets))(*tooffsets)
