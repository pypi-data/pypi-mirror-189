...
def test_cpuawkward_IndexedArray_fill_to64_from32_1():
...
def test_cpuawkward_IndexedArray_fill_to64_from32_2():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    toindexoffset = 3
...
def test_cpuawkward_IndexedArray_fill_to64_from32_3():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    toindexoffset = 3
...
def test_cpuawkward_IndexedArray_fill_to64_from32_4():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    toindexoffset = 3
...
def test_cpuawkward_IndexedArray_fill_to64_from32_5():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    toindexoffset = 3
