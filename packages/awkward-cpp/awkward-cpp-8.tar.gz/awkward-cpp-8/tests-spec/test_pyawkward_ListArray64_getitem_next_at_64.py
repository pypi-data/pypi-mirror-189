...
def test_pyawkward_ListArray64_getitem_next_at_64_1():
    tocarry = [123, 123, 123]
    fromstarts = [2, 0, 2, 1, 2, 1, 2, 1, 2, 1, 2, 1]
    fromstops = [3, 2, 4, 5, 3, 4, 2, 5, 3, 4, 6, 11]
    lenstarts = 3
    at = 0
    funcPy = getattr(kernels, 'awkward_ListArray64_getitem_next_at_64')
...
def test_pyawkward_ListArray64_getitem_next_at_64_2():
    tocarry = [123]
