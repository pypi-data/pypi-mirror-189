...
def test_pyawkward_ListArray32_validity_1():
    starts = [2, 0, 2, 1, 2, 1, 2, 1, 2, 1, 2, 1]
    stops = [3, 2, 4, 5, 3, 4, 2, 5, 3, 4, 6, 11]
    length = 3
    lencontent = 3
    funcPy = getattr(kernels, 'awkward_ListArray32_validity')
    with pytest.raises(Exception):
        funcPy(starts=starts, stops=stops, length=length, lencontent=lencontent)

def test_pyawkward_ListArray32_validity_2():
...
def test_pyawkward_ListArray32_validity_3():
...
def test_pyawkward_ListArray32_validity_4():
...
def test_pyawkward_ListArray32_validity_5():
