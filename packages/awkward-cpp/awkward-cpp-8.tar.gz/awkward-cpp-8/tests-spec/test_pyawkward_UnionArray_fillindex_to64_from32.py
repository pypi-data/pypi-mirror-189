...
def test_pyawkward_UnionArray_fillindex_to64_from32_1():
    toindex = [123, 123, 123, 123, 123, 123]
    toindexoffset = 3
    fromindex = [1, 0, 0, 1, 1, 1, 0, 0, 1, 0, 1, 0, 1, 1]
    length = 3
    funcPy = getattr(kernels, 'awkward_UnionArray_fillindex_to64_from32')
...
def test_pyawkward_UnionArray_fillindex_to64_from32_2():
    toindex = [123, 123, 123, 123, 123, 123]
    toindexoffset = 3
...
def test_pyawkward_UnionArray_fillindex_to64_from32_3():
    toindex = [123, 123, 123, 123, 123, 123]
    toindexoffset = 3
...
def test_pyawkward_UnionArray_fillindex_to64_from32_4():
    toindex = [123, 123, 123, 123, 123, 123]
    toindexoffset = 3
...
def test_pyawkward_UnionArray_fillindex_to64_from32_5():
    toindex = [123, 123, 123, 123, 123, 123]
    toindexoffset = 3
