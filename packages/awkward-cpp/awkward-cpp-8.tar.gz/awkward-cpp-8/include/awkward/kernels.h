...
extern "C" {
  ...
  awkward_unique_copy_bool(
    ...
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_unique_copy_int8(
    const int8_t* fromptr,
    int8_t* toptr,
    int64_t length,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_unique_copy_int16(
    const int16_t* fromptr,
    int16_t* toptr,
    int64_t length,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_unique_copy_int32(
    const int32_t* fromptr,
    int32_t* toptr,
    int64_t length,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_unique_copy_int64(
    const int64_t* fromptr,
    int64_t* toptr,
    int64_t length,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_unique_copy_uint8(
    const uint8_t* fromptr,
    uint8_t* toptr,
    int64_t length,
    int64_t* tolength);
  EXPORT_SYMBOL ERROR
  awkward_unique_copy_uint16(
    const uint16_t* fromptr,
    uint16_t* toptr,
    int64_t length,
    int64_t* tolength);
