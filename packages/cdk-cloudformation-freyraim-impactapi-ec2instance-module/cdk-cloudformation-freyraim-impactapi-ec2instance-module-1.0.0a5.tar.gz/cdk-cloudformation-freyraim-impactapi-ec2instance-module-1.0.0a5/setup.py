    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_freyraim_impactapi_ec2instance_module",
        "cdk_cloudformation_freyraim_impactapi_ec2instance_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_freyraim_impactapi_ec2instance_module._jsii": [
            "freyraim-impactapi-ec2instance-module@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_freyraim_impactapi_ec2instance_module": [
            "py.typed"
        ]
