...
class JudgeAnalyticsApi(object):
    ...
    def get_norm_attorneys_associated_with_norm_judge(
        ...
        **kwargs
        ...
        Args:
            norm_judge_id (str): Norm  ID of the Judge.   - minimum: 17   - maximum: 18 
