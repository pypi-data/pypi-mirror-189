...
class Exception(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, message, details, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            object (str): defaults to "Exception"  # noqa: E501
        ...
        object = kwargs.get('object', "Exception")
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, message, details, *args, **kwargs):  # noqa: E501
        """Exception - a model defined in OpenAPI
