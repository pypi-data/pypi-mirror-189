...
class Address(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, street_address1, street_address2, city, state_code, country_code, zip, zip4, is_visible, first_fetch_date, last_fetch_date, latitude, longitude, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            object (str): defaults to "Address"  # noqa: E501
            state_name (str): State Name if present else default value.. defaults to "UNKNOWN"  # noqa: E501
            country_name (str): Country Name if present else default value.. defaults to "UNKNOWN"  # noqa: E501
        ...
        object = kwargs.get('object', "Address")
        state_name = kwargs.get('state_name', "UNKNOWN")
        country_name = kwargs.get('country_name', "UNKNOWN")
    ...
    @convert_js_args_to_python_args
    def __init__(self, street_address1, street_address2, city, state_code, country_code, zip, zip4, is_visible, first_fetch_date, last_fetch_date, latitude, longitude, *args, **kwargs):  # noqa: E501
        """Address - a model defined in OpenAPI
