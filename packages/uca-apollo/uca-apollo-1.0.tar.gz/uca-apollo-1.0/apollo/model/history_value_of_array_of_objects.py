...
class HistoryValueOfArrayOfObjects(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """HistoryValueOfArrayOfObjects - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type]):  # noqa: E501
