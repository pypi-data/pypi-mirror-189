...
class Individual(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, first_name, middle_name, last_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, first_name, middle_name, last_name, *args, **kwargs):  # noqa: E501
        """Individual - a model defined in OpenAPI
