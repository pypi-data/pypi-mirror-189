...
class CaseSearchResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_id, case_name, case_number, filed_date, court, court_location, case_type, case_status, first_fetch_date, last_fetch_date, last_fetch_date_with_updates, participants_last_fetch_date, case_api, matched_object_array, *args, **kwargs):  # noqa: E501
        """CaseSearchResult - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): defaults to "CaseSearchResult"  # noqa: E501
        ...
        object = kwargs.get('object', "CaseSearchResult")
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_id, case_name, case_number, filed_date, court, court_location, case_type, case_status, first_fetch_date, last_fetch_date, last_fetch_date_with_updates, participants_last_fetch_date, case_api, matched_object_array, *args, **kwargs):  # noqa: E501
        """CaseSearchResult - a model defined in OpenAPI
