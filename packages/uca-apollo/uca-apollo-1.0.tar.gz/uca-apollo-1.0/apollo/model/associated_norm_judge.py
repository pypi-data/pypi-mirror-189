...
class AssociatedNormJudge(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, norm_judge_id, norm_judge_api, case_timeline, name, first_name, middle_name, last_name, case_search_api, case_count, version, *args, **kwargs):  # noqa: E501
        """AssociatedNormJudge - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): defaults to "AssociatedNormJudge"  # noqa: E501
        ...
        object = kwargs.get('object', "AssociatedNormJudge")
    ...
    @convert_js_args_to_python_args
    def __init__(self, norm_judge_id, norm_judge_api, case_timeline, name, first_name, middle_name, last_name, case_search_api, case_count, version, *args, **kwargs):  # noqa: E501
        """AssociatedNormJudge - a model defined in OpenAPI
