...
class APIUsageResponseBillingCycle(ModelNormal):
    ...
    def _from_openapi_data(cls, start_date, end_date, *args, **kwargs):  # noqa: E501
        """APIUsageResponseBillingCycle - a model defined in OpenAPI

        Args:
            start_date (date): Start date of the billing cycle.
            end_date (date): End date of the billing cycle.
