...
class JudgePreview(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, judge_id, name, judge_type, is_visible, norm_judge_id, *args, **kwargs):  # noqa: E501
        """JudgePreview - a model defined in OpenAPI
        ...
        Args:
            ...
            norm_judge_id (str): Norm ID of a Judge.

        Keyword Args:
            object (str): Name of the object. defaults to "JudgePreview"  # noqa: E501
        ...
        object = kwargs.get('object', "JudgePreview")
    ...
    @convert_js_args_to_python_args
    def __init__(self, judge_id, name, judge_type, is_visible, norm_judge_id, *args, **kwargs):  # noqa: E501
        """JudgePreview - a model defined in OpenAPI
