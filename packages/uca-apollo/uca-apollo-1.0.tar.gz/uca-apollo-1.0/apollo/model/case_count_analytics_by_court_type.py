...
class CaseCountAnalyticsByCourtType(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_count, case_search_api, court_type, geo, *args, **kwargs):  # noqa: E501
        """CaseCountAnalyticsByCourtType - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): defaults to "CaseCountAnalyticsByCourtType"  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_count, case_search_api, court_type, geo, *args, **kwargs):  # noqa: E501
        """CaseCountAnalyticsByCourtType - a model defined in OpenAPI
