...
class BarSourceDataOtherJurisdictionArrayInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bar_number, state, *args, **kwargs):  # noqa: E501
        """BarSourceDataOtherJurisdictionArrayInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, bar_number, state, *args, **kwargs):  # noqa: E501
        """BarSourceDataOtherJurisdictionArrayInner - a model defined in OpenAPI
