...
class BarSourceDataOpenActionStatusArrayInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date, reason, *args, **kwargs):  # noqa: E501
        """BarSourceDataOpenActionStatusArrayInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, reason, *args, **kwargs):  # noqa: E501
        """BarSourceDataOpenActionStatusArrayInner - a model defined in OpenAPI
