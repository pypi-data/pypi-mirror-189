...
class CaseCountAnalyticsByCaseType(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_count, case_search_api, case_type, *args, **kwargs):  # noqa: E501
        """CaseCountAnalyticsByCaseType - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): defaults to "CaseCountAnalyticsByCaseType"  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_count, case_search_api, case_type, *args, **kwargs):  # noqa: E501
        """CaseCountAnalyticsByCaseType - a model defined in OpenAPI
