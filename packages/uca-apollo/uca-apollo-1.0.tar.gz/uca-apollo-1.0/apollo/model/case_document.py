...
class CaseDocument(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_document_id, sort_order, name, description, document_filed_date, parent_document_id, child_document_id_array, pages, is_preview_available, preview_document, price, in_library, added_to_library_date, estimated_order_duration, download_api, first_fetch_date, source_data_status, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            estimated_order_duration (str): Estimated duration of a Order.
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_document_id, sort_order, name, description, document_filed_date, parent_document_id, child_document_id_array, pages, is_preview_available, preview_document, price, in_library, added_to_library_date, estimated_order_duration, download_api, first_fetch_date, source_data_status, *args, **kwargs):  # noqa: E501
        """CaseDocument - a model defined in OpenAPI
