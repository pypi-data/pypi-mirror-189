...
oiio = None
''' Constant value bpy.app.oiio(supported=True, version=(2, 4, 6), version_string=' 2, 4, 6')
'''
...
sdl = None
''' Constant value bpy.app.sdl(supported=True, version=(2, 0, 20), version_string='2.0.20', available=True)
'''
