...
#include <../../build/temp.macosx-10.9-universal2-cpython-311/dlstatic/revlib/include/rev/CANAnalog.h>
...
using PyTrampolineCfgBase_rev__CANAnalog =
...
struct PyTrampolineCfg_rev__CANAnalog :
    PyTrampolineCfgBase_rev__CANAnalog< CfgBase>
{
...
struct PyTrampoline_rev__CANAnalog : PyTrampolineBase_rev__CANAnalog<PyTrampolineBase, PyTrampolineCfg> {
    ...
    int GetSparkMaxFeedbackDeviceID() const override {
        using LookupBase = typename PyTrampolineCfg::Base;
        RPYBUILD_OVERRIDE_PURE_NAME(CANAnalog, PYBIND11_TYPE(int), LookupBase,
