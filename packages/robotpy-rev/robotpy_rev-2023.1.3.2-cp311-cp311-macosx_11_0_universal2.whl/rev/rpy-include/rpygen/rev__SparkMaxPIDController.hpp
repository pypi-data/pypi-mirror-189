...
#include <../../build/temp.macosx-10.9-universal2-cpython-311/dlstatic/revlib/include/rev/SparkMaxPIDController.h>
...
struct PyTrampoline_rev__SparkMaxPIDController : PyTrampolineBase, virtual py::trampoline_self_life_support {
    ...
    using ArbFFUnits = rev::SparkMaxPIDController::ArbFFUnits;
