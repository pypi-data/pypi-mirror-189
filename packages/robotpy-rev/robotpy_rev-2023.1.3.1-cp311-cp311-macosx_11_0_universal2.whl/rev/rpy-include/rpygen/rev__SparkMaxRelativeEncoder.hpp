...
#include <../../build/temp.macosx-10.9-universal2-cpython-311/dlstatic/revlib/include/rev/SparkMaxRelativeEncoder.h>
...
using PyTrampolineCfgBase_rev__SparkMaxRelativeEncoder =
    PyTrampolineCfg_rev__RelativeEncoder<
CfgBase
>;

template <typename CfgBase = EmptyTrampolineCfg>
struct PyTrampolineCfg_rev__SparkMaxRelativeEncoder :
    PyTrampolineCfgBase_rev__SparkMaxRelativeEncoder< CfgBase>
{
    using Base = rev::SparkMaxRelativeEncoder;

    using override_base_KGetPosition_v = rev::SparkMaxRelativeEncoder;
    using override_base_KGetVelocity_v = rev::SparkMaxRelativeEncoder;
    using override_base_SetPosition_d = rev::SparkMaxRelativeEncoder;
    using override_base_SetPositionConversionFactor_d = rev::SparkMaxRelativeEncoder;
    using override_base_SetVelocityConversionFactor_d = rev::SparkMaxRelativeEncoder;
    using override_base_KGetPositionConversionFactor_v = rev::SparkMaxRelativeEncoder;
    using override_base_KGetVelocityConversionFactor_v = rev::SparkMaxRelativeEncoder;
    using override_base_SetAverageDepth_j = rev::SparkMaxRelativeEncoder;
    using override_base_SetMeasurementPeriod_j = rev::SparkMaxRelativeEncoder;
    using override_base_KGetAverageDepth_v = rev::SparkMaxRelativeEncoder;
    using override_base_KGetMeasurementPeriod_v = rev::SparkMaxRelativeEncoder;
    using override_base_KGetCountsPerRevolution_v = rev::SparkMaxRelativeEncoder;
    using override_base_SetInverted_b = rev::SparkMaxRelativeEncoder;
    using override_base_KGetInverted_v = rev::SparkMaxRelativeEncoder;
};


template <typename PyTrampolineBase, typename PyTrampolineCfg>
using PyTrampolineBase_rev__SparkMaxRelativeEncoder =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_rev__SparkMaxRelativeEncoder : PyTrampolineBase_rev__SparkMaxRelativeEncoder<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_rev__SparkMaxRelativeEncoder<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_rev__SparkMaxRelativeEncoder;
    ...
    int GetSparkMaxFeedbackDeviceID() const override {
        using LookupBase = typename PyTrampolineCfg::Base;
        using CxxCallBase = typename PyTrampolineCfg::override_base_KGetSparkMaxFeedbackDeviceID_v;
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(int), LookupBase,
            "_getSparkMaxFeedbackDeviceID", );
        return CxxCallBase::GetSparkMaxFeedbackDeviceID();
    }
#endif
