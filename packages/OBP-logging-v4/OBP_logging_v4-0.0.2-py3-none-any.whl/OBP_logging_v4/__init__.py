...
class aws_client:
    ...
    from .utils import get_regions, list_log_groups, list_rds_instances, list_rds_clusters
    from .cloudwatch import log_group_encrypted, log_group_retention_period_check
    from .rds import rds_logging_enabled, rds_cluster_deletion_protection_enabled, rds_cluster_multi_az_enabled, rds_instance_iam_authentication_enabled
