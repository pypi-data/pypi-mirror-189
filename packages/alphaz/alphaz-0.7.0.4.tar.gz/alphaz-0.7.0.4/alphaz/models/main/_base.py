...
class AlphaClass:
    ...
    def to_json(
        self, rejected: list = None, not_none: bool = False, not_empty: bool = False
    ):
...
class AutoMapping(AlphaClass):
    ...
    def __map_flat(self, dict_values: Dict[str, object]):
        ...
        field_values = {}
        for (key, fd,) in self.identified_object_fields.items():
    ...
    def map(self, dict_values: Dict[str, object]):
        ...
        for (key, fd,) in self.identified_dict_fields.items():
        ...
        for (key, fd,) in self.identified_list_fields.items():
    ...
    def get_fields_dict(self, keys: List[str] = None) -> dict:
        ...
        for f in dataclasses.fields(self):
            ...
            if (
                ...
                and issubclass(f_type, AlphaClass)
