...
from echolocator_lib.configurators.base import Base

logger = logging.getLogger(__name__)


thing_type = "echolocator_lib.echolocator_configurators.yaml"
...
class Yaml(Base):
    ...
    # ----------------------------------------------------------------------------------------
    def callsign(self):
        return f"Configurator.Yaml {self.__filename}"
