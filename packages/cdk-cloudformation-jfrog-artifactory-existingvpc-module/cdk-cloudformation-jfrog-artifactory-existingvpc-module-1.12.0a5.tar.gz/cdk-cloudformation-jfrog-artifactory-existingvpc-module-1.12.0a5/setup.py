    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_jfrog_artifactory_existingvpc_module",
        "cdk_cloudformation_jfrog_artifactory_existingvpc_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_jfrog_artifactory_existingvpc_module._jsii": [
            "jfrog-artifactory-existingvpc-module@1.12.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_jfrog_artifactory_existingvpc_module": [
            "py.typed"
        ]
