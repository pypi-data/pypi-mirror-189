...
class Browser:
    ...
    def getDomCaptureData(self, driver, path, type=""):
    ...
    def takeFullpageScreenshot(self, path: str):
        ...
        if totalPages == 1:
            ...
            self.domCaptureInfo = self.getDomCaptureData(self._driver, path, 'fullpage')
    ...
    def takeElementScreenshot(self, element, path):
        ...
        self.domCaptureInfo = self.getDomCaptureData(self._driver, path, 'element')
    ...
    def takeViewportScreenshot(self, path):
        ...
        # capture dom AFTER creating screenshot but BEFORE displaying scrollbar again (else get vertical offset on dom elements to image)
        self.domCaptureInfo = self.getDomCaptureData(self._driver, path, 'viewport')
