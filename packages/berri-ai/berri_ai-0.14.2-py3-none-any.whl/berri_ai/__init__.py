...
def deploy(user_email: str):
  ...
  time.sleep(2)
  print("🚧 Currently deploying to [NOT READY YET] 👉 https://agent-repo-821afd26-fce3-449d-95da-994481b8be0d-5377-g0e8.zeet-team-ishaan-jaff.zeet.app/")
  print("⌛️ It'll be ready in 15 mins. We'll email you  @ ishaanjaffer0324@gmail.com")
