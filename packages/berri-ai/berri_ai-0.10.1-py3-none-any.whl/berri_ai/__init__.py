...
def deploy(user_email: str):
  print("Begun deployment.. \n Hit an error? let us know in the Discord (https://discord.gg/KvG3azf39U).")
  ...
  print("Currently deploying to 👉 " + endpoint)
  print("It'll be ready in 5-10 mins. We'll email you  @ " + user_email + " ⌛️")
  print("=====================")
