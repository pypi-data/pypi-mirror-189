...
def getCaseInfo(text: str):
	...
	alias = "" # Add support for PyPDF2 version, in meantime crawl with PDFPlumber version
...
def getCharges(text: str):
	...
	return [convictions, dcharges, fcharges, cerv_convictions, pardon_convictions, perm_convictions, conviction_ct, charge_ct, cerv_ct, pardon_ct, perm_ct, conv_cerv_ct, conv_pardon_ct, conv_perm_ct, charge_codes, conv_codes]
