...
- Install `boto3-stubs[support]` in your environment:
...
Install `boto3-stubs-lite[support]` in your environment:
...
- Install `boto3-stubs[support]` with services you use in your environment:
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_support/)
