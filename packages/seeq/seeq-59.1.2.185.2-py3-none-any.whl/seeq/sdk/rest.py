...
class RESTClientObject(object):
    ...
    def __init__(self, configuration, pools_size=4, maxsize=4):
        ...
        # cert_reqs
        if self.configuration.verify_ssl:
        ...
        # cert_file
        cert_file = self.configuration.cert_file

        # key file
        key_file = self.configuration.key_file
    ...
    def __del__(self):
        try:
            ...
            # In urllib3\connectionpool.py's close() function, there is an "except queue.Empty:" that causes a
            # TypeError to be thrown and is annoyingly printed to the console in pytest.
            pass
