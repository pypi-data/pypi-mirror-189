...
class ItemsApi(object):
    ...
    def clear_cache(self, **kwargs):
        ...
        :param str cache_layer: Cache layer to clear
        :return: CacheInfoV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CacheInfoV1
    ...
    def clear_cache_with_http_info(self, **kwargs):
        ...
        all_params = ['id', 'clear_dependents', 'cache_layer']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'cache_layer' in params:
            query_params.append(('cacheLayer', params['cache_layer']))
    ...
    def get_cache(self, **kwargs):
        """
        Get information about the cache of an item
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.get_cache(id=id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: ID of the item to get cache info for (required)
        :param str cache_layer: Cache layer to get info for
        :return: CacheInfoV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CacheInfoV1
    ...
    def get_cache_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_cache_with_http_info(id=id_value, callback=callback_function)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_cache`")
        ...
        return self.api_client.call_api('/items/{id}/cache', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
