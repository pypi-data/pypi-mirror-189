...
class ApiClient(object):
    ...
    def __init__(self, host=None, header_name=None, header_value=None, cookie=None, configuration=None):
        ...
        self.user_agent = 'Swagger-Codegen/59.1.2/python'
        ...
        while True:
            try:
                ...
                if isinstance(e, (MaxRetryError, TimeoutError)):
                    ...
                    # This is "Conflict", which can happen due to CRAB-28592
                    if e.status == 409:
                        if timed_out:
                            e.reason = new_reason
                            raise e

                    # This is "Gateway Timeout", which can happen due to a bug in Grizzly
                    elif e.status == 504:
                        if timed_out:
                            e.reason = new_reason
                            raise e
