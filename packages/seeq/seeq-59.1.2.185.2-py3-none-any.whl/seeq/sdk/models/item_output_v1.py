...
class ItemOutputV1(object):
    ...
    def __init__(self, cached=False, datasource=None, description=None, effective_permissions=None, fingerprint=None, id=None, is_archived=False, is_redacted=False, name=None, properties=None, scoped_to=None, status_message=None, translation_key=None, type=None, workbook_id=None):
        """
