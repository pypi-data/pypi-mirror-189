...
class ConnectionStatusV1(object):
    ...
    def __init__(self, connection_message=None, datasource_class=None, datasource_id=None, id=None, indexing_datasource_connection=False, name=None, pull_datasource_connection=False, reinitialized=False, status=None, sync_progress=None, sync_status=None):
        """
