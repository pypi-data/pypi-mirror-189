...
class ContentInputV1(object):
    ...
    def __init__(self, archived=False, asset_selection_id=None, date_range_id=None, description=None, height=None, name=None, react=False, report_id=None, scale=None, selector=None, summary_type=None, summary_value=None, timezone=None, width=None, worksheet_id=None, workstep_id=None):
        """
