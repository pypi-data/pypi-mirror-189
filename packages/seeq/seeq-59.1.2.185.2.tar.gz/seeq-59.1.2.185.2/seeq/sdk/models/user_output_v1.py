...
class UserOutputV1(object):
    ...
    def __init__(self, access_key_validity_duration=None, created_at=None, datasource_name=None, description=None, effective_access_key_validity_duration=None, effective_permissions=None, effective_session_duration=None, email=None, first_name=None, groups=None, id=None, is_active=False, is_admin=None, is_archived=False, is_enabled=False, is_password_settable=False, is_redacted=False, last_login_at=None, last_name=None, max_requests=None, name=None, session_duration=None, status_message=None, translation_key=None, type=None, username=None, workbench=None):
        """
    ...
    def access_key_validity_duration(self):
        ...
        The access key validity duration, in minutes, to override the 'Authentication/AccessKey/ValidityWithoutUserLogin' configuration. After the last user activity, authentication is allowed with an access key for the period specified here. A value of 0 will effectively disable access keys for this user.
