...
class AgentsApi(object):
    ...
    def create_or_update_connection(self, **kwargs):
        ...
        :param str connector_name: Name of the connector where the connection resides. The connector name can be obtained from the 'Connector' array in the response of 'GET / agents / {agentName}' (required)
        :param str connection_name: Name of the connection to create or update. For update, the connection name can be obtained from the 'Connections' array in the response of 'GET /agents/{agentName}/connectors/{connectorName}' (required)
