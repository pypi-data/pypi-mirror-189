    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_splunk_enterprise_quickstart_module",
        "cdk_cloudformation_splunk_enterprise_quickstart_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_splunk_enterprise_quickstart_module._jsii": [
            "splunk-enterprise-quickstart-module@1.0.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_splunk_enterprise_quickstart_module": [
            "py.typed"
        ]
