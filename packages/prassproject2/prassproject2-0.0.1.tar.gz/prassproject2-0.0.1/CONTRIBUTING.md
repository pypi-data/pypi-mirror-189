...
Welcome to `prassproject2` contributor's guide.
...
If you experience bugs or general issues with `prassproject2`, please have a look
...
You can help improve `prassproject2` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`prassproject2` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `prassproject2`'s files. While this mechanism can
...
```
conda create -n prassproject2 python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/prassproject2.git
   cd prassproject2
   ```
...
5. Install [pre-commit]:
   ...
   `prassproject2` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/prassproject2
[issue tracker]: https://github.com/<USERNAME>/prassproject2/issues
