...
def help():
    print("\n@author: Raghav Gohil")
    print("\nAbout:\nThis package is made to acquire all the connected wifi passwords and related data and store it in your desired place.\nYou can even store it in your pendrive.\nUsually, if the location and name of the file is not specifed, the output file containing the data will be stored in the working directory with the name \'out.txt\'.\nYou can go full-on hacker mode and clone the data from a target-pc in mere seconds.")
