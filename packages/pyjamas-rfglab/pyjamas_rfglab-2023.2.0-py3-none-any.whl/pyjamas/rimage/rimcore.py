...
plt.ioff()  # to keep figure windows from popping up unless show is invoked. Alternatively, use the 'Agg' backend (instead of 'Qt5Agg') above.
...
class rimage:
    ...
    def show(self):
        plt.imshow(Image.fromarray(self.image_array))
        plt.show()
