...
class AccountService(BaseRdbmsService):
    ...
    def get_picture(
        ...
        @return: The information about the picture:
            ...
            - `creation_time: timestamp` (required): The time when this photo has
              been registered.
            ...
            - `image_file_size: integer` (optional): The size in bytes of the
              user's original photo image file.  This attribute is only returned
              if the argument `include_image_info` is `True`.

            - `image_height: integer`: (optional): The number of pixel rows of the
              user's original photo image.  This attribute is only returned if the
              argument `include_image_info` is `True`.

            - `image_width: integer` (optional): The number of pixel columns of
              the user's original photo image.  This attribute is only returned if
              the argument `include_image_info` is `True`.
            ...
            - `update_time: timestamp` (required): The time of the most recent 
