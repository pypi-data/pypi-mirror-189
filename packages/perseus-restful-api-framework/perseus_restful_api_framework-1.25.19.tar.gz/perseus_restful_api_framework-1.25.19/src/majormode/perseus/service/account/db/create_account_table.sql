...
(
  ...
  -- The time when the user's picture was taken.
  picture_time timestamptz(3) NULL
...
(
  ...
  -- with.
  --
  -- @note: This column is null when a user account is hard-deleted.  A
  ...
  -- The message digest of the the binary data of the user's original
  -- photo image file.
