...
#   filename:  folder_metadata_basic_v1.json
...
class Model(BaseModel):
    ...
    created: datetime = Field(..., description="The creation date of the folder.")
    modified: datetime = Field(..., description="The modification date of the folder.")
