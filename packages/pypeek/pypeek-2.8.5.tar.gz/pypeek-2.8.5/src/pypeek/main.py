...
class PyPeek(QMainWindow):
    ...
    def create_settings_widget(self):
        ...
        self.copyright_widget = PyPeek.create_row_widget("About", f"Peek {self.version}, Cross platform screen recorder", PyPeek.create_hyperlink("Website", "https://github.com/pypeek/pypeek/wiki"))
    ...
    def do_update(self, latest_version):
        if latest_version != self.version:
            ...
            if result == QMessageBox.Ok:
                url = QUrl('https://github.com/pypeek/pypeek/wiki')
