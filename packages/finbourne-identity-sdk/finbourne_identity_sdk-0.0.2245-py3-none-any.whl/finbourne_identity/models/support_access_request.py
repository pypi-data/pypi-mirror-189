...
"""
    ...
    The version of the OpenAPI document: 0.0.2245
...
class SupportAccessRequest(object):
    ...
    def __init__(self, duration=None, description=None, permitted_roles=None, local_vars_configuration=None):  # noqa: E501
    ...
    def duration(self, duration):
        ...
        if (self.local_vars_configuration.client_side_validation and
                duration is not None and len(duration) > 30):
            raise ValueError("Invalid value for `duration`, length must be less than or equal to `30`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                duration is not None and len(duration) < 2):
            raise ValueError("Invalid value for `duration`, length must be greater than or equal to `2`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                duration is not None and not re.search(r'^P(?!$)((\d+Y)|(\d+\.\d+Y$))?((\d+M)|(\d+\.\d+M$))?((\d+W)|(\d+\.\d+W$))?((\d+D)|(\d+\.\d+D$))?(T(?=\d)((\d+H)|(\d+\.\d+H$))?((\d+M)|(\d+\.\d+M$))?(\d+(\.\d+)?S)?)??$', duration)):  # noqa: E501
    ...
    def permitted_roles(self):
        """Gets the permitted_roles of this SupportAccessRequest.  # noqa: E501


        :return: The permitted_roles of this SupportAccessRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def permitted_roles(self, permitted_roles):
        """Sets the permitted_roles of this SupportAccessRequest.


        :param permitted_roles: The permitted_roles of this SupportAccessRequest.  # noqa: E501
        :type permitted_roles: list[str]
        """
