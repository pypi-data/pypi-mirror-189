...
class UserSummary(object):
    ...
    def __init__(self, id=None, login=None, email=None, second_email=None, first_name=None, last_name=None, type=None, links=None, local_vars_configuration=None):  # noqa: E501
