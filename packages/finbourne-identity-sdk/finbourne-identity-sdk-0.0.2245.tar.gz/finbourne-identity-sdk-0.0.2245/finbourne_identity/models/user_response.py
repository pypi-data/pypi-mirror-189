...
class UserResponse(object):
    ...
    def __init__(self, id=None, email_address=None, second_email_address=None, login=None, first_name=None, last_name=None, roles=None, type=None, status=None, external=None, links=None, local_vars_configuration=None):  # noqa: E501
