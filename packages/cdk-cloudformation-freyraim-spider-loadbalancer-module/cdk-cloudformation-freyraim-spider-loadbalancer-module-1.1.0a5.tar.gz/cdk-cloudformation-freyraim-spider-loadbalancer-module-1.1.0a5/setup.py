    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_freyraim_spider_loadbalancer_module",
        "cdk_cloudformation_freyraim_spider_loadbalancer_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_freyraim_spider_loadbalancer_module._jsii": [
            "freyraim-spider-loadbalancer-module@1.1.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_freyraim_spider_loadbalancer_module": [
            "py.typed"
        ]
