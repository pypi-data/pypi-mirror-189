...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        drawLineMode = action(
            self.tr("Draw line"),
            lambda: self.toggleDrawMode(False, createMode="drawline"),
            shortcuts["draw_line"],
            "objects",
            self.tr("Start drawing line"),
            enabled=False,
        )
        modifyLineMode = action(
            self.tr("Modify line"),
            lambda: self.toggleDrawMode(False, createMode="modifyline"),
            shortcuts["modify_line"],
            "objects",
            self.tr("Start modify line"),
            enabled=False,
        )
        createMode = action(
    ...
    def saveLabels(self, filename):
        ...
        for item in self.labelList:
            if item.shape().shape_type == 'modifyline':
                continue
            else:
                shapes.append(format_shape(item.shape()))
