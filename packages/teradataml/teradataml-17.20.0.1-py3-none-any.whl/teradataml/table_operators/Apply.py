...
class Apply(TableOperator):
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            is_local_order:
                ...
                Notes:
                    ...
                    2) When "is_local_order" is set to 'True', "data_order_column" should be specified,
        ...
        # Datatypes supported in 'returns' clause of APPLY table operator.
    ...
    def __apply__validate(self):
        ...
        # Validate 'returns' argument clause.
