...
class _DataTransferUtils():
   ...
   # General functions to get warrnings and errors.
    ...
    def _table_exists(self, con):
        ...
        """
        return con.dialect.has_table(con, self.table_name, self.schema_name)
    ...
    def _get_sqlalc_table_columns(self):
        ...
        if self.types is None and self.if_exists == 'append':
            ...
            # and types=None.
            if not self._table_exists(get_context()):
    ...
    def _validate(self):
        ...
        allowed_schemas = df_utils._get_database_names(eng, self.schema_name)
