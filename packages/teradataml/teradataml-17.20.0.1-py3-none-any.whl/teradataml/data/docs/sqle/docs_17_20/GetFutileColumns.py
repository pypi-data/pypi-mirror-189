def GetFutileColumns(data=None, object=None, category_summary_column=None, threshold_value=None, **generic_arguments):
    """
    DESCRIPTION:
    ...
    EXAMPLES:
        ...
        # Import functions GetFutileColumns and CategoricalSummary.
        from teradataml import GetFutileColumns, CategoricalSummary
