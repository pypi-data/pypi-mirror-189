def TDGLMPredict(object = None, newdata = None, id_column = None, accumulate = None, output_prob = False,
        ...
        EXAMPLES:
            ...
            # Import function TDGLMPredict.
            from teradataml import TDGLMPredict, ScaleFit, ScaleTransform, GLM
            ...
            # TDGLMPredict() predicts target values using generated regression model by GLM() and newdata.
