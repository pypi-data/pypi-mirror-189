def RandomProjectionFit(data=None, target_columns=None, num_components=None, seed=0, epsilon=0.1,
                        density=0.33333333, projection_method="GAUSSIAN",
    ...
    EXAMPLES:
        ...
        # Import function RandomProjectionFit.
        from teradataml import RandomProjectionFit
