def GetRowsWithoutMissingValues(data=None, target_columns=None, accumulate=None, **generic_arguments):
    """
    DESCRIPTION:
    ...
    EXAMPLES:
        ...
        #    2. User can import the function, if it is available on Vantage user is connected to.
        #    3. To check the list of analytic functions available on Vantage user connected to,
        ...
        # Import function GetRowsWithoutMissingValues
        from teradataml import GetRowsWithoutMissingValues
