def KMeansPredict(data=None, object=None, accumulate=None, output_distance=False, **generic_arguments):
    ...
    EXAMPLES:
        ...
        # Import function KMeans, KMeansPredict.
        ...
        # Example 1 : Assigning the input data points to the cluster
        #             centroids using the cluster centroids in the KMeans
        #             function output passed as teradataml DataFrame
        #             to object argument.
        ...
        # Example 2 : Assigning the input data points to the cluster
        #             centroids using the cluster centroids in the KMeans
        #             function output passed as instance of KMeans
        #             to object argument.
