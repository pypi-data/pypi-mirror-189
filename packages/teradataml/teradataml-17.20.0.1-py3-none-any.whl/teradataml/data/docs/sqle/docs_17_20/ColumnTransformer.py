def ColumnTransformer(input_data = None, bincode_fit_data = None, function_fit_data = None,
        ...
        PARAMETERS:
            ...
            onehotencoding_fit_data:
                ...
                One can pass multiple OneHotEncodingFit() function's output using argument names
                as onehotencoding_fit_data1, onehotencoding_fit_data2 and so on.
                Notes:
                     * Function considers the arguments which are in sequence and ignores the arguments
                       which are out of sequence.
                       Example - If arguments are onehotencoding_fit_data, onehotencoding_fit_data1,
                       onehotencoding_fit_data2, onehotencoding_fit_data4, the function considers only
                       onehotencoding_fit_data, onehotencoding_fit_data1 and onehotencoding_fit_data2
                       for processing and ignores onehotencoding_fit_data4 since it is out of sequence.
                     * Argument sequence starts from "onehotencoding_fit_data", followed by
                       "onehotencoding_fit_data1", "onehotencoding_fit_data2", so on..
                Types: teradataml DataFrame

            ordinalencoding_fit_data:
                Optional Argument.
                Specifies the teradataml DataFrame generated by the OrdinalEncodingFit() function.
                One can pass multiple OrdinalEncodingFit() function's output using argument names
                as ordinalencoding_fit_data1, ordinalencoding_fit_data2 and so on.
                Notes:
                     * Function considers the arguments which are in sequence and ignores the arguments
                       which are out of sequence.
                       Example - If arguments are ordinalencoding_fit_data, ordinalencoding_fit_data1,
                       ordinalencoding_fit_data2, ordinalencoding_fit_data4, the function considers only
                       ordinalencoding_fit_data, ordinalencoding_fit_data1 and ordinalencoding_fit_data2
                       for processing and ignores ordinalencoding_fit_data4 since it is out of sequence.
                     * Argument sequence starts from "ordinalencoding_fit_data", followed by
                       "ordinalencoding_fit_data1", "ordinalencoding_fit_data2", so on..
                Types: teradataml DataFrame
        ...
        EXAMPLES:
            ...
            #            ColumnTransformer() function.
            # Import functions NonLinearCombineFit and ColumnTransformer. Then, create multiple
            # NonLinearCombineFit objects and pass those to ColumnTransformer.
            from teradataml import NonLinearCombineFit, ColumnTransformer
            ...
            # Example 3: Perform BincodeFit transformation along with multiple OrdinalEncodingFit and
            #            OneHotEncodingFit transformation using fit functions and ColumnTransformer()
            #            function.
            # Import functions OrdinalEncodingFit, OneHotEncodingFit, ColumnTransformer, BincodeFit.
            # Then, create BincodeFit object along with multiple OrdinalEncodingFit and
            # OneHotEncodingFit objects, and pass those to ColumnTransformer.
            from teradataml import OrdinalEncodingFit, OneHotEncodingFit, ColumnTransformer, BincodeFit
            bin_code = BincodeFit(data=titanic,
                                  target_columns='age',
                                  method_type='Equal-Width',
                                  nbins=2,
            ...
            one_hot_encoding1 = OneHotEncodingFit(data=titanic,
                                                  is_input_dense=True,
                                                  target_column="embarked",
                                                  categorical_values=["c", "s"],
                                                  other_column="other")

            one_hot_encoding2 = OneHotEncodingFit(data=titanic,
                                                  is_input_dense=True,
                                                  target_column="sex",
                                                  categorical_values=["male", "female"],
                                                  other_column="other")

            ordinal_encodingfit1 = OrdinalEncodingFit(target_column='sex', data=titanic)

            ordinal_encodingfit2 = OrdinalEncodingFit(target_column='embarked',
                                                      approach='LIST',
            ...
            ColumnTransformer_out3 = ColumnTransformer(fillrowid_column_name="output_value",
                                                       input_data=titanic,
                                                       bincode_fit_data=bin_code.output,
                                                       onehotencoding_fit_data=one_hot_encoding1.result,
                                                       onehotencoding_fit_data1=one_hot_encoding2.result,
                                                       ordinalencoding_fit_data=ordinal_encodingfit1.result)
                                                       ordinalencoding_fit_data1=ordinal_encodingfit2.result)
