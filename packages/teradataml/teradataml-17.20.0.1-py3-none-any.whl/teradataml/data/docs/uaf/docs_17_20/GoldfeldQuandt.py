def GoldfeldQuandt(data=None, data_filter_expr=None, 
    ...
    PARAMETERS:
        ...
        formula:
            ...
            Notes:
                * When no "formula" is passed, then the default "formula" used
                 for the regression is as follow:
                    'Y = C + a * X1'
    ...
    EXAMPLES:
        ...
        # Import function GoldfeldQuandt.
        from teradataml import GoldfeldQuandt
