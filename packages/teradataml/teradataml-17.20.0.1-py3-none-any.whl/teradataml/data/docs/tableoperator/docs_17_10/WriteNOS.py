def WriteNOS(data=None, location=None, authorization=None, stored_as="PARQUET", naming="RANGE", manifest_file=None,
             manifest_only=False, overwrite=False, include_ordering=None, include_hashby=None, max_object_size="16MB",
             compression=None, **generic_arguments):
    """
    DESCRIPTION:
    ...
    EXAMPLES:
        ...
        # Below examples assume use of function mapping with location and authorization object.
