...
class UAFQueryGenerator:
    ...
    def __get_arg_expressions(self, arg, value):
        """
        ...
        for _arg, _value in value.items():
            _p_sql, _p_sql_values, _np_sql = self.__get_arg_expressions(_arg, _value)
    ...
    def __generate_uaf_func_params_sql(self):
        ...
        EXAMPLES:
            ...
            # Output is as shown in example in description.
        """
        _, _, func_params = self.__get_arg_expressions("FUNC_PARAMS", self.__func_other_args)
    ...
    def __generate_uaf_input_fmt_arg_sql(self):
        ...
        """
        _, _, input_fmt_sql = self.__get_arg_expressions("INPUT_FMT", self.__func_input_fmt_args)
    ...
    def __generate_uaf_output_fmt_arg_sql(self):
        ...
        _, _, output_fmt_sql = self.__get_arg_expressions("OUTPUT_FMT", self.__func_output_fmt_args)
