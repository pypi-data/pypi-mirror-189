...
class FuncSpecialCaseHandler():
    ...
    def _add_quote_arg_value_json(self, arg_value, *args, **kwargs):
        """
        DESCRIPTION:
            Given a string or list of strings as an argument:
                * String value will be single quoted only for valid string based on
                  special function arguments.
                * List of strings will be single quoted based on special function
        ...
        EXAMPLES:
            # Scenario 1: 'arg_value' requires quote for json string
                self._add_quote_arg_value_json(arg_value)
                # result: "'json'"

            # Scenario 2: 'arg_value' does not require 
            #             quote for authorization object.
                self._add_quote_arg_value_json(arg_value)
                # result: "alice.deauth"
        """
        ...
        # Avoid quotes for authorization object 'arg_value'.
        return arg_value
