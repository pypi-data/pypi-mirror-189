    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_dynatrace_environment_syntheticmonitor",
        "cdk_cloudformation_dynatrace_environment_syntheticmonitor._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_dynatrace_environment_syntheticmonitor._jsii": [
            "dynatrace-environment-syntheticmonitor@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_dynatrace_environment_syntheticmonitor": [
            "py.typed"
        ]
