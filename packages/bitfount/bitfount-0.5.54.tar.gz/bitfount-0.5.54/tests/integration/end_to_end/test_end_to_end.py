...
from bitfount.runners.config_schemas import AlgorithmConfig, ModellerConfig, PodConfig
...
class TestCensusIncomeEndToEnd:
    ...
    async def test_local_vs_pod(
        ...
        try:
            ...
            modeller, pod_identifiers, _, _ = setup_modeller_from_config(
            ...
            algorithm = cast(
                AlgorithmConfig, census_income_modeller_config.task.algorithm
            )
