...
if update_pip_packages:
    ...
    subprocess.run(f"pip install -t /projects/{project}/packages/python -r /projects/{project}/requirements.txt", shell=True, capture_output=True)
...
if update_tables or update_modules or update_packages or update_endpoints:
