    ...
    def _screenshot(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if not result:
                ...
                # base_page.save_screenshot(screenshot_name)
                # ...
                request = getattr(func, "request", None)
                if request:
                    html_report = request.config.pluginmanager.get_plugin("html")
                    if html_report:
                        html_report.attach_file(screenshot_name)
