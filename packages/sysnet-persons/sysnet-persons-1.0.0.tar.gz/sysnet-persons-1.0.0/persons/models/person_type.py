...
class PersonType(object):
    ...
    attribute_map = {
        ...
        'addresses': 'addresses',
        'address_printable': 'addressPrintable',
    ...
    def __init__(self, identifier=None, pid=None, code=None, registry=None, ico=None, person_type=None, name=None, headquarters=None, department=None, addresses=None, address_printable=None, representative=None, contacts=None, admins=None, members=None, issuing=None, linked_persons=None, tags=None, document=None):  # noqa: E501
    ...
    def person_type(self, person_type):
        ...
        :type: str
        """
        allowed_values = ["legalEntity", "legalEntityWithoutIco", "foreignLegalEntity", "naturalPerson", "businsessNaturalPerson", "foreignNaturalPerson"]  # noqa: E501
