...
class RoleType(object):
    ...
    swagger_types = {
        ...
        'holders_individual': 'list[str]',
        'holders_personal': 'list[str]',
        'admins_individual': 'list[str]',
        'admins_personal': 'list[str]',
        'tags': 'TagType',
    ...
    attribute_map = {
        ...
        'holders_individual': 'holdersIndividual',
        'holders_personal': 'holdersPersonal',
        'admins_individual': 'adminsIndividual',
        'admins_personal': 'adminsPersonal',
        'tags': 'tags',
        'document': 'document'
    }
