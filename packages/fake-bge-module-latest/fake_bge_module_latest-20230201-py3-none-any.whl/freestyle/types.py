...
class Curve:
    ...
    def push_vertex_back(
            self, vertex: typing.Union['SVertex', 'bpy.types.CurvePoint']):
        ''' Adds a single vertex at the end of the Curve.

        :param vertex: A vertex object.
        :type vertex: typing.Union['SVertex', 'bpy.types.CurvePoint']
        '''
        pass

    def push_vertex_front(
            self, vertex: typing.Union['SVertex', 'bpy.types.CurvePoint']):
...
class CurvePoint:
    ...
    def __init__(self):
        ...
        :type brother: 'bpy.types.CurvePoint'
        ...
        :type first_point: 'bpy.types.CurvePoint'
        :param second_point: The second CurvePoint.
        :type second_point: 'bpy.types.CurvePoint'
...
class CurvePointIterator:
    ...
    object: 'bpy.types.CurvePoint' = None
    ''' The CurvePoint object currently pointed by this iterator.

    :type: 'bpy.types.CurvePoint'
    '''
...
class StrokeVertex:
    ...
    def __init__(self):
        ...
        :type point: 'bpy.types.CurvePoint'
