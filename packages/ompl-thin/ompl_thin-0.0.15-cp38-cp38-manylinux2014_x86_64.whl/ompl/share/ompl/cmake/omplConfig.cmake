...
set(OMPL_VERSION 1.6.0)
set(OMPL_MAJOR_VERSION 1)
set(OMPL_MINOR_VERSION 6)
set(OMPL_PATCH_VERSION 0)

set_and_check(OMPL_INCLUDE_DIR "${PACKAGE_PREFIX_DIR}/include/ompl-1.6")
set(OMPL_INCLUDE_DIRS "${OMPL_INCLUDE_DIR};/usr/include;/usr/include/eigen3")
foreach(_dir /usr/include;/usr/include;;TRIANGLE_INCLUDE_DIR-NOTFOUND;;;;)
    if(_dir)
...
foreach(_dir /usr/lib/x86_64-linux-gnu;/usr/lib/x86_64-linux-gnu;;;)
    if(_dir)
...
foreach(_lib optimized;/usr/lib/x86_64-linux-gnu/libboost_serialization.so.1.71.0;debug;/usr/lib/x86_64-linux-gnu/libboost_serialization.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;ode;)
    if(_lib)
