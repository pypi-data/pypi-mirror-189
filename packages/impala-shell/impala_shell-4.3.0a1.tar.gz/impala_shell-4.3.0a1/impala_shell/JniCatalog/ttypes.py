...
class TGetOperationUsageResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.catalog_op_counters is not None:
            ...
            for iter347 in self.catalog_op_counters:
                iter347.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TCatalogdHmsCacheMetrics(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i352 in range(_size348):
                        _elem353 = TCatalogHmsCacheApiMetrics()
                        _elem353.read(iprot)
                        self.api_metrics.append(_elem353)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.api_metrics is not None:
            ...
            for iter354 in self.api_metrics:
                iter354.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.cache_hit_ratio is not None:
...
class TGetCatalogServerMetricsResponse(object):
    ...
    def __init__(self, catalog_partial_fetch_rpc_queue_len=None, event_metrics=None, catalogd_hms_cache_metrics=None,):
