...
class TRuntimeFilterMode(object):
    OFF = 0
    LOCAL = 1
    GLOBAL = 2
...
class TFunctionName(object):
    ...
    def validate(self):
        if self.function_name is None:
            raise TProtocolException(message='Required field function_name is unset!')
        return
...
class TAggregateFunction(object):
    ...
    def __init__(self, intermediate_type=None, is_analytic_only_fn=None, update_fn_symbol=None, init_fn_symbol=None, serialize_fn_symbol=None, merge_fn_symbol=None, finalize_fn_symbol=None, get_value_fn_symbol=None, remove_fn_symbol=None, ignores_distinct=None,):
        self.intermediate_type = intermediate_type
        self.is_analytic_only_fn = is_analytic_only_fn
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.is_analytic_only_fn = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.intermediate_type is not None:
            ...
            oprot.writeFieldEnd()
        if self.is_analytic_only_fn is not None:
            oprot.writeFieldBegin('is_analytic_only_fn', TType.BOOL, 2)
            oprot.writeBool(self.is_analytic_only_fn)
            oprot.writeFieldEnd()
    ...
    def validate(self):
        if self.intermediate_type is None:
            raise TProtocolException(message='Required field intermediate_type is unset!')
        if self.is_analytic_only_fn is None:
            raise TProtocolException(message='Required field is_analytic_only_fn is unset!')
        if self.update_fn_symbol is None:
            raise TProtocolException(message='Required field update_fn_symbol is unset!')
        if self.init_fn_symbol is None:
            raise TProtocolException(message='Required field init_fn_symbol is unset!')
        return
...
class TFunction(object):
    ...
    def __init__(self, name=None, binary_type=None, arg_types=None, ret_type=None, has_var_args=None, comment=None, signature=None, hdfs_location=None, scalar_fn=None, aggregate_fn=None, is_persistent=None, last_modified_time=None,):
        self.name = name
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.is_persistent = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.I64:
    ...
    def write(self, oprot):
        ...
        if self.is_persistent is not None:
            oprot.writeFieldBegin('is_persistent', TType.BOOL, 11)
            oprot.writeBool(self.is_persistent)
            oprot.writeFieldEnd()
        if self.last_modified_time is not None:
            oprot.writeFieldBegin('last_modified_time', TType.I64, 12)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(TScalarType)
TScalarType.thrift_spec = (
    None,  # 0
...
TTypeNode.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'type', None, None, ),  # 1
    (2, TType.STRUCT, 'scalar_type', [TScalarType, None], None, ),  # 2
    (3, TType.LIST, 'struct_fields', (TType.STRUCT, [TStructField, None], False), None, ),  # 3
)
all_structs.append(TColumnType)
TColumnType.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'types', (TType.STRUCT, [TTypeNode, None], False), None, ),  # 1
)
...
TFunction.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'name', [TFunctionName, None], None, ),  # 1
    ...
    (12, TType.I64, 'last_modified_time', None, None, ),  # 12
)
