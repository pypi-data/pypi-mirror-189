...
class TSlotDescriptor(object):
    ...
    def __init__(self, id=None, parent=None, itemTupleId=None, slotType=None, materializedPath=None, byteOffset=None, nullIndicatorByte=None, nullIndicatorBit=None, slotIdx=None, virtual_col_type=0,):
        self.id = id
        self.parent = parent
        ...
        self.virtual_col_type = virtual_col_type
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.virtual_col_type = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.slotIdx is not None:
            ...
            oprot.writeFieldEnd()
        if self.virtual_col_type is not None:
            oprot.writeFieldBegin('virtual_col_type', TType.I32, 10)
            oprot.writeI32(self.virtual_col_type)
            oprot.writeFieldEnd()
    ...
    def validate(self):
        ...
        if self.virtual_col_type is None:
            raise TProtocolException(message='Required field virtual_col_type is unset!')
        return
...
class TColumnDescriptor(object):
    ...
    Attributes:
     ...
     - type
     - icebergFieldId
     - icebergFieldMapKeyId
     - icebergFieldMapValueId
    """


    def __init__(self, name=None, type=None, icebergFieldId=None, icebergFieldMapKeyId=None, icebergFieldMapValueId=None,):
        self.name = name
        self.type = type
        self.icebergFieldId = icebergFieldId
        self.icebergFieldMapKeyId = icebergFieldMapKeyId
        self.icebergFieldMapValueId = icebergFieldMapValueId
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.icebergFieldId = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I32:
                    self.icebergFieldMapKeyId = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.I32:
                    self.icebergFieldMapValueId = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.type is not None:
            ...
            oprot.writeFieldEnd()
        if self.icebergFieldId is not None:
            oprot.writeFieldBegin('icebergFieldId', TType.I32, 3)
            oprot.writeI32(self.icebergFieldId)
            oprot.writeFieldEnd()
        if self.icebergFieldMapKeyId is not None:
            oprot.writeFieldBegin('icebergFieldMapKeyId', TType.I32, 4)
            oprot.writeI32(self.icebergFieldMapKeyId)
            oprot.writeFieldEnd()
        if self.icebergFieldMapValueId is not None:
            oprot.writeFieldBegin('icebergFieldMapValueId', TType.I32, 5)
            oprot.writeI32(self.icebergFieldMapValueId)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TTableDescriptor(object):
    ...
    def __init__(self, id=None, tableType=None, columnDescriptors=None, numClusteringCols=None, hdfsTable=None, hbaseTable=None, dataSourceTable=None, kuduTable=None, icebergTable=None, tableName=None, dbName=None,):
        self.id = id
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.icebergTable = CatalogObjects.ttypes.TIcebergTable()
                    self.icebergTable.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.kuduTable is not None:
            ...
            oprot.writeFieldEnd()
        if self.icebergTable is not None:
            oprot.writeFieldBegin('icebergTable', TType.STRUCT, 11)
            self.icebergTable.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TSlotDescriptor.thrift_spec = (
    ...
    (10, TType.I32, 'virtual_col_type', None, 0, ),  # 10
)
...
TColumnDescriptor.thrift_spec = (
    ...
    (3, TType.I32, 'icebergFieldId', None, None, ),  # 3
    (4, TType.I32, 'icebergFieldMapKeyId', None, None, ),  # 4
    (5, TType.I32, 'icebergFieldMapValueId', None, None, ),  # 5
)
...
TTableDescriptor.thrift_spec = (
    ...
    (11, TType.STRUCT, 'icebergTable', [CatalogObjects.ttypes.TIcebergTable, None], None, ),  # 11
)
