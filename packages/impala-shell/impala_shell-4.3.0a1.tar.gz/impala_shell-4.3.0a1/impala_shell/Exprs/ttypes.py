...
class TDateLiteral(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.date_string = iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.date_string is not None:
            ...
            oprot.writeString(self.date_string)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCastExpr(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.cast_format = iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.cast_format is not None:
            ...
            oprot.writeString(self.cast_format)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TExprNode(object):
    ...
    def __init__(self, node_type=None, type=None, num_children=None, is_constant=None, fn=None, vararg_start_idx=None, bool_literal=None, case_expr=None, date_literal=None, float_literal=None, int_literal=None, in_predicate=None, is_null_pred=None, literal_pred=None, slot_ref=None, string_literal=None, tuple_is_null_pred=None, decimal_literal=None, agg_expr=None, timestamp_literal=None, kudu_partition_expr=None, cast_expr=None, is_codegen_disabled=None,):
        ...
        self.is_codegen_disabled = is_codegen_disabled
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.is_codegen_disabled = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.cast_expr is not None:
            ...
            oprot.writeFieldEnd()
        if self.is_codegen_disabled is not None:
            oprot.writeFieldBegin('is_codegen_disabled', TType.BOOL, 23)
            oprot.writeBool(self.is_codegen_disabled)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TDateLiteral.thrift_spec = (
    ...
    (2, TType.STRING, 'date_string', None, None, ),  # 2
)
...
TCastExpr.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'cast_format', None, None, ),  # 1
)
...
TExprNode.thrift_spec = (
    ...
    (23, TType.BOOL, 'is_codegen_disabled', None, None, ),  # 23
)
