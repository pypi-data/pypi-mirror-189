            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i81 in range(_size77):
                        _elem82 = TGetTableHistoryResultItem()
                        _elem82.read(iprot)
                        self.result.append(_elem82)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetFunctionsResult(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i88 in range(_size84):
                        ...
                        self.fn_signatures.append(_elem89)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i94 in range(_size90):
                        ...
                        self.fn_ret_types.append(_elem95)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i100 in range(_size96):
                        ...
                        self.fn_binary_types.append(_elem101)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i106 in range(_size102):
                        ...
                        self.fn_persistence.append(_elem107)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fn_signatures is not None:
            ...
            for iter108 in self.fn_signatures:
        ...
        if self.fn_ret_types is not None:
            ...
            for iter109 in self.fn_ret_types:
        ...
        if self.fn_binary_types is not None:
            ...
            for iter110 in self.fn_binary_types:
        ...
        if self.fn_persistence is not None:
            ...
            for iter111 in self.fn_persistence:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i116 in range(_size112):
                        _elem117 = Data.ttypes.TResultRow()
                        _elem117.read(iprot)
                        self.results.append(_elem117)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TLoadDataReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i123 in range(_size119):
                        _elem124 = CatalogObjects.ttypes.TPartitionKeyValue()
                        _elem124.read(iprot)
                        self.partition_spec.append(_elem124)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.partition_spec is not None:
            ...
            for iter125 in self.partition_spec:
                iter125.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TLoadDataResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i130 in range(_size126):
                        ...
                        self.loaded_files.append(_elem131)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.loaded_files is not None:
            ...
            for iter132 in self.loaded_files:
...
class TExecRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i137 in range(_size133):
                        _elem138 = TAccessEvent()
                        _elem138.read(iprot)
                        self.access_events.append(_elem138)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i143 in range(_size139):
                        ...
                        self.analysis_warnings.append(_elem144)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
    ...
    def write(self, oprot):
        ...
        if self.access_events is not None:
            ...
            for iter145 in self.access_events:
                iter145.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.analysis_warnings is not None:
            ...
            for iter146 in self.analysis_warnings:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i151 in range(_size147):
                        _elem152 = Types.ttypes.TColumnType()
                        _elem152.read(iprot)
                        self.arg_types.append(_elem152)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class TUpdateCatalogCacheRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i158 in range(_size154):
                        _elem159 = CatalogObjects.ttypes.TCatalogObject()
                        _elem159.read(iprot)
                        self.updated_objects_deprecated.append(_elem159)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i164 in range(_size160):
                        _elem165 = CatalogObjects.ttypes.TCatalogObject()
                        _elem165.read(iprot)
                        self.removed_objects_deprecated.append(_elem165)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.updated_objects_deprecated is not None:
            ...
            for iter166 in self.updated_objects_deprecated:
                iter166.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.removed_objects_deprecated is not None:
            ...
            for iter167 in self.removed_objects_deprecated:
                iter167.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TUpdateExecutorMembershipRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i178 in range(_size174):
                        ...
                        self.ip_addresses.add(_elem179)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i184 in range(_size180):
                        _elem185 = TExecutorGroupSet()
                        _elem185.read(iprot)
                        self.exec_group_sets.append(_elem185)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ip_addresses is not None:
            ...
            for iter187 in self.ip_addresses:
        ...
        if self.exec_group_sets is not None:
            ...
            for iter188 in self.exec_group_sets:
                iter188.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetJvmMemoryMetricsResponse(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i193 in range(_size189):
                        _elem194 = TJvmMemoryPool()
                        _elem194.read(iprot)
                        self.memory_pools.append(_elem194)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.memory_pools is not None:
            ...
            for iter195 in self.memory_pools:
                iter195.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i200 in range(_size196):
                        _elem201 = TJvmThreadInfo()
                        _elem201.read(iprot)
                        self.threads.append(_elem201)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetAllHadoopConfigsResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.configs is not None:
            ...
            for kiter210, viter211 in self.configs.items():
...
class TBuildTestDescriptorTableParams(object):
                ...
                if ftype == TType.LIST:
                    ...
                    for _i223 in range(_size219):
                        ...
                        for _i229 in range(_size225):
                            _elem230 = Types.ttypes.TColumnType()
                            _elem230.read(iprot)
                            _elem224.append(_elem230)
                        iprot.readListEnd()
                        self.slot_types.append(_elem224)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.slot_types is not None:
            ...
            for iter231 in self.slot_types:
                oprot.writeListBegin(TType.STRUCT, len(iter231))
                for iter232 in iter231:
                    iter232.write(oprot)
                oprot.writeListEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TTestCaseData(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i237 in range(_size233):
                        _elem238 = CatalogObjects.ttypes.TTable()
                        _elem238.read(iprot)
                        self.tables_and_views.append(_elem238)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i243 in range(_size239):
                        _elem244 = CatalogObjects.ttypes.TDatabase()
                        _elem244.read(iprot)
                        self.dbs.append(_elem244)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.tables_and_views is not None:
            ...
            for iter245 in self.tables_and_views:
                iter245.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dbs is not None:
...
class TWrappedHttpRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.params is not None:
            ...
            for kiter268, viter269 in self.params.items():
        ...
        if self.headers is not None:
            ...
            for kiter270, viter271 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            for kiter272, viter273 in self.cookies.items():
...
class TWrappedHttpResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.headers is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.headers))
            for kiter288, viter289 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.cookies))
            for kiter290, viter291 in self.cookies.items():
