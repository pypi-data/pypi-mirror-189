...
class THdfsFileSplit(object):
    ...
    def __init__(self, relative_path=None, offset=None, length=None, partition_id=None, file_length=None, file_compression=None, mtime=None, partition_path_hash=None, absolute_path=None, is_erasure_coded=None,):
    ...
    def write(self, oprot):
        ...
        if self.is_erasure_coded is not None:
            oprot.writeFieldBegin('is_erasure_coded', TType.BOOL, 11)
...
class TScanRange(object):
    ...
    def __init__(self, hdfs_file_split=None, hbase_key_range=None, kudu_scan_token=None, file_metadata=None,):
...
class TJoinNode(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i122 in range(_size118):
                        ...
                        self.build_tuples.append(_elem123)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i128 in range(_size124):
                        ...
                        self.nullable_build_tuples.append(_elem129)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.build_tuples is not None:
            ...
            for iter130 in self.build_tuples:
        ...
        if self.nullable_build_tuples is not None:
            ...
            for iter131 in self.nullable_build_tuples:
...
class TAggregator(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i136 in range(_size132):
                        ...
                        _elem137.read(iprot)
                        self.grouping_exprs.append(_elem137)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i142 in range(_size138):
                        ...
                        _elem143.read(iprot)
                        self.aggregate_functions.append(_elem143)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.grouping_exprs is not None:
            ...
            for iter144 in self.grouping_exprs:
                iter144.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.aggregate_functions is not None:
            ...
            for iter145 in self.aggregate_functions:
                iter145.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TAggregationNode(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i150 in range(_size146):
                        _elem151 = TAggregator()
                        _elem151.read(iprot)
                        self.aggregators.append(_elem151)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.aggregators is not None:
            ...
            for iter152 in self.aggregators:
                iter152.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TSortInfo(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i157 in range(_size153):
                        _elem158 = Exprs.ttypes.TExpr()
                        _elem158.read(iprot)
                        self.ordering_exprs.append(_elem158)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i163 in range(_size159):
                        ...
                        self.is_asc_order.append(_elem164)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i169 in range(_size165):
                        _elem170 = iprot.readBool()
                        self.nulls_first.append(_elem170)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i175 in range(_size171):
                        _elem176 = Exprs.ttypes.TExpr()
                        _elem176.read(iprot)
                        self.sort_tuple_slot_exprs.append(_elem176)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.ordering_exprs is not None:
            ...
            for iter177 in self.ordering_exprs:
                iter177.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.is_asc_order is not None:
            ...
            for iter178 in self.is_asc_order:
                oprot.writeBool(iter178)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.nulls_first is not None:
            ...
            for iter179 in self.nulls_first:
                oprot.writeBool(iter179)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.sort_tuple_slot_exprs is not None:
            ...
            for iter180 in self.sort_tuple_slot_exprs:
                iter180.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TSortNode(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i185 in range(_size181):
                        _elem186 = Exprs.ttypes.TExpr()
                        _elem186.read(iprot)
                        self.partition_exprs.append(_elem186)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
    ...
    def write(self, oprot):
        ...
        if self.partition_exprs is not None:
            ...
            for iter187 in self.partition_exprs:
                iter187.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TAnalyticNode(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i198 in range(_size194):
                        ...
                        _elem199.read(iprot)
                        self.order_by_exprs.append(_elem199)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i204 in range(_size200):
                        _elem205 = Exprs.ttypes.TExpr()
                        _elem205.read(iprot)
                        self.analytic_functions.append(_elem205)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.partition_exprs is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.partition_exprs))
            for iter206 in self.partition_exprs:
                iter206.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.order_by_exprs is not None:
            ...
            for iter207 in self.order_by_exprs:
                iter207.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.analytic_functions is not None:
            ...
            for iter208 in self.analytic_functions:
                iter208.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TUnionNode(object):
                ...
                if ftype == TType.LIST:
                    ...
                    for _i213 in range(_size209):
                        ...
                        for _i219 in range(_size215):
                            _elem220 = Exprs.ttypes.TExpr()
                            _elem220.read(iprot)
                            _elem214.append(_elem220)
                        iprot.readListEnd()
                        self.result_expr_lists.append(_elem214)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i225 in range(_size221):
                        ...
                        for _i231 in range(_size227):
                            _elem232 = Exprs.ttypes.TExpr()
                            _elem232.read(iprot)
                            _elem226.append(_elem232)
                        iprot.readListEnd()
                        self.const_expr_lists.append(_elem226)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.result_expr_lists is not None:
            ...
            for iter233 in self.result_expr_lists:
                oprot.writeListBegin(TType.STRUCT, len(iter233))
        ...
        if self.const_expr_lists is not None:
            ...
            for iter235 in self.const_expr_lists:
                oprot.writeListBegin(TType.STRUCT, len(iter235))
                for iter236 in iter235:
                    iter236.write(oprot)
                oprot.writeListEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TExchangeNode(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i241 in range(_size237):
                        ...
                        self.input_row_tuples.append(_elem242)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.input_row_tuples is not None:
            ...
            for iter243 in self.input_row_tuples:
...
class TUnnestNode(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i248 in range(_size244):
                        _elem249 = Exprs.ttypes.TExpr()
                        _elem249.read(iprot)
                        self.collection_exprs.append(_elem249)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.collection_exprs is not None:
            ...
            for iter250 in self.collection_exprs:
                iter250.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TPlanNode(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i255 in range(_size251):
                        ...
                        self.row_tuples.append(_elem256)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i261 in range(_size257):
                        ...
                        self.nullable_tuples.append(_elem262)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i267 in range(_size263):
                        _elem268 = Exprs.ttypes.TExpr()
                        _elem268.read(iprot)
                        self.conjuncts.append(_elem268)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i273 in range(_size269):
                        _elem274 = TPipelineMembership()
                        _elem274.read(iprot)
                        self.pipelines.append(_elem274)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i279 in range(_size275):
                        _elem280 = TRuntimeFilterDesc()
                        _elem280.read(iprot)
                        self.runtime_filters.append(_elem280)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 25:
    ...
    def write(self, oprot):
        ...
        if self.row_tuples is not None:
            ...
            for iter281 in self.row_tuples:
        ...
        if self.nullable_tuples is not None:
            ...
            for iter282 in self.nullable_tuples:
                oprot.writeBool(iter282)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.runtime_filters is not None:
            ...
            for iter284 in self.runtime_filters:
                iter284.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.resource_profile is not None:
...
THdfsFileSplit.thrift_spec = (
    ...
    (11, TType.BOOL, 'is_erasure_coded', None, None, ),  # 11
)
