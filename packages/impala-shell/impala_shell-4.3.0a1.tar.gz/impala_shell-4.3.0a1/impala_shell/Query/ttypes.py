...
class TQueryOptions(object):
    ...
    def write(self, oprot):
        ...
        if self.enabled_runtime_filter_types is not None:
            ...
            for iter6 in self.enabled_runtime_filter_types:
...
class TQueryCtx(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        _elem12 = CatalogObjects.ttypes.TTableName()
                        _elem12.read(iprot)
                        self.tables_missing_stats.append(_elem12)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i17 in range(_size13):
                        _elem18 = CatalogObjects.ttypes.TTableName()
                        _elem18.read(iprot)
                        self.tables_with_corrupt_stats.append(_elem18)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i23 in range(_size19):
                        _elem24 = CatalogObjects.ttypes.TTableName()
                        _elem24.read(iprot)
                        self.tables_missing_diskids.append(_elem24)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 17:
    ...
    def write(self, oprot):
        ...
        if self.tables_missing_stats is not None:
            ...
            for iter25 in self.tables_missing_stats:
                iter25.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.tables_with_corrupt_stats is not None:
            ...
            for iter26 in self.tables_with_corrupt_stats:
                iter26.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.tables_missing_diskids is not None:
            ...
            for iter27 in self.tables_missing_diskids:
                iter27.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.request_pool is not None:
...
class TPlanExecInfo(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i32 in range(_size28):
                        _elem33 = Planner.ttypes.TPlanFragment()
                        _elem33.read(iprot)
                        self.fragments.append(_elem33)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i38 in range(_size34):
                        ...
                        _val40 = Planner.ttypes.TScanRangeSpec()
                        _val40.read(iprot)
                        self.per_node_scan_ranges[_key39] = _val40
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.per_node_scan_ranges is not None:
            ...
            for kiter42, viter43 in self.per_node_scan_ranges.items():
...
class TQueryExecRequest(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i48 in range(_size44):
                        _elem49 = TPlanExecInfo()
                        _elem49.read(iprot)
                        self.plan_exec_info.append(_elem49)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i54 in range(_size50):
                        _elem55 = Types.ttypes.TNetworkAddress()
                        _elem55.read(iprot)
                        self.host_list.append(_elem55)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.plan_exec_info is not None:
            ...
            for iter56 in self.plan_exec_info:
                iter56.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
TQueryOptions.thrift_spec = (
    ...
    (116, TType.DOUBLE, 'report_skew_limit', None, 1, ),  # 116
    (117, TType.BOOL, 'optimize_simple_limit', None, False, ),  # 117
    (118, TType.BOOL, 'use_dop_for_costing', None, True, ),  # 118
    (119, TType.DOUBLE, 'broadcast_to_partition_factor', None, 1, ),  # 119
    ...
    (123, TType.DOUBLE, 'minmax_filter_threshold', None, 0, ),  # 123
