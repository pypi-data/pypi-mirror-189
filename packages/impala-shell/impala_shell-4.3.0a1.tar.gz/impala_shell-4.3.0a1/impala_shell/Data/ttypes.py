...
class TColumnValue(object):
    ...
    def __init__(self, bool_val=None, byte_val=None, short_val=None, int_val=None, long_val=None, double_val=None, string_val=None, binary_val=None, timestamp_val=None, decimal_val=None, date_val=None,):
    ...
    def write(self, oprot):
        ...
        if self.date_val is not None:
            oprot.writeFieldBegin('date_val', TType.I32, 11)
            oprot.writeI32(self.date_val)
            oprot.writeFieldEnd()
...
TColumnValue.thrift_spec = (
    ...
    (11, TType.I32, 'date_val', None, None, ),  # 11
)
...
TColumnData.thrift_spec = (
    ...
    (8, TType.LIST, 'string_vals', (TType.STRING, None, False), None, ),  # 8
