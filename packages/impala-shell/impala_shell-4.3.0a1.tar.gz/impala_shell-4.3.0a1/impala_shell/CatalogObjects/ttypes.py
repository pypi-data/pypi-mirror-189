...
class THdfsTable(object):
    ...
    def write(self, oprot):
        ...
        if self.partitions is not None:
            ...
            for kiter93, viter94 in self.partitions.items():
        ...
        if self.network_addresses is not None:
            ...
            for iter95 in self.network_addresses:
                iter95.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.partition_prefixes is not None:
            ...
            for iter96 in self.partition_prefixes:
...
class THBaseTable(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i107 in range(_size103):
                        ...
                        self.qualifiers.append(_elem108)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i113 in range(_size109):
                        ...
                        self.binary_encoded.append(_elem114)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.qualifiers is not None:
            ...
            for iter116 in self.qualifiers:
        ...
        if self.binary_encoded is not None:
            ...
            for iter117 in self.binary_encoded:
...
class TRangePartition(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i129 in range(_size125):
                        _elem130 = Exprs.ttypes.TExpr()
                        _elem130.read(iprot)
                        self.lower_bound_values.append(_elem130)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i135 in range(_size131):
                        _elem136 = Exprs.ttypes.TExpr()
                        _elem136.read(iprot)
                        self.upper_bound_values.append(_elem136)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i141 in range(_size137):
                        _elem142 = TKuduPartitionParam()
                        _elem142.read(iprot)
                        self.hash_specs.append(_elem142)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.lower_bound_values is not None:
            ...
            for iter143 in self.lower_bound_values:
                iter143.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.upper_bound_values is not None:
            ...
            for iter144 in self.upper_bound_values:
                iter144.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.hash_specs is not None:
            ...
            for iter145 in self.hash_specs:
                iter145.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TKuduPartitionByRangeParam(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i156 in range(_size152):
                        _elem157 = TRangePartition()
                        _elem157.read(iprot)
                        self.range_partitions.append(_elem157)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.range_partitions is not None:
            ...
            for iter159 in self.range_partitions:
                iter159.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TKuduTable(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i164 in range(_size160):
                        ...
                        self.master_addresses.append(_elem165)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i170 in range(_size166):
                        ...
                        self.key_columns.append(_elem171)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i176 in range(_size172):
                        _elem177 = TKuduPartitionParam()
                        _elem177.read(iprot)
                        self.partition_by.append(_elem177)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.master_addresses is not None:
            ...
            for iter178 in self.master_addresses:
        ...
        if self.key_columns is not None:
            ...
            for iter179 in self.key_columns:
        ...
        if self.partition_by is not None:
            ...
            for iter180 in self.partition_by:
                iter180.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TIcebergPartitionField(object):
    ...
    def __init__(self, source_id=None, field_id=None, orig_field_name=None, field_name=None, transform=None,):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i185 in range(_size181):
                        _elem186 = TIcebergPartitionField()
                        _elem186.read(iprot)
                        self.partition_fields.append(_elem186)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TIcebergContentFileStore(object):
    ...
    def __init__(self, path_hash_to_data_file_without_deletes=None, path_hash_to_data_file_with_deletes=None, path_hash_to_delete_file=None, has_avro=None, has_orc=None, has_parquet=None,):
        ...
        self.path_hash_to_delete_file = path_hash_to_delete_file
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i192 in range(_size188):
                        ...
                        _val194 = THdfsFileDesc()
                        _val194.read(iprot)
                        self.path_hash_to_data_file_without_deletes[_key193] = _val194
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i199 in range(_size195):
                        ...
                        _val201.read(iprot)
                        self.path_hash_to_data_file_with_deletes[_key200] = _val201
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    self.path_hash_to_delete_file = {}
                    (_ktype203, _vtype204, _size202) = iprot.readMapBegin()
                    for _i206 in range(_size202):
                        _key207 = iprot.readString()
                        _val208 = THdfsFileDesc()
                        _val208.read(iprot)
                        self.path_hash_to_delete_file[_key207] = _val208
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.path_hash_to_data_file_without_deletes is not None:
            ...
            for kiter209, viter210 in self.path_hash_to_data_file_without_deletes.items():
        ...
        if self.path_hash_to_data_file_with_deletes is not None:
            ...
            for kiter211, viter212 in self.path_hash_to_data_file_with_deletes.items():
                oprot.writeString(kiter211)
                viter212.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.path_hash_to_delete_file is not None:
            oprot.writeFieldBegin('path_hash_to_delete_file', TType.MAP, 3)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.path_hash_to_delete_file))
            for kiter213, viter214 in self.path_hash_to_delete_file.items():
                oprot.writeString(kiter213)
                viter214.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.has_avro is not None:
            oprot.writeFieldBegin('has_avro', TType.BOOL, 4)
            oprot.writeBool(self.has_avro)
            oprot.writeFieldEnd()
        if self.has_orc is not None:
            oprot.writeFieldBegin('has_orc', TType.BOOL, 5)
            oprot.writeBool(self.has_orc)
            oprot.writeFieldEnd()
        if self.has_parquet is not None:
            oprot.writeFieldBegin('has_parquet', TType.BOOL, 6)
...
class TIcebergTable(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i219 in range(_size215):
                        _elem220 = TIcebergPartitionSpec()
                        _elem220.read(iprot)
                        self.partition_spec.append(_elem220)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i225 in range(_size221):
                        ...
                        _val227 = TIcebergPartitionStats()
                        _val227.read(iprot)
                        self.partition_stats[_key226] = _val227
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_spec is not None:
            ...
            for iter228 in self.partition_spec:
                iter228.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.partition_stats is not None:
            ...
            for kiter229, viter230 in self.partition_stats.items():
...
class TTable(object):
    ...
    def __init__(self, db_name=None, tbl_name=None, load_status=None, access_level=None, columns=None, clustering_columns=None, virtual_columns=None, table_stats=None, table_type=None, hdfs_table=None, hbase_table=None, metastore_table=None, data_source_table=None, kudu_table=None, storage_metadata_load_time_ns=None, iceberg_table=None, tbl_comment=None,):
        self.db_name = db_name
        self.tbl_name = tbl_name
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i241 in range(_size237):
                        _elem242 = TColumn()
                        _elem242.read(iprot)
                        self.clustering_columns.append(_elem242)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i247 in range(_size243):
                        _elem248 = TColumn()
                        _elem248.read(iprot)
                        self.virtual_columns.append(_elem248)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
    ...
    def write(self, oprot):
        ...
        if self.clustering_columns is not None:
            ...
            for iter250 in self.clustering_columns:
                iter250.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.virtual_columns is not None:
            ...
            for iter251 in self.virtual_columns:
                iter251.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TPrincipal(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i256 in range(_size252):
                        ...
                        self.grant_groups.append(_elem257)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.grant_groups is not None:
            ...
            for iter258 in self.grant_groups:
...
class TCatalogObject(object):
    ...
    def __init__(self, type=None, catalog_version=None, catalog=None, db=None, table=None, fn=None, data_source=None, principal=None, privilege=None, cache_pool=None, authz_cache_invalidation=None, hdfs_partition=None,):
        self.type = type
...
TIcebergContentFileStore.thrift_spec = (
    ...
    (3, TType.MAP, 'path_hash_to_delete_file', (TType.STRING, None, TType.STRUCT, [THdfsFileDesc, None], False), None, ),  # 3
    (4, TType.BOOL, 'has_avro', None, None, ),  # 4
    (5, TType.BOOL, 'has_orc', None, None, ),  # 5
    (6, TType.BOOL, 'has_parquet', None, None, ),  # 6
)
