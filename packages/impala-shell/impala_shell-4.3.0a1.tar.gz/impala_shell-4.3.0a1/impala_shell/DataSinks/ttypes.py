...
class THdfsTableSink(object):
    ...
    Attributes:
     ...
     - is_result_sink
     - external_output_dir
     - external_output_partition_depth
     - parquet_bloom_filter_col_info
    """


    def __init__(self, partition_key_exprs=None, overwrite=None, skip_header_line_count=None, input_is_clustered=None, sort_columns=None, write_id=None, sorting_order=None, is_result_sink=False, external_output_dir=None, external_output_partition_depth=None, parquet_bloom_filter_col_info=None,):
        ...
        self.is_result_sink = is_result_sink
        self.external_output_dir = external_output_dir
        self.external_output_partition_depth = external_output_partition_depth
        self.parquet_bloom_filter_col_info = parquet_bloom_filter_col_info
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.is_result_sink = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.STRING:
                    self.external_output_dir = iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.I32:
                    self.external_output_partition_depth = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
                if ftype == TType.MAP:
                    self.parquet_bloom_filter_col_info = {}
                    (_ktype13, _vtype14, _size12) = iprot.readMapBegin()
                    for _i16 in range(_size12):
                        _key17 = iprot.readString()
                        _val18 = iprot.readI64()
                        self.parquet_bloom_filter_col_info[_key17] = _val18
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_key_exprs is not None:
            ...
            for iter19 in self.partition_key_exprs:
                iter19.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.sort_columns is not None:
            ...
            for iter20 in self.sort_columns:
        ...
        if self.sorting_order is not None:
            ...
            oprot.writeFieldEnd()
        if self.is_result_sink is not None:
            oprot.writeFieldBegin('is_result_sink', TType.BOOL, 8)
            oprot.writeBool(self.is_result_sink)
            oprot.writeFieldEnd()
        if self.external_output_dir is not None:
            oprot.writeFieldBegin('external_output_dir', TType.STRING, 9)
            oprot.writeString(self.external_output_dir)
            oprot.writeFieldEnd()
        if self.external_output_partition_depth is not None:
            oprot.writeFieldBegin('external_output_partition_depth', TType.I32, 10)
            oprot.writeI32(self.external_output_partition_depth)
            oprot.writeFieldEnd()
        if self.parquet_bloom_filter_col_info is not None:
            oprot.writeFieldBegin('parquet_bloom_filter_col_info', TType.MAP, 11)
            oprot.writeMapBegin(TType.STRING, TType.I64, len(self.parquet_bloom_filter_col_info))
            for kiter21, viter22 in self.parquet_bloom_filter_col_info.items():
...
class TKuduTableSink(object):
    ...
    def __init__(self, referenced_columns=None, ignore_not_found_or_duplicate=None, kudu_txn_token=None,):
        self.referenced_columns = referenced_columns
        self.ignore_not_found_or_duplicate = ignore_not_found_or_duplicate
        self.kudu_txn_token = kudu_txn_token
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i27 in range(_size23):
                        ...
                        self.referenced_columns.append(_elem28)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.STRING:
                    self.kudu_txn_token = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.referenced_columns is not None:
            ...
            for iter29 in self.referenced_columns:
        ...
        if self.ignore_not_found_or_duplicate is not None:
            ...
            oprot.writeFieldEnd()
        if self.kudu_txn_token is not None:
            oprot.writeFieldBegin('kudu_txn_token', TType.STRING, 3)
            oprot.writeBinary(self.kudu_txn_token)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TJoinBuildSink(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i34 in range(_size30):
                        _elem35 = PlanNodes.ttypes.TEqJoinCondition()
                        _elem35.read(iprot)
                        self.eq_join_conjuncts.append(_elem35)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i40 in range(_size36):
                        _elem41 = PlanNodes.ttypes.TRuntimeFilterDesc()
                        _elem41.read(iprot)
                        self.runtime_filters.append(_elem41)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.eq_join_conjuncts is not None:
            ...
            for iter42 in self.eq_join_conjuncts:
                iter42.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.runtime_filters is not None:
            ...
            for iter43 in self.runtime_filters:
                iter43.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TDataSink(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i48 in range(_size44):
                        _elem49 = Exprs.ttypes.TExpr()
                        _elem49.read(iprot)
                        self.output_exprs.append(_elem49)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
    ...
    def write(self, oprot):
        ...
        if self.output_exprs is not None:
            ...
            for iter50 in self.output_exprs:
                iter50.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.resource_profile is not None:
