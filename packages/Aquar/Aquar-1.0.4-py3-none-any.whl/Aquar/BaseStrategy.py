...
class BaseStrategy(ABC):
    ...
    def calc_profit(self, is_latest_day=False):
        ...
        this_pos_df = (
            ...
            if os.path.exists(this_file_path)
                ...
                columns=['portfolio', 'contract', 'o', 'c', 'day_pnl', 'night_pnl']
            )
        )
    ...
    def _extracted_from_calc_return_(self, data_df):
        ...
        x_ticks = plotReturn.get_first_tdates(start_date.year, end_date.year)
        ...
        with sns.axes_style('white'):
            ...
            plotReturn.plottext(ax, indicators, '')
        f.tight_layout()
