    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_jfrog_artifactory_core_module",
        "cdk_cloudformation_jfrog_artifactory_core_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_jfrog_artifactory_core_module._jsii": [
            "jfrog-artifactory-core-module@1.12.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_jfrog_artifactory_core_module": [
            "py.typed"
        ]
