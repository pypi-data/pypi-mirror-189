...
from chainmaker.utils import sm3
...
def _get_ski_from_public_key(pk_or_pk_bytes: Union[PublicKey, bytes], hash_type: HashType = HashType.SHA256) -> str:
    """
...
def get_chainmaker_address_from_public_key(pk: PublicKey, hash_type: HashType = HashType.SHA256) -> str:
    ...
    :return: 40位地址
    """
    ski = _get_ski_from_public_key(pk, hash_type)
...
def get_zxl_address_from_cert_pem(cert_bytes: bytes) -> str:
    """
