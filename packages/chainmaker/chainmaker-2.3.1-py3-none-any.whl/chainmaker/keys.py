...
class ChainConfigMethod(Enum):
    ...
    CORE_UPDATE = 2  # update core
    BLOCK_UPDATE = 3  # update block
    ...
    CONSENSUS_EXT_UPDATE = 14  # update consensus parameters, key exit in ext_config
    CONSENSUS_EXT_DELETE = 15  # delete consensus parameters, key exit in ext_config
    PERMISSION_ADD = 16  # add permission
    PERMISSION_UPDATE = 17  # update permission
    ...
    UPDATE_VERSION = 30  # update version
    CONSENSUS_SWITCH = 31  # switch consensus algorithm
    DPOS_NODE_ID_UPDATE = 32  # update node ids in dpos
...
class CertManageMethod(Enum):
    ...
    CERT_ALIAS_UPDATE = 7  # update one certificate alias, self
...
class DposStakeMethod(Enum):
    ...
    UPDATE_MIN_SELF_DELEGATION = 10  # update min self delegation
    READ_MIN_SELF_DELEGATION = 11  # read min self delegation
    UPDATE_EPOCH_VALIDATOR_NUMBER = 12  # update epoch validator number
    READ_EPOCH_VALIDATOR_NUMBER = 13  # read epoch validator number
    UPDATE_EPOCH_BLOCK_NUMBER = 14  # update epoch block number
    ...
    UPDATE_EPOCH_VALIDATOR_NUMBER_AND_EPOCH_BLOCK_NUMBER = 21  # update epoch validator num and block num
...
class RelayCrossMethod(Enum):  # todo
    ...
    UPDATE_GATEWAY = 1  # update gateway
    ...
    UPDATE_CROSS_CHAIN_TRY = 5  # update cross chain try
    UPDATE_CROSS_CHAIN_RESULT = 6  # update cross chain result
    UPDATE_CROSS_CHAIN_CONFIRM = 7  # update cross chain confirm
    UPDATE_SRC_GATEWAY_CONFIRM = 8  # update source gateway confirm
...
class DposConfigMethod(Enum):  # todo
    ...
    UPDATE_DPOS_CONFIG = 1  # update dpos config
