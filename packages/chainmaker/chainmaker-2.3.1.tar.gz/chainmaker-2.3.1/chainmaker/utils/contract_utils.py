...
class Contract(object):
    ...
    def __init__(self, cc: ChainClient, byte_code_path: str, runtime_type: Union[RuntimeType, str] = None,
    ...
    def create(self, contract_name: str = None):
        """
        创建合约
    ...
    def invoke(self, method, params=None, contract_result_type: ContractResultType = ContractResultType.STRING.name,
               by_address=False):
        """调用合约方法"""
        ...
        return parse_result(result, contract_result_type)
    ...
    def run_livecycle(self, method, params=None):
        """合约生命周期"""
        self.create()
