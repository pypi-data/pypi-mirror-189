# required function: get_nth_trading_day, get_lastnth_trading_day, count_days, date_from_string
# import optlib as opt
import os
import datetime
# calendar = opt.Calendar(os.path.abspath(os.path.join(os.path.dirname(__file__))) + "/China.txt")
...
if __name__ == "__main__":
    ...
    print(date_from_string("2022-01-01"))
