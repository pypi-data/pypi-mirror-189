...
class ResultJSONKpi(object):
    ...
    def __init__(self, escalation=None, resolution=None, agentperfscore=None, satisfaction=None, propensity=None, success=None, negativity=None, agent_empathy=None, customer_satisfaction=None, trends=None, compliance=None):  # noqa: E501
        ...
        if agent_empathy is not None:
            self.agent_empathy = agent_empathy
    ...
    def negativity(self):
        ...
        Probability that the call contains negative emotions, 0 corresponds to no negative emotions whereas 1 only to negative emotions  # noqa: E501
    ...
    @property
    def agent_empathy(self):
        """Gets the agent_empathy of this ResultJSONKpi.  # noqa: E501

        Probability that the agent exhibits empathy between 0 (non empathetic) and 1 (empathetic)  # noqa: E501

        :return: The agent_empathy of this ResultJSONKpi.  # noqa: E501
        :rtype: float
        """
        return self._agent_empathy

    @agent_empathy.setter
    def agent_empathy(self, agent_empathy):
        """Sets the agent_empathy of this ResultJSONKpi.

        Probability that the agent exhibits empathy between 0 (non empathetic) and 1 (empathetic)  # noqa: E501

        :param agent_empathy: The agent_empathy of this ResultJSONKpi.  # noqa: E501
        :type: float
        """

        self._agent_empathy = agent_empathy

    @property
    def customer_satisfaction(self):
        """Gets the customer_satisfaction of this ResultJSONKpi.  # noqa: E501

        Probability that the customer had a positive experience between 0 (dissatisfied) and 1 (satisfied)  # noqa: E501

        :return: The customer_satisfaction of this ResultJSONKpi.  # noqa: E501
        :rtype: float
        """
        return self._customer_satisfaction

    @customer_satisfaction.setter
    def customer_satisfaction(self, customer_satisfaction):
        """Sets the customer_satisfaction of this ResultJSONKpi.

        Probability that the customer had a positive experience between 0 (dissatisfied) and 1 (satisfied)  # noqa: E501

        :param customer_satisfaction: The customer_satisfaction of this ResultJSONKpi.  # noqa: E501
        :type: float
        """

        self._customer_satisfaction = customer_satisfaction
