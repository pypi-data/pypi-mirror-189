...
def render_pdf(xlsfile=None, output_dir=None, template_filepath=None, path_wkhtmltopdf=os.path.expanduser("~")+"\\wkhtmltopdf\\bin\\wkhtmltopdf.exe", options=None, default_value="n. d."):
