...
def evolutionDynamics(an_path, norm_path):
    ...
    name = an[0,2].rstrip('_analytical_')
    _out_an = an[0,1]
    _out_norm = norm[0,1]
    ...
    try:
        ...
        if os.path.exists(_out_an + "evolution_dynamics_" + name + ".jpg"):
            os.remove(_out_an + "evolution_dynamics_" + name + ".jpg")
        if os.path.exists(_out_norm + "evolution_dynamics_" + name + ".jpg"):
            os.remove(_out_norm + "evolution_dynamics_" + name + ".jpg")
        fig.savefig(_out_an + "evolution_dynamics_" + name + ".jpg")
        fig.savefig(_out_norm + "evolution_dynamics_" + name + ".jpg")
        plt.close(fig)  
