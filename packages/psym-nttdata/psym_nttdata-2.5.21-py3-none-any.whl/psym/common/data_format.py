...
from psym.graphql.fragment.work_order_type import AddEditWorkOrderTypeCard_workOrderType
...
def format_to_work_order_type(
    work_order_type_fragment: AddEditWorkOrderTypeCard_workOrderType,
) -> WorkOrderType:
    """This function gets `psym.graphql.fragment.work_order_type.AddEditWorkOrderTypeCard_workOrderType` object as argument
    and formats it to `psym.common.data_class.WorkOrderType` object
        ...
        :type work_order_type_fragment: :class:`~psym.graphql.fragment.work_order_type.AddEditWorkOrderTypeCard_workOrderType`
