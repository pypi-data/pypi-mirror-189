    ...
    **Example**
    ...
    files = [
        Document(
            ...
            document_category=file.documentCategory
        )
...
def get_location_by_name(client: SymphonyClient, name: str) -> Location:
    locations = get_locations(client=client)
    for location in locations:
        if location.name == name:
            return location
    raise EntityNotFoundError(entity=Entity.Location, entity_name=name)