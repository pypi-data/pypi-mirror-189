...
class NormJudgePublicDataJudicialSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type, url, *args, **kwargs):  # noqa: E501
        """NormJudgePublicDataJudicialSource - a model defined in OpenAPI
