...
class BarSourceDataName(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, first_name, middle_name, last_name, prefix, suffix, *args, **kwargs):  # noqa: E501
        """BarSourceDataName - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, first_name, middle_name, last_name, prefix, suffix, *args, **kwargs):  # noqa: E501
        """BarSourceDataName - a model defined in OpenAPI
