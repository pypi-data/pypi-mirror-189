...
class CaseCountAnalyticsByCourtLocation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_count, case_search_api, court_location, court, geo, *args, **kwargs):  # noqa: E501
        """CaseCountAnalyticsByCourtLocation - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): defaults to "CaseCountAnalyticsByCourtLocation"  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_count, case_search_api, court_location, court, geo, *args, **kwargs):  # noqa: E501
        """CaseCountAnalyticsByCourtLocation - a model defined in OpenAPI
