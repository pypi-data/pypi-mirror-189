...
class CaseTrack(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_id, pacer_options, schedule, last_tracked_details, last_fetch_date, last_fetch_date_with_updates, case_api, case, *args, **kwargs):  # noqa: E501
        """CaseTrack - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): Name of the object.. defaults to "CaseTrack"  # noqa: E501
        ...
        object = kwargs.get('object', "CaseTrack")
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_id, pacer_options, schedule, last_tracked_details, last_fetch_date, last_fetch_date_with_updates, case_api, case, *args, **kwargs):  # noqa: E501
        """CaseTrack - a model defined in OpenAPI
