...
class ExportFile(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, expiry_date, file_url, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            object (str): defaults to "ExportFile"  # noqa: E501
        ...
        object = kwargs.get('object', "ExportFile")
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, expiry_date, file_url, *args, **kwargs):  # noqa: E501
        """ExportFile - a model defined in OpenAPI
