...
class Schedule(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, days, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            object (str): Name of the object.. defaults to "Schedule"  # noqa: E501
        ...
        object = kwargs.get('object', "Schedule")
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, days, *args, **kwargs):  # noqa: E501
        """Schedule - a model defined in OpenAPI
