...
class NormJudgePublicDataNameHistoryArrayInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, first_name, middle_name, last_name, prefix, suffix, is_visible, *args, **kwargs):  # noqa: E501
        """NormJudgePublicDataNameHistoryArrayInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, first_name, middle_name, last_name, prefix, suffix, is_visible, *args, **kwargs):  # noqa: E501
        """NormJudgePublicDataNameHistoryArrayInner - a model defined in OpenAPI
