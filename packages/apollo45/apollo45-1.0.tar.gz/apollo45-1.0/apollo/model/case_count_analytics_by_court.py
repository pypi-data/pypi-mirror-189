...
class CaseCountAnalyticsByCourt(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_count, case_search_api, court, geo, *args, **kwargs):  # noqa: E501
        """CaseCountAnalyticsByCourt - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): defaults to "CaseCountAnalyticsByCourt"  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_count, case_search_api, court, geo, *args, **kwargs):  # noqa: E501
        """CaseCountAnalyticsByCourt - a model defined in OpenAPI
