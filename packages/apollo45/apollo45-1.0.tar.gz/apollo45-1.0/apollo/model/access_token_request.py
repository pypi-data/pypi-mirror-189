...
class AccessTokenRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, client_id, client_secret, *args, **kwargs):  # noqa: E501
        """AccessTokenRequest - a model defined in OpenAPI

        Args:
            client_id (str): clientId to get JWT token.
            client_secret (str): clientSecret to get JWT token.
