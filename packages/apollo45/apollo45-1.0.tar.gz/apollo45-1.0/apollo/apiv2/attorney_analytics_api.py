...
class AttorneyAnalyticsApi(object):
    ...
    def get_norm_attorney_by_id(
        ...
        **kwargs
        ...
        The Norm Attorney API allows you to look up Attorney Details by normAttorneyId.  # noqa: E501
