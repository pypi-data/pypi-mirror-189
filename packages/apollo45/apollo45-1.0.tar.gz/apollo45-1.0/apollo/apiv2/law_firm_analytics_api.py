...
class LawFirmAnalyticsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_norm_attorneys_associated_with_norm_law_firm_endpoint = _Endpoint(
            settings={
                'response_type': (AssociatedNormAttorneyResponse,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/normLawFirm/{normLawFirmId}/associatedNormAttorneys',
                'operation_id': 'get_norm_attorneys_associated_with_norm_law_firm',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_norm_judges_associated_with_norm_law_firm_endpoint = _Endpoint(
            settings={
                'response_type': (AssociatedNormJudgeResponse,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/normLawFirm/{normLawFirmId}/associatedNormJudges',
                'operation_id': 'get_norm_judges_associated_with_norm_law_firm',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_norm_law_firm_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (NormLawFirm,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/normLawFirm/{normLawFirmId}',
                'operation_id': 'get_norm_law_firm_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_norm_parties_associated_with_norm_law_firm_endpoint = _Endpoint(
            settings={
                'response_type': (AssociatedNormPartyResponse,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/normLawFirm/{normLawFirmId}/associatedNormParties',
                'operation_id': 'get_norm_parties_associated_with_norm_law_firm',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_normalized_law_firms_endpoint = _Endpoint(
            settings={
                'response_type': (NormLawFirmSearchResponse,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/normLawFirmSearch',
                'operation_id': 'search_normalized_law_firms',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.search_normalized_law_firms_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (NormLawFirmSearchResponse,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/normLawFirmSearch/{normLawFirmSearchId}',
                'operation_id': 'search_normalized_law_firms_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    'norm_law_firm_search_id': 'normLawFirmSearchId',
                    'page_number': 'pageNumber',
                },
                'location_map': {
                    'norm_law_firm_search_id': 'path',
                    'page_number': 'query',
                },
                'collection_format_map': {
                }
    ...
    def get_norm_attorneys_associated_with_norm_law_firm(
        ...
        **kwargs
        ...
        kwargs['page_number'] = \
            page_number
        return self.get_norm_attorneys_associated_with_norm_law_firm_endpoint.call_with_http_info(**kwargs)
    ...
    def get_norm_judges_associated_with_norm_law_firm(
        ...
        **kwargs
        ...
        kwargs['page_number'] = \
            page_number
        return self.get_norm_judges_associated_with_norm_law_firm_endpoint.call_with_http_info(**kwargs)
    ...
    def get_norm_law_firm_by_id(
        ...
        **kwargs
        ...
        """Norm LawFirm Details.  # noqa: E501

        The Law Firm API allows you to look up Law Firms by normLawFirmId.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_norm_law_firm_by_id(norm_law_firm_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['norm_law_firm_id'] = \
            norm_law_firm_id
        return self.get_norm_law_firm_by_id_endpoint.call_with_http_info(**kwargs)
    ...
    def get_norm_parties_associated_with_norm_law_firm(
        ...
        **kwargs
        ...
        kwargs['page_number'] = \
            page_number
        return self.get_norm_parties_associated_with_norm_law_firm_endpoint.call_with_http_info(**kwargs)

    def search_normalized_law_firms(
        self,
        **kwargs
    ):
        """Law firm search.  # noqa: E501

        ### All query parameters supported for this API can be found in below schema section. Schema --> NormLawFirmSearchQueryObject   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_normalized_law_firms(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.search_normalized_law_firms_endpoint.call_with_http_info(**kwargs)
    ...
    def search_normalized_law_firms_by_id(
        ...
        **kwargs
        ...
        """Norm law firm search result for a given normLawFirmSearchId.  # noqa: E501

        ### All query parameters supported for this API can be found in below schema section. Schema --> NormLawFirmSearchQueryObject   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_normalized_law_firms_by_id(norm_law_firm_search_id, async_req=True)
        >>> result = thread.get()

        Args:
            norm_law_firm_search_id (str): Norm law firm search information for the given normLawFirmSearchId.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['norm_law_firm_search_id'] = \
            norm_law_firm_search_id
        return self.search_normalized_law_firms_by_id_endpoint.call_with_http_info(**kwargs)
