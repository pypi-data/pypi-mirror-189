...
class AuthenticationApi(object):
    ...
    def generate_new_token(
        ...
        **kwargs
        ...
        Generate new access token, UniCourt provides clientId and client Secret. Each time you will get new Access token. At a time you can have max 10 access tokens. There will not be any expiry for access token. If you request for more than 10 tokens you will get error message.  # noqa: E501
        ...
        Keyword Args:
            access_token_request (AccessTokenRequest): clientId and clientSecret is needed to generate JWT token.. [optional]
    ...
    def invalidate_all_tokens(
        ...
        **kwargs
        ...
        Logout API to invalidate all access tokens.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Keyword Args:
            access_token_request (AccessTokenRequest): clientId and clientSecret is needed to invalidate all access tokens.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def invalidate_token(
        ...
        **kwargs
        ...
        Keyword Args:
            invalidate_access_token_request (InvalidateAccessTokenRequest): clientId, clientSecret and tokenId is needed to invalidate the access token.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def list_all_token_ids(
        ...
        **kwargs
        ...
        Keyword Args:
            access_token_request (AccessTokenRequest): clientId and clientSecret is needed to list all the access tokens Id.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
