...
from apollo import rest
from apollo.configuration import Configuration
from apollo.exceptions import ApiTypeError, ApiValueError, ApiException
from apollo.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AttorneyAnalyticsApi()
        api_instance.get_norm_attorney_by_id  # this is an instance of the class Endpoint
        api_instance.get_norm_attorney_by_id()  # this invokes api_instance.get_norm_attorney_by_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_norm_attorney_by_id.callable or self.callable in this class
