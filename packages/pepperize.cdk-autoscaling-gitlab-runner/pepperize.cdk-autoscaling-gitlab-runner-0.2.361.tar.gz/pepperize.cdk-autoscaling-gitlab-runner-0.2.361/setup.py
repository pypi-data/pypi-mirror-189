    ...
    """
{
    ...
    "package_data": {
        "pepperize_cdk_autoscaling_gitlab_runner._jsii": [
            "cdk-autoscaling-gitlab-runner@0.2.361.jsii.tgz"
        ],
        "pepperize_cdk_autoscaling_gitlab_runner": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "jsii>=1.62.0, <2.0.0",
        "pepperize.cdk-private-bucket>=0.0.143, <0.0.144",
        "pepperize.cdk-security-group>=0.0.115, <0.0.116",
        "pepperize.cdk-vpc>=0.0.210, <0.0.211",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
    "classifiers": [
