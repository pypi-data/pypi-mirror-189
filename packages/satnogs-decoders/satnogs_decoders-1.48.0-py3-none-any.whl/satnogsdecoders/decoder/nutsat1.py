...
class Nutsat1(KaitaiStruct):
    ...
    :field eps_pv1: ax25_frame.payload.ax25_info.data.eps_str.eps_pv1
    :field eps_pv2: ax25_frame.payload.ax25_info.data.eps_str.eps_pv2
    :field eps_pv3: ax25_frame.payload.ax25_info.data.eps_str.eps_pv3
    :field eps_pv4: ax25_frame.payload.ax25_info.data.eps_str.eps_pv4
    :field eps_battery: ax25_frame.payload.ax25_info.data.eps_str.eps_battery
    :field eps_power33: ax25_frame.payload.ax25_info.data.eps_str.eps_power33
    :field eps_power5: ax25_frame.payload.ax25_info.data.eps_str.eps_power5
    :field eps_vgps: ax25_frame.payload.ax25_info.data.eps_str.eps_vgps
    :field eps_sw: ax25_frame.payload.ax25_info.data.eps_str.eps_sw
    :field eps_t_bat: ax25_frame.payload.ax25_info.data.eps_str.eps_t_bat
    :field eps_day: ax25_frame.payload.ax25_info.data.eps_str.eps_day
    :field eps_vmtq: ax25_frame.payload.ax25_info.data.eps_str.eps_vmtq
    :field eps_vadsb: ax25_frame.payload.ax25_info.data.eps_str.eps_vadsb
    :field eps_vuhf: ax25_frame.payload.ax25_info.data.eps_str.eps_vuhf
    :field eps_t_venv: ax25_frame.payload.ax25_info.data.eps_str.eps_t_venv
    :field eps_hour: ax25_frame.payload.ax25_info.data.eps_str.eps_hour
    :field eps_minute: ax25_frame.payload.ax25_info.data.eps_str.eps_minute
    :field cdhs_sun1: ax25_frame.payload.ax25_info.data.obc_str.cdhs_sun1
    :field cdhs_sun2: ax25_frame.payload.ax25_info.data.obc_str.cdhs_sun2
    :field cdhs_sun3: ax25_frame.payload.ax25_info.data.obc_str.cdhs_sun3
    :field cdhs_acc_x: ax25_frame.payload.ax25_info.data.obc_str.cdhs_acc_x
    :field cdhs_acc_y: ax25_frame.payload.ax25_info.data.obc_str.cdhs_acc_y
    :field cdhs_acc_z: ax25_frame.payload.ax25_info.data.obc_str.cdhs_acc_z
    :field cdhs_gyro_x: ax25_frame.payload.ax25_info.data.obc_str.cdhs_gyro_x
    :field cdhs_gyro_y: ax25_frame.payload.ax25_info.data.obc_str.cdhs_gyro_y
    :field cdhs_gyro_z: ax25_frame.payload.ax25_info.data.obc_str.cdhs_gyro_z
    :field cdhs_temp: ax25_frame.payload.ax25_info.data.obc_str.cdhs_temp
    :field cdhs_mx: ax25_frame.payload.ax25_info.data.obc_str.cdhs_mx
    :field cdhs_my: ax25_frame.payload.ax25_info.data.obc_str.cdhs_my
    :field cdhs_mz: ax25_frame.payload.ax25_info.data.obc_str.cdhs_mz
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.ax25_info = Nutsat1.HeaderT(_io__raw_ax25_info, self, self._root)
    ...
    class EpsT(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.eps_t_bat = self._io.read_u2be()
            ...
            self.eps_t_venv = self._io.read_u2be()
    ...
    class ObcStrT(KaitaiStruct):
        ...
        def _read(self):
            self._raw__raw_obc_str = self._io.read_bytes_full()
    ...
    class EpsStrT(KaitaiStruct):
        ...
        def _read(self):
            self._raw__raw_eps_str = self._io.read_bytes_full()
            _process = satnogsdecoders.process.Unhexl()
