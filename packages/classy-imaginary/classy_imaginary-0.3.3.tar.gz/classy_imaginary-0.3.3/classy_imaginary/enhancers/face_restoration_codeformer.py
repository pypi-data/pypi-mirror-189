...
from classy_imaginary.model_manager import get_cached_url_path
from classy_imaginary.vendored.codeformer.codeformer_arch import CodeFormer
...
def enhance_faces(img, net, fidelity=0):
