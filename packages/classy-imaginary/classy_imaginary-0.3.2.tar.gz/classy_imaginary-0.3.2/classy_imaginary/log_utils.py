...
class ImageLoggingContext:
    ...
    def log_progress_latent(self, latent):
        from classy_imaginary.img_utils import model_latents_to_pillow_imgs  # noqa
...
def configure_logging(level="INFO"):
    ...
    LOGGING_CONFIG = {
        ...
        "formatters": {
            "standard": {
                "format": fmt,
                "class": "classy_imaginary.log_utils.IndentingFormatter",
            },
        },
        "handlers": {
            "default": {
        ...
        "loggers": {
            ...
            "classy_imaginary": {"handlers": ["default"], "level": level, "propagate": False},
