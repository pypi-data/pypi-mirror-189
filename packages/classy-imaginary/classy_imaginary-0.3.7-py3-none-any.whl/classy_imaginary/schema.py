...
class ImaginePrompt:
    ...
    def validate(self):
        from classy_imaginary.samplers import SAMPLER_LOOKUP, SamplerName
        ...
        if self.height is None or self.width is None or self.steps is None:
            from classy_imaginary.model_manager import get_model_default_image_size
...
class ImagineResult:
    def __init__(
        ...
        from classy_imaginary.utils import get_device, get_hardware_description
    ...
    def _exif(self):
        ...
        exif[ExifCodes.Software] = f"classy_imaginary / Stable Diffusion {sd_version}"
