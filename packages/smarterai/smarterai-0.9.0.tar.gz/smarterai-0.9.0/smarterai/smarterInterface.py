...
class SmarterSender:
    ...
    def query_data_lake(self, sql_query: str, args=None, paramstyle: str = "format") -> Tuple:
        """
        ...
        """
        data = self.__db.execute_sql_query(query=sql_query, args=args, paramstyle=paramstyle, fetch="all")
        return data
