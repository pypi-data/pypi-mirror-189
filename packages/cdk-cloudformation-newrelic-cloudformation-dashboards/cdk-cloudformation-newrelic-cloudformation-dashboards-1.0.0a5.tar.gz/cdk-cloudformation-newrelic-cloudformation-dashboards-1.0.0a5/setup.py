    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_newrelic_cloudformation_dashboards",
        "cdk_cloudformation_newrelic_cloudformation_dashboards._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_newrelic_cloudformation_dashboards._jsii": [
            "newrelic-cloudformation-dashboards@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_newrelic_cloudformation_dashboards": [
            "py.typed"
        ]
