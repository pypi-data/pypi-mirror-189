...
class Stem(Layer):
    ...
    Args:
        ...
        weights_bits (int, optional): number of bits used to quantize weights.
            Defaults to 4.
        tokens_bits (int, optional): number of bits used to quantize the additionnal
            non patch tokens. Defaults to 10.
        bias_bits (int, optional): number of bits used to quantize the bias.
            Defaults to 8.
        pos_embedding_bits (int, optional): number of bits used to quantize the
            positional embedding matrix. Defaults to 8.
