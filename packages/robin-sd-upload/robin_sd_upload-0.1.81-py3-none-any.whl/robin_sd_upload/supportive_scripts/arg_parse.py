...
def arg_parser():
    ...
    if args.check:
        ...
        dir_to_zip = upload_file_path

        create_zip.create_zip(dir_to_zip, zipped_file_path, version_name)
        push_software.push_software(zipped_file_path + '/' + version_name + '.zip', radarType, version_name)
