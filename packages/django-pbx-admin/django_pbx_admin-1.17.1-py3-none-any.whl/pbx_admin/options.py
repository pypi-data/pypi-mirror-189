...
from typing import Any, Optional, Sequence, Tuple, TypedDict, TypeVar, Union
...
class _OptionalFieldOpts(TypedDict, total=False):
    ...
    fieldsets: _ListOrTuple[tuple[Optional[str], dict]]
...
class ModelAdmin:
    ...
    success_url: str | Callable[..., Any] | None = None
    cancel_url: str | Callable[..., Any] | None = None
