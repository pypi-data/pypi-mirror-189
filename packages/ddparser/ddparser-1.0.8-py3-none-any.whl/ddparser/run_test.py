...
from ddparser.parser.model_test import epoch_evaluate_infer
...
def train(env):
    ...
    if args.encoding_model.startswith("ernie") and args.encoding_model != "ernie-lstm" or args.encoding_model == 'transformer':
...
class DDParser(object):
    ...
    def __init__(self,
        ...
        # self.save_to_static(model_files_path + '_static')

    def save_to_static(self, path):
        if self.args.prob or getattr(self.args, "use_pos", None):
