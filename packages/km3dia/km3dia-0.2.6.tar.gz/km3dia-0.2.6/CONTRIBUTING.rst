...
https://git.km3net.de/km3py/km3dia/issues

You can browse all the issues here: https://git.km3net.de/km3py/km3dia/issues
...
Check out our KanBan board https://git.km3net.de/km3py/km3dia/boards,
...
Go to https://git.km3net.de/km3py/km3dia and click on "Fork".

After that, you will have a full copy of the code with write access under an URL
like this: ``https://git.km3net.de/YOUR_USERNAME/km3dia``
...
Go to https://git.km3net.de/km3py/km3dia/merge_requests/new and select your
