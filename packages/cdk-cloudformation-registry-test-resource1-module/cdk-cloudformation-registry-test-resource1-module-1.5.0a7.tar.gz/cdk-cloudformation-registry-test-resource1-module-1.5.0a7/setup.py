    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_registry_test_resource1_module",
        "cdk_cloudformation_registry_test_resource1_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_registry_test_resource1_module._jsii": [
            "registry-test-resource1-module@1.5.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_registry_test_resource1_module": [
            "py.typed"
        ]
