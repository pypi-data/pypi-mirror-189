class Pickson:
    ...
    def info(self):
        ...
        print("This is an awesome lecture about PyPI!")
        
    @classmethod
    def save_data(cls, name: str, data:object or str or bytes, 
                  data_type:str, folder: str = ".") -> None:
        ...
        if cls.data_type == "json":
            ...
            if cls.folder == ".":
                ...
                if cls.os.path.exists(cls.folder):
                    file = open(cls.folder + "/" + cls.name + ".json", "w")
                else:
                    cls.os.mkdir(cls.folder)
                    file = open(cls.folder + "/" + cls.name + ".json", "w")
            file.write(saving)
            file.close()
            ...
            if cls.os.path.exists(cls.folder):
                ...
                cls.os.mkdir(cls.folder)
                with open(cls.folder + "/" + cls.name + ".pickle", "wb") as file:
                        cls.pickle.dump(cls.data, file)
        else:
    ...
    def get_current_data(cls) -> object:
        ...
        if cls.data_type == "json":
            ...
            if cls.folder == ".":
                ...
                with open(cls.folder + "/" + cls.name + ".pickle", "rb") as r:
                    mydata = cls.pickle.load(r)
