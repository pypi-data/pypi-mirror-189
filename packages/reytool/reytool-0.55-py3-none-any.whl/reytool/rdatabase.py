...
from .rdata import to_table, to_df, to_sql, to_csv, to_excel
...
class RConn(object):
    ...
    def execute(
        ...
        **kw_parms: Any
        ...
        if self.conn == None:
            self.conn = self.create_conn(database=database, once=once)
