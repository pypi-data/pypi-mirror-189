...
def to_excel(
    ...
    sheets_set: Dict[Union[str, int], Union[
        Dict[Literal["name"], str],
        Dict[Literal["index"], int],
        Dict[Literal["filter"], List[str]]
    ]] = {},
) -> Tuple[Tuple[str, DataFrame], ...]:
    """
    Fetch data to save excel file and return sheet name and sheet data.
