...
from .rdata import to_table, to_df, to_sql, to_excel
...
def monkey_patch_more_fetch() -> None:
    ...
    # Fetch SQL result or Iterable[Dict] to List[Dict[str, Any]] table format.
    Result.fetch_table = to_table

    # Fetch SQL result or Iterable[Dict] to DataFrame object.
    Result.fetch_df = to_df

    # Fetch SQL result or Iterable[Dict] to SQL syntax.
    Result.fetch_sql = to_sql

    # Fetch SQL result or Iterable[Dict] to save excel file.
    Result.fetch_excel = to_excel
