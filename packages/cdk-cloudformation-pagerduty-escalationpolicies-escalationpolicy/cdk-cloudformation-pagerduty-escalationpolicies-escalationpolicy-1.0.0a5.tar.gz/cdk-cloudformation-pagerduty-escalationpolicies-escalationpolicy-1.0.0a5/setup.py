    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_pagerduty_escalationpolicies_escalationpolicy",
        "cdk_cloudformation_pagerduty_escalationpolicies_escalationpolicy._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_pagerduty_escalationpolicies_escalationpolicy._jsii": [
            "pagerduty-escalationpolicies-escalationpolicy@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_pagerduty_escalationpolicies_escalationpolicy": [
            "py.typed"
        ]
