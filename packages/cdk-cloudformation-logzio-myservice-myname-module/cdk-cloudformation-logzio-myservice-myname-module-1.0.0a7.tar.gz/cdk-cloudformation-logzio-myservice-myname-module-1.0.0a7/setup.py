    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_logzio_myservice_myname_module",
        "cdk_cloudformation_logzio_myservice_myname_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_logzio_myservice_myname_module._jsii": [
            "logzio-myservice-myname-module@1.0.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_logzio_myservice_myname_module": [
            "py.typed"
        ]
