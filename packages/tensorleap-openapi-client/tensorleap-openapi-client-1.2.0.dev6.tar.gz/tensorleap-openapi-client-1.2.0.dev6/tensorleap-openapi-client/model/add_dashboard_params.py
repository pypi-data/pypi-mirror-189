...
class AddDashboardParams(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["items"], typing_extensions.Literal["projectId"], typing_extensions.Literal["description"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["items"], typing_extensions.Literal["projectId"], typing_extensions.Literal["description"], ]):
