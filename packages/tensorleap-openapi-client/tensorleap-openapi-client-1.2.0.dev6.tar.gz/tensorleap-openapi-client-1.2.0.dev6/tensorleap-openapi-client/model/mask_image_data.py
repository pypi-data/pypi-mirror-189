...
class MaskImageData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mask_blob"], typing_extensions.Literal["blob"], typing_extensions.Literal["src"], typing_extensions.Literal["mask_src"], typing_extensions.Literal["type"], typing_extensions.Literal["labels"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mask_blob"], typing_extensions.Literal["blob"], typing_extensions.Literal["src"], typing_extensions.Literal["mask_src"], typing_extensions.Literal["type"], typing_extensions.Literal["labels"], ]):
