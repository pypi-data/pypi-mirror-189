...
class TrainFromInitialWeightsParams(
    schemas.DictSchema
):
    ...
    fromModelId: MetaOapg.properties.fromModelId
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fromModelId"]) -> MetaOapg.properties.fromModelId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fromEpoch"], typing_extensions.Literal["fromModelId"], typing_extensions.Literal["modelName"], typing_extensions.Literal["versionId"], typing_extensions.Literal["trainingParams"], typing_extensions.Literal["shouldRunPopulationExploration"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fromModelId"]) -> MetaOapg.properties.fromModelId: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fromEpoch"], typing_extensions.Literal["fromModelId"], typing_extensions.Literal["modelName"], typing_extensions.Literal["versionId"], typing_extensions.Literal["trainingParams"], typing_extensions.Literal["shouldRunPopulationExploration"], ]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        fromModelId: typing.Union[MetaOapg.properties.fromModelId, str, ],
