...
class SetDefaultOrganizationRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_id"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_id"], ]):
