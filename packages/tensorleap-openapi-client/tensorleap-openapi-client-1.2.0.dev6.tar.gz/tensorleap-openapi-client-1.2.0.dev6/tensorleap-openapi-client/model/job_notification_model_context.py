...
class JobNotificationModelContext(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["modelExtId", "modelName", "projectId", "projectName", "jobType", "jobId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["modelExtId", "modelName", "projectId", "projectName", "jobType", "jobId", ], str]):
