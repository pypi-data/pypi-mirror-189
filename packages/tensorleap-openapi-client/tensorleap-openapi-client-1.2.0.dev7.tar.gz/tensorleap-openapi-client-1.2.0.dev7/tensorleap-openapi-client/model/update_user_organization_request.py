...
class UpdateUserOrganizationRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["organizationId"], typing_extensions.Literal["userId"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["organizationId"], typing_extensions.Literal["userId"], ]):
