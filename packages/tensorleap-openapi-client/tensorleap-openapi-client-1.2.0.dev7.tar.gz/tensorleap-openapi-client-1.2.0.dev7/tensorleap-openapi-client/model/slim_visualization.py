...
class SlimVisualization(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["createdAt"], typing_extensions.Literal["jobId"], typing_extensions.Literal["modelId"], typing_extensions.Literal["visualizationUuid"], typing_extensions.Literal["epoch"], typing_extensions.Literal["_id"], typing_extensions.Literal["type"], typing_extensions.Literal["jobParms"], typing_extensions.Literal["sampleId"], typing_extensions.Literal["layout"], ]):
