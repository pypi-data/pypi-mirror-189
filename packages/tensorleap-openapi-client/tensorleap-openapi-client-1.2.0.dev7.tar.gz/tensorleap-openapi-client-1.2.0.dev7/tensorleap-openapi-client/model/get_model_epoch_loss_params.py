...
class GetModelEpochLossParams(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["modelExtId"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["modelExtId"], ]):
