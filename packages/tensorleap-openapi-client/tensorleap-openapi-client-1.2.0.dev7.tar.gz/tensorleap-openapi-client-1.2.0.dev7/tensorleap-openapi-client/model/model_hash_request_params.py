...
class ModelHashRequestParams(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hash"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hash"], ]):
