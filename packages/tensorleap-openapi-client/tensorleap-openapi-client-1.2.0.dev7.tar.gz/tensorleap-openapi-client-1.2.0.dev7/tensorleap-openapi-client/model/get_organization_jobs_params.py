...
class GetOrganizationJobsParams(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lastUpdated"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lastUpdated"], ]):
