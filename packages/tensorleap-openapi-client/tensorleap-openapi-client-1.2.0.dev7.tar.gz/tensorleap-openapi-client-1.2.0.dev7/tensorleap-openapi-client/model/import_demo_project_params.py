...
class ImportDemoProjectParams(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["versionId"], typing_extensions.Literal["modelId"], typing_extensions.Literal["projectId"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["versionId"], typing_extensions.Literal["modelId"], typing_extensions.Literal["projectId"], ]):
