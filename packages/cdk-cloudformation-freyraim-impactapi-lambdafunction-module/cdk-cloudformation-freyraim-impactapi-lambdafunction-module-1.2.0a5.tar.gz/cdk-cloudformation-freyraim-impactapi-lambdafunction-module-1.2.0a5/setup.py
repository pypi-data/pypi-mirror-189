    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_freyraim_impactapi_lambdafunction_module",
        "cdk_cloudformation_freyraim_impactapi_lambdafunction_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_freyraim_impactapi_lambdafunction_module._jsii": [
            "freyraim-impactapi-lambdafunction-module@1.2.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_freyraim_impactapi_lambdafunction_module": [
            "py.typed"
        ]
