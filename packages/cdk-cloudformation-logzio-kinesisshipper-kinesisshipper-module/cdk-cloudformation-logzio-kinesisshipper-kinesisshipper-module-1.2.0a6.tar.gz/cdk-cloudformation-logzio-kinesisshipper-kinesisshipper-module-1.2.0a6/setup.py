    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_logzio_kinesisshipper_kinesisshipper_module",
        "cdk_cloudformation_logzio_kinesisshipper_kinesisshipper_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_logzio_kinesisshipper_kinesisshipper_module._jsii": [
            "logzio-kinesisshipper-kinesisshipper-module@1.2.0-alpha.6.jsii.tgz"
        ],
        "cdk_cloudformation_logzio_kinesisshipper_kinesisshipper_module": [
            "py.typed"
        ]
