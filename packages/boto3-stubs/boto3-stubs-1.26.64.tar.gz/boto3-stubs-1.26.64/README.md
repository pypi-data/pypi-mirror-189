...
[boto3 1.26.64](https://boto3.amazonaws.com/v1/documentation/api/1.26.64/index.html)
...
- `boto3-stubs[all]` - Type annotations for all 339 services.
...
- `boto3-stubs[gamelift]` - Type annotations for
  ...
  service.
- `boto3-stubs[gamesparks]` - Type annotations for
