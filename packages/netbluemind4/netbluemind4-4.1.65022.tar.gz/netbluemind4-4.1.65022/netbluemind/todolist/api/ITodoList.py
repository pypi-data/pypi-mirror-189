...
class ITodoList(BaseEndpoint):
    ...
    def getVersion(self):
        ...
        response = requests.get(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': ITodoList_VERSION}, data=__encoded__)
    ...
    def updateById(self, id, arg1):
        ...
        from netbluemind.todolist.api.VTodo import VTodo
        from netbluemind.todolist.api.VTodo import __VTodoSerDer__
        __data__ = __VTodoSerDer__().encode(arg1)
        __encoded__ = json.dumps(__data__)
        queryParams = {}
