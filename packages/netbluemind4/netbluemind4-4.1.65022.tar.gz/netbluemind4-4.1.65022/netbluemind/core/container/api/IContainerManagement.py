...
IContainerManagement_VERSION = "4.1.65022"
...
class IContainerManagement(BaseEndpoint):
    ...
    def getDescriptor(self):
        ...
        response = requests.get(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IContainerManagement_VERSION}, data=__encoded__)
    ...
    def setAccessControlList(self, entries):
        ...
        __data__ = serder.ListSerDer(
            __AccessControlEntrySerDer__()).encode(entries)
