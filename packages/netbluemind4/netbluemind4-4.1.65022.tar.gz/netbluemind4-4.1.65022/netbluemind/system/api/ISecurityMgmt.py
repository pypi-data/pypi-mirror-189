...
ISecurityMgmt_VERSION = "4.1.65022"
...
class ISecurityMgmt(BaseEndpoint):
    ...
    def updateFirewallRules(self):
        ...
        response = requests.post(self.base + postUri, params=queryParams, verify=False, headers={
                                 'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': ISecurityMgmt_VERSION}, data=__encoded__)
    ...
    def generateLetsEncrypt(self, certData):
        postUri = "/lets_encrypt"
        __data__ = None
        __encoded__ = None
    ...
    def approveLetsEncryptTos(self, uid):
        postUri = "/lets_encrypt_tos/{uid}"
        __data__ = None
        __encoded__ = None
    ...
    def getLetsEncryptTos(self):
        postUri = "/lets_encrypt_tos"
        __data__ = None
        __encoded__ = None
        queryParams = {}
