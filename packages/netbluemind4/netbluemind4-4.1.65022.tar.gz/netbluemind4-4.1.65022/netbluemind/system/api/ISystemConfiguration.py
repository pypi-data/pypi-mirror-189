...
ISystemConfiguration_VERSION = "4.1.65022"
...
class ISystemConfiguration(BaseEndpoint):
    ...
    def updateMutableValues(self, values):
        ...
        response = requests.post(self.base + postUri, params=queryParams, verify=False, headers={
                                 'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': ISystemConfiguration_VERSION}, data=__encoded__)
