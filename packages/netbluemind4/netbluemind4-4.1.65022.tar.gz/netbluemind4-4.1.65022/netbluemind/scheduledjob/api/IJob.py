...
class IJob(BaseEndpoint):
    ...
    def cancel(self, jobId, domainName):
        postUri = "/_cancel/{jobId}"
        __data__ = None
        __encoded__ = None
        ...
        response = requests.delete(self.base + postUri, params=queryParams, verify=False, headers={
                                   'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IJob_VERSION}, data=__encoded__)
