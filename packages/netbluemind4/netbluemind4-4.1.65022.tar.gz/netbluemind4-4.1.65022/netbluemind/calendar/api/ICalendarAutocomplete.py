...
ICalendarAutocomplete_VERSION = "4.1.65022"
...
class ICalendarAutocomplete(BaseEndpoint):
    ...
    def calendarLookup(self, pattern, verb):
        ...
        response = requests.post(self.base + postUri, params=queryParams, verify=False, headers={
                                 'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': ICalendarAutocomplete_VERSION}, data=__encoded__)
