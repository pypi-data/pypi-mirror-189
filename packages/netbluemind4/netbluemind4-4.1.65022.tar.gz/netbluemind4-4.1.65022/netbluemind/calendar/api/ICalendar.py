...
class ICalendar(BaseEndpoint):
    ...
    def getVersion(self):
        ...
        response = requests.get(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': ICalendar_VERSION}, data=__encoded__)
    ...
    def updateById(self, id, arg1):
        ...
        from netbluemind.calendar.api.VEventSeries import VEventSeries
        from netbluemind.calendar.api.VEventSeries import __VEventSeriesSerDer__
        __data__ = __VEventSeriesSerDer__().encode(arg1)
        __encoded__ = json.dumps(__data__)
        queryParams = {}
    ...
    def searchPendingCounters(self):
