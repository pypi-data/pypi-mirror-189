...
IAddressBook_VERSION = "4.1.65022"
...
class IAddressBook(BaseEndpoint):
    ...
    def getVersion(self):
        ...
        response = requests.get(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IAddressBook_VERSION}, data=__encoded__)
    ...
    def updateById(self, id, arg1):
        ...
        from netbluemind.addressbook.api.VCard import VCard
        from netbluemind.addressbook.api.VCard import __VCardSerDer__
        __data__ = __VCardSerDer__().encode(arg1)
        __encoded__ = json.dumps(__data__)
        queryParams = {}
    ...
    def touch(self, uid):
        ...
        __data__ = None
        __encoded__ = None
        __data__ = serder.STRING.encode(uid)
        __encoded__ = json.dumps(__data__)
        queryParams = {}
