...
IFileHosting_VERSION = "4.1.65022"
...
class IFileHosting(BaseEndpoint):
    ...
    def store(self, path, document):
        ...
        response = requests.put(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IFileHosting_VERSION}, data=__encoded__)
    ...
    def share(self, path, downloadLimit, expirationDate):
        ...
        __data__ = None
        __encoded__ = None
        queryParams = {'path': path, 'downloadLimit': downloadLimit,
