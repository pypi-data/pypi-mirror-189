...
class IResources(BaseEndpoint):
    ...
    def addToEventDescription(self, uid, eventInfo):
        ...
        response = requests.post(self.base + postUri, params=queryParams, verify=False, headers={
                                 'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IResources_VERSION}, data=__encoded__)
    ...
    def update(self, uid, resourceDescriptor):
        postUri = "/{uid}"
        __data__ = None
        __encoded__ = None
        postUri = postUri.replace("{uid}", uid)
        ...
        __data__ = __ResourceDescriptorSerDer__().encode(resourceDescriptor)
        __encoded__ = json.dumps(__data__)
        queryParams = {}
    ...
    def create(self, uid, resourceDescriptor):
        postUri = "/{uid}"
        __data__ = None
        __encoded__ = None
        postUri = postUri.replace("{uid}", uid)
