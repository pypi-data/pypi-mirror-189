...
IComputerTelephonyIntegration_VERSION = "4.1.65022"
...
class IComputerTelephonyIntegration(BaseEndpoint):
    ...
    def getUserEmails(self):
        ...
        response = requests.get(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IComputerTelephonyIntegration_VERSION}, data=__encoded__)
