...
IItemsTransfer_VERSION = "4.1.65022"
...
class IItemsTransfer(BaseEndpoint):
    def __init__(self, apiKey, url, fromMailboxUid, toMailboxUid):
        ...
        self.apiKey = apiKey
        self.base = url + \
            '/mail_items_transfer/{fromMailboxUid}/{toMailboxUid}'
    ...
    def move(self, itemIds):
        ...
        response = requests.post(self.base + postUri, params=queryParams, verify=False, headers={
                                 'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IItemsTransfer_VERSION}, data=__encoded__)
