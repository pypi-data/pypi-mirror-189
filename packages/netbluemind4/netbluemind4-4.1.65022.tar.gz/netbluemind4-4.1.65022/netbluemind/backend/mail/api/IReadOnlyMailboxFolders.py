...
IReadOnlyMailboxFolders_VERSION = "4.1.65022"
...
class IReadOnlyMailboxFolders(BaseEndpoint):
    ...
    def getVersion(self):
        ...
        response = requests.get(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IReadOnlyMailboxFolders_VERSION}, data=__encoded__)
