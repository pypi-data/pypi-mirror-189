...
IDirEntryPath_VERSION = "4.1.65022"
...
class IDirEntryPath(BaseEndpoint):
    ...
    def getPath(self, domain, uid, kind):
        postUri = "/{domain}/{uid}"
        __data__ = None
        __encoded__ = None
        ...
        response = requests.get(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IDirEntryPath_VERSION}, data=__encoded__)
