...
IUserExternalAccount_VERSION = "4.1.65022"
...
class IUserExternalAccount(BaseEndpoint):
    ...
    def getAll(self):
        ...
        response = requests.get(self.base + postUri, params=queryParams, verify=False, headers={
                                'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IUserExternalAccount_VERSION}, data=__encoded__)
