...
IInstantMessaging_VERSION = "4.1.65022"
...
class IInstantMessaging(BaseEndpoint):
    ...
    def getLastMessagesBetween(self, user1, user2, messagesCount):
        ...
        __data__ = None
        __encoded__ = None
        queryParams = {'user1': user1, 'user2': user2,
                       'messagesCount': messagesCount}

        response = requests.post(self.base + postUri, params=queryParams, verify=False, headers={
                                 'X-BM-ApiKey': self.apiKey, 'Accept': 'application/json', 'X-BM-ClientVersion': IInstantMessaging_VERSION}, data=__encoded__)
