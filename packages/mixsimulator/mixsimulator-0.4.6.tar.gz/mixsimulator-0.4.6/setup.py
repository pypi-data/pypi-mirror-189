...
setuptools.setup(
    ...
    package_data={
        "mixsimulator": [
            "Experiments/Scenario_type.py",
            "data/RIToamasina/dataset_RI_Toamasina.csv",
            "data/RIToamasina/dataset_RI_Toamasina_v2.csv",
            "data/RIToamasina/dataset_RI_Toamasina_variation_template.csv",
            "data/RIToamasina/DIR-TOAMASINA_concat.csv",
            "LICENSE",
            "params_files/exchange_code.json",
