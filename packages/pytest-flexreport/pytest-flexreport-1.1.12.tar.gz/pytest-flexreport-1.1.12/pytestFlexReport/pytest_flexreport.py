...
def pytest_sessionfinish(session):
    ...
    shutil.copyfile(os.path.join(template_path, "echarts.min.js"), os.path.join(report_dir, "echarts.min.js"))
    shutil.copyfile(os.path.join(template_path, "jquery.slim.min.js"), os.path.join(report_dir, "jquery.slim.min.js"))
