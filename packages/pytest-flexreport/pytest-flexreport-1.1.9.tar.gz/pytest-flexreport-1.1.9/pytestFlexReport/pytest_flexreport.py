...
def pytest_sessionfinish(session):
    ...
    # 复制渲染文件 css、js
    shutil.copyfile(os.path.join(template_path, "bootstrap.min.css"), report_dir)
    shutil.copyfile(os.path.join(template_path, "echarts.min.js"), report_dir)
    shutil.copyfile(os.path.join(template_path, "jquery.slim.min.js"), report_dir)
