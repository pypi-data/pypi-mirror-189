...
def pytest_sessionfinish(session):
    ...
    # 复制渲染文件 css、js
    shutil.copyfile(os.path.join(template_path, "bootstrap.min.css"), os.path.join(report_dir, "bootstrap.min.css"))
    shutil.copyfile(os.path.join(template_path, "echarts.min.js"), os.path.join(report_dir, "bootstrap.min.css"))
    shutil.copyfile(os.path.join(template_path, "jquery.slim.min.js"), os.path.join(report_dir, "bootstrap.min.css"))
