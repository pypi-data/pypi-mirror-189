    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_logzio_awssecurityhub_collector_module",
        "cdk_cloudformation_logzio_awssecurityhub_collector_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_logzio_awssecurityhub_collector_module._jsii": [
            "logzio-awssecurityhub-collector-module@1.0.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_logzio_awssecurityhub_collector_module": [
            "py.typed"
        ]
