    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_jfrog_artifactory_newvpc_module",
        "cdk_cloudformation_jfrog_artifactory_newvpc_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_jfrog_artifactory_newvpc_module._jsii": [
            "jfrog-artifactory-newvpc-module@1.9.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_jfrog_artifactory_newvpc_module": [
            "py.typed"
        ]
