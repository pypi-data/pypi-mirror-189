...
nodejs.NodejsFunction(self, "my-handler",
    bundling=nodejs.BundlingOptions(
        ...
        log_level=nodejs.LogLevel.SILENT,  # defaults to LogLevel.WARNING
...
class BundlingOptions(_DockerRunOptions_81583d32):
    def __init__(
        ...
        *,
        ...
        :param docker_image: A custom bundling Docker image. This image should have esbuild installed globally. If you plan to use ``nodeModules`` it should also have ``npm``, ``yarn`` or ``pnpm`` depending on the lock file you're using. See https://github.com/aws/aws-cdk/blob/main/packages/%40aws-cdk/aws-lambda-nodejs/lib/Dockerfile for the default image provided by @aws-cdk/aws-lambda-nodejs. Default: - use the Docker image provided by
        ...
        :param external_modules: A list of modules that should be considered as externals (already available in the runtime). Default: - ['aws-sdk'] if the runtime is < Node.js 18.x, ['
    ...
    def external_modules(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        :default: - ['aws-sdk'] if the runtime is < Node.js 18.x, ['
