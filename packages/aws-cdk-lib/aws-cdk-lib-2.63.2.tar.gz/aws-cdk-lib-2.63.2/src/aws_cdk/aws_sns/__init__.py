...
class CfnTopic(
    ...
    def __init__(
        ...
        *,
        ...
        subscription: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnTopic.SubscriptionProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]]]] = None,
        ...
        :param signature_version: ``AWS::SNS::Topic.SignatureVersion``.
