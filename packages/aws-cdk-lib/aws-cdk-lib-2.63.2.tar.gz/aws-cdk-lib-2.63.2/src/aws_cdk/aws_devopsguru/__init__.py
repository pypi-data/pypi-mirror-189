...
class CfnNotificationChannel(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        config: typing.Union[typing.Union["CfnNotificationChannel.NotificationChannelConfigProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b],
    ) -> None:
    ...
    class NotificationChannelConfigProperty:
        def __init__(
            self,
            *,
            filters: typing.Optional[typing.Union[typing.Union["CfnNotificationChannel.NotificationFilterConfigProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
            sns: typing.Optional[typing.Union[typing.Union["CfnNotificationChannel.SnsChannelConfigProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
        ) -> None:
        ...
        def filters(
            self,
        ) -> typing.Optional[typing.Union["CfnNotificationChannel.NotificationFilterConfigProperty", _IResolvable_da3f097b]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnNotificationChannel.NotificationFilterConfigProperty", _IResolvable_da3f097b]], result)
...
class CfnResourceCollection(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        resource_collection_filter: typing.Union[typing.Union["CfnResourceCollection.ResourceCollectionFilterProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b],
    ) -> None:
    ...
    class ResourceCollectionFilterProperty:
        def __init__(
            self,
            *,
            cloud_formation: typing.Optional[typing.Union[typing.Union["CfnResourceCollection.CloudFormationCollectionFilterProperty", typing.Dict[builtins.str, typing.Any]], _IResolvable_da3f097b]] = None,
