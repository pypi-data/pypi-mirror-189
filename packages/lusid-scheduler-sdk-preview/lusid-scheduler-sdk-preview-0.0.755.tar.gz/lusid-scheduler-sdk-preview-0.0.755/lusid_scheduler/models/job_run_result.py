...
class JobRunResult(object):
    ...
    @property
    def command(self):
        """Gets the command of this JobRunResult.  # noqa: E501

        The command used to run the job  # noqa: E501

        :return: The command of this JobRunResult.  # noqa: E501
        :rtype: str
        """
    ...
    def command(self, command):
        """Sets the command of this JobRunResult.

        The command used to run the job  # noqa: E501

        :param command: The command of this JobRunResult.  # noqa: E501
        :type command: str
        """
