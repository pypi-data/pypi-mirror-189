...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'bellek'},
  'syms': { 'bellek.ml.clip': { 'bellek.ml.clip.ClipZeroShotClassifier': ('ml.clip.html#clipzeroshotclassifier', 'bellek/ml/clip.py'),
                                ...
                                'bellek.ml.clip.make_tfms_from_clip_preprocess': ( 'ml.clip.html#make_tfms_from_clip_preprocess',
                                                                                   'bellek/ml/clip.py')},
            'bellek.ml.cocoop': { 'bellek.ml.cocoop.ClipClassificationHead': ( 'ml.cocoop.html#clipclassificationhead',
                                                                               'bellek/ml/cocoop.py'),
