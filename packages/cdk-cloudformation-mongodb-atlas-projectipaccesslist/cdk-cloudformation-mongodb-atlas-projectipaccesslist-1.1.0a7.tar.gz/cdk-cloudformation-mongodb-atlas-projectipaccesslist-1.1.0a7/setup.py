    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_mongodb_atlas_projectipaccesslist",
        "cdk_cloudformation_mongodb_atlas_projectipaccesslist._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_mongodb_atlas_projectipaccesslist._jsii": [
            "mongodb-atlas-projectipaccesslist@1.1.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_mongodb_atlas_projectipaccesslist": [
            "py.typed"
        ]
