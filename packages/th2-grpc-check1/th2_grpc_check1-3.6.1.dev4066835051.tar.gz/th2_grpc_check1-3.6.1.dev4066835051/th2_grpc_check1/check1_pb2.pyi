...
class CheckRuleResponse(google.protobuf.message.Message):
    ...
    """Can be used for requesting response via 'waitForResponse' method"""
    ...
    def ClearField(self, field_name: typing_extensions.Literal["chain_id",b"chain_id","request_id",b"request_id","status",b"status"]) -> None: ...
...
class WaitForResultResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["rule_result",b"rule_result"]) -> None: ...
