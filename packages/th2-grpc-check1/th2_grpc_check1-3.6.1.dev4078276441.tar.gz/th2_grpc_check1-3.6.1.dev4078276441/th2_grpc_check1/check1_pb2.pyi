...
class CheckRuleRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["chain_id",b"chain_id","checkpoint",b"checkpoint","connectivity_id",b"connectivity_id","filter",b"filter","kind",b"kind","parent_event_id",b"parent_event_id","root_filter",b"root_filter"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["chain_id",b"chain_id","checkpoint",b"checkpoint","connectivity_id",b"connectivity_id","description",b"description","direction",b"direction","filter",b"filter","kind",b"kind","message_timeout",b"message_timeout","parent_event_id",b"parent_event_id","root_filter",b"root_filter","timeout",b"timeout"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["kind",b"kind"]) -> typing.Optional[typing_extensions.Literal["filter","root_filter"]]: ...
...
class CheckRuleResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["chain_id",b"chain_id","rule_id",b"rule_id","status",b"status"]) -> None: ...
...
class CheckSequenceRuleRequest(google.protobuf.message.Message):
    ...
    MESSAGE_FILTERS_FIELD_NUMBER: builtins.int
    ...
    @property
    def message_filters(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[th2_grpc_common.common_pb2.MessageFilter]:
        """
    ...
    def __init__(self,
        *,
        ...
        message_filters: typing.Optional[typing.Iterable[th2_grpc_common.common_pb2.MessageFilter]] = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["chain_id",b"chain_id","check_order",b"check_order","checkpoint",b"checkpoint","connectivity_id",b"connectivity_id","description",b"description","direction",b"direction","message_filters",b"message_filters","message_timeout",b"message_timeout","parent_event_id",b"parent_event_id","pre_filter",b"pre_filter","root_message_filters",b"root_message_filters","silence_check",b"silence_check","timeout",b"timeout"]) -> None: ...
...
class NoMessageCheckRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["chain_id",b"chain_id","checkpoint",b"checkpoint","connectivity_id",b"connectivity_id","description",b"description","direction",b"direction","message_timeout",b"message_timeout","parent_event_id",b"parent_event_id","pre_filter",b"pre_filter","timeout",b"timeout"]) -> None: ...
...
class WaitForResultRequest(google.protobuf.message.Message):
    ...
    def timeout(self) -> google.protobuf.duration_pb2.Duration:
        """Timeout in milliseconds for waiting for result"""
        pass
    def __init__(self,
        *,
        rule_id: builtins.int = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["rule_id",b"rule_id","timeout",b"timeout"]) -> None: ...
...
class WaitForResultResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["rule_result",b"rule_result","status",b"status"]) -> None: ...
