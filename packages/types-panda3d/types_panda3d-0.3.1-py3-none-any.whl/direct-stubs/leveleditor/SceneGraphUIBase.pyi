...
class SceneGraphUIBase(wx.Panel, metaclass=ABCMeta):
    ...
    def onCollapseAllChildren(self, evt: Unused = ...) -> None: ...
    def onExpandAllChildren(self, evt: Unused = ...) -> None: ...
    def onDelete(self, evt: Unused = ...) -> None: ...
    def onRename(self, evt: Unused = ...) -> None: ...
