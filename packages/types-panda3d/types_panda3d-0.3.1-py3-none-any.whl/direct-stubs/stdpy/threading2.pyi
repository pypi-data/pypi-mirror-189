...
def RLock(verbose: bool | None = ...) -> _RLock: ...
...
def Condition(lock: _RLock | None = ..., verbose: bool | None = ...) -> _Condition: ...

class _Condition:
    def __init__(self, lock: _RLock | None = ..., verbose: bool | None = ...) -> None: ...
    def __enter__(self) -> bool: ...
    def __exit__(self, __t: Unused, __v: Unused, __tb: Unused) -> None: ...  # noqa: Y036
    def wait(self, timeout: float | None = ...) -> None: ...
    def notify(self, n: int = ...) -> None: ...
    def notifyAll(self) -> None: ...

def Semaphore(value: int = ..., verbose: bool | None = ...) -> _Semaphore: ...

class _Semaphore:
    def __init__(self, value: int = ..., verbose: bool | None = ...) -> None: ...
    def __enter__(self, blocking: bool = ...) -> bool: ...
    def release(self) -> None: ...
    def __exit__(self, t: Unused, v: Unused, tb: Unused) -> None: ...  # noqa: Y036
    acquire = __enter__

def BoundedSemaphore(value: int = ..., verbose: bool | None = ...) -> _BoundedSemaphore: ...

class _BoundedSemaphore:
    def __init__(self, value: int = ..., verbose: bool | None = ...) -> None: ...
    def release(self) -> None: ...

def Event(verbose: bool | None = ...) -> _Event: ...
