...
class LockType:
    ...
    def __enter__(self, waitflag: bool = ..., timeout: float = ...) -> bool: ...
    def __exit__(self, t: Unused, v: Unused, tb: Unused) -> None: ...  # noqa: Y036
    acquire = __enter__

def start_new_thread(
    function: Callable[..., object], args: Sequence[Any], kwargs: Mapping[str, Any] = ..., name: str | None = ...
) -> int: ...
def interrupt_main() -> None: ...
def exit() -> NoReturn: ...
def allocate_lock() -> LockType: ...
def get_ident() -> int: ...
def stack_size(size: Unused = ...) -> NoReturn: ...
