...
class Actor(DirectObject, NodePath):
    ...
    class AnimDef:
        ...
        def __init__(self, filename: str | None = ..., animBundle: AnimBundle | None = ...) -> None: ...
    ...
    def __init__(
        self,
        models: dict[str, dict[str, _NodePathOrFilepath] | _NodePathOrFilepath] | _NodePathOrFilepath | None = ...,
        anims: dict[str, Mapping[str, str]] | Mapping[str, str] | None = ...,
        other: Actor | None = ...,
        copy: bool = ...,
        lodNode: LODNode | None = ...,
        flattenable: bool = ...,
        setFinal: bool = ...,
        mergeLODBundles: bool | None = ...,
        allowAsyncBind: bool | None = ...,
        okMissing: bool | None = ...,
    ) -> None: ...
    def delete(self) -> None: ...
    def copy_actor(self, other: Actor, overwrite: bool = ...) -> None: ...
    def __cmp__(self, other: object) -> Literal[0, 1]: ...
    def list_joints(self, partName: str = ..., lodName: str = ...) -> None: ...
    ...
    def get_part_bundles(self, partName: str | None = ...) -> list[PartBundle]: ...
    ...
    def set_lod_node(self, node: LODNode | None = ...) -> None: ...
    def use_lod(self, lodName: object) -> None: ...
    def print_lod(self) -> None: ...
    def reset_lod(self) -> None: ...
    def add_lod(self, lodName: str, inDist: float = ..., outDist: float = ..., center: Vec3Like | None = ...) -> None: ...
    def set_lod(self, lodName: str, inDist: float = ..., outDist: float = ...) -> None: ...
    ...
    def update(self, lod: int = ..., partName: str | None = ..., lodName: str | None = ..., force: bool = ...) -> bool: ...
    def get_frame_rate(self, animName: str | None = ..., partName: str | None = ...) -> float: ...
    def get_base_frame_rate(self, animName: str | None = ..., partName: str | None = ...) -> float: ...
    def get_play_rate(self, animName: str | None = ..., partName: str | None = ...) -> float: ...
    def set_play_rate(self, rate: float, animName: str, partName: str | None = ...) -> None: ...
    def get_duration(
        self, animName: str | None = ..., partName: str | None = ..., fromFrame: float | None = ..., toFrame: float | None = ...
    ) -> float | None: ...
    def get_num_frames(self, animName: str | None = ..., partName: str | None = ...) -> int: ...
    def get_frame_time(self, anim: str | None, frame: SupportsFloat, partName: str | None = ...) -> float: ...
    def get_current_anim(self, partName: str | None = ...) -> str | None: ...
    def get_current_frame(self, animName: str | None = ..., partName: str | None = ...) -> int: ...
    def get_part(self, partName: str, lodName: str = ...) -> NodePath[Character]: ...
    def get_part_bundle(self, partName: str, lodName: str = ...) -> PartBundle | None: ...
    def remove_part(self, partName: str, lodName: str = ...) -> None: ...
    def hide_part(self, partName: str, lodName: str = ...) -> None: ...
    def show_part(self, partName: str, lodName: str = ...) -> None: ...
    def show_all_parts(self, partName: str, lodName: str = ...) -> None: ...
    def expose_joint(
        self, node: NodePath, partName: str, jointName: str, lodName: str = ..., localTransform: bool = ...
    ) -> NodePath | None: ...
    def stop_joint(self, partName: str, jointName: str, lodName: str = ...) -> None: ...
    def get_joints(self, partName: str | None = ..., jointName: str = ..., lodName: str | None = ...) -> list[AnimGroup]: ...
    def get_overlapping_joints(
        self, partNameA: str, partNameB: str, jointName: str = ..., lodName: str | None = ...
    ) -> set[AnimGroup]: ...
    ...
    def control_joint(self, node: NodePath | None, partName: str, jointName: str, lodName: str = ...) -> NodePath[ModelNode]: ...
    def freeze_joint(
        self,
        partName: str,
        jointName: str,
    ...
    def draw_in_front(
        self, frontPartName: str, backPartName: str, mode: int, root: NodePath | None = ..., lodName: str | None = ...
    ) -> None: ...
    def fix_bounds(self, partName: str | None = ...) -> None: ...
    def fix_bounds_old(self, part: NodePath | None = ...) -> None: ...
    def show_all_bounds(self) -> None: ...
    def hide_all_bounds(self) -> None: ...
    def anim_panel(self) -> AnimPanel: ...
    def stop(self, animName: str | None = ..., partName: str | None = ...) -> None: ...
    def play(
        self, animName: str | None, partName: str | None = ..., fromFrame: float | None = ..., toFrame: float | None = ...
    ) -> None: ...
    def loop(
    ...
    def pose(self, animName: str, frame: int, partName: str | None = ..., lodName: str | None = ...) -> None: ...
    def set_blend(
        self,
        animBlend: bool | None = ...,
        frameBlend: bool | None = ...,
        blendType: _BlendType | None = ...,
        partName: str | None = ...,
    ) -> None: ...
    def enable_blend(self, blendType: _BlendType = ..., partName: str | None = ...) -> None: ...
    def disable_blend(self, partName: str | None = ...) -> None: ...
    def set_control_effect(self, animName: str, effect: float, partName: str | None = ..., lodName: str | None = ...) -> None: ...
    def get_anim_filename(self, animName: str, partName: str = ...) -> str | None: ...
    def get_anim_control(
        self, animName: str, partName: str | None = ..., lodName: str | None = ..., allowAsyncBind: bool = ...
    ) -> AnimControl | None: ...
    def get_anim_controls(
        self, animName: str | None = ..., partName: str | None = ..., lodName: str | None = ..., allowAsyncBind: bool = ...
    ) -> list[AnimControl]: ...
    def load_model(
        self,
    ...
    def verify_subparts_complete(self, partName: str | None = ..., lodName: str | None = ...) -> None: ...
    def load_anims(self, anims: Mapping[str, str], partName: str = ..., lodName: str = ...) -> None: ...
    ...
    def unload_anims(self, anims: Iterable[str] | None = ..., partName: str | None = ..., lodName: str | None = ...) -> None: ...
    def bind_anim(
        self, animName: str, partName: str | None = ..., lodName: str | None = ..., allowAsyncBind: bool = ...
    ) -> None: ...
    def bind_all_anims(self, allowAsyncBind: bool = ...) -> None: ...
    def wait_pending(self, partName: str | None = ...) -> None: ...
    def actor_interval(
        self,
        animName: str,
        loop: bool = ...,
    ...
    def get_anim_blends(
        self, animName: str | None = ..., partName: str | None = ..., lodName: str | None = ...
    ) -> list[tuple[str, list[tuple[str, list[tuple[str, float]]]]]]: ...
    def print_anim_blends(self, animName: str | None = ..., partName: str | None = ..., lodName: str | None = ...) -> None: ...
    def osd_anim_blends(self, animName: str | None = ..., partName: str | None = ..., lodName: str | None = ...) -> None: ...
