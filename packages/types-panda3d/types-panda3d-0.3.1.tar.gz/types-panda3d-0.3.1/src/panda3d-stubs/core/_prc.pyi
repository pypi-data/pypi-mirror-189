...
class ConfigVariableBool(ConfigVariable):
    ...
    def assign(self: Self, value: bool) -> Self: ...
...
class ConfigVariableDouble(ConfigVariable):
    ...
    def assign(self: Self, value: float) -> Self: ...
...
class ConfigVariableFilename(ConfigVariable):
    ...
    def assign(self: Self, value: StrOrBytesPath) -> Self: ...
    def c_str(self) -> str:
...
class ConfigVariableInt(ConfigVariable):
    ...
    def assign(self: Self, value: int) -> Self: ...
...
class ConfigVariableString(ConfigVariable):
    ...
    def assign(self: Self, value: str) -> Self: ...
    def c_str(self) -> str:
