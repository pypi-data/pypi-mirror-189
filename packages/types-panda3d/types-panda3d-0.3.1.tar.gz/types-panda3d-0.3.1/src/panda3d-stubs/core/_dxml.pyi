...
class TiXmlDocument(TiXmlNode):
    ...
    def __copy__(self: Self) -> Self: ...
    def __deepcopy__(self: Self, __memo: object) -> Self: ...
    def assign(self: Self, copy: TiXmlDocument | str) -> Self: ...
    @overload
...
class TiXmlElement(TiXmlNode):
    ...
    def __copy__(self: Self) -> Self: ...
    def __deepcopy__(self: Self, __memo: object) -> Self: ...
    def assign(self: Self, base: TiXmlElement | str) -> Self: ...
...
class TiXmlComment(TiXmlNode):
    ...
    def __copy__(self: Self) -> Self: ...
    def __deepcopy__(self: Self, __memo: object) -> Self: ...
    def assign(self: Self, base: TiXmlComment | str) -> Self: ...
...
class TiXmlText(TiXmlNode):
    ...
    def __copy__(self: Self) -> Self: ...
    def __deepcopy__(self: Self, __memo: object) -> Self: ...
    def assign(self: Self, base: TiXmlText | str) -> Self: ...
    def CDATA(self) -> bool:
...
class TiXmlHandle:
    ...
    def __copy__(self: Self) -> Self: ...
    def __deepcopy__(self: Self, __memo: object) -> Self: ...
    def assign(self: Self, ref: TiXmlHandle | TiXmlNode) -> Self: ...
    @overload
