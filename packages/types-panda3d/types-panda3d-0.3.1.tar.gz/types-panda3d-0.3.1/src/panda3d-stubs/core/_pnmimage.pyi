...
class pixel:
    ...
    def __iadd__(self: Self, other: pixel) -> Self: ...
    def __isub__(self: Self, other: pixel) -> Self: ...
    def __imul__(self: Self, mult: float) -> Self: ...
...
class PfmFile(PNMImageHeader):
    ...
    def __imul__(self: Self, multiplier: float) -> Self: ...
    @overload
    def clear(self) -> None:
        """`(self)`:
...
class PNMImage(PNMImageHeader):
    ...
    def __iadd__(self: Self, other: PNMImage | Vec4Like) -> Self: ...
    def __isub__(self: Self, other: PNMImage | Vec4Like) -> Self: ...
    @overload
    def __imul__(self: Self, other: PNMImage | Vec4Like) -> Self: ...
    @overload
    def __imul__(self: Self, multiplier: float) -> Self: ...
