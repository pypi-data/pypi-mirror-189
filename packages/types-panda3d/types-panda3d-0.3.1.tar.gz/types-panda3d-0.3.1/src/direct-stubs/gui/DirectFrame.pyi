...
class DirectFrame(DirectGuiWidget):
    ...
    def setText(self, text: str | Sequence[str] | None = ...) -> None: ...
    def clearGeom(self) -> None: ...
    def setGeom(self, geom: _MaybeGeom | Sequence[_MaybeGeom] = ...) -> None: ...
    def clearImage(self) -> None: ...
    def setImage(self, image: _MaybeImage | Sequence[_MaybeImage] = ...) -> None: ...
