...
class DirectBoundingBox:
    ...
    def getMin(self) -> LPoint3f: ...
    def getMax(self) -> LPoint3f: ...
    def vecAsString(self, vec: Vec3Like) -> str: ...
...
class SelectionRay(SelectionQueue):
    def pick(self, targetNodePath: NodePath, xy: LVecBase2f | None = ...) -> None: ...
    def pickBitMask(
        self, bitMask: BitMask32 = ..., targetNodePath: NodePath | None = ..., skipFlags: int = ...
    ) -> CollisionEntry: ...
    def pickGeom(
        self, targetNodePath: NodePath | None = ..., skipFlags: int = ..., xy: LVecBase2f | None = ...
    ) -> CollisionEntry: ...
