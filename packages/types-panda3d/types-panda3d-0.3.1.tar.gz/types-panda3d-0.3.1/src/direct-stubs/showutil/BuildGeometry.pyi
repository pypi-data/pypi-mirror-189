...
def addSquare(attachNode: GeomNode, sizeX: float, sizeY: float, color: LColor = ..., layer: Unused = ...) -> Geom: ...
def addSquareGeom(
    rootNode: NodePath, sizeX: float, sizeY: float, color: LColor = ..., layer: Unused = ...
) -> tuple[NodePath[GeomNode], GeomNode, Geom]: ...
...
def addArrow(attachNode: GeomNode, sizeX: float, sizeY: float, color: LColor = ..., layer: Unused = ...) -> Geom: ...
def addArrowGeom(
    rootNode: NodePath, sizeX: float, sizeY: float, color: LColor = ..., layer: Unused = ...
) -> tuple[NodePath[GeomNode], GeomNode, Geom]: ...
