...
class Indirection:
    evalStr: str
    dictKey: Any
    def __init__(self, evalStr: str | None = ..., dictKey: Hashable = ...) -> None: ...
    ...
    def getString(self, prevIndirection: Indirection | None = ..., nextIndirection: Indirection | None = ...) -> str: ...

class ObjectRef:
    class FailedEval(Exception): ...
    notify: ClassVar[Notifier]
    def __init__(self, indirection: Indirection, objId: int, other: ObjectRef | None = ...) -> None: ...
    def destroy(self) -> None: ...
    def getNumIndirections(self) -> int: ...
    @overload
    def goesThroughGen(self, obj: object, objId: None = ...) -> Generator[bool | None, None, None]: ...
    @overload
    ...
    @overload
    def goesThrough(self, obj: object, objId: None = ...) -> bool: ...
    @overload
    def goesThrough(self, obj: None, objId: int) -> bool: ...
    @overload
    def goesThrough(self, *, objId: int) -> bool: ...
    def getContainerGen(self, getInstance: bool = ...) -> Generator[Any | None, None, None]: ...
    def getEvalStrGen(self, getInstance: bool = ...) -> Generator[str | None, None, None]: ...
...
class FPTObjsOfType(Job):
    notify: Notifier
    def __init__(
        self, name: str, leakDetector: ContainerLeakDetector, otn: str, doneCallback: SimpleCallback | None = ...
    ) -> None: ...
    def run(self) -> Generator[Any | None, None, None]: ...
...
class FPTObjsNamed(Job):
    notify: Notifier
    def __init__(
        self, name: str, leakDetector: ContainerLeakDetector, on: str, doneCallback: SimpleCallback | None = ...
    ) -> None: ...
    def run(self) -> Generator[Any | None, None, None]: ...
...
class ContainerLeakDetector(Job):
    ...
    def __init__(self, name: str, firstCheckDelay: float | None = ...) -> None: ...
    ...
    def getPathsToContainers(self, name: str, ot: str, doneCallback: SimpleCallback | None = ...) -> FPTObjsOfType: ...
    def getPathsToContainersNamed(self, name: str, on: str, doneCallback: SimpleCallback | None = ...) -> FPTObjsNamed: ...
