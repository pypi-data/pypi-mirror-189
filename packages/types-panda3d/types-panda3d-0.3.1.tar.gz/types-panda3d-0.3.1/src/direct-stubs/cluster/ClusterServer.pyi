...
class ClusterServer(DirectObject):
    ...
    def addNamedObjectMapping(self, object: NodePath, name: str, hasColor: bool = ..., priority: Unused = ...) -> None: ...
    def removeObjectMapping(self, name: str) -> None: ...
    def redoSortedPriorities(self) -> None: ...
    def addControlMapping(
        self, objectName: str, controlledName: str, offset: LVector3f | None = ..., priority: int = ...
    ) -> None: ...
