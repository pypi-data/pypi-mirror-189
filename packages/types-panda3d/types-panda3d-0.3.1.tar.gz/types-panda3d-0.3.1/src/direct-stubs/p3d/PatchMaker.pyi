...
class PatchMaker:
    ...
    class Package:
        ...
        def __init__(self, packageDesc: StrOrBytesPath, patchMaker: PatchMaker, xpackage: TiXmlElement | None = ...) -> None: ...
        ...
        def readDescFile(self, doProcessing: bool = ...) -> bool: ...
    ...
    def buildPatches(self, packageNames: MutableSequence[PatchMaker.Patchfile] | None = ...) -> bool: ...
    def cleanup(self) -> None: ...
