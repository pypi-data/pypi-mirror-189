...
class Chord():
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, notes: typing.List[Note]) -> None: ...
    @typing.overload
    def __init__(self, pitches: typing.List[str]) -> None: ...
    ...
    def getCloseStackIntervals(self, firstNoteAsReference: bool = False) -> typing.List[Interval]: ...
    def getDuration(self) -> str: ...
    def getDurationTicks(self) -> int: ...
    def getIntervals(self, firstNoteAsReference: bool = False) -> typing.List[Interval]: ...
    def getMIDIIntervals(self, firstNoteAsReference: bool = False) -> typing.List[int]: ...
    ...
    def getOpenStackIntervals(self, firstNoteAsReference: bool = False) -> typing.List[Interval]: ...
    def getOpenStackNotes(self) -> typing.List[Note]: ...
    def getQuarterDuration(self) -> float: ...
    def getRoot(self) -> Note: ...
    def getStackDataFrame(self, enharmonyNotes: bool = False) -> object: ...
...
class Clef():
    def __hash__(self) -> int: ...
    def __init__(self, sign: str = 'G', line: int = 2) -> None: ...
    def __repr__(self) -> str: ...
...
class Duration():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    BREVE: maialib.maiacore.maiacore.Duration # value = <Duration.BREVE: 34>
    BREVE_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.BREVE_DOT: 35>
    BREVE_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.BREVE_DOT_DOT: 36>
    EIGHTH: maialib.maiacore.maiacore.Duration # value = <Duration.EIGHTH: 22>
    EIGHTH_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.EIGHTH_DOT: 23>
    EIGHTH_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.EIGHTH_DOT_DOT: 24>
    HALF: maialib.maiacore.maiacore.Duration # value = <Duration.HALF: 28>
    HALF_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.HALF_DOT: 29>
    HALF_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.HALF_DOT_DOT: 30>
    LONG: maialib.maiacore.maiacore.Duration # value = <Duration.LONG: 37>
    LONG_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.LONG_DOT: 38>
    LONG_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.LONG_DOT_DOT: 39>
    MAXIMA: maialib.maiacore.maiacore.Duration # value = <Duration.MAXIMA: 40>
    MAXIMA_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.MAXIMA_DOT: 41>
    MAXIMA_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.MAXIMA_DOT_DOT: 42>
    N1024TH: maialib.maiacore.maiacore.Duration # value = <Duration.N1024TH: 1>
    N1024TH_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N1024TH_DOT: 2>
    N1024TH_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N1024TH_DOT_DOT: 3>
    N128TH: maialib.maiacore.maiacore.Duration # value = <Duration.N128TH: 10>
    N128TH_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N128TH_DOT: 11>
    N128TH_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N128TH_DOT_DOT: 12>
    N16TH: maialib.maiacore.maiacore.Duration # value = <Duration.N16TH: 19>
    N16TH_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N16TH_DOT: 20>
    N16TH_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N16TH_DOT_DOT: 21>
    N256TH: maialib.maiacore.maiacore.Duration # value = <Duration.N256TH: 7>
    N256TH_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N256TH_DOT: 8>
    N256TH_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N256TH_DOT_DOT: 9>
    N32ND: maialib.maiacore.maiacore.Duration # value = <Duration.N32ND: 16>
    N32ND_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N32ND_DOT: 17>
    N32ND_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N32ND_DOT_DOT: 18>
    N512TH: maialib.maiacore.maiacore.Duration # value = <Duration.N512TH: 4>
    N512TH_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N512TH_DOT: 5>
    N512TH_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N512TH_DOT_DOT: 6>
    N64TH: maialib.maiacore.maiacore.Duration # value = <Duration.N64TH: 13>
    N64TH_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N64TH_DOT: 14>
    N64TH_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.N64TH_DOT_DOT: 15>
    QUARTER: maialib.maiacore.maiacore.Duration # value = <Duration.QUARTER: 25>
    QUARTER_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.QUARTER_DOT: 26>
    QUARTER_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.QUARTER_DOT_DOT: 27>
    WHOLE: maialib.maiacore.maiacore.Duration # value = <Duration.WHOLE: 31>
    WHOLE_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.WHOLE_DOT: 32>
    WHOLE_DOT_DOT: maialib.maiacore.maiacore.Duration # value = <Duration.WHOLE_DOT_DOT: 33>
    __members__: dict # value = {'MAXIMA_DOT_DOT': <Duration.MAXIMA_DOT_DOT: 42>, 'MAXIMA_DOT': <Duration.MAXIMA_DOT: 41>, 'MAXIMA': <Duration.MAXIMA: 40>, 'LONG_DOT_DOT': <Duration.LONG_DOT_DOT: 39>, 'LONG_DOT': <Duration.LONG_DOT: 38>, 'LONG': <Duration.LONG: 37>, 'BREVE_DOT_DOT': <Duration.BREVE_DOT_DOT: 36>, 'BREVE_DOT': <Duration.BREVE_DOT: 35>, 'BREVE': <Duration.BREVE: 34>, 'WHOLE_DOT_DOT': <Duration.WHOLE_DOT_DOT: 33>, 'WHOLE_DOT': <Duration.WHOLE_DOT: 32>, 'WHOLE': <Duration.WHOLE: 31>, 'HALF_DOT_DOT': <Duration.HALF_DOT_DOT: 30>, 'HALF_DOT': <Duration.HALF_DOT: 29>, 'HALF': <Duration.HALF: 28>, 'QUARTER_DOT_DOT': <Duration.QUARTER_DOT_DOT: 27>, 'QUARTER_DOT': <Duration.QUARTER_DOT: 26>, 'QUARTER': <Duration.QUARTER: 25>, 'EIGHTH_DOT_DOT': <Duration.EIGHTH_DOT_DOT: 24>, 'EIGHTH_DOT': <Duration.EIGHTH_DOT: 23>, 'EIGHTH': <Duration.EIGHTH: 22>, 'N16TH_DOT_DOT': <Duration.N16TH_DOT_DOT: 21>, 'N16TH_DOT': <Duration.N16TH_DOT: 20>, 'N16TH': <Duration.N16TH: 19>, 'N32ND_DOT_DOT': <Duration.N32ND_DOT_DOT: 18>, 'N32ND_DOT': <Duration.N32ND_DOT: 17>, 'N32ND': <Duration.N32ND: 16>, 'N64TH_DOT_DOT': <Duration.N64TH_DOT_DOT: 15>, 'N64TH_DOT': <Duration.N64TH_DOT: 14>, 'N64TH': <Duration.N64TH: 13>, 'N128TH_DOT_DOT': <Duration.N128TH_DOT_DOT: 12>, 'N128TH_DOT': <Duration.N128TH_DOT: 11>, 'N128TH': <Duration.N128TH: 10>, 'N256TH_DOT_DOT': <Duration.N256TH_DOT_DOT: 9>, 'N256TH_DOT': <Duration.N256TH_DOT: 8>, 'N256TH': <Duration.N256TH: 7>, 'N512TH_DOT_DOT': <Duration.N512TH_DOT_DOT: 6>, 'N512TH_DOT': <Duration.N512TH_DOT: 5>, 'N512TH': <Duration.N512TH: 4>, 'N1024TH_DOT_DOT': <Duration.N1024TH_DOT_DOT: 3>, 'N1024TH_DOT': <Duration.N1024TH_DOT: 2>, 'N1024TH': <Duration.N1024TH: 1>}
    pass
class HeapData():
    pass
class Helper():
    ...
    @staticmethod
    def freq2midiNote(freq: float, modelo: typing.Callable[[float], int] = None) -> typing.Tuple[int, int]: ...
    @staticmethod
    def freq2pitch(freq: float, accType: str = '#') -> typing.Tuple[str, int]: ...
    @staticmethod
    def getPercentiles(arg0: object, arg1: typing.List[float]) -> object: ...
    @staticmethod
    def isEnharmonic(arg0: str, arg1: str) -> bool: ...
    @staticmethod
    def midiNote2freq(midiNoteValue: int) -> float: ...
    @staticmethod
    def midiNote2octave(midiNote: int) -> int: ...
    @staticmethod
    def midiNote2pitch(midiNote: int, accType: str = '') -> str: ...
    @staticmethod
    def midiNote2pitches(midiNote: int) -> typing.List[str]: ...
    @staticmethod
    def noteSimilarity(pitchClass_A: str, octave_A: int, duration_A: float, pitchClass_B: str, octave_B: int, duration_B: float, enableEnharmonic: bool = False) -> typing.Tuple[float, float, float]: ...
    @staticmethod
    def noteType2duration(noteType: str) -> Duration: ...
    @staticmethod
    def noteType2ticks(noteType: str, divisionsPerQuarterNote: int = 256) -> int: ...
    @staticmethod
    def notes2Intervals(notes: typing.List[Note], firstNoteAsReference: bool = False) -> typing.List[Interval]: ...
    @staticmethod
...
class Measure():
    ...
    def addNote(self, note: Note, staveId: int = 0, position: int = -1) -> None: 
        ...
        """
    @typing.overload
    def addNote(self, noteVec: typing.List[Note], staveId: int = 0, position: int = -1) -> None: ...
    @typing.overload
    def addNote(self, pitchClass: str, staveId: int = 0, position: int = -1) -> None: ...
    @typing.overload
    def addNote(self, pitchClassVec: typing.List[str], staveId: int = 0, position: int = -1) -> None: ...
    def clear(self) -> None: ...
    def clefChanged(self) -> bool: ...
    ...
    def getTimeMetronome(self) -> typing.Tuple[str, int]: ...
    def getTimeSignature(self) -> typing.Tuple[int, int]: ...
    def info(self) -> None: ...
    ...
    def setIsClefChanged(self, isClefChanged: bool = False) -> None: ...
    ...
    def setKeySignature(self, fifthCicle: int, isMajorMode: bool = True) -> None: ...
    def setMetronome(self, bpm: int, duration: Duration = Duration.QUARTER) -> None: ...
...
class Note():
    ...
    def getArticulation(self) -> typing.List[str]: ...
    def getBeam(self) -> typing.List[str]: ...
    ...
    def getEnharmonicNotes(self, includeCurrentPitch: bool = False) -> typing.List[Note]: ...
    def getEnharmonicPitch(self, alternativeEnhamonicPitch: bool = False) -> str: ...
    def getEnharmonicPitches(self, includeCurrentPitch: bool = False) -> typing.List[str]: ...
    ...
    def getTie(self) -> typing.List[str]: ...
...
class Part():
    ...
    @typing.overload
    def append(self, obj: typing.Union[Note, Chord], position: int = -1, staveId: int = 0) -> None: ...
    @typing.overload
    def append(self, objs: typing.List[typing.Union[Note, Chord]], position: int = -1, staveId: int = 0) -> None: ...
    def clear(self) -> None: ...
    def getMeasure(self, measureId: int) -> Measure: ...
    def getMidiUnpitched(self) -> typing.List[int]: ...
    def getName(self) -> str: ...
...
class Score():
    ...
    def getChords(self, config: json = None) -> object: ...
    ...
    def getPartNames(self) -> typing.List[str]: ...
    def getPartsName(self) -> typing.Dict[int, str]: ...
    ...
    def selectNotes(self, config: json) -> json: ...
    ...
    def setMetronomeMark(self, bpm: int, duration: Duration = Duration.QUARTER, measureStart: int = 0) -> None: ...
    ...
    def toDataFrame(self) -> object: ...
    def toFile(self, fileName: str, identSize: int = 2) -> None: ...
    def toJSON(self) -> str: ...
    def toXML(self, identSize: int = 2) -> str: ...
