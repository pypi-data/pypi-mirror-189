...
class ServicesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.categorize_transactions_endpoint = _Endpoint(
            settings={
                'response_type': (CategorizeTransactionsResponse,),
                'auth': [
                    'apikeyAuth',
                    'appIdAuth'
                ],
                'endpoint_path': '/v1/ml/categorize_transaction',
                'operation_id': 'categorize_transactions',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def categorize_transactions(
        ...
        **kwargs
        ...
        >>> thread = api.categorize_transactions(async_req=True)
        >>> result = thread.get()
        ...
        return self.categorize_transactions_endpoint.call_with_http_info(**kwargs)
