...
from dojah_client import rest
from dojah_client.configuration import Configuration
from dojah_client.exceptions import ApiTypeError, ApiValueError, ApiException
from dojah_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AMLApi()
        api_instance.get_screening_info  # this is an instance of the class Endpoint
        api_instance.get_screening_info()  # this invokes api_instance.get_screening_info.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_screening_info.callable or self.callable in this class
