...
if (QI_TOOLCHAIN_TARGET)
  qi_verbose("With toolchain target: ${QI_TOOLCHAIN_TARGET}")
  string(TOUPPER ${QI_TOOLCHAIN_TARGET} QI_TOOLCHAIN_TARGET_VALUE)
  add_definitions("-DQI_TOOLCHAIN_TARGET=${QI_TOOLCHAIN_TARGET}")
  add_definitions("-DQI_TOOLCHAIN_TARGET_${QI_TOOLCHAIN_TARGET_VALUE}")
  qi_verbose("With toolchain target full macro: QI_TOOLCHAIN_TARGET_${QI_TOOLCHAIN_TARGET_VALUE}")
endif()
