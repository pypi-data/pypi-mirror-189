...
import dateutil.tz
from xml.etree import ElementTree as ET  # nosec - not using this for parsing

import rssgen.version
from rssgen.compat import string_types
from rssgen.entry import FeedEntry
from rssgen.util import ensure_format, formatRFC2822, xml_elem

_rssgen_version = rssgen.version.version_str
...
class RssGenerator(object):
    ...
    def __init__(self):
        ...
        self.__atom_generator = {
                'value': 'python-rssgen',
                'uri': 'https://lkiesow.github.io/python-rssgen',
                'version': rssgen.version.version_str}  # {value*,uri,version}
        ...
        self.__rss_generator = 'python-rssgen'
    ...
    def atom_str(self, pretty=False, extensions=True, encoding='UTF-8',
        ...
        **Return type:** The return type may vary between different Python
        ...
        return ET.tostring(feed, encoding=encoding,
    ...
    def atom_file(self, filename, extensions=True, pretty=False,
        ...
        '''
        feed, doc = self._create_atom(extensions=extensions)
        doc.write(filename, encoding=encoding,
                  xml_declaration=xml_declaration)
    ...
    def author(self, author=None, replace=False, **kwargs):
        ...
        Example::
            ...
            >>> rssgen.author({'name':'John Doe', 'email':'jdoe@example.com'})
            [{'name':'John Doe','email':'jdoe@example.com'}]

            >>> rssgen.author([{'name':'Mr. X'},{'name':'Max'}])
            [{'name':'John Doe','email':'jdoe@example.com'},
    ...
    def link(self, link=None, replace=False, **kwargs):
        ...
        Example::
            ...
            >>> rssgen.link( href='http://example.com/', rel='self')
