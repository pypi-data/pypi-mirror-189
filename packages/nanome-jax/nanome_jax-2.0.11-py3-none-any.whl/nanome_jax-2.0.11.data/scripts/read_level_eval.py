...
def parse_arguments():
    ...
    parser.add_argument('--using-cache', help="if use cache files, will use cache files if possible",
                        action='store_true')
