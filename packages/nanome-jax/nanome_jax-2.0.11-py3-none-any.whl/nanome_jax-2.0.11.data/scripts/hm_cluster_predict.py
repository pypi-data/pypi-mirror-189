...
nbsize = 25;
#train_mod = '/projects/li-lab/yang/tools/latest-version/DeepMod/train_mod/na12878_cluster_train_mod-keep_prob0.7-nb25-chr1/{}.cov{}.nb{}'.format(mpat, cov_thrd, nbsize)
train_mod = sys.argv[3]
