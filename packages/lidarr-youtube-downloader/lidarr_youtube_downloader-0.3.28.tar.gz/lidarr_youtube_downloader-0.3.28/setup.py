...
package_data = \
{'': ['*'], 'lidarr_youtube_downloader': ['view/*']}

install_requires = \
['eyed3', 'requests', 'youtube-search-python']

entry_points = \
{'console_scripts': ['lyd = lidarr_youtube_downloader.lyd:app',
                     'lyd-unmapped = '
                     'lidarr_youtube_downloader.lyd-unmapped:app']}
