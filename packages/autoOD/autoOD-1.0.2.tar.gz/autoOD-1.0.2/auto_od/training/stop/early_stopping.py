...
class EarlyStopping:
    ...
    def algorithm(self, losses: List[float], ckpt: List[str], step: List[int]) -> Tuple[str, int]:
        """!
    ...
    def save_best_ckpt(self, best_ckpt: str, step: str) -> None:
        """!
