...
from nomad_pilot_cli.models.package_required import PackageRequired  # noqa: E501
from nomad_pilot_cli.rest import ApiException

class TestPackageRequired(unittest.TestCase):
    """PackageRequired unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PackageRequired
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = nomad_pilot_cli.models.package_required.PackageRequired()  # noqa: E501
        if include_optional :
