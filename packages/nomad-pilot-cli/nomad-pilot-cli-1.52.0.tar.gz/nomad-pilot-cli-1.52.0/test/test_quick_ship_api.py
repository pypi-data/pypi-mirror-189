...
from nomad_pilot_cli.api.quick_ship_api import QuickShipApi  # noqa: E501
from nomad_pilot_cli.rest import ApiException


class TestQuickShipApi(unittest.TestCase):
    """QuickShipApi unit test stubs"""

    def setUp(self):
        self.api = nomad_pilot_cli.api.quick_ship_api.QuickShipApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_quick_ship(self):
        """Test case for quick_ship
