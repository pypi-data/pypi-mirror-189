...
from nomad_pilot_cli.models.callback_body import CallbackBody  # noqa: E501
from nomad_pilot_cli.rest import ApiException

class TestCallbackBody(unittest.TestCase):
    """CallbackBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = nomad_pilot_cli.models.callback_body.CallbackBody()  # noqa: E501
        if include_optional :
            return CallbackBody(
                delivery_order = nomad_pilot_cli.models.haiku_delivery_order.HaikuDeliveryOrder(
