...
from nomad_pilot_cli.models.package_item_quick import PackageItemQuick  # noqa: E501
from nomad_pilot_cli.rest import ApiException

class TestPackageItemQuick(unittest.TestCase):
    """PackageItemQuick unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PackageItemQuick
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = nomad_pilot_cli.models.package_item_quick.PackageItemQuick()  # noqa: E501
        if include_optional :
            return PackageItemQuick(
                sku_number = 'SMK123', 
