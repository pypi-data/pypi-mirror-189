...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of nomad_pilot_cli.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = nomad_pilot_cli.Configuration(
    ...
    Note you can use the constants defined in the nomad_pilot_cli.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = nomad_pilot_cli.Configuration(
        signing_info = nomad_pilot_cli.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://nomad.samarkand-global.cn/pilot",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("nomad_pilot_cli")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'x-ca-key' in self.api_key:
            auth['ca_key'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-ca-key',
                'value': self.get_api_key_with_prefix('x-ca-key')
            }
        if 'x-ca-stage' in self.api_key:
            auth['ca_stage'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-ca-stage',
                'value': self.get_api_key_with_prefix('x-ca-stage')
            }
        return auth
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 1.52.0\n"\
               "SDK Package Version: 1.52.0".\
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://nomad.samarkand-global.cn/pilot",
