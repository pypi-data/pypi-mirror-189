...
import nomad_pilot_cli.models
from nomad_pilot_cli import rest
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/1.52.0/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(nomad_pilot_cli.models, klass)
...
'''
modified from https://gitlab.com/samarkand-docker/swagger-codegen/commit/b8b6c3af005768d32b99320d7aa9b1342edbccf2
...
def validate_swagger_type_decorator(func):
    def f(self, obj):
        if not self.configuration.validation_enabled:
            return func(self, obj)
        if hasattr(obj, SwaggerValidator.KEY_OPENAPI_TYPES):
            SwaggerValidator.validate(obj, type(obj))
        return func(self, obj)
    return f


ApiClient.sanitize_for_serialization = validate_swagger_type_decorator(ApiClient.sanitize_for_serialization)
