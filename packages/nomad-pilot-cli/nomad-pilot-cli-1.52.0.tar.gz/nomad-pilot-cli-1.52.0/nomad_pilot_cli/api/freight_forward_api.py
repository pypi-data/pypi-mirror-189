...
class FreightForwardApi(object):
    ...
    def put_freight_forward_product(self, carrier, **kwargs):  # noqa: E501
        """freightForward  # noqa: E501

        Update product data with specified carrier in Freight Forwarding DB.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_freight_forward_product(carrier, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str carrier: Carrier name to ship, e.g. samarkand.sfexpress.test (required)
        :param ProductFreight product_freight: Package to ship for Freight Forwarding DB
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_freight_forward_product_with_http_info(carrier, **kwargs)  # noqa: E501

    def put_freight_forward_product_with_http_info(self, carrier, **kwargs):  # noqa: E501
        """freightForward  # noqa: E501

        Update product data with specified carrier in Freight Forwarding DB.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_freight_forward_product_with_http_info(carrier, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['carrier', 'product_freight']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_freight_forward_product" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'carrier' is set
        if self.api_client.client_side_validation and ('carrier' not in local_var_params or  # noqa: E501
                                                        local_var_params['carrier'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `carrier` when calling `put_freight_forward_product`")  # noqa: E501
        ...
        body_params = None
        if 'product_freight' in local_var_params:
            body_params = local_var_params['product_freight']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/freight-forward/product/{carrier}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def query_freight_forward_with_http_info(self, carrier, status, page_no, page_size, **kwargs):  # noqa: E501
        ...
        all_params = ['carrier', 'status', 'page_no', 'page_size', 'created_range']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
