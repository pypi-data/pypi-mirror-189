...
from nomad_pilot_cli.exceptions import ApiException, ApiValueError
...
from nomad_pilot_cli.append_alibaba_headers import append_alibaba_headers, keep_configuration_in_RESTClientObject
RESTClientObject.__init__ = keep_configuration_in_RESTClientObject(RESTClientObject.__init__)
RESTClientObject.request = append_alibaba_headers(RESTClientObject.request)
