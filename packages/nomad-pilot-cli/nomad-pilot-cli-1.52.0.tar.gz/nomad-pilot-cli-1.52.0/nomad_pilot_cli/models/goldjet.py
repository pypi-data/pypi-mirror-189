...
class Goldjet(object):
    ...
    attribute_map = {
        'goods_ptcode': 'goodsPtcode'
    }

    def __init__(self, goods_ptcode=None, local_vars_configuration=None):  # noqa: E501
        """Goldjet - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._goods_ptcode = None
        self.discriminator = None

        if goods_ptcode is not None:
            self.goods_ptcode = goods_ptcode

    @property
    def goods_ptcode(self):
        """Gets the goods_ptcode of this Goldjet.  # noqa: E501


        :return: The goods_ptcode of this Goldjet.  # noqa: E501
        :rtype: str
        """
        return self._goods_ptcode

    @goods_ptcode.setter
    def goods_ptcode(self, goods_ptcode):
        """Sets the goods_ptcode of this Goldjet.


        :param goods_ptcode: The goods_ptcode of this Goldjet.  # noqa: E501
        :type: str
        """

        self._goods_ptcode = goods_ptcode
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Goldjet):
            return False
