...
# It is often
# described as a "batteries included" language due to it's comprehensive standard library.
...
#    static types, but    they are
# not checked    in the default implementation CPython. An experimental optional static type-checker, mypy, supports compile-time type checking.
...
#
# > In elementary algebra, the quadratic formula is a formula that provides the solution(s) to a quadratic equations. There are other ways of solving a quadratic equation instead of using the quadratic formula such as factoring (direct factoring, grouping, AC method), completing the square, graphing and others.
