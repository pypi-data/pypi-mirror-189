    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_karte_eventbridge_documentdb_module",
        "cdk_cloudformation_karte_eventbridge_documentdb_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_karte_eventbridge_documentdb_module._jsii": [
            "karte-eventbridge-documentdb-module@1.0.2-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_karte_eventbridge_documentdb_module": [
            "py.typed"
        ]
