...
from ocp_project_plugin.views.worker import add_project, clone_repo, sync_project
...
urlpatterns = [
    ...
    # Worker urls
    #
    path("worker/clone_repo", clone_repo, name="clone_repo"),
    path("worker/add_project", add_project, name="add_project"),
    path("worker/sync/", sync_project, name="sync_project"),
]
