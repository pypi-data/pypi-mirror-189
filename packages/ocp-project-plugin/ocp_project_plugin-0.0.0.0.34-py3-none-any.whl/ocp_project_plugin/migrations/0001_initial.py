    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("owner", models.ForeignKey(on_delete=models.deletion.PROTECT, related_name="ocp_project_owner",
                                            to="tenancy.Contact")),
                ("contact", models.ForeignKey(on_delete=models.deletion.PROTECT, related_name="ocp_project_contact",
                                              to="tenancy.Contact")),
                ("customer",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("requests_cpu", models.CharField(max_length=5, null=True)),
                ("requests_memory", models.CharField(max_length=5, null=True)),
                ("limits_cpu", models.CharField(max_length=5, null=True)),
                ("limits_memory", models.CharField(max_length=5, null=True)),
            ],
            options={
                "ordering": ["cluster_env", "app_env", "mtls", "repo", "branch", "path", "egress_ip", "helm",
                             "monitoring", "postgres_monitoring", "kustomize", "ocp_project", "requests_cpu",
