...
class OCPProjectView(ObjectView):
    ...
    def get_extra_context(self, request, instance):
        ...
        result = AppEnvironment.objects.filter(ocp_project=instance).annotate(limits_cpu_as_float=Cast('limits_cpu', output_field=FloatField())).aggregate(Sum('limits_cpu_as_float'))
        print(result)
        return {
