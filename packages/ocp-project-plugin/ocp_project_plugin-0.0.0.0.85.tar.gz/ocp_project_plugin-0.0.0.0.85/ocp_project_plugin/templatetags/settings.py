...
def get_cpu_cost(amount):
    return CPU_COST * amount


@register.simple_tag
def get_memory_cost(amount):
    return MEMORY_COST * amount


@register.simple_tag
def get_storage_cost(amount):
    return STORAGE_COST * amount


@register.simple_tag
def get_total_cost(cpu_amount, memory_amount, storage_amount):
    return CPU_COST * cpu_amount + MEMORY_COST * memory_amount + STORAGE_COST * storage_amount
