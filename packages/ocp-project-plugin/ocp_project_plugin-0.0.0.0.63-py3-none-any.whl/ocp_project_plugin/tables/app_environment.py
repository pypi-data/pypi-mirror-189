...
class AppEnvironmentTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        ...
        fields = ["pk", "cluster_env", "app_env", "mtls", "repo", "branch", "path", "egress_ip", "deployment_kind", "monitoring",
                  "postgres_monitoring", "ocp_project"]

        default_columns = ["cluster_env", "app_env", "mtls", "repo", "branch", "path", "egress_ip", "deployment_kind",
