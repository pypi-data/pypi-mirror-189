...
class AppEnvironmentSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        ...
        fields = ["url", "id", "cluster_env", "app_env", "mtls", "repo", "branch", "path", "egress_ip", "helm",
                  "monitoring", "postgres_monitoring", "kustomize", "ocp_project", "requests_cpu", "requests_memory",
