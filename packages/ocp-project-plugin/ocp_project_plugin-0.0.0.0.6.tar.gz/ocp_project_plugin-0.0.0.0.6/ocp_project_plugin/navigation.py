...
resource_quota_menu_item = PluginMenuItem(
    link="plugins:ocp_project_plugin:resourcequota_list",
    link_text="Resource Quota",
    permissions=["ocp_project_plugin.resourcequota_view"],
    buttons=(
        PluginMenuButton(
            "plugins:ocp_project_plugin:resourcequota_add",
            "Add",
            "mdi mdi-plus-thick",
            ButtonColorChoices.GREEN,
            permissions=["ocp_project_plugin.add_resourcequota"],
        ),
        PluginMenuButton(
            "plugins:ocp_project_plugin:resourcequota_import",
            "Import",
            "mdi mdi-upload",
            ButtonColorChoices.CYAN,
            permissions=["ocp_project_plugin.add_resourcequota"],
