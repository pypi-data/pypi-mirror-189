...
class OCPProjectTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        ...
        fields = ["pk", "name", "description", "display_name", "owner", "contact", "customer", "url", "workload",
                  "request"]

        default_columns = ["name", "description", "display_name", "owner", "contact", "customer", "url", "workload",
                           "request"]
