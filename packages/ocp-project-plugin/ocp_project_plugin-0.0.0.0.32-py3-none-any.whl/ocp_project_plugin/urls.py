...
from ocp_project_plugin.views import (
    ...
    OCPProjectBulkDeleteView,
    # Resource Quota
    ResourceQuotaListView,
    ResourceQuotaEditView,
    ResourceQuotaBulkImportView,
    ResourceQuotaBulkEditView,
    ResourceQuotaBulkDeleteView,
    ResourceQuotaView,
    ResourceQuotaDeleteView,
)
...
urlpatterns = [
    ...
    path("appenvironment/add/", AppEnvironmentEditView.as_view(), name="appenvironment_add"),
    ...
    # Resource Quota urls
    #
    path("resourcequota/", ResourceQuotaListView.as_view(), name="resourcequota_list"),
    path("resourcequota/add/", ResourceQuotaEditView.as_view(), name="resourcequota_add"),
    path("resourcequota/import/", ResourceQuotaBulkImportView.as_view(), name="resourcequota_import"),
    path("resourcequota/edit/", ResourceQuotaBulkEditView.as_view(), name="resourcequota_bulk_edit"),
    path("resourcequota/delete/", ResourceQuotaBulkDeleteView.as_view(), name="resourcequota_bulk_delete"),
    path("resourcequota/<int:pk>/", ResourceQuotaView.as_view(), name="resourcequota"),
    path("resourcequota/<int:pk>/edit/", ResourceQuotaEditView.as_view(), name="resourcequota_edit"),
    path("resourcequota/<int:pk>/delete/", ResourceQuotaDeleteView.as_view(), name="resourcequota_delete"),
    path(
        "resourcequota/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="resourcequota_changelog",
        kwargs={"model": ResourceQuota},
    ),
]
