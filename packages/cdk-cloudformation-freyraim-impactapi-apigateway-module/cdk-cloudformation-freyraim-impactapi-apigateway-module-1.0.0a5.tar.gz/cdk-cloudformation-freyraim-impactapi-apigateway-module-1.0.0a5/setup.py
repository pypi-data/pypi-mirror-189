    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_freyraim_impactapi_apigateway_module",
        "cdk_cloudformation_freyraim_impactapi_apigateway_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_freyraim_impactapi_apigateway_module._jsii": [
            "freyraim-impactapi-apigateway-module@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_freyraim_impactapi_apigateway_module": [
            "py.typed"
        ]
