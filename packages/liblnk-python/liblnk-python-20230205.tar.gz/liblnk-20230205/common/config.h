...
/* Define to 1 if you have the <libfwps.h> header file. */
/* #undef HAVE_LIBFWPS_H */

/* Define to 1 if you have the `fwsi' library (-lfwsi). */
/* #undef HAVE_LIBFWSI */

/* Define to 1 if you have the <libfwsi.h> header file. */
/* #undef HAVE_LIBFWSI_H */
...
#define HAVE_LOCAL_LIBFDATETIME 1
...
#define HAVE_LOCAL_LIBFWPS 1

/* Define to 1 if the local version of libfwsi is used. */
#define HAVE_LOCAL_LIBFWSI 1
