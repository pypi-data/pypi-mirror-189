...
from .message_types import WEBSOCKET_MESSAGE, WEBSOCKET_HEARTBEAT, WEBSOCKET_STATUS
from .status import (
    WEBSOCKET_OPENED,
    WEBSOCKET_CLOSED,
    Status,
...
raw_logger = getLogger(f'{__name__}.raw')

USER_URL = getenv("CRYPTODOTCOM_USER_URL", "wss://stream.crypto.com/exchange/v1/user")
MARKET_URL = getenv("CRYPTODOTCOM_MARKET_URL", "wss://stream.crypto.com/exchange/v1/market")
