# import time
# from cache_dec import cache_dec


# @cache_dec(4,1,verbose=2)
# def fact(n):
#     if n==0 or n==1:
#         return n
...
def threadf1(lock):
    ...
    print("Info for Cache for Thread 1:",end=" ")
    cache.get_info()
...
def threadf2(lock):
    ...
    print("Info for Cache for Thread 2:",end=" ")
    cache.get_info()
