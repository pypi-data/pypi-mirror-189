...
instance (from ``selkie.io``) so that the argument is interpreted as a
...
>>> from selkie.tree import tree_string
>>> tree_string(foo)
'0    (NP:subj &1\n        foo\n1       (Det the)\n2       (N:head dog))'
>>> print(_)
0    (NP:subj &1
...
>>> from selkie.tree import save_trees
...
.. py:class:: selkie.tree.TreeBuilder
