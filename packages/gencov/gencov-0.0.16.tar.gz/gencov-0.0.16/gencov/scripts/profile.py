...
def main(raw_args):
    ...
    info = '''
get coverage profile over loci
...
arguments:
    ...
    --transform ::: apply function to transform values with x as variable
                    eg, log10(x + 1)
                    none by default
    --sample :::::: output size as < column_count(/method) >
                    with column_count as all, integer
...
'''
    ...
    row_count, col_count, sample_method = parse_sample_setting(args.sample, row_count="all")
