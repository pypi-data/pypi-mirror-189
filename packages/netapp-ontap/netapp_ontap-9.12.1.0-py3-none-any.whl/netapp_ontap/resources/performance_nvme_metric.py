...
* PT5M"""
    ...
    fc = fields.Nested("netapp_ontap.models.performance_nvme_metric_properties.PerformanceNvmeMetricPropertiesSchema", data_key="fc", unknown=EXCLUDE)
...
* partial_no_uuid"""
    ...
    tcp = fields.Nested("netapp_ontap.models.performance_nvme_metric_properties.PerformanceNvmeMetricPropertiesSchema", data_key="tcp", unknown=EXCLUDE)
...
class PerformanceNvmeMetric(Resource):
    ...
    def get_collection(
        ...
        **kwargs
        ...
        r"""Retrieves historical performance metrics for NVMe protocol of an SVM."""
