...
class MetroclusterDrGroupSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    mccip_ports = fields.List(fields.Nested("netapp_ontap.models.metrocluster_mccip_ports.MetroclusterMccipPortsSchema", unknown=EXCLUDE), data_key="mccip_ports")
    ...
    """dr_pairs,partner_cluster.links,partner_cluster.name,partner_cluster.uuid,"""
    ...
    """dr_pairs,mccip_ports,partner_cluster.links,partner_cluster.name,partner_cluster.uuid,"""
...
* [`DOC /cluster/metrocluster/dr-groups`](#docs-cluster-cluster_metrocluster_dr-groups)"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="metrocluster dr group show")
...
"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="metrocluster dr group create")
        async def metrocluster_dr_group_create(
            ...
            try:
                ...
                raise ReclineCommandError("Unable to create MetroclusterDrGroup: %s" % err)
            return [resource]
...
* [`DOC /cluster/metrocluster/dr-groups`](#docs-cluster-cluster_metrocluster_dr-groups)"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="metrocluster dr group delete")
        async def metrocluster_dr_group_delete(
            ...
            try:
                ...
                raise ReclineCommandError("Unable to delete MetroclusterDrGroup: %s" % err)
