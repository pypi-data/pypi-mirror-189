...
__pdoc__ = {
    ...
    "VolumeMetricsSchema.opts": False,
...
class VolumeMetricsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the VolumeMetrics object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", data_key="_links", unknown=EXCLUDE)
    r""" The links field of the volume_metrics."""

    cloud = fields.Nested("netapp_ontap.models.volume_metric_cloud.VolumeMetricCloudSchema", data_key="cloud", unknown=EXCLUDE)
...
* PT5M"""
    ...
    flexcache = fields.Nested("netapp_ontap.models.volume_metric_flexcache.VolumeMetricFlexcacheSchema", data_key="flexcache", unknown=EXCLUDE)
...
class VolumeMetrics(Resource):
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="volume metrics show")
    ...
    def count_collection(
        ...
        **kwargs
        ...
        """Returns a count of all VolumeMetrics resources that match the provided query"""
