...
class PortMetricsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
class PortMetrics(Resource):
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="port metrics show")
    ...
    def count_collection(
        ...
        **kwargs
        ...
        """Returns a count of all PortMetrics resources that match the provided query"""
