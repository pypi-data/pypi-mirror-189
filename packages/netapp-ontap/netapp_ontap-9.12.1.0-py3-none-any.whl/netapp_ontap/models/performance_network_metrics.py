...
__all__ = ["PerformanceNetworkMetrics", "PerformanceNetworkMetricsSchema"]
__pdoc__ = {
    "PerformanceNetworkMetricsSchema.resource": False,
    "PerformanceNetworkMetricsSchema.opts": False,
    "PerformanceNetworkMetrics": False,
}


class PerformanceNetworkMetricsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the PerformanceNetworkMetrics object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the performance_network_metrics. """
...
* inconsistent_old_data """
    ...
    r""" The throughput field of the performance_network_metrics. """
...
Example: 2017-01-25T11:20:13Z """
    ...
    @property
    def resource(self):
        return PerformanceNetworkMetrics
...
class PerformanceNetworkMetrics(Resource):

    _schema = PerformanceNetworkMetricsSchema
