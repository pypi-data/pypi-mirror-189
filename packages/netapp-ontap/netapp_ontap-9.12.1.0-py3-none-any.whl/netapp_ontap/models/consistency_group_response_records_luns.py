...
class ConsistencyGroupResponseRecordsLunsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The clone field of the consistency_group_response_records_luns. """
...
Example: 2018-06-04T19:00:00Z """
    ...
    lun_maps = fields.List(fields.Nested("netapp_ontap.models.consistency_group_response_records_consistency_groups_luns_lun_maps.ConsistencyGroupResponseRecordsConsistencyGroupsLunsLunMapsSchema", unknown=EXCLUDE), data_key="lun_maps")
...
* xen """
    ...
    r""" The provisioning_options field of the consistency_group_response_records_luns. """
    ...
    r""" The space field of the consistency_group_response_records_luns. """
