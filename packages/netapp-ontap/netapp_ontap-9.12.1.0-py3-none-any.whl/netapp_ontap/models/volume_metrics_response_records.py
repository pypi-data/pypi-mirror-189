...
__all__ = ["VolumeMetricsResponseRecords", "VolumeMetricsResponseRecordsSchema"]
__pdoc__ = {
    "VolumeMetricsResponseRecordsSchema.resource": False,
    "VolumeMetricsResponseRecordsSchema.opts": False,
    "VolumeMetricsResponseRecords": False,
}


class VolumeMetricsResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the VolumeMetricsResponseRecords object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the volume_metrics_response_records. """
...
* PT5M """
    ...
    r""" The iops field of the volume_metrics_response_records. """
    ...
    r""" The latency field of the volume_metrics_response_records. """
...
* partial_no_uuid """
    ...
    r""" The throughput field of the volume_metrics_response_records. """
...
Example: 2017-01-25T11:20:13Z """
    ...
    @property
    def resource(self):
        return VolumeMetricsResponseRecords
...
class VolumeMetricsResponseRecords(Resource):

    _schema = VolumeMetricsResponseRecordsSchema
