...
__all__ = ["ConsistencyGroupResponseRecordsConsistencyGroupsNamespaces", "ConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema"]
__pdoc__ = {
    "ConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema.resource": False,
    "ConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema.opts": False,
    "ConsistencyGroupResponseRecordsConsistencyGroupsNamespaces": False,
}


class ConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
* windows """
    ...
    r""" The provisioning_options field of the consistency_group_response_records_consistency_groups_namespaces. """
    ...
    r""" The space field of the consistency_group_response_records_consistency_groups_namespaces. """
    ...
    r""" The status field of the consistency_group_response_records_consistency_groups_namespaces. """
    ...
    r""" The subsystem_map field of the consistency_group_response_records_consistency_groups_namespaces. """
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return ConsistencyGroupResponseRecordsConsistencyGroupsNamespaces
...
class ConsistencyGroupResponseRecordsConsistencyGroupsNamespaces(Resource):

    _schema = ConsistencyGroupResponseRecordsConsistencyGroupsNamespacesSchema
