...
class ConsistencyGroupConsistencyGroupsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    application = fields.Nested("netapp_ontap.models.consistency_group_consistency_groups_application.ConsistencyGroupConsistencyGroupsApplicationSchema", unknown=EXCLUDE, data_key="application")
...
An NVMe namespace must be mapped to an NVMe subsystem to grant access to the subsystem's hosts. Hosts can then access the NVMe namespace and perform I/O using the NVMe over Fabrics protocol. """
    ...
    r""" The provisioning_options field of the consistency_group_consistency_groups. """
    ...
    r""" The restore_to field of the consistency_group_consistency_groups. """
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    volumes = fields.List(fields.Nested("netapp_ontap.models.consistency_group_volume.ConsistencyGroupVolumeSchema", unknown=EXCLUDE), data_key="volumes")
