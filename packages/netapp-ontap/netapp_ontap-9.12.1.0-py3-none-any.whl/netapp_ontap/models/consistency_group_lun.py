...
__all__ = ["ConsistencyGroupLun", "ConsistencyGroupLunSchema"]
__pdoc__ = {
    "ConsistencyGroupLunSchema.resource": False,
    "ConsistencyGroupLunSchema.opts": False,
    "ConsistencyGroupLun": False,
}


class ConsistencyGroupLunSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The clone field of the consistency_group_lun. """
...
Example: 2018-06-04T19:00:00Z """
    ...
    lun_maps = fields.List(fields.Nested("netapp_ontap.models.consistency_group_child_luns_lun_maps.ConsistencyGroupChildLunsLunMapsSchema", unknown=EXCLUDE), data_key="lun_maps")
...
* xen """
    ...
    r""" The space field of the consistency_group_lun. """
...
class ConsistencyGroupLun(Resource):

    _schema = ConsistencyGroupLunSchema
