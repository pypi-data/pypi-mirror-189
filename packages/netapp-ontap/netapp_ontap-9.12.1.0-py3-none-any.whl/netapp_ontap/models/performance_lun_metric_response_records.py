...
__all__ = ["PerformanceLunMetricResponseRecords", "PerformanceLunMetricResponseRecordsSchema"]
__pdoc__ = {
    "PerformanceLunMetricResponseRecordsSchema.resource": False,
    "PerformanceLunMetricResponseRecordsSchema.opts": False,
    "PerformanceLunMetricResponseRecords": False,
}


class PerformanceLunMetricResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the PerformanceLunMetricResponseRecords object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the performance_lun_metric_response_records. """
...
* PT5M """
    ...
    r""" The iops field of the performance_lun_metric_response_records. """
    ...
    r""" The latency field of the performance_lun_metric_response_records. """
...
* partial_no_uuid """
    ...
    r""" The throughput field of the performance_lun_metric_response_records. """
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return PerformanceLunMetricResponseRecords
...
class PerformanceLunMetricResponseRecords(Resource):

    _schema = PerformanceLunMetricResponseRecordsSchema
