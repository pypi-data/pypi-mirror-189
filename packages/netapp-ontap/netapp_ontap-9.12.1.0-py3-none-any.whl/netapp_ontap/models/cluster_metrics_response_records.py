...
__all__ = ["ClusterMetricsResponseRecords", "ClusterMetricsResponseRecordsSchema"]
__pdoc__ = {
    "ClusterMetricsResponseRecordsSchema.resource": False,
    "ClusterMetricsResponseRecordsSchema.opts": False,
    "ClusterMetricsResponseRecords": False,
}


class ClusterMetricsResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the ClusterMetricsResponseRecords object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the cluster_metrics_response_records. """
...
* PT5M """
    ...
    r""" The iops field of the cluster_metrics_response_records. """
    ...
    r""" The latency field of the cluster_metrics_response_records. """
...
* partial_no_uuid """
    ...
    r""" The throughput field of the cluster_metrics_response_records. """
...
Example: 2017-01-25T11:20:13Z """
    ...
    @property
    def resource(self):
        return ClusterMetricsResponseRecords
...
class ClusterMetricsResponseRecords(Resource):

    _schema = ClusterMetricsResponseRecordsSchema
