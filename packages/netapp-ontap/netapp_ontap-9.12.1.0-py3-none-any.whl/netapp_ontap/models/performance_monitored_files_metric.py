...
__all__ = ["PerformanceMonitoredFilesMetric", "PerformanceMonitoredFilesMetricSchema"]
__pdoc__ = {
    "PerformanceMonitoredFilesMetricSchema.resource": False,
    "PerformanceMonitoredFilesMetricSchema.opts": False,
    "PerformanceMonitoredFilesMetric": False,
}


class PerformanceMonitoredFilesMetricSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the PerformanceMonitoredFilesMetric object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the performance_monitored_files_metric. """
...
* PT5M """
    ...
    r""" The iops field of the performance_monitored_files_metric. """
    ...
    r""" The latency field of the performance_monitored_files_metric. """
...
* partial_no_uuid """
    ...
    r""" The throughput field of the performance_monitored_files_metric. """
...
Example: 2017-01-25T11:20:13Z """
    ...
    @property
    def resource(self):
        return PerformanceMonitoredFilesMetric
...
class PerformanceMonitoredFilesMetric(Resource):

    _schema = PerformanceMonitoredFilesMetricSchema
