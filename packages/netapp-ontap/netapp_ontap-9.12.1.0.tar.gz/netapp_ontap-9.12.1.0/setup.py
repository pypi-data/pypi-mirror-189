...
setuptools.setup(
    ...
    project_urls={
        "Documentation": "https://library.netapp.com/ecmdocs/ECMLP2884819/html/index.html",
    },
    ...
    install_requires=["marshmallow>=3.2.1", "requests>=2.26.0", "requests-toolbelt>=0.9.1", "urllib3>=1.26.7"],
