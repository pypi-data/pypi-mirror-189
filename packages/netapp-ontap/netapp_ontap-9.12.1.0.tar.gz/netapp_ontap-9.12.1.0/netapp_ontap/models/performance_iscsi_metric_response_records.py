...
__all__ = ["PerformanceIscsiMetricResponseRecords", "PerformanceIscsiMetricResponseRecordsSchema"]
__pdoc__ = {
    "PerformanceIscsiMetricResponseRecordsSchema.resource": False,
    "PerformanceIscsiMetricResponseRecordsSchema.opts": False,
    "PerformanceIscsiMetricResponseRecords": False,
}


class PerformanceIscsiMetricResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the PerformanceIscsiMetricResponseRecords object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the performance_iscsi_metric_response_records. """
...
* PT5M """
    ...
    r""" The iops field of the performance_iscsi_metric_response_records. """
    ...
    r""" The latency field of the performance_iscsi_metric_response_records. """
...
* partial_no_uuid """
    ...
    r""" The svm field of the performance_iscsi_metric_response_records. """
    ...
    r""" The throughput field of the performance_iscsi_metric_response_records. """
...
Example: 2017-01-25T11:20:13Z """
    ...
    @property
    def resource(self):
        return PerformanceIscsiMetricResponseRecords
...
class PerformanceIscsiMetricResponseRecords(Resource):

    _schema = PerformanceIscsiMetricResponseRecordsSchema
