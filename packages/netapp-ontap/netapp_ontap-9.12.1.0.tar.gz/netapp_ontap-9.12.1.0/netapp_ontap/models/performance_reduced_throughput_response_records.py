...
__all__ = ["PerformanceReducedThroughputResponseRecords", "PerformanceReducedThroughputResponseRecordsSchema"]
__pdoc__ = {
    "PerformanceReducedThroughputResponseRecordsSchema.resource": False,
    "PerformanceReducedThroughputResponseRecordsSchema.opts": False,
    "PerformanceReducedThroughputResponseRecords": False,
}


class PerformanceReducedThroughputResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the PerformanceReducedThroughputResponseRecords object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the performance_reduced_throughput_response_records. """
...
* PT5M """
    ...
    r""" The iops field of the performance_reduced_throughput_response_records. """
    ...
    r""" The latency field of the performance_reduced_throughput_response_records. """
...
* partial_no_uuid """
    ...
    r""" The throughput field of the performance_reduced_throughput_response_records. """
...
Example: 2017-01-25T11:20:13Z """
    ...
    @property
    def resource(self):
        return PerformanceReducedThroughputResponseRecords
...
class PerformanceReducedThroughputResponseRecords(Resource):

    _schema = PerformanceReducedThroughputResponseRecordsSchema
