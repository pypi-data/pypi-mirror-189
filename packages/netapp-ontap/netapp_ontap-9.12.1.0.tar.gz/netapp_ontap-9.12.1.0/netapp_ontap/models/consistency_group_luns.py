...
__all__ = ["ConsistencyGroupLuns", "ConsistencyGroupLunsSchema"]
__pdoc__ = {
    "ConsistencyGroupLunsSchema.resource": False,
    "ConsistencyGroupLunsSchema.opts": False,
    "ConsistencyGroupLuns": False,
}
...
class ConsistencyGroupLunsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The clone field of the consistency_group_luns. """
...
Example: 2018-06-04T19:00:00Z """
    ...
    lun_maps = fields.List(fields.Nested("netapp_ontap.models.consistency_group_consistency_groups_luns_lun_maps.ConsistencyGroupConsistencyGroupsLunsLunMapsSchema", unknown=EXCLUDE), data_key="lun_maps")
...
* xen """
    ...
    r""" The space field of the consistency_group_luns. """
...
class ConsistencyGroupLuns(Resource):
    ...
    _schema = ConsistencyGroupLunsSchema
