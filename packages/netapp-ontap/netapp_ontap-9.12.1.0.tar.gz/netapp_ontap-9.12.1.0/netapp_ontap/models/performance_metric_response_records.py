...
__all__ = ["PerformanceMetricResponseRecords", "PerformanceMetricResponseRecordsSchema"]
__pdoc__ = {
    "PerformanceMetricResponseRecordsSchema.resource": False,
    "PerformanceMetricResponseRecordsSchema.opts": False,
    "PerformanceMetricResponseRecords": False,
}


class PerformanceMetricResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the PerformanceMetricResponseRecords object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", unknown=EXCLUDE, data_key="_links")
    r""" The links field of the performance_metric_response_records. """
...
* PT5M """
    ...
    r""" The iops field of the performance_metric_response_records. """
    ...
    r""" The latency field of the performance_metric_response_records. """
...
* partial_no_uuid """
    ...
    r""" The throughput field of the performance_metric_response_records. """
...
Example: 2017-01-25T11:20:13Z """
    ...
    @property
    def resource(self):
        return PerformanceMetricResponseRecords
...
class PerformanceMetricResponseRecords(Resource):

    _schema = PerformanceMetricResponseRecordsSchema
