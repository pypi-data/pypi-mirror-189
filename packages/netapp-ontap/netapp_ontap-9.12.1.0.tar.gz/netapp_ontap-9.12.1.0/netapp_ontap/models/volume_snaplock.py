...
Example: P30M """
    ...
    compliance_clock_time = ImpreciseDateTime(data_key="compliance_clock_time")
...
Example: true """
    ...
    litigation_count = Size(data_key="litigation_count")
...
* non_snaplock """
    ...
    unspecified_retention_file_count = Size(data_key="unspecified_retention_file_count")
