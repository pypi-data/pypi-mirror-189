...
* PT5M """
    ...
    fc = fields.Nested("netapp_ontap.models.performance_nvme_metric_properties.PerformanceNvmeMetricPropertiesSchema", unknown=EXCLUDE, data_key="fc")
    r""" The fc field of the performance_nvme_metric_response_records. """
...
* partial_no_uuid """
    ...
    tcp = fields.Nested("netapp_ontap.models.performance_nvme_metric_properties.PerformanceNvmeMetricPropertiesSchema", unknown=EXCLUDE, data_key="tcp")
    r""" The tcp field of the performance_nvme_metric_response_records. """
