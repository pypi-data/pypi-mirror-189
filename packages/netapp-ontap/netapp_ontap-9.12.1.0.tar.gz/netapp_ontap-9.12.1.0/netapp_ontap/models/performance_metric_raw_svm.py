...
__pdoc__ = {
    ...
    "PerformanceMetricRawSvmSchema.opts": False,
    "PerformanceMetricRawSvm": False,
}


class PerformanceMetricRawSvmSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
class PerformanceMetricRawSvm(Resource):
