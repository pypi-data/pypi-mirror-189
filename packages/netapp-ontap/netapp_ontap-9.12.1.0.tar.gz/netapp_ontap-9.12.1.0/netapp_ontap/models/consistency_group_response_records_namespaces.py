...
__all__ = ["ConsistencyGroupResponseRecordsNamespaces", "ConsistencyGroupResponseRecordsNamespacesSchema"]
__pdoc__ = {
    "ConsistencyGroupResponseRecordsNamespacesSchema.resource": False,
    "ConsistencyGroupResponseRecordsNamespacesSchema.opts": False,
    "ConsistencyGroupResponseRecordsNamespaces": False,
}


class ConsistencyGroupResponseRecordsNamespacesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the ConsistencyGroupResponseRecordsNamespaces object"""
...
* windows """
    ...
    r""" The provisioning_options field of the consistency_group_response_records_namespaces. """
    ...
    r""" The space field of the consistency_group_response_records_namespaces. """
    ...
    r""" The status field of the consistency_group_response_records_namespaces. """
    ...
    r""" The subsystem_map field of the consistency_group_response_records_namespaces. """
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    @property
    def resource(self):
        return ConsistencyGroupResponseRecordsNamespaces
...
class ConsistencyGroupResponseRecordsNamespaces(Resource):

    _schema = ConsistencyGroupResponseRecordsNamespacesSchema
