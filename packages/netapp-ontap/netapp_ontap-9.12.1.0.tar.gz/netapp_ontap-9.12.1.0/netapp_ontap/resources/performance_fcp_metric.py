...
__all__ = ["PerformanceFcpMetric", "PerformanceFcpMetricSchema"]
__pdoc__ = {
    "PerformanceFcpMetricSchema.resource": False,
    "PerformanceFcpMetricSchema.opts": False,
    "PerformanceFcpMetric.performance_fcp_metric_show": False,
    "PerformanceFcpMetric.performance_fcp_metric_create": False,
    "PerformanceFcpMetric.performance_fcp_metric_modify": False,
    "PerformanceFcpMetric.performance_fcp_metric_delete": False,
}


class PerformanceFcpMetricSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the PerformanceFcpMetric object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", data_key="_links", unknown=EXCLUDE)
    r""" The links field of the performance_fcp_metric."""
...
* PT5M"""
    ...
    r""" The iops field of the performance_fcp_metric."""
    ...
    r""" The latency field of the performance_fcp_metric."""
...
* partial_no_uuid"""
    ...
    svm = fields.Nested("netapp_ontap.models.performance_fcp_metric_svm.PerformanceFcpMetricSvmSchema", data_key="svm", unknown=EXCLUDE)
    r""" The svm field of the performance_fcp_metric."""
    ...
    r""" The throughput field of the performance_fcp_metric."""
...
def _get_field_list(field: str) -> Callable[[], List]:
    def getter():
        return [getattr(r, field) for r in PerformanceFcpMetric.get_collection(fields=field)]
    return getter
...
async def _wait_for_job(response: NetAppResponse) -> None:
    ...
    while True:
        ...
        if job.state == "failure":
            raise NetAppRestError("PerformanceFcpMetric modify job failed")
        if job.state == "success":
            break
        await asyncio.sleep(1)

class PerformanceFcpMetric(Resource):
    r""" Performance numbers, such as IOPS latency and throughput, for SVM protocols. """

    _schema = PerformanceFcpMetricSchema
    _path = "/api/protocols/san/fcp/services/{svm[uuid]}/metrics"
    _keys = ["svm.uuid"]
    ...
    def get_collection(
        ...
        **kwargs
        ...
        r"""Retrieves historical performance metrics for the FC Protocol service of an SVM."""
        return super()._get_collection(*args, connection=connection, max_records=max_records, **kwargs)

    get_collection.__func__.__doc__ += "\n\n---\n" + inspect.cleandoc(Resource._get_collection.__doc__)

    if RECLINE_INSTALLED:
        @recline.command(name="performance fcp metric show")
        def performance_fcp_metric_show(
            svm_uuid,
            ...
            """Fetch a list of PerformanceFcpMetric resources
            ...
            return PerformanceFcpMetric.get_collection(
                svm_uuid,
                **kwargs
            )
    ...
    def count_collection(
        ...
        **kwargs
        ...
        """Returns a count of all PerformanceFcpMetric resources that match the provided query"""
