...
__all__ = ["PerformanceFcInterfaceMetric", "PerformanceFcInterfaceMetricSchema"]
__pdoc__ = {
    "PerformanceFcInterfaceMetricSchema.resource": False,
    "PerformanceFcInterfaceMetricSchema.opts": False,
    "PerformanceFcInterfaceMetric.performance_fc_interface_metric_show": False,
    "PerformanceFcInterfaceMetric.performance_fc_interface_metric_create": False,
    "PerformanceFcInterfaceMetric.performance_fc_interface_metric_modify": False,
    "PerformanceFcInterfaceMetric.performance_fc_interface_metric_delete": False,
}


class PerformanceFcInterfaceMetricSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    """The fields of the PerformanceFcInterfaceMetric object"""

    links = fields.Nested("netapp_ontap.models.self_link.SelfLinkSchema", data_key="_links", unknown=EXCLUDE)
    r""" The links field of the performance_fc_interface_metric."""
...
* PT5M"""
    ...
    r""" The iops field of the performance_fc_interface_metric."""
    ...
    r""" The latency field of the performance_fc_interface_metric."""
...
* partial_no_uuid"""
    ...
    r""" The throughput field of the performance_fc_interface_metric."""
...
Example: 2017-01-25T11:20:13Z"""
    ...
    @property
    def resource(self):
        return PerformanceFcInterfaceMetric
...
def _get_field_list(field: str) -> Callable[[], List]:
    def getter():
        return [getattr(r, field) for r in PerformanceFcInterfaceMetric.get_collection(fields=field)]
    return getter
...
async def _wait_for_job(response: NetAppResponse) -> None:
    ...
    while True:
        ...
        if job.state == "failure":
            raise NetAppRestError("PerformanceFcInterfaceMetric modify job failed")
        if job.state == "success":
            break
        await asyncio.sleep(1)

class PerformanceFcInterfaceMetric(Resource):
    r""" Performance numbers, such as IOPS latency and throughput """

    _schema = PerformanceFcInterfaceMetricSchema
    _path = "/api/network/fc/interfaces/{fc_interface[uuid]}/metrics"
    _keys = ["fc_interface.uuid"]
    ...
    def get_collection(
        ...
        **kwargs
        ...
        r"""Retrieves historical performance metrics for an FC interface."""
        return super()._get_collection(*args, connection=connection, max_records=max_records, **kwargs)

    get_collection.__func__.__doc__ += "\n\n---\n" + inspect.cleandoc(Resource._get_collection.__doc__)

    if RECLINE_INSTALLED:
        @recline.command(name="performance fc interface metric show")
        def performance_fc_interface_metric_show(
            uuid,
            ...
            """Fetch a list of PerformanceFcInterfaceMetric resources
            ...
            return PerformanceFcInterfaceMetric.get_collection(
                uuid,
                **kwargs
            )
    ...
    def count_collection(
        ...
        **kwargs
        ...
        """Returns a count of all PerformanceFcInterfaceMetric resources that match the provided query"""
