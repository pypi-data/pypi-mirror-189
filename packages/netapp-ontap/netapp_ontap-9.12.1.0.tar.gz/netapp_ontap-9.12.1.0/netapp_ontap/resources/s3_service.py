...
Example: Server-1"""
    ...
    """certificate.name,certificate.uuid,comment,default_unix_user,default_win_user,enabled,is_http_enabled,is_https_enabled,name,port,secure_port,"""
    ...
    """buckets,certificate.name,certificate.uuid,comment,default_unix_user,default_win_user,enabled,is_http_enabled,is_https_enabled,name,port,secure_port,svm.name,svm.uuid,users,"""
...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        def s3_service_show(
            fields: List[Choices.define(["comment", "default_unix_user", "default_win_user", "enabled", "is_http_enabled", "is_https_enabled", "name", "port", "secure_port", "*"])]=None,
        ) -> ResourceTable:
