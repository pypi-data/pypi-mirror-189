...
* mixed_fabric"""
    ...
    mccip_ports = fields.List(fields.Nested("netapp_ontap.models.mccip_port.MccipPortSchema", unknown=EXCLUDE), data_key="mccip_ports")
    ...
    """links,configuration_type,local,remote,"""
    ...
    """dr_pairs,local,mccip_ports,mediator,partner_cluster.links,partner_cluster.name,partner_cluster.uuid,remote,"""
...
* [`DOC /cluster/metrocluster`](#docs-cluster-cluster_metrocluster)"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="metrocluster show")
        def metrocluster_show(
            ...
            Args:
                configuration_type: Displays the MetroCluster configuration type.
            """

            kwargs = {}
            if configuration_type is not None:
                kwargs["configuration_type"] = configuration_type
...
"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="metrocluster create")
        async def metrocluster_create(
            ...
            Args:
                ...
                local: 
                mccip_ports: List of Port specifications.
                mediator: 
                partner_cluster: 
                remote: 
            """
            ...
            if local is not None:
                kwargs["local"] = local
            if mccip_ports is not None:
                kwargs["mccip_ports"] = mccip_ports
            ...
            try:
                ...
                raise ReclineCommandError("Unable to create Metrocluster: %s" % err)
            return [resource]
...
* [`DOC /cluster/metrocluster`](#docs-cluster-cluster_metrocluster)"""
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="metrocluster modify")
        async def metrocluster_modify(
            ...
            Args:
                configuration_type: Displays the MetroCluster configuration type.
                query_configuration_type: Displays the MetroCluster configuration type.
            """

            kwargs = {}
            changes = {}
            if query_configuration_type is not None:
                kwargs["configuration_type"] = query_configuration_type

            if configuration_type is not None:
                changes["configuration_type"] = configuration_type
            ...
            try:
                ...
                raise ReclineCommandError("Unable to modify Metrocluster: %s" % err)
