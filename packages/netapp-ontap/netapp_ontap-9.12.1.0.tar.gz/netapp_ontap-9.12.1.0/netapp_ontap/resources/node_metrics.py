...
class NodeMetricsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
...
class NodeMetrics(Resource):
    ...
    if RECLINE_INSTALLED:
        @recline.command(name="node metrics show")
    ...
    def count_collection(
        ...
        **kwargs
        ...
        """Returns a count of all NodeMetrics resources that match the provided query"""
