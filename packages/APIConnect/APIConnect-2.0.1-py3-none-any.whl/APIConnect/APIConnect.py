...
class APIConnect:
    ...
    def __init__(self, ApiKey, Password, reqID, downloadContract: bool, conf = None) -> None:
        ...
        AppIdKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHAiOjAsImZmIjoiVyIsImJkIjoid2ViLXBjIiwibmJmIjoxNjcwOTEwNjA5LCJzcmMiOiJlbXRtdyIsImF2IjoiMi4wLjAiLCJhcHBpZCI6ImI1YzEzNDJhNzBiNzgwNGRlZGEzNDg0OGM3ZDM5Yjc2IiwiaXNzIjoiZW10IiwiZXhwIjoxNjcwOTU2MjAwLCJpYXQiOjE2NzA5MTA5MDl9.19ysMc8CC-xHKJm4i4BWlyQUH4o2QsUFQSJ0EBeYUEI"
