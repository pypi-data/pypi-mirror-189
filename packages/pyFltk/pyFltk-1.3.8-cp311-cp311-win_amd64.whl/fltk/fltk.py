...
def fl_contrast(*args):
    r"""fl_contrast(Fl_Color fg, Fl_Color bg) -> Fl_Color"""
...
class Fl_Widget(object):
    ...
    def default_callback(*args):
        r"""default_callback(Fl_Widget cb, void * d)"""
...
class Fl_Group(Fl_Widget):
    ...
    def as_group(self, *args):
        r"""as_group(Fl_Group self) -> Fl_Group"""
        return _fltk.Fl_Group_as_group(self, *args)

    def focus(self, *args):
        r"""focus(Fl_Group self, Fl_Widget W)"""
...
class Fl_File_Chooser(object):
    ...
    def __init__(self, *args):
        r"""__init__(Fl_File_Chooser self, char const * d, char const * p, int t, char const * title) -> Fl_File_Chooser"""
...
class Fl(object):
    ...
    def add_awake_handler_(*args):
        r"""add_awake_handler_(Fl_Awake_Handler arg1, void * arg2) -> int"""
    ...
    @staticmethod
    def abi_check(*args):
        r"""abi_check(int const val=(1*10000+3*100)) -> int"""
    ...
    def has_timeout(*args):
        r"""has_timeout(Fl_Timeout_Handler arg1, void * arg2=None) -> int"""
        return _fltk.Fl_has_timeout(*args)

    @staticmethod
    def add_idle(*args):
        r"""add_idle(Fl_Idle_Handler cb, void * data=None)"""
    ...
    @staticmethod
    def get_key(*args):
        r"""get_key(int key) -> int"""
        return _fltk.Fl_get_key(*args)

    @staticmethod
    def event_text(*args):
        r"""event_text() -> char const *"""
    ...
    @staticmethod
    def event_clipboard(*args):
        r"""event_clipboard() -> void *"""
        return _fltk.Fl_event_clipboard(*args)

    @staticmethod
    def event_clipboard_type(*args):
        r"""event_clipboard_type() -> char const *"""
        return _fltk.Fl_event_clipboard_type(*args)

    @staticmethod
    def compose(*args):
        r"""compose(int & _del) -> int"""
    ...
    @staticmethod
    def test_shortcut(*args):
        r"""test_shortcut(Fl_Shortcut arg1) -> int"""
    ...
    @staticmethod
    def handle(*args):
        r"""handle(int arg1, Fl_Window arg2) -> int"""
        return _fltk.Fl_handle(*args)

    @staticmethod
    def handle_(*args):
        r"""handle_(int arg1, Fl_Window arg2) -> int"""
    ...
    @staticmethod
    def add_system_handler(*args):
        r"""add_system_handler(Fl_System_Handler h, void * data)"""
        return _fltk.Fl_add_system_handler(*args)

    @staticmethod
    def remove_system_handler(*args):
        r"""remove_system_handler(Fl_System_Handler h)"""
        return _fltk.Fl_remove_system_handler(*args)

    @staticmethod
    def event_dispatch(*args):
        r"""
    ...
    @staticmethod
    def set_idle(*args):
        r"""set_idle(Fl_Old_Idle_Handler cb)"""
    ...
    def fltk_exit(*args):
        r"""fltk_exit()"""
        return _fltk.Fl_fltk_exit(*args)
    __swig_destroy__ = _fltk.delete_Fl

# Register Fl in _fltk:
_fltk.Fl_swigregister(Fl)
class Fl_Widget_Tracker(object):
    r"""Proxy of C++ Fl_Widget_Tracker class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(Fl_Widget_Tracker self, Fl_Widget wi) -> Fl_Widget_Tracker"""
        _fltk.Fl_Widget_Tracker_swiginit(self, _fltk.new_Fl_Widget_Tracker(*args))
    __swig_destroy__ = _fltk.delete_Fl_Widget_Tracker

    def widget(self, *args):
        r"""widget(Fl_Widget_Tracker self) -> Fl_Widget"""
        return _fltk.Fl_Widget_Tracker_widget(self, *args)

    def deleted(self, *args):
        r"""deleted(Fl_Widget_Tracker self) -> int"""
        return _fltk.Fl_Widget_Tracker_deleted(self, *args)

    def exists(self, *args):
        r"""exists(Fl_Widget_Tracker self) -> int"""
        return _fltk.Fl_Widget_Tracker_exists(self, *args)

# Register Fl_Widget_Tracker in _fltk:
_fltk.Fl_Widget_Tracker_swigregister(Fl_Widget_Tracker)
...
class dirent(object):
    r"""Proxy of C++ dirent class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(dirent self) -> dirent"""
        _fltk.dirent_swiginit(self, _fltk.new_dirent(*args))
    __swig_destroy__ = _fltk.delete_dirent

# Register dirent in _fltk:
_fltk.dirent_swigregister(dirent)
...
def fl_mt_ask(*args):
    r"""fl_mt_ask(char const * text) -> int"""
...
class Fl_Bitmap(Fl_Image):
    ...
    def __init__(self, *args):
        r"""__init__(Fl_Bitmap self, uchar const * bits, int W, int H) -> Fl_Bitmap"""
...
class Fl_BMP_Image(Fl_RGB_Image):
    ...
    def __init__(self, *args):
        r"""__init__(Fl_BMP_Image self, char const * filename) -> Fl_BMP_Image"""
...
def fl_old_shortcut(*args):
    r"""fl_old_shortcut(char const * arg1) -> Fl_Shortcut"""
...
class Fl_Check_Browser(Fl_Browser_):
    ...
    def item_next(self, *args):
        r"""item_next(Fl_Check_Browser self, void * item) -> void *"""
        return _fltk.Fl_Check_Browser_item_next(self, *args)

    def item_prev(self, *args):
        r"""item_prev(Fl_Check_Browser self, void * item) -> void *"""
    ...
    def item_height(self, *args):
        r"""item_height(Fl_Check_Browser self, void * item) -> int"""
        return _fltk.Fl_Check_Browser_item_height(self, *args)

    def item_width(self, *args):
        r"""item_width(Fl_Check_Browser self, void * item) -> int"""
    ...
    def item_draw(self, *args):
        r"""item_draw(Fl_Check_Browser self, void * item, int X, int Y, int W, int H)"""
    ...
    def item_swap(self, *args):
        r"""item_swap(Fl_Check_Browser self, void * a, void * b)"""
    ...
    def item_select(self, *args):
        r"""item_select(Fl_Check_Browser self, void * item, int val=1)"""
        return _fltk.Fl_Check_Browser_item_select(self, *args)

    def item_selected(self, *args):
        r"""item_selected(Fl_Check_Browser self, void * item) -> int"""
...
class Fl_Window(Fl_Group):
    ...
    def default_icons(*args):
        ...
        default_icons(HICON big_icon, HICON small_icon)
        """
    ...
    def icons(self, *args):
        ...
        icons(Fl_Window self, HICON big_icon, HICON small_icon)
        """
    ...
    def as_window(self, *args):
        r"""as_window(Fl_Window self) -> Fl_Window"""
...
def fl_draw_pixmap(*args):
    r"""fl_draw_pixmap(char *const * data, int x, int y, Fl_Color arg4=) -> int"""
...
class Fl_Input_(Fl_Widget):
    ...
    def index(self, *args):
        r"""index(Fl_Input_ self, int i) -> Fl_Char"""
...
class Fl_Fill_Dial(Fl_Dial):
    ...
    def __init__(self, *args):
        r"""__init__(Fl_Fill_Dial self, int X, int Y, int W, int H, char const * L) -> Fl_Fill_Dial"""
...
class Fl_FormsBitmap(Fl_Widget):
    r"""Proxy of C++ Fl_FormsBitmap class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def draw(self, *args):
        r"""draw(Fl_FormsBitmap self)"""
        return _fltk.Fl_FormsBitmap_draw(self, *args)

    def __init__(self, *args):
        r"""__init__(Fl_FormsBitmap self, Fl_Boxtype arg2, int arg3, int arg4, int arg5, int arg6, char const * arg7=None) -> Fl_FormsBitmap"""
        if self.__class__ == Fl_FormsBitmap:
            _self = None
        else:
            _self = self
        _fltk.Fl_FormsBitmap_swiginit(self, _fltk.new_Fl_FormsBitmap(_self, *args))
    ...
    def set(self, *args):
        r"""set(Fl_FormsBitmap self, int W, int H, uchar const * bits)"""
...
# Register Fl_FormsBitmap in _fltk:
_fltk.Fl_FormsBitmap_swigregister(Fl_FormsBitmap)
class Fl_FormsPixmap(Fl_Widget):
    r"""Proxy of C++ Fl_FormsPixmap class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def draw(self, *args):
        r"""draw(Fl_FormsPixmap self)"""
        return _fltk.Fl_FormsPixmap_draw(self, *args)

    def __init__(self, *args):
        r"""__init__(Fl_FormsPixmap self, Fl_Boxtype t, int X, int Y, int W, int H, char const * L=None) -> Fl_FormsPixmap"""
        if self.__class__ == Fl_FormsPixmap:
            _self = None
        else:
            _self = self
        _fltk.Fl_FormsPixmap_swiginit(self, _fltk.new_Fl_FormsPixmap(_self, *args))
    ...
    def set(self, *args):
        r"""set(Fl_FormsPixmap self, char *const * bits)"""
...
# Register Fl_FormsPixmap in _fltk:
...
class Fl_Free(Fl_Widget):
    ...
    def handle(self, *args):
        r"""handle(Fl_Free self, int e) -> int"""
        return _fltk.Fl_Free_handle(self, *args)

    def __init__(self, *args):
        r"""__init__(Fl_Free self, uchar t, int X, int Y, int W, int H, char const * L, FL_HANDLEPTR hdl) -> Fl_Free"""
        if self.__class__ == Fl_Free:
            _self = None
        else:
            _self = self
        _fltk.Fl_Free_swiginit(self, _fltk.new_Fl_Free(_self, *args))
...
class Fl_GIF_Image(Fl_Pixmap):
    ...
    def __init__(self, *args):
        r"""__init__(Fl_GIF_Image self, char const * filename) -> Fl_GIF_Image"""
...
class Fl_Gl_Window(Fl_Window):
    ...
    def as_gl_window(self, *args):
        r"""as_gl_window(Fl_Gl_Window self) -> Fl_Gl_Window"""
...
class Fl_Help_Dialog(object):
    ...
    def load(self, *args):
        r"""load(Fl_Help_Dialog self, char const * f)"""
...
class Fl_Help_Block(object):
    r"""Proxy of C++ Fl_Help_Block class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(Fl_Help_Block self) -> Fl_Help_Block"""
        _fltk.Fl_Help_Block_swiginit(self, _fltk.new_Fl_Help_Block(*args))
    __swig_destroy__ = _fltk.delete_Fl_Help_Block

# Register Fl_Help_Block in _fltk:
_fltk.Fl_Help_Block_swigregister(Fl_Help_Block)
class Fl_Help_Link(object):
    r"""Proxy of C++ Fl_Help_Link class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(Fl_Help_Link self) -> Fl_Help_Link"""
        _fltk.Fl_Help_Link_swiginit(self, _fltk.new_Fl_Help_Link(*args))
    __swig_destroy__ = _fltk.delete_Fl_Help_Link

# Register Fl_Help_Link in _fltk:
_fltk.Fl_Help_Link_swigregister(Fl_Help_Link)
class Fl_Help_Font_Style(object):
    r"""Proxy of C++ Fl_Help_Font_Style class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def get(self, *args):
        r"""get(Fl_Help_Font_Style self, Fl_Color & acolor)"""
        return _fltk.Fl_Help_Font_Style_get(self, *args)

    def set(self, *args):
        r"""set(Fl_Help_Font_Style self, Fl_Font afont, Fl_Fontsize asize, Fl_Color acolor)"""
    ...
    def __init__(self, *args):
        ...
        """
        _fltk.Fl_Help_Font_Style_swiginit(self, _fltk.new_Fl_Help_Font_Style(*args))
    __swig_destroy__ = _fltk.delete_Fl_Help_Font_Style

# Register Fl_Help_Font_Style in _fltk:
_fltk.Fl_Help_Font_Style_swigregister(Fl_Help_Font_Style)
class Fl_Help_Font_Stack(object):
    r"""Proxy of C++ Fl_Help_Font_Stack class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(Fl_Help_Font_Stack self) -> Fl_Help_Font_Stack"""
        _fltk.Fl_Help_Font_Stack_swiginit(self, _fltk.new_Fl_Help_Font_Stack(*args))

    def init(self, *args):
        r"""init(Fl_Help_Font_Stack self, Fl_Font f, Fl_Fontsize s, Fl_Color c)"""
        return _fltk.Fl_Help_Font_Stack_init(self, *args)

    def top(self, *args):
        r"""top(Fl_Help_Font_Stack self, Fl_Color & c)"""
        return _fltk.Fl_Help_Font_Stack_top(self, *args)

    def push(self, *args):
        r"""push(Fl_Help_Font_Stack self, Fl_Font f, Fl_Fontsize s, Fl_Color c)"""
        return _fltk.Fl_Help_Font_Stack_push(self, *args)

    def pop(self, *args):
        r"""pop(Fl_Help_Font_Stack self, Fl_Color & c)"""
        return _fltk.Fl_Help_Font_Stack_pop(self, *args)

    def count(self, *args):
        r"""count(Fl_Help_Font_Stack self) -> size_t"""
        return _fltk.Fl_Help_Font_Stack_count(self, *args)
    __swig_destroy__ = _fltk.delete_Fl_Help_Font_Stack

# Register Fl_Help_Font_Stack in _fltk:
_fltk.Fl_Help_Font_Stack_swigregister(Fl_Help_Font_Stack)
class Fl_Help_Target(object):
    r"""Proxy of C++ Fl_Help_Target class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(Fl_Help_Target self) -> Fl_Help_Target"""
        _fltk.Fl_Help_Target_swiginit(self, _fltk.new_Fl_Help_Target(*args))
    __swig_destroy__ = _fltk.delete_Fl_Help_Target

# Register Fl_Help_Target in _fltk:
...
class Fl_Shared_Image(Fl_Image):
    ...
    def scale(self, *args):
        r"""scale(Fl_Shared_Image self, int width, int height, int proportional=1, int can_expand=0)"""
    ...
    def scaling_algorithm(*args):
        r"""scaling_algorithm(Fl_RGB_Scaling algorithm)"""
...
class Fl_Spinner(Fl_Group):
    ...
    def maxinum(self, *args):
        r"""maxinum(Fl_Spinner self) -> double"""
        return _fltk.Fl_Spinner_maxinum(self, *args)

    def mininum(self, *args):
        r"""mininum(Fl_Spinner self) -> double"""
...
class Fl_Tabs(Fl_Group):
    ...
    def __init__(self, *args):
        r"""__init__(Fl_Tabs self, int arg2, int arg3, int arg4, int arg5, char const * arg6=None) -> Fl_Tabs"""
...
class Fl_Text_Selection(object):
    ...
    def set(self, *args):
        r"""set(Fl_Text_Selection self, int start, int end)"""
    ...
    def position(self, *args):
        r"""position(Fl_Text_Selection self, int * start, int * end) -> int"""
...
class Fl_Text_Buffer(object):
    ...
    def insert(self, *args):
        r"""insert(Fl_Text_Buffer self, int pos, char const * text)"""
        return _fltk.Fl_Text_Buffer_insert(self, *args)

    def append(self, *args):
        r"""append(Fl_Text_Buffer self, char const * t)"""
    ...
    def replace(self, *args):
        r"""replace(Fl_Text_Buffer self, int start, int end, char const * text)"""
...
class Fl_Text_Display(Fl_Group):
    ...
    def cursor_style(self, *args):
        r"""cursor_style(Fl_Text_Display self, int style)"""
...
class Fl_Text_Editor(Fl_Text_Display):
    ...
    def bound_key_function(self, *args):
        r"""bound_key_function(Fl_Text_Editor self, int key, int state) -> Fl_Text_Editor::Key_Func"""
...
class Fl_Tile(Fl_Group):
    ...
    def position(self, *args):
        r"""position(Fl_Tile self, int oldx, int oldy, int newx, int newy)"""
...
class Fl_Timer(Fl_Widget):
    ...
    def draw(self, *args):
        r"""draw(Fl_Timer self)"""
        return _fltk.Fl_Timer_draw(self, *args)

    def handle(self, *args):
        r"""handle(Fl_Timer self, int arg0) -> int"""
        return _fltk.Fl_Timer_handle(self, *args)

    def __init__(self, *args):
        r"""__init__(Fl_Timer self, uchar t, int x, int y, int w, int h, char const * l) -> Fl_Timer"""
        if self.__class__ == Fl_Timer:
            _self = None
        else:
            _self = self
        _fltk.Fl_Timer_swiginit(self, _fltk.new_Fl_Timer(_self, *args))
...
VK_LWIN = _fltk.VK_LWIN

VK_RWIN = _fltk.VK_RWIN

VK_APPS = _fltk.VK_APPS

class XRectangle(object):
    r"""Proxy of C++ XRectangle class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(XRectangle self) -> XRectangle"""
        _fltk.XRectangle_swiginit(self, _fltk.new_XRectangle(*args))
    __swig_destroy__ = _fltk.delete_XRectangle

# Register XRectangle in _fltk:
_fltk.XRectangle_swigregister(XRectangle)

def XRectangleRegion(*args):
    r"""XRectangleRegion(int x, int y, int w, int h) -> Fl_Region"""
    return _fltk.XRectangleRegion(*args)

def XDestroyRegion(*args):
    r"""XDestroyRegion(Fl_Region r)"""
    return _fltk.XDestroyRegion(*args)

def XClipBox(*args):
    r"""XClipBox(Fl_Region r, XRectangle rect)"""
    return _fltk.XClipBox(*args)
class Fl_X(object):
    ...
    @staticmethod
    def i(*args):
        r"""i(Fl_Window w) -> Fl_X"""
        return _fltk.Fl_X_i(*args)

    @staticmethod
    def fake_X_wm(*args):
        r"""fake_X_wm(Fl_Window w) -> int"""
        return _fltk.Fl_X_fake_X_wm(*args)

    def make_fullscreen(self, *args):
        r"""make_fullscreen(Fl_X self, int X, int Y, int W, int H)"""
        return _fltk.Fl_X_make_fullscreen(self, *args)

    def setwindow(self, *args):
        r"""setwindow(Fl_X self, Fl_Window wi)"""
        return _fltk.Fl_X_setwindow(self, *args)

    def flush(self, *args):
        r"""flush(Fl_X self)"""
        return _fltk.Fl_X_flush(self, *args)

    def set_minmax(self, *args):
        r"""set_minmax(Fl_X self, MINMAXINFO * minmax)"""
        return _fltk.Fl_X_set_minmax(self, *args)

    @staticmethod
    def set_default_icons(*args):
        r"""
        set_default_icons(Fl_RGB_Image const *[] arg1, int arg2)
        set_default_icons(HICON arg1, HICON arg2)
        """
        return _fltk.Fl_X_set_default_icons(*args)

    def set_icons(self, *args):
        r"""set_icons(Fl_X self)"""
        return _fltk.Fl_X_set_icons(self, *args)
    ...
    def set_cursor(self, *args):
        ...
        """
        return _fltk.Fl_X_set_cursor(self, *args)

    @staticmethod
    def make(*args):
        r"""make(Fl_Window arg1) -> Fl_X"""
        return _fltk.Fl_X_make(*args)
...
def fl_release_dc(*args):
    r"""fl_release_dc(HWND w, HDC dc)"""
    return _fltk.fl_release_dc(*args)

def fl_save_dc(*args):
    r"""fl_save_dc(HWND w, HDC dc)"""
    return _fltk.fl_save_dc(*args)
...
class Fl_XMap(object):
    r"""Proxy of C++ Fl_XMap class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(Fl_XMap self) -> Fl_XMap"""
        _fltk.Fl_XMap_swiginit(self, _fltk.new_Fl_XMap(*args))
    __swig_destroy__ = _fltk.delete_Fl_XMap

# Register Fl_XMap in _fltk:
_fltk.Fl_XMap_swigregister(Fl_XMap)

def fl_RGB(*args):
    r"""fl_RGB() -> COLORREF"""
    return _fltk.fl_RGB(*args)

def fl_pen(*args):
    r"""fl_pen() -> HPEN"""
    return _fltk.fl_pen(*args)

def fl_brush(*args):
    r"""fl_brush() -> HBRUSH"""
    return _fltk.fl_brush(*args)

def fl_brush_action(*args):
    r"""fl_brush_action(int arg1) -> HBRUSH"""
    return _fltk.fl_brush_action(*args)

def fl_GetDC(*args):
    r"""fl_GetDC(Window arg1) -> HDC"""
    return _fltk.fl_GetDC(*args)

def fl_makeDC(*args):
    r"""fl_makeDC(HBITMAP arg1) -> HDC"""
    return _fltk.fl_makeDC(*args)

def fl_copy_offscreen(*args):
    r"""fl_copy_offscreen(int x, int y, int w, int h, HBITMAP pixmap, int srcx, int srcy)"""
    return _fltk.fl_copy_offscreen(*args)

def fl_create_bitmask(*args):
    r"""fl_create_bitmask(int w, int h, uchar const * data) -> Fl_Bitmask"""
    return _fltk.fl_create_bitmask(*args)

def fl_create_alphamask(*args):
    r"""fl_create_alphamask(int w, int h, int d, int ld, uchar const * data) -> Fl_Bitmask"""
    return _fltk.fl_create_alphamask(*args)

def fl_delete_bitmask(*args):
    r"""fl_delete_bitmask(Fl_Bitmask bm)"""
    return _fltk.fl_delete_bitmask(*args)
...
class Fl_Tree_Item(object):
    ...
    def __init__(self, *args):
        ...
        """
        _fltk.Fl_Tree_Item_swiginit(self, _fltk.new_Fl_Tree_Item(*args))
    ...
    def draw(self, *args):
        r"""draw(Fl_Tree_Item self, int X, int W, Fl_Widget tree, Fl_Tree_Item itemfocus, Fl_Tree_Prefs prefs, int lastchild=1)"""
...
class Fl_Tree(Fl_Group):
    ...
    def next_item(self, *args):
        r"""next_item(Fl_Tree self, Fl_Tree_Item item, int dir=0xff54, bool visible=False) -> Fl_Tree_Item"""
...
class Fl_Paged_Device(object):
    ...
    def class_name(self, *args):
        r"""class_name(Fl_Paged_Device self) -> char const *"""
        return _fltk.Fl_Paged_Device_class_name(self, *args)

    def start_job(self, *args):
        r"""start_job(Fl_Paged_Device self, int pagecount, int * frompage=None, int * topage=None) -> int"""
    ...
    def printable_rect(self, *args):
        r"""printable_rect(Fl_Paged_Device self, int * w, int * h) -> int"""
    ...
    def translate(self, *args):
        r"""translate(Fl_Paged_Device self, int x, int y)"""
        return _fltk.Fl_Paged_Device_translate(self, *args)

    def untranslate(self, *args):
        r"""untranslate(Fl_Paged_Device self)"""
    ...
    def print_window(self, *args):
        r"""print_window(Fl_Paged_Device self, Fl_Window win, int x_offset=0, int y_offset=0)"""
        return _fltk.Fl_Paged_Device_print_window(self, *args)

    def print_window_part(self, *args):
        r"""print_window_part(Fl_Paged_Device self, Fl_Window win, int x, int y, int w, int h, int delta_x=0, int delta_y=0)"""
...
class Fl_Printer(Fl_Paged_Device):
    ...
    def class_name(self, *args):
        r"""class_name(Fl_Printer self) -> char const *"""
    ...
    def start_job(self, *args):
        r"""start_job(Fl_Printer self, int pagecount, int * frompage=None, int * topage=None) -> int"""
        return _fltk.Fl_Printer_start_job(self, *args)

    def start_page(self, *args):
        r"""start_page(Fl_Printer self) -> int"""
        return _fltk.Fl_Printer_start_page(self, *args)

    def printable_rect(self, *args):
        r"""printable_rect(Fl_Printer self, int * w, int * h) -> int"""
        return _fltk.Fl_Printer_printable_rect(self, *args)

    def margins(self, *args):
        r"""margins(Fl_Printer self, int * left, int * top, int * right, int * bottom)"""
    ...
    def print_widget(self, *args):
        r"""print_widget(Fl_Printer self, Fl_Widget widget, int delta_x=0, int delta_y=0)"""
        return _fltk.Fl_Printer_print_widget(self, *args)

    def print_window_part(self, *args):
        r"""print_window_part(Fl_Printer self, Fl_Window win, int x, int y, int w, int h, int delta_x=0, int delta_y=0)"""
    ...
    def driver(self, *args):
        r"""driver(Fl_Printer self) -> Fl_Graphics_Driver *"""
...
def rint(*args):
    r"""rint(double v) -> double"""
    return _fltk.rint(*args)

def copysign(*args):
    r"""copysign(double a, double b) -> double"""
    return _fltk.copysign(*args)
