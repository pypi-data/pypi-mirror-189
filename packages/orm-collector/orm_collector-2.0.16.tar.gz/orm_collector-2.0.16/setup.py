...
package_data = \
{'': ['*'],
 'orm_collector': ['sql/CREAR_DB.sql',
                   'sql/CREAR_DB.sql',
                   'sql/CREAR_DB.sql',
                   'sql/CREAR_DB.sql',
                   'sql/CREAR_DB.sql',
