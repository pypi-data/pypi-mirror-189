    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_symphonia_opensource_cloudformationartifactsbucket_module",
        "cdk_cloudformation_symphonia_opensource_cloudformationartifactsbucket_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_symphonia_opensource_cloudformationartifactsbucket_module._jsii": [
            "symphonia-opensource-cloudformationartifactsbucket-module@1.0.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_symphonia_opensource_cloudformationartifactsbucket_module": [
            "py.typed"
        ]
