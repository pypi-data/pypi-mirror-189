...
from collibra_core import (ApiClient, ApplicationApi, AssetsApi, CommunitiesApi, Configuration, OutputModuleApi)
...
class CollibraClient:
    def __init__(self, runner):
        ...
        try:
            ...
            logger.error("invalid viewConfig configuration")
            raise (e)
