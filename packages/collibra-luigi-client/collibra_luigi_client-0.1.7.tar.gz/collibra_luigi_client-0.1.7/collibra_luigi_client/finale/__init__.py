...
from collibra_luigi_client.service import CollibraClient
...
class Finale(luigi.Task):    
    ...
    def __write_entries_cluster(self, infile, entriesCluster, entries, parts):
        ...
        logger.info(f"preparing file {infile.name} cluster {entriesCluster:02d} with {numberOfEntriesPerFile:02d} entries per file and {numberOfFiles:02d} files")
