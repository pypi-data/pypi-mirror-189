...
from lakefs_client import rest
from lakefs_client.configuration import Configuration
from lakefs_client.exceptions import ApiTypeError, ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'lakefs-python-sdk/0.89.1'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_run  # this is an instance of the class Endpoint
        api_instance.get_run()  # this invokes api_instance.get_run.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_run.callable or self.callable in this class
