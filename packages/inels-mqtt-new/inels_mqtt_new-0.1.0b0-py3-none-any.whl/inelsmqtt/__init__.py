...
class InelsMqtt:
    ...
    def __init__(
        ...
        self.__entity_keys = dict[str, (str, int)]()
    ...
    def subscribe_listener(self, topic: str, unique_id: str, fnc: Callable[[Any], Any], entity_key: tuple(str, int)) -> None:
        ...
        self.__entity_keys[unique_id] = entity_key
        ...
        if len(self.__listeners) > 0 and msg.topic in self.__listeners:
            ...
            if len(self.__listeners[msg.topic]) > 0:
                ...
                for unique_id in list(self.__listeners[msg.topic]): #prevents the dictionary increased in size during iteration exception
                    key, index = self.__entity_keys[unique_id]
                    self.__listeners[msg.topic][unique_id](msg.payload.__dict__[key][index])
