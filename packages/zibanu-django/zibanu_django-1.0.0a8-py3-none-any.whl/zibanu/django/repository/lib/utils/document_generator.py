...
class DocumentGenerator:
    def __init__(self, template_prefix: str, custom_dir: str = None):
    ...
    def generate_from_template(self, template_name: str, context: dict, request: HttpRequest, key: str = "code"):
        """
        ...
        try:
            ...
            if not pisa_status.err:
                document = Document(code=validation_code, uuid=file_uuid, owner=request.user)
                document.save()
                file_handler.close()
            else:
                file_handler.close()
