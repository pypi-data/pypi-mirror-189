...
class HltTap(BaseModel):
    ...
    date_tap = models.DateTimeField(db_column="DateTAP", default=0)
    ...
    date_close = models.DateTimeField(db_column="DateClose", default=0)
    ...
    care_begin = models.DateTimeField(db_column="CareBegin", default=0)
    care_end = models.DateTimeField(db_column="CareEnd", default=0)
    ...
    mkp_card = models.UUIDField(db_column="rf_mkp_CardGUID", default=0)
    date_create_tap = models.DateTimeField(db_column="DateCreateTAP", default=0)
