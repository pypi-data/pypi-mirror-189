"""
Setup script for mypy-boto3-connect.
"""
...
setup(
    ...
    description=(
        "Type annotations for boto3.Connect 1.26.63 service generated with mypy-boto3-builder"
        " 7.12.3"
    ),
    classifiers=[
    ...
    package_data={"mypy_boto3_connect": ["py.typed", "*.pyi"]},
    python_requires=">=3.7",
    project_urls={
