...
['neptune',
 ...
 'neptune.new.attributes.atoms',
 'neptune.new.attributes.series',
 'neptune.new.attributes.sets',
 'neptune.new.cli',
 'neptune.new.integrations',
 'neptune.new.integrations.aws',
 'neptune.new.integrations.detectron2',
 'neptune.new.integrations.fastai',
 'neptune.new.integrations.kedro',
 'neptune.new.integrations.lightgbm',
 'neptune.new.integrations.optuna',
 'neptune.new.integrations.prophet',
 'neptune.new.integrations.pytorch_lightning',
 'neptune.new.integrations.sacred',
 'neptune.new.integrations.sklearn',
 'neptune.new.integrations.tensorflow_keras',
 'neptune.new.integrations.transformers',
 'neptune.new.integrations.xgboost',
 'neptune.new.internal',
 'neptune.new.internal.artifacts',
 'neptune.new.internal.artifacts.drivers',
 'neptune.new.internal.backends',
 'neptune.new.internal.hardware',
 'neptune.new.internal.hardware.gpu',
 'neptune.new.internal.init',
 'neptune.new.internal.notebooks',
 'neptune.new.internal.operation_processors',
 'neptune.new.internal.streams',
 'neptune.new.internal.threading',
 'neptune.new.internal.types',
 'neptune.new.internal.utils',
 'neptune.new.internal.websockets',
 'neptune.new.logging',
 'neptune.new.metadata_containers',
 'neptune.new.sync',
 'neptune.new.types',
 'neptune.new.types.atoms',
 'neptune.new.types.series',
 'neptune.new.types.sets',
 'neptune.vendor']
...
entry_points = \
{'console_scripts': ['neptune = neptune.new.cli.__main__:main']}
