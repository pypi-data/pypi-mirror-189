...
class AdsApi:
    ...
    def request(self, endpoint: str, params: dict | None = None, data: dict | None = None, attempts: int = 5, method:str = 'GET'):
        ...
        for attempt in range(attempts):
            try:
                ...
                response = methods[method](
                    self.base_url_ads + endpoint, params=params, data=data).json()
                self.lock.release()
            except:
    ...
    def delete_account(self, user_ids:list[int]) -> dict:
        resp = self.request('/api/v1/user/delete',
                            data={'user_ids': user_ids}, method='POST')
        return resp
