    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_logzio_autodeploymentlogzio_cloudwatch_module",
        "cdk_cloudformation_logzio_autodeploymentlogzio_cloudwatch_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_logzio_autodeploymentlogzio_cloudwatch_module._jsii": [
            "logzio-autodeploymentlogzio-cloudwatch-module@2.2.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_logzio_autodeploymentlogzio_cloudwatch_module": [
            "py.typed"
        ]
