...
class AutoFontSizeBehavior:
    ...
    min(:data:`~ae.gui_app.MAX_FONT_SIZE`, :attr:`~ae.kivy_app.FrameworkApp.max_font_size`).
    """
    ...
    max(:data:`~ae.gui_app.MIN_FONT_SIZE`, :attr:`~ae.kivy_app.FrameworkApp.min_font_size`).
    """
