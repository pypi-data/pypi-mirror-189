...
```python
# Example automatically generated from non-compiling source. May contain errors.
params = ClusterParameterGroup(stack, "Params",
    description="desc",
    parameters={
        "require_ssl": "true"
    }
...
class Column:
    def __init__(
        ...
        *,
        ...
        :param name: (experimental) The unique name/identifier of the column. **NOTE**. After deploying this column, you cannot change its name. Doing so will cause the column to be dropped and recreated.
    ...
    def name(self) -> builtins.str:
        '''(experimental) The unique name/identifier of the column.
