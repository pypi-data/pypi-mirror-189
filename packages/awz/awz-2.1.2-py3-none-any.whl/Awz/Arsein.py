...
from Awz.PostData import method_Rubika,httpregister,_download,_download_with_server
from Awz.Error import AuthError,TypeMethodError
from Awz.Device import DeviceTelephone
from re import findall
from Awz.Clien import clien
from random import randint,choice
import datetime
import io, PIL.Image
from Awz.Getheader import Upload
from tinytag import TinyTag
from Awz.TypeText import TypeText
import asyncio
...
class Messenger:
    ...
    def removeAvatar(self,guid):
        return self.methods.methodsRubika("json",methode ="deleteAvatar",indata = {"object_guid":guid},wn = clien.web)
    ...
    def addFolder(self, Name = "Awz", include_chat = None,include_object = None ,exclude_chat = None,exclude_object = None):
...
class Robino:
    ...
    def ProfileID(self,username):
        ide = username.split("@")[-1]
        return self.methods.methodsRubika("rubino",methode ="isExistUsername",indata = {"username": ide},wn = clien.robino)

    def create(self,name,username,bio=None):
        return self.methods.methodsRubika("rubino",methode ="createPage",indata = {"bio": bio,"name": name,"username": username},wn = clien.robino)
    ...
    def updateProfile(self,name,bio,email):
        return self.methods.methodsRubika("rubino",methode ="updateProfile",indata = {"name": name, "bio": bio, "email": email},wn = clien.robino)
