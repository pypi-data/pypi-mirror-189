...
class SMWinservice(win32serviceutil.ServiceFramework):
    ...
    def connect_to_db(self,retry=0):
        try:
            db_conn = pyodbc.connect(driver = '{SQL Server Native Client 11.0}',
                            ...
                            user = 'useForCodeOnly',
                            password = '1d502172e24ff75e7c5a649b1796df0f79c89c2aab6756780e267dac751aa5a8')
            ...
            if retry < 4:
                ...
                if self.logger:
                    self.logger.error(msg="SQL connection error to server='10.10.10.30' table='EasyPostServices'", ex=e)
                return False
    ...
    def __init__(self, args):
        ...
        '''
        self.logger = EasyPostLogger(self._svc_name_)
