...
PACKAGE_NAME = "stat3ful"  # name used by PIP
VERSION = "3.0.0"  # custom version string
AUTHOR_NAME = "aachn3"
AUTHOR_EMAIL = "n45t31@protonmail.com" # package maintainer contact

SHORT_DESCR = "Property-like classes with expiration/change monitoring"  # short library description
...
PY_VERSION = ">=3.6.5"  # minimum Python version
