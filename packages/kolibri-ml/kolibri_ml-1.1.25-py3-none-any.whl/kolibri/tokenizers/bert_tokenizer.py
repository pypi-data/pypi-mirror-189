...
class BertTokenizer(Tokenizer):
    ...
    def __init__(self, *, token_dict: Optional[Dict[str, int]] = None, token_cls: str = TOKEN_CLS,
                 token_sep: str = TOKEN_SEP, token_unk: str = TOKEN_UNK, pad_index: int = 0, cased: bool = False) -> None:
        """
