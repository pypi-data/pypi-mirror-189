...
from kolibri.backend.tensorflow.layers.crf import ConditionalRandomField as CRF
from kolibri.backend.tensorflow.utils import custom_objects
...
class BiLSTM_CRF_Model(BaseLabelingModel):
    ...
    def compile_model(self, **kwargs):
        ...
        if kwargs.get('metrics') is None:
            kwargs['metrics'] = [self.layer_crf.accuracy]
...
if __name__ == "__main__":
    ...
    x, y = DatasetReader.read_conll_format_file("/Users/mohamedmentis/.kolibri/datasets/conll_2003/train.txt", label_index=3)
    x_valid, y_valid = DatasetReader.read_conll_format_file('/Users/mohamedmentis/.kolibri/datasets/conll_2003/test.txt', label_index=3)
    model = BiLSTM_Model()
    model.fit(x, y, x_valid, y_valid, epochs=6)
    model.evaluate(*DatasetReader.read_conll_format_file('/Users/mohamedmentis/.kolibri/datasets/conll_2003/valid.txt', label_index=3))