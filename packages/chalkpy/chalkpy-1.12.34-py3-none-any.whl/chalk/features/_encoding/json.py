...
def structure_json_to_primitive(val: TJSON, typ: Type[TPrimitive]) -> TPrimitive:
...
_json_converter.register_structure_hook(int, _structure_rich)
_json_converter.register_structure_hook(float, _structure_rich)
_json_converter.register_structure_hook(str, _structure_rich)
_json_converter.register_structure_hook(bool, _structure_rich)
