...
class Feature(Generic[_TPrim, _TRich]):
    def __init__(
        ...
        window_mode: Optional[Literal["tumbling", "continuous"]] = None,
...
"""
    ...
    @property
    def encoder(self):
        warnings.warn(DeprecationWarning("Feature.encoder is deprecated. Instead, use Feature.converter"))
        # Returning None to force the engine to go through the deprecated codec, which will use Feature.converter
        return None
...
def feature(
    ...
    return cast(
        ...
        Feature(
            ...
            primary=primary,
            max_staleness=(
                timedelta_to_duration(max_staleness) if isinstance(max_staleness, timedelta) else max_staleness
            ),
