...
def set_logging_context(_merge: bool = True, **extra: Any):
    ...
    Args:
        _merge: If true, the new context will be merged with the current context. Otherwise, the new context will overwrite the existing context.
    """
...
def add_logging_context(_merge: bool = True, **extra: Any):
    ...
    Args:
        ...
        extra: Contextual information to add to the log record
    """
