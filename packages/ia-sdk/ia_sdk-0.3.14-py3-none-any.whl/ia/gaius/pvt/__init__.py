...
class PerformanceValidationTest():
    ...
    def __init__(self, agent: AgentClient,ingress_nodes: list,query_nodes: list,num_of_tests: int, pct_of_ds: float,
                 ...
                 shuffle:bool=False, sio=None, task=None, user_id:str=None, mongo_db=None, dataset_info:dict=None, test_id=None, test_configuration:dict=None, socket_channel:str='pvt_status'):
    ...
    def train_agent(self):
        ...
        for j, _ in enumerate(self.dataset.train_sequences):
            ...
            if self.sio:
                self.sio.emit(self.socket_channel, training_msg.toJSON(), to=self.user_id)
    ...
    def test_agent(self):
        ...
        for k, _ in enumerate(self.dataset.test_sequences):
            ...
            if self.sio:
                self.sio.emit(self.socket_channel, test_step_msg.toJSON(), to=self.user_id)
