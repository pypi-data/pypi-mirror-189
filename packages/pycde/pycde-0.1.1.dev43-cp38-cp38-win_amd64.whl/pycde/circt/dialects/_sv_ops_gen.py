...
class ArrayIndexInOutOp(_ods_ir.OpView):
  ...
  def __init__(self, input, index, *, loc=None, ip=None):
    ...
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(ArrayIndexInOutOp).inferReturnTypes(
        operands=operands,
...
class ConstantStrOp(_ods_ir.OpView):
  ...
  @builtins.property
  def str(self):
    return _ods_ir.StringAttr(self.operation.attributes["str"])
...
class MacroRefExprOp(_ods_ir.OpView):
  ...
  def __init__(self, result, ident, *, loc=None, ip=None):
    ...
    regions = None
    _ods_context = _ods_get_default_loc_context(loc)
    attributes["ident"] = (ident if (
    issubclass(type(ident), _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('MacroIdentAttr')) else
      _ods_ir.AttrBuilder.get('MacroIdentAttr')(ident, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class ReadInOutOp(_ods_ir.OpView):
  ...
  def __init__(self, input, *, loc=None, ip=None):
    ...
    operands.append(_get_op_result_or_value(input))
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(ReadInOutOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
...
class SystemFunctionOp(_ods_ir.OpView):
  ...
  @builtins.property
  def fnName(self):
    return _ods_ir.StringAttr(self.operation.attributes["fnName"])
...
class XMRRefOp(_ods_ir.OpView):
  ...
  def __init__(self, result, ref, *, stringLeaf=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('NameRefAttr')) else
      _ods_ir.AttrBuilder.get('NameRefAttr')(ref, context=_ods_context))
    if stringLeaf is not None: attributes["stringLeaf"] = (stringLeaf if (
        issubclass(type(stringLeaf), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('StrAttr')) else
          _ods_ir.AttrBuilder.get('StrAttr')(stringLeaf, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
