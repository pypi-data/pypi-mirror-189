...
# Target: src/ai/backend/agent:dist
...
""",
        """backend.ai-kernel-binary==22.09.10
""",
        """backend.ai-kernel-helper==22.09.10
""",
        """backend.ai-kernel==22.09.10
""",
        'backend.ai-krunner-static-gnu~=3.0.0',
...
""",
    ...
    'license': 'LGPLv3',
    'long_description': """# Backend.AI Agent
...
""",
    ...
    'package_data': {
        ...
        'ai.backend.agent.docker': (
            'backendai-socket-relay.img.aarch64.tar.gz',
            'backendai-socket-relay.img.x86_64.tar.gz',
            'backendai-socket-relay.version.txt',
            'linuxkit-metadata-proxy-worker.aarch64.bin',
            'linuxkit-metadata-proxy-worker.x86_64.bin',
            'linuxkit-nsenter.img.aarch64.tar.gz',
            'linuxkit-nsenter.img.x86_64.tar.gz',
            'linuxkit-nsenter.version.txt',
        ),
        'ai.backend.agent.kubernetes': (
            'backendai-socket-relay.img.tar.gz',
            'backendai-socket-relay.version.txt',
        ),
    },
    'packages': (
        'ai.backend.agent',
        'ai.backend.agent.docker',
        'ai.backend.agent.docker.metadata',
        'ai.backend.agent.kubernetes',
        'ai.backend.agent.vendor',
    ),
    'project_urls': {
