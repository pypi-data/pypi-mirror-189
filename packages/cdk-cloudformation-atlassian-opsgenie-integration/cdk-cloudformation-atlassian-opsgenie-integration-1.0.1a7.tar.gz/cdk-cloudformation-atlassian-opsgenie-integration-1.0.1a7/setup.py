    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_atlassian_opsgenie_integration",
        "cdk_cloudformation_atlassian_opsgenie_integration._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_atlassian_opsgenie_integration._jsii": [
            "atlassian-opsgenie-integration@1.0.1-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_atlassian_opsgenie_integration": [
            "py.typed"
        ]
