...
def _get_codeclimate_severity(valgrind_severity: str) -> str:
    ...
    if "Leak" in valgrind_severity:
        ...
        if valgrind_severity in [
            ...
            severity = "major"
        elif valgrind_severity in ["InvalidRead", "InvalidWrite"]:
            severity = "critical"
        else:
            severity = "info"
...
def convert_file(
    ...
    base_dirs: typing.Optional[list] = None,
...
def _convert(
    xml_input,
    base_dirs: typing.Optional[typing.List[str]] = None,
    relative_dir: typing.Optional[str] = None,
    ...
    if not "error" in dict_in["valgrindoutput"]:
            ...
            if "dir" in frame and "file" in frame:
                ...
                if not os.path.isfile(path):
                    ...
                    if isinstance(base_dirs, list):
                        for d in base_dirs:
                            tmp_path = os.path.join(d, frame["file"])
