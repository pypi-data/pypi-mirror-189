...
from .util import legend_current_items, _style_colorbar, _dyn_y_label_size, remove_whitespace_around_fig
import plotly
import pandas as pd
import numpy as np
...
def activities_and_devices(df_devs, df_acts, states=False, st=None, et=None,
                           ...
                           height=350, zoomed_range=[], fig=None, row=None, col=None
                           ):
    """
