...
class HTTPStatus(Enum):
    ...
    INPUTS_MUST_PRAM_ERR = (400006, "必传的参数未传", "必须的参数（inputs）未传")
    ...
    IS_SPLIT_BOOL_TYPE_ERR = (400008, "请求体的参数字段类型错误", "IsSplit 字段应该是 bool 类型")  # 语音识别
    IS_STRUCT_BOOL_TYPE_ERR = (400008, "请求体的参数字段类型错误", "IsStruct 字段应该是 bool 类型")  # 报关单识别
    ...
    INPUTS_EMPTY_ERR = (400009, "请求体的参数字段值为空", "inputs 列表为空")
    ...
    SUBEVENT_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "SubEvent 字段不符合规范，请参考接口文档说明")  # 内容审核
    ...
    VIDEO_SIZE_DOC_ERR = (400013, "文件大小不符合要求", "该文件大小不符合要求，请参考接口文档说明")
