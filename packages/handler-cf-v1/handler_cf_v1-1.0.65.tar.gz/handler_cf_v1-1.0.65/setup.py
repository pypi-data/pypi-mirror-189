...
setuptools.setup(
    ...
    install_requires=['requests', 'five9',
                      'google-cloud-firestore', 'pandas', "beautifulsoup4", "sqlalchemy", 'pymysql'],
    ...
    download_url="https://github.com/luigicfh/cf_handler_module/archive/refs/tags/1.0.65.tar.gz",
)
