...
class GuiModule(VisusKernelPy.VisusModule):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    attached = property(_VisusGuiPy.GuiModule_attached_get, _VisusGuiPy.GuiModule_attached_set)
...
class GLTexture(VisusKernelPy.DynObject):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    NoCompression = _VisusGuiPy.GLTexture_NoCompression
    GenericCompression = _VisusGuiPy.GLTexture_GenericCompression
    S3TCCompression = _VisusGuiPy.GLTexture_S3TCCompression
    ETC2Compression = _VisusGuiPy.GLTexture_ETC2Compression
    dims = property(_VisusGuiPy.GLTexture_dims_get, _VisusGuiPy.GLTexture_dims_set)
    dtype = property(_VisusGuiPy.GLTexture_dtype_get, _VisusGuiPy.GLTexture_dtype_set)
    minfilter = property(_VisusGuiPy.GLTexture_minfilter_get, _VisusGuiPy.GLTexture_minfilter_set)
    magfilter = property(_VisusGuiPy.GLTexture_magfilter_get, _VisusGuiPy.GLTexture_magfilter_set)
    wrap = property(_VisusGuiPy.GLTexture_wrap_get, _VisusGuiPy.GLTexture_wrap_set)
    envmode = property(_VisusGuiPy.GLTexture_envmode_get, _VisusGuiPy.GLTexture_envmode_set)
    ranges = property(_VisusGuiPy.GLTexture_ranges_get, _VisusGuiPy.GLTexture_ranges_set)
    compression = property(_VisusGuiPy.GLTexture_compression_get, _VisusGuiPy.GLTexture_compression_set)

    def __init__(self):
        _VisusGuiPy.GLTexture_swiginit(self, _VisusGuiPy.new_GLTexture())
    __swig_destroy__ = _VisusGuiPy.delete_GLTexture

    @staticmethod
    def createFromArray(src):
        return _VisusGuiPy.GLTexture_createFromArray(src)

    @staticmethod
    def createFromQImage(src):
        return _VisusGuiPy.GLTexture_createFromQImage(src)

    def width(self):
        return _VisusGuiPy.GLTexture_width(self)

    def height(self):
        return _VisusGuiPy.GLTexture_height(self)

    def depth(self):
        return _VisusGuiPy.GLTexture_depth(self)

    def target(self):
        return _VisusGuiPy.GLTexture_target(self)

    def uploaded(self):
        return _VisusGuiPy.GLTexture_uploaded(self)

    def textureId(self, gl):
        return _VisusGuiPy.GLTexture_textureId(self, gl)

# Register GLTexture in _VisusGuiPy:
_VisusGuiPy.GLTexture_swigregister(GLTexture)
...
class GLPhongObject(GLObject):
    ...
    point_size = property(_VisusGuiPy.GLPhongObject_point_size_get, _VisusGuiPy.GLPhongObject_point_size_set)
...
class IsoContourNode(VisusDataflowPy.Node):
    ...
    @staticmethod
    def castFrom(obj):
        return _VisusGuiPy.IsoContourNode_castFrom(obj)
...
class IsoContourRenderNode(VisusDataflowPy.Node, GLObject):
    ...
    def setBackColor(self, diffuse):
        return _VisusGuiPy.IsoContourRenderNode_setBackColor(self, diffuse)

    def setFrontColor(self, diffuse):
        return _VisusGuiPy.IsoContourRenderNode_setFrontColor(self, diffuse)
    ...
    @staticmethod
    def castFrom(obj):
        return _VisusGuiPy.IsoContourRenderNode_castFrom(obj)
...
class Viewer(VisusDataflowPy.DataflowListener):
    ...
    def setWindowTitle(self, value):
        return _VisusGuiPy.Viewer_setWindowTitle(self, value)

    def showMaximized(self):
        return _VisusGuiPy.Viewer_showMaximized(self)
    ...
    def isRunning(self):
        return _VisusGuiPy.Viewer_isRunning(self)
    ...
    def beginFreeTransformOnQueryNode(self, node):
        return _VisusGuiPy.Viewer_beginFreeTransformOnQueryNode(self, node)

    def beginFreeTransformOnDatasetNode(self, node):
        return _VisusGuiPy.Viewer_beginFreeTransformOnDatasetNode(self, node)

    def beginFreeTransformOnModelviewNode(self, node):
        return _VisusGuiPy.Viewer_beginFreeTransformOnModelviewNode(self, node)
    ...
    def removeNode(self, *args):
        return _VisusGuiPy.Viewer_removeNode(self, *args)
    ...
    def openSnapshot(self, prev=False):
        return _VisusGuiPy.Viewer_openSnapshot(self, prev)

    def saveSnapshot(self):
        return _VisusGuiPy.Viewer_saveSnapshot(self)

    def enableHistory(self):
        return _VisusGuiPy.Viewer_enableHistory(self)
    ...
    def loadDataset(self, url):
        return _VisusGuiPy.Viewer_loadDataset(self, url)
    ...
    def rotateCamera(self, axis, angle=5):
        return _VisusGuiPy.Viewer_rotateCamera(self, axis, angle)
