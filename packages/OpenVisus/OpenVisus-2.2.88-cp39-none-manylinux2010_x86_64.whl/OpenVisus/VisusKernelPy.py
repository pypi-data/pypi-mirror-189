...
class DynObject(object):
    ...
    def __init__(self):
        _VisusKernelPy.DynObject_swiginit(self, _VisusKernelPy.new_DynObject())
    __swig_destroy__ = _VisusKernelPy.delete_DynObject

# Register DynObject in _VisusKernelPy:
_VisusKernelPy.DynObject_swigregister(DynObject)
...
class KernelModule(VisusModule):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    attached = property(_VisusKernelPy.KernelModule_attached_get, _VisusKernelPy.KernelModule_attached_set)
...
def GetHomeDirectory():
    return _VisusKernelPy.GetHomeDirectory()
...
class RamResource(object):
    ...
    __swig_destroy__ = _VisusKernelPy.delete_RamResource

    def getVisusUsedMemory(self):
        return _VisusKernelPy.RamResource_getVisusUsedMemory(self)

    def getOsUsedMemory(self):
        return _VisusKernelPy.RamResource_getOsUsedMemory(self)

    def getOsTotalMemory(self):
        return _VisusKernelPy.RamResource_getOsTotalMemory(self)

    def setOsTotalMemory(self, value):
        return _VisusKernelPy.RamResource_setOsTotalMemory(self, value)

    def allocateMemory(self, reqsize):
        return _VisusKernelPy.RamResource_allocateMemory(self, reqsize)

    def freeMemory(self, reqsize):
        return _VisusKernelPy.RamResource_freeMemory(self, reqsize)

    def getPeakMemory(self):
        return _VisusKernelPy.RamResource_getPeakMemory(self)

    def setPeakMemory(self, value):
        return _VisusKernelPy.RamResource_setPeakMemory(self, value)

# Register RamResource in _VisusKernelPy:
_VisusKernelPy.RamResource_swigregister(RamResource)
...
class StringTree(object):
    ...
    def readTextInline(self):
        return _VisusKernelPy.StringTree_readTextInline(self)
...
class Path(object):
    ...
    def withoutExtension(self):
        return _VisusKernelPy.Path_withoutExtension(self)
...
class FileGlobalStats(object):
    ...
    def getNumClose(self):
        return _VisusKernelPy.FileGlobalStats_getNumClose(self)

    def getRunning(self):
        return _VisusKernelPy.FileGlobalStats_getRunning(self)
...
class Encoder(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _VisusKernelPy.delete_Encoder

    def isLossy(self):
        return _VisusKernelPy.Encoder_isLossy(self)

    def encode(self, dims, dtype, decoded):
        return _VisusKernelPy.Encoder_encode(self, dims, dtype, decoded)

    def decode(self, dims, dtype, encoded):
        return _VisusKernelPy.Encoder_decode(self, dims, dtype, encoded)

# Register Encoder in _VisusKernelPy:
_VisusKernelPy.Encoder_swigregister(Encoder)
...
class Encoders(object):
    ...
    @staticmethod
    def getSingleton():
        return _VisusKernelPy.Encoders_getSingleton()

    @staticmethod
    def setSingleton(value):
        return _VisusKernelPy.Encoders_setSingleton(value)

    @staticmethod
    def allocSingleton():
        return _VisusKernelPy.Encoders_allocSingleton()

    @staticmethod
    def releaseSingleton():
        return _VisusKernelPy.Encoders_releaseSingleton()

    def registerEncoder(self, key, creator):
        return _VisusKernelPy.Encoders_registerEncoder(self, key, creator)

    def createEncoder(self, specs):
        return _VisusKernelPy.Encoders_createEncoder(self, specs)
    __swig_destroy__ = _VisusKernelPy.delete_Encoders

# Register Encoders in _VisusKernelPy:
_VisusKernelPy.Encoders_swigregister(Encoders)

def Encoders_getSingleton():
    return _VisusKernelPy.Encoders_getSingleton()

def Encoders_setSingleton(value):
    return _VisusKernelPy.Encoders_setSingleton(value)

def Encoders_allocSingleton():
    return _VisusKernelPy.Encoders_allocSingleton()

def Encoders_releaseSingleton():
    return _VisusKernelPy.Encoders_releaseSingleton()
...
class StringUtils(object):
    ...
    @staticmethod
    def hexdigest(value):
        return _VisusKernelPy.StringUtils_hexdigest(value)

    @staticmethod
    def sha256(str):
        return _VisusKernelPy.StringUtils_sha256(str)
...
def StringUtils_hexdigest(value):
    return _VisusKernelPy.StringUtils_hexdigest(value)

def StringUtils_sha256(str):
    return _VisusKernelPy.StringUtils_sha256(str)
...
class StatisticsComponent(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    dtype = property(_VisusKernelPy.StatisticsComponent_dtype_get, _VisusKernelPy.StatisticsComponent_dtype_set)
    dims = property(_VisusKernelPy.StatisticsComponent_dims_get, _VisusKernelPy.StatisticsComponent_dims_set)
    field_range = property(_VisusKernelPy.StatisticsComponent_field_range_get, _VisusKernelPy.StatisticsComponent_field_range_set)
    computed_range = property(_VisusKernelPy.StatisticsComponent_computed_range_get, _VisusKernelPy.StatisticsComponent_computed_range_set)
    average = property(_VisusKernelPy.StatisticsComponent_average_get, _VisusKernelPy.StatisticsComponent_average_set)
    variance = property(_VisusKernelPy.StatisticsComponent_variance_get, _VisusKernelPy.StatisticsComponent_variance_set)
    standard_deviation = property(_VisusKernelPy.StatisticsComponent_standard_deviation_get, _VisusKernelPy.StatisticsComponent_standard_deviation_set)
    median = property(_VisusKernelPy.StatisticsComponent_median_get, _VisusKernelPy.StatisticsComponent_median_set)
    histogram = property(_VisusKernelPy.StatisticsComponent_histogram_get, _VisusKernelPy.StatisticsComponent_histogram_set)

    def __init__(self):
        _VisusKernelPy.StatisticsComponent_swiginit(self, _VisusKernelPy.new_StatisticsComponent())
    __swig_destroy__ = _VisusKernelPy.delete_StatisticsComponent

# Register StatisticsComponent in _VisusKernelPy:
_VisusKernelPy.StatisticsComponent_swigregister(StatisticsComponent)

class Statistics(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    dtype = property(_VisusKernelPy.Statistics_dtype_get, _VisusKernelPy.Statistics_dtype_set)
    dims = property(_VisusKernelPy.Statistics_dims_get, _VisusKernelPy.Statistics_dims_set)
    components = property(_VisusKernelPy.Statistics_components_get, _VisusKernelPy.Statistics_components_set)

    def __init__(self):
        _VisusKernelPy.Statistics_swiginit(self, _VisusKernelPy.new_Statistics())

    def __nonzero__(self):
        return _VisusKernelPy.Statistics___nonzero__(self)
    __bool__ = __nonzero__
    ...
    __swig_destroy__ = _VisusKernelPy.delete_Statistics

# Register Statistics in _VisusKernelPy:
_VisusKernelPy.Statistics_swigregister(Statistics)
...
class VectorOfStatisticsComponent(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _VisusKernelPy.VectorOfStatisticsComponent___nonzero__(self)

    def __bool__(self):
        return _VisusKernelPy.VectorOfStatisticsComponent___bool__(self)

    def __len__(self):
        return _VisusKernelPy.VectorOfStatisticsComponent___len__(self)

    def __getslice__(self, i, j):
        return _VisusKernelPy.VectorOfStatisticsComponent___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _VisusKernelPy.VectorOfStatisticsComponent___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _VisusKernelPy.VectorOfStatisticsComponent___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _VisusKernelPy.VectorOfStatisticsComponent___delitem__(self, *args)

    def __getitem__(self, *args):
        return _VisusKernelPy.VectorOfStatisticsComponent___getitem__(self, *args)

    def __setitem__(self, *args):
        return _VisusKernelPy.VectorOfStatisticsComponent___setitem__(self, *args)

    def pop(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_pop(self)

    def append(self, x):
        return _VisusKernelPy.VectorOfStatisticsComponent_append(self, x)

    def empty(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_empty(self)

    def size(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_size(self)

    def swap(self, v):
        return _VisusKernelPy.VectorOfStatisticsComponent_swap(self, v)

    def begin(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_begin(self)

    def end(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_end(self)

    def rbegin(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_rbegin(self)

    def rend(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_rend(self)

    def clear(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_clear(self)

    def get_allocator(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_get_allocator(self)

    def pop_back(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_pop_back(self)

    def erase(self, *args):
        return _VisusKernelPy.VectorOfStatisticsComponent_erase(self, *args)

    def __init__(self, *args):
        _VisusKernelPy.VectorOfStatisticsComponent_swiginit(self, _VisusKernelPy.new_VectorOfStatisticsComponent(*args))

    def push_back(self, x):
        return _VisusKernelPy.VectorOfStatisticsComponent_push_back(self, x)

    def front(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_front(self)

    def back(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_back(self)

    def assign(self, n, x):
        return _VisusKernelPy.VectorOfStatisticsComponent_assign(self, n, x)

    def resize(self, *args):
        return _VisusKernelPy.VectorOfStatisticsComponent_resize(self, *args)

    def insert(self, *args):
        return _VisusKernelPy.VectorOfStatisticsComponent_insert(self, *args)

    def reserve(self, n):
        return _VisusKernelPy.VectorOfStatisticsComponent_reserve(self, n)

    def capacity(self):
        return _VisusKernelPy.VectorOfStatisticsComponent_capacity(self)
    __swig_destroy__ = _VisusKernelPy.delete_VectorOfStatisticsComponent

# Register VectorOfStatisticsComponent in _VisusKernelPy:
_VisusKernelPy.VectorOfStatisticsComponent_swigregister(VectorOfStatisticsComponent)
...
class NetGlobalStats(object):
    ...
    def getRunningRequests(self):
        return _VisusKernelPy.NetGlobalStats_getRunningRequests(self)
...
class TransferFunction(object):
    ...
    def applyToArray(self, *args):
        return _VisusKernelPy.TransferFunction_applyToArray(self, *args)
...
class KeyPoint(object):
    ...
    @staticmethod
    def adaptiveNonMaximalSuppression(responses, xs, ys, max_keypoints):
...
def LoadBinaryDocument(url):
    return _VisusKernelPy.LoadBinaryDocument(url)

def SaveBinaryDocument(url, src):
    return _VisusKernelPy.SaveBinaryDocument(url, src)

def Encode(compression, dims, dtype, value):
    return _VisusKernelPy.Encode(compression, dims, dtype, value)

def Decode(compression, dims, dtype, value):
    return _VisusKernelPy.Decode(compression, dims, dtype, value)

def call_callback(msg, data):
    return _VisusKernelPy.call_callback(msg, data)

def SetLoggingFunction(callback):
    return _VisusKernelPy.SetLoggingFunction(callback)
