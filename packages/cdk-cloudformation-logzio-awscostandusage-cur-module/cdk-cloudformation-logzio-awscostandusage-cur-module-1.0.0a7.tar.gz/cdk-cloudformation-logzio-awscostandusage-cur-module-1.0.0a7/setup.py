    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_logzio_awscostandusage_cur_module",
        "cdk_cloudformation_logzio_awscostandusage_cur_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_logzio_awscostandusage_cur_module._jsii": [
            "logzio-awscostandusage-cur-module@1.0.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_logzio_awscostandusage_cur_module": [
            "py.typed"
        ]
