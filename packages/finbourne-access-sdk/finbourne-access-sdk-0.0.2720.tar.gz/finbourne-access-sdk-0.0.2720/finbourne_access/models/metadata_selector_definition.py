...
class MetadataSelectorDefinition(object):
    ...
    def __init__(self, expressions=None, actions=None, name=None, description=None, local_vars_configuration=None):  # noqa: E501
    ...
    def expressions(self):
        ...
        :rtype: list[finbourne_access.MetadataExpression]
        """
    ...
    def expressions(self, expressions):
        ...
        :type expressions: list[finbourne_access.MetadataExpression]
        """
        if self.local_vars_configuration.client_side_validation and expressions is None:  # noqa: E501
            raise ValueError("Invalid value for `expressions`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                expressions is not None and len(expressions) < 1):
            raise ValueError("Invalid value for `expressions`, number of items must be greater than or equal to `1`")  # noqa: E501
