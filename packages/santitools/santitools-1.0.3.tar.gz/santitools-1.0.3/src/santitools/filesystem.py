...
Coroutine[Ellipsis, Ellipsis, tuple[None | BaseException, bytes | None]]:
    return readfile(filename, encoding)
async def writeco(filename, encoding=None) -> Coroutine[Ellipsis, Ellipsis, BaseException | None]:
    return writefile(filename, encoding)
async def appendco(filename, encoding=None) -> Coroutine[Ellipsis, Ellipsis, BaseException | None]:
    return append(filename, encoding)
async def deleteco(filename) -> Coroutine[Ellipsis, Ellipsis, BaseException | None]:
