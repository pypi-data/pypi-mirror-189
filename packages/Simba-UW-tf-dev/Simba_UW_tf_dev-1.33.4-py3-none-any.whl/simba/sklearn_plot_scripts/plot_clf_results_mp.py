...
class PlotSklearnResultsMultiProcess(object):
    """
    ...
    def __init__(self,
        ...
        self.animal_bp_dict = create_body_part_dictionary(self.multi_animal_status, self.multi_animal_id_lst, self.no_animals, self.x_cols, self.y_cols, self.pcols, self.color_lst_of_lst)
    ...
    def create_visualizations(self):
        ...
        if self.video_setting:
            ...
            self.video_temp_dir = os.path.join(self.save_folder, self.video_name,  'temp')
