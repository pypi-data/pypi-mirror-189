...
#
#
# def parse_configparser(config: ConfigParser):
#
#     parsed_config = dict(config._sections)
#     for k in parsed_config:
#         parsed_config[k] = dict(config._defaults, **d[k])
#         parsed_config[k].pop('__name__', None)
#
...
# config = read_config_file('/Users/simon/Desktop/envs/troubleshooting/Termites_5/project_folder/project_config.ini')
# parse_configparser(config=config)
# concatenate_videos_in_folder(in_folder='/Users/simon/Desktop/envs/troubleshooting/Termites_5/concat_test',
#                              remove_splits=False,
#                              save_path='/Users/simon/Desktop/envs/troubleshooting/Termites_5/test.mp4')