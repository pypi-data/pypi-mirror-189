    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_pagerduty_responseplays_responseplay",
        "cdk_cloudformation_pagerduty_responseplays_responseplay._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_pagerduty_responseplays_responseplay._jsii": [
            "pagerduty-responseplays-responseplay@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_pagerduty_responseplays_responseplay": [
            "py.typed"
        ]
