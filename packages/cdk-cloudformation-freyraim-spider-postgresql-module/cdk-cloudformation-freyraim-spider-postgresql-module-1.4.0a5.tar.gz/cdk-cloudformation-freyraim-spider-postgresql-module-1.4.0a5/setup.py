    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_freyraim_spider_postgresql_module",
        "cdk_cloudformation_freyraim_spider_postgresql_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_freyraim_spider_postgresql_module._jsii": [
            "freyraim-spider-postgresql-module@1.4.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_freyraim_spider_postgresql_module": [
            "py.typed"
        ]
