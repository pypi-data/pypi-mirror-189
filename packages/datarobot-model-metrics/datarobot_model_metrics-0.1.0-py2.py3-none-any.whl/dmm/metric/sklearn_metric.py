...
class SklearnMetric(MetricBase):
    ...
    def __init__(self, metric):
        self.name = metric
        self.description = f"A metric based on sklearn.metrics.{metric}."
        # all sklearn metrics are what we would call model quality metrics and take only actuals and predictions.
        self._need_predictions = True
        self._need_actuals = True
        self._need_scoring_data = False
        self._need_training_data = False
