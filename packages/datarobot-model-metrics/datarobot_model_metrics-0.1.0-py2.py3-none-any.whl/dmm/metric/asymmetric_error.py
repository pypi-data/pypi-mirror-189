...
class AsymmetricError(ModelMetricBase):
    """
    An example of how to calculate the asymmetric error based on the mean absolute error
    """

    def __init__(self, above_weight=2, below_weight=1):
        super().__init__(
            name="Asymmetric Error",
            description="Asymmetric error between prediction and actual value",
    ...
    def score(self, predictions=None, actuals=None, **kwargs) -> float:
        ...
        true_count = (above_mask == True).count()
