...
@action(name='heaserver-buckets-bucket-get-properties', rel='hea-properties')
@action(name='heaserver-buckets-bucket-duplicate', rel='hea-duplicator', path='/volumes/{volume_id}/buckets/{id}/duplicator')
@action('heaserver-buckets-bucket-get-open-choices', rel='hea-opener-choices',
...
@routes.get('/volumes/{volume_id}/buckets/{id}/duplicator')
@action(name='heaserver-buckets-bucket-duplicate-form', path='/volumes/{volume_id}/buckets/{id}')
async def get_bucket_duplicator(request: web.Request) -> web.Response:
    return await awsservicelib.get_bucket(request=request)
...
async def get_bucket_options(request: web.Request) -> web.Response:
    ...
    responses:
      ...
      '404':
        $ref: '#/components/responses/404'
    """
    return await get_options(request, ['GET', 'POST', 'DELETE', 'HEAD', 'OPTIONS'], awsservicelib.has_bucket)
