...
import tempfile
from iris import dataset_iris,phenonaut_object_iris_2_views
...
def test_write_heatmap():
    with tempfile.TemporaryDirectory() as tmp_dir:
        df=pd.DataFrame(data=np.array([[0.1,0.2,0.3],[0.1,0.2,0.3],[0.5,0.6,0.7]]), columns=["X1","X2","X3"], index=["Y1", "Y2", "Y3"])
