...
from decentro_in_kyc_client import rest
from decentro_in_kyc_client.configuration import Configuration
from decentro_in_kyc_client.exceptions import ApiTypeError, ApiValueError, ApiException
from decentro_in_kyc_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'Konfig/1.1.0/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = KYCApi()
        api_instance.check_image_quality  # this is an instance of the class Endpoint
        api_instance.check_image_quality()  # this invokes api_instance.check_image_quality.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.check_image_quality.callable or self.callable in this class
