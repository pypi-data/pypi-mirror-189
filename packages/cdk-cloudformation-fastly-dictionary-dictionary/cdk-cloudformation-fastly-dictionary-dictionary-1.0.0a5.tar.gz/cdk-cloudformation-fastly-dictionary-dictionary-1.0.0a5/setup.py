    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_fastly_dictionary_dictionary",
        "cdk_cloudformation_fastly_dictionary_dictionary._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_fastly_dictionary_dictionary._jsii": [
            "fastly-dictionary-dictionary@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_fastly_dictionary_dictionary": [
            "py.typed"
        ]
