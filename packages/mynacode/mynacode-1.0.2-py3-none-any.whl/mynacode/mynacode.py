...
def tracefunc(frame, event, arg, indent=[0]):
    ...
    if ('_init_' in frame.f_code.co_name and (('torch' in frame.f_code.co_filename and 'models' in frame.f_code.co_filename and 'optim' in frame.f_code.co_filename and 'modules' in frame.f_code.co_filename) or ('sklearn' in frame.f_code.co_filename and 'linear_model' in frame.f_code.co_filename and 'metrics' in frame.f_code.co_filename)  or ('keras' in frame.f_code.co_filename and 'convolutional' in frame.f_code.co_filename and 'pooling' in frame.f_code.co_filename and 'reshaping' in frame.f_code.co_filename and 'regularization' in frame.f_code.co_filename and 'dense' in frame.f_code.co_filename))):
