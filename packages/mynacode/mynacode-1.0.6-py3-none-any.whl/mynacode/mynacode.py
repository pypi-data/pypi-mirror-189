...
def tracefunc(frame, event, arg, indent=[0]):
    ...
    if ('_init_' in frame.f_code.co_name and '__autograph_generated' not in frame.f_code.co_filename and (('torch' in frame.f_code.co_filename and ('models' in frame.f_code.co_filename or 'optim' in frame.f_code.co_filename or 'modules' in frame.f_code.co_filename)) or ('sklearn' in frame.f_code.co_filename and ('linear_model' in frame.f_code.co_filename or 'metrics' in frame.f_code.co_filename))  or ('keras' in frame.f_code.co_filename and ('convolutional' in frame.f_code.co_filename or 'pooling' in frame.f_code.co_filename or 'reshaping' in frame.f_code.co_filename or 'regularization' in frame.f_code.co_filename or 'dense' in frame.f_code.co_filename)))):
