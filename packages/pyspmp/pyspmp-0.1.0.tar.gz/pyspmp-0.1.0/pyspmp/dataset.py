...
def filtrar_dados_dataset(df_parametro, dataset):

    # carrega o dataset localizado na pasta "dataset"
    diretorio = os.path.dirname(__file__)
    diretorio = os.path.join(diretorio, "dataset")
    file = dataset + ".csv"
    df_dataset = pd.read_csv(os.path.join(diretorio, file), ",")
