...
class image_dehazer():
    def __init__(self, airlightEstimation_windowSze=15, boundaryConstraint_windowSze=3, C0=20, C1=300, regularize_lambda=0.1, sigma=0.5, delta=0.85, showHazeTrasmissionMap=True):
        ...
        self.sigma = sigma
        self.delta = delta
        self.showHazeTrasmissionMap=showHazeTrasmissionMap
        self._A = []
        self._transmission = []
        self._WFun = []
    ...
    def __CalTransmission(self, HazeImg):
        ...
        if(self.showHazeTrasmissionMap):
...
def remove_haze(HazeImg, airlightEstimation_windowSze=15, boundaryConstraint_windowSze=3, C0=20, C1=300, regularize_lambda=0.1, sigma=0.5, delta=0.85, showHazeTrasmissionMap=True):
    Dehazer = image_dehazer(airlightEstimation_windowSze=airlightEstimation_windowSze,
                            ...
                            regularize_lambda=regularize_lambda, sigma=sigma, delta=delta, showHazeTrasmissionMap=showHazeTrasmissionMap)
