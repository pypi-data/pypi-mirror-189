...
Incomplete = True
while(Incomplete):
    AdminInput = input("Please respond to log-in as admin")
    if len(AdminInput) > 0:
        Admin = True
    else:
        break
...
SubHeading = Label(root, text="Where you can learn Coding + Physics", fg="blue", font=("Courier 9")).place(x=72,y=42.5)
