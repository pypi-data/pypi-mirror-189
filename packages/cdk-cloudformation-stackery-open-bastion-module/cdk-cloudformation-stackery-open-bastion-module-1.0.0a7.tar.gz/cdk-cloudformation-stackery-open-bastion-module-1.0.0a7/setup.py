    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_stackery_open_bastion_module",
        "cdk_cloudformation_stackery_open_bastion_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_stackery_open_bastion_module._jsii": [
            "stackery-open-bastion-module@1.0.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_stackery_open_bastion_module": [
            "py.typed"
        ]
