...
from pytest_ver.lib.iuv.iuv_data import IUVData
from pytest_ver.lib.iuv.iuv_requirements import IUVRequirements
...
class IUV:
    ...
    def abort(self, msg=None):
        ...
        print('IUV: iuv.abort() called')
        print(f'IUV: iuv.abort() msg: {msg}')
        print('IUV: exiting testcase (ignore next "SKIPPED")')
    ...
    def _get_location(self):
        ...
        location = f'{tb.tb_frame.f_code.co_filename}({tb.tb_frame.f_lineno})'
        return tb, location
    ...
    def _log(self, tag, val=None, total=None):
        ...
        if val is None:
            ...
            print(f'   {tag: <25} {val: >5}')
        else:
            print(f'   {tag: <25} {val: >5} {round(val / total * 100.0, 0):>5}%')
