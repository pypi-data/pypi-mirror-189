    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_dynatrace_configuration_dashboard",
        "cdk_cloudformation_dynatrace_configuration_dashboard._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_dynatrace_configuration_dashboard._jsii": [
            "dynatrace-configuration-dashboard@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_dynatrace_configuration_dashboard": [
            "py.typed"
        ]
