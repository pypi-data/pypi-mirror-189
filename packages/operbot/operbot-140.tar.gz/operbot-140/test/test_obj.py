...
# pylint: disable=E1101,C0116,C0411,R0904,C0115,W0622
...
from opr.obj import Object, items, keys, update, values
from opr.obj import edit, fmt, kind
from opr.jsn import ObjectDecoder, ObjectEncoder, load, save
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "opr.obj.Object")
