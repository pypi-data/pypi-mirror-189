    ...
    """
{
    ...
    "license": "Apache-2.0",
    "url": "https://github.com/iann0036/cfn-tf-custom-types/blob/docs/resources/aws/TF-AWS-KeyPair/docs/README.md",
    ...
    "packages": [
        "cdk_cloudformation_tf_aws_keypair",
        "cdk_cloudformation_tf_aws_keypair._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_tf_aws_keypair._jsii": [
            "tf-aws-keypair@1.0.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_tf_aws_keypair": [
            "py.typed"
        ]
