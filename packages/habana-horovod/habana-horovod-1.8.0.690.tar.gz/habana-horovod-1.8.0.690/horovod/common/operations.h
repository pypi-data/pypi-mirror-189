...
// C interface to return integer indicating whether Horovod was compiled with HCCL support.
// Returns HCCL_VERSION_CODE if HCCL is available, else returns 0.
...
Status EnqueueTensorAllreduce(std::shared_ptr<OpContext> context,
                              ...
                              int order_index = -1,
                              std::vector<int64_t> group_order_indices = {0});
