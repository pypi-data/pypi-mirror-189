...
#define INIT_HCCL "INIT_HCCL"
#define HCCL_ALLREDUCE "HCCL_ALLREDUCE"
#define HCCL_ALLGATHER "HCCL_ALLGATHER"
#define HCCL_BROADCAST "HCCL_BROADCAST"
#define HCCL_REDUCE_SCATTER "HCCL_REDUCE_SCATTER"

#define HCCL_REORDERING "HCCL_REORDERING"
...
struct TensorTableEntry {
  ...
  int order_index;
  std::set<int> group_order_indices;
