...
class HorovodBasics(object):
    ...
    def __init__(self, pkg_path, *args):
        ...
        print("Using custom Horovod, path:", full_path)
    ...
    def hccl_built(self):
        """Function to check if Horovod was compiled with HCCL support.

        Returns:
          An integer value indicating whether HCCL support was compiled.
          If HCCL support was compiled, returns HCCL_VERSION_CODE. Otherwise,
          returns 0.
        """
        return int(self.MPI_LIB_CTYPES.horovod_hccl_built())
