...
# Fixed bug in rickRoll() introduced in Version 11
...
###########################
# Thanks to @KanavGupta7 on Repl.it for this simpler clear command. It works just the same but is much shorter.
# To use, type "clear()"
...
def rickRoll(fileName="rickRoll_full.txt", timePerLine=2, infinity="yes"):
  from time import sleep
  rick = open(fileName)
