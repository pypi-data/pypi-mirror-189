...
namespace __pythran__hessian_det_appx
{
  ...
  typename _hessian_matrix_det::type<argument_type0, argument_type1>::result_type _hessian_matrix_det::operator()(argument_type0&& img, argument_type1&& sigma) const
  {
    ...
    {
      long  __target140396396632336 = height;
      for (long  r=0L; r < __target140396396632336; r += 1L)
      {
        {
          long  __target140396396593696 = width;
          for (long  c=0L; c < __target140396396593696; c += 1L)
          {
...
PYTHRAN_MODULE_INIT(_hessian_det_appx)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.12.1",
                                      "2023-02-01 20:35:18.417577",
                                      "67a393a32f2b544d478fe58f60dff73598ecd1346242b4931c3fa512288b017f");
    if(! theDoc)
        PYTHRAN_RETURN;
