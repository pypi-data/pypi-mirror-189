...
class Frame(object):
    ...
    def __init__(self, position: "Vec3", tangent: "Vec3", normal: "Vec3", binormal: "Vec3"):
...
class Domain(object):
    ...
    def __init__(self, min: "tinyspline::real", max: "tinyspline::real"):
...
class Morphism(object):
    ...
    def __init__(self, origin: "BSpline", target: "BSpline", epsilon: "tinyspline::real"=1e-5):
