...
def search_porn_base(query:str, url_base:str, call_get_videos_site, url_base_page_number_search, site_name:str, page_limit=2, page_number:int=None):
    ...
    data_videos = DataVideos(site_name=site_name,         query=query,         url_base=url_base,         url_search=url_base_page_number_search(query,1),         videos=list_videos,         ping=time_ping_end,         videos_per_pages=len_videos_pages,         len_pages=len_pg,         len_videos=len_videos)
    return data_videos
