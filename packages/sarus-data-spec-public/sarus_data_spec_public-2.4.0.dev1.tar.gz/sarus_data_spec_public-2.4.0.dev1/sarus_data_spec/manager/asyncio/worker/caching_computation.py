...
from sarus_data_spec.manager.ops.asyncio.source.to_sql import async_to_sql_op
...
class ToSQLComputation(WorkerComputation[str]):
    """Class responsible for handling the caching
    in SQL of a dataset"""
    ...
    async def read_ready_result(
        ...
        **kwargs: t.Any,
        ...
        """
        return properties[SQL_CACHING_URI]
