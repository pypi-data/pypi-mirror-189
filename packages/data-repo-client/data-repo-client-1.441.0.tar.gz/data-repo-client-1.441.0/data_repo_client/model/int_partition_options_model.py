...
class IntPartitionOptionsModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["column", "min", "max", "interval", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["column", "min", "max", "interval", ], str]):
