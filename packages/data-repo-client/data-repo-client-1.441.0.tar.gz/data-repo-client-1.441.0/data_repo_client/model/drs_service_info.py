...
class DRSServiceInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            contact = schemas.DictSchema
            license = schemas.DictSchema
            __annotations__ = {
                "version": version,
                "title": title,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "title", "description", "contact", "license", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "title", "description", "contact", "license", ], str]):
