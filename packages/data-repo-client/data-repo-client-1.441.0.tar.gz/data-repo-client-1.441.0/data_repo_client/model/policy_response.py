    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class workspaces(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WorkspacePolicyModel'], typing.List['WorkspacePolicyModel']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'workspaces':
                    return super().__new__(
                        cls,
            ...
            class inaccessibleWorkspaces(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['InaccessibleWorkspacePolicyModel'], typing.List['InaccessibleWorkspacePolicyModel']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
