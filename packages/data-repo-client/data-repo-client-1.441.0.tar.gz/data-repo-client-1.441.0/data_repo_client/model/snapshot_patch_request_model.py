...
class SnapshotPatchRequestModel(
    schemas.DictSchema
):
    ...
    A 'lite' snapshot definition (used to modify supported fields of a snapshot). Null assignments will be ignored.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["consentCode", "description", "properties", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["consentCode", "description", "properties", ], str]):
