...
class SnapshotRequestModel(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class contents(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SnapshotRequestContentsModel'], typing.List['SnapshotRequestContentsModel']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "contents", "description", "consentCode", "readers", "profileId", "properties", "policies", "globalFileIds", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "contents", "description", "consentCode", "readers", "profileId", "properties", "policies", "globalFileIds", ], str]):
        return super().get_item_oapg(name)
