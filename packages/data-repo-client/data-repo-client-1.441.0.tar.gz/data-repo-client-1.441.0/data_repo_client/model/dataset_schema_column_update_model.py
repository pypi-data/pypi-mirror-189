...
class DatasetSchemaColumnUpdateModel(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class columns(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ColumnModel'], typing.List['ColumnModel']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tableName", "columns", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tableName", "columns", ], str]):
