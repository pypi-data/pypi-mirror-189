...
class SnapshotModel(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class source(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SnapshotSourceModel'], typing.List['SnapshotSourceModel']],
            ...
            class tables(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TableModel'], typing.List['TableModel']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'tables':
                    return super().__new__(
                        cls,
            ...
            class relationships(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RelationshipModel'], typing.List['RelationshipModel']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'relationships':
                    return super().__new__(
                        cls,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "createdDate", "consentCode", "source", "tables", "relationships", "profileId", "dataProject", "accessInformation", "creationInformation", "cloudPlatform", "properties", "duosFirecloudGroup", "globalFileIds", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "createdDate", "consentCode", "source", "tables", "relationships", "profileId", "dataProject", "accessInformation", "creationInformation", "cloudPlatform", "properties", "duosFirecloudGroup", "globalFileIds", ], str]):
