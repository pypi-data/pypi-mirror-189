...
class IngestRequestModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["table", "format", "path", "records", "load_tag", "profile_id", "max_bad_records", "max_failed_file_loads", "ignore_unknown_values", "csv_field_delimiter", "csv_quote", "csv_skip_leading_rows", "csv_allow_quoted_newlines", "csv_null_marker", "csv_generate_row_ids", "resolve_existing_files", "transactionId", "updateStrategy", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["max_bad_records"]) -> typing.Union[MetaOapg.properties.max_bad_records, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["max_failed_file_loads"]) -> typing.Union[MetaOapg.properties.max_failed_file_loads, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        max_bad_records: typing.Union[MetaOapg.properties.max_bad_records, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        max_failed_file_loads: typing.Union[MetaOapg.properties.max_failed_file_loads, decimal.Decimal, int, schemas.Unset] = schemas.unset,
