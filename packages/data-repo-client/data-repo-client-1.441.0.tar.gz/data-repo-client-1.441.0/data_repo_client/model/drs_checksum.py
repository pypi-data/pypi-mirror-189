...
class DRSChecksum(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["checksum", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["checksum", "type", ], str]):
