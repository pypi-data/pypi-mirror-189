...
# body param
SchemaForRequestBodyApplicationJson = BulkLoadArrayRequestModel


request_body_bulk_file_load_array = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JobModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _bulk_file_load_array_oapg(
        self,
    ...
    def _bulk_file_load_array_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_bulk_file_load_array.serialize(body, content_type)
...
class BulkFileLoadArray(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def bulk_file_load_array(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def bulk_file_load_array(
        ...
        return self._bulk_file_load_array_oapg(
            body=body,
