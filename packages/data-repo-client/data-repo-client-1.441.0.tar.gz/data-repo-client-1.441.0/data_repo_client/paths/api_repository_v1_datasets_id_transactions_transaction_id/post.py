...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'transactionId': typing.Union[TransactionIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = TransactionCloseModel


request_body_transaction_close_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _close_transaction_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_transaction_close_model.serialize(body, content_type)
...
class CloseTransaction(BaseApi):
    ...
    def close_transaction(
        ...
        return self._close_transaction_oapg(
            body=body,
