...
# body param
SchemaForRequestBodyApplicationJson = FileLoadModel


request_body_ingest_file = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _ingest_file_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_ingest_file.serialize(body, content_type)
