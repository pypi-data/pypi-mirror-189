...
# body param
SchemaForRequestBodyApplicationJson = BulkLoadRequestModel


request_body_bulk_file_load = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _bulk_file_load_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_bulk_file_load.serialize(body, content_type)
...
class BulkFileLoad(BaseApi):
    ...
    def bulk_file_load(
        ...
        return self._bulk_file_load_oapg(
            body=body,
