...
SortSchema = EnumerateSortByParam
DirectionSchema = SqlSortDirection
FilterSchema = schemas.StrSchema
RegionSchema = schemas.StrSchema


class DatasetIdsSchema(
    schemas.ListSchema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'datasetIds': typing.Union[DatasetIdsSchema, list, tuple, ],
    },
    total=False
)
...
request_query_dataset_ids = api_client.QueryParameter(
    name="datasetIds",
    style=api_client.ParameterStyle.FORM,
    schema=DatasetIdsSchema,
    explode=True,
)
_auth = [
    'googleoauth',
...
SchemaFor200ResponseBodyApplicationJson = EnumerateSnapshotModel
...
class EnumerateSnapshots(BaseApi):
    ...
    def enumerate_snapshots(
        ...
        return self._enumerate_snapshots_oapg(
