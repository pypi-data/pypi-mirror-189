...
# body param
SchemaForRequestBodyApplicationJson = SnapshotRequestModel


request_body_snapshot = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_snapshot_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_snapshot.serialize(body, content_type)
...
class CreateSnapshot(BaseApi):
    ...
    def create_snapshot(
        ...
        return self._create_snapshot_oapg(
            body=body,
