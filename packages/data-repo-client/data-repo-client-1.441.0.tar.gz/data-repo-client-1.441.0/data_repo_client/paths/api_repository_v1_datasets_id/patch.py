...
# body param
SchemaForRequestBodyApplicationJson = DatasetPatchRequestModel


request_body_dataset_patch_request_model = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DatasetSummaryModel
...
class BaseApi(api_client.Api):
    ...
    def _patch_dataset_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_dataset_patch_request_model.serialize(body, content_type)
...
class PatchDataset(BaseApi):
    ...
    def patch_dataset(
        ...
        return self._patch_dataset_oapg(
            body=body,
