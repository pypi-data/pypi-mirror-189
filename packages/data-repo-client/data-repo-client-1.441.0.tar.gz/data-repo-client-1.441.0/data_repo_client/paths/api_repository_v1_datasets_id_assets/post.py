...
# body param
SchemaForRequestBodyApplicationJson = AssetModel


request_body_asset_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_dataset_asset_specifications_oapg(
        self,
    ...
    def _add_dataset_asset_specifications_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_asset_model.serialize(body, content_type)
...
class AddDatasetAssetSpecifications(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_dataset_asset_specifications(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def add_dataset_asset_specifications(
        ...
        return self._add_dataset_asset_specifications_oapg(
            body=body,
