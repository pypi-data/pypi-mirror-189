...
# body param
SchemaForRequestBodyApplicationJson = BillingProfileRequestModel


request_body_billing_profile_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_profile_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_billing_profile_request.serialize(body, content_type)
...
class CreateProfile(BaseApi):
    ...
    def create_profile(
        ...
        return self._create_profile_oapg(
            body=body,
