...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['JobModel']:
            return JobModel

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['JobModel'], typing.List['JobModel']],
    ...
    def __getitem__(self, i: int) -> 'JobModel':
...
class EnumerateJobs(BaseApi):
    ...
    def enumerate_jobs(
        ...
        return self._enumerate_jobs_oapg(
