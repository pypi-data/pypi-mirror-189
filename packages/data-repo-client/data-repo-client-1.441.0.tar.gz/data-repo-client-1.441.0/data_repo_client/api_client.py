...
from data_repo_client.exceptions import ApiTypeError, ApiValueError
from data_repo_client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.441.0/python'
