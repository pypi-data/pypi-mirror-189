...
class UserStatusInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            userSubjectId = schemas.StrSchema
    ...
    userSubjectId: MetaOapg.properties.userSubjectId
    userEmail: MetaOapg.properties.userEmail
    enabled: MetaOapg.properties.enabled
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["userSubjectId"]) -> MetaOapg.properties.userSubjectId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userSubjectId", "userEmail", "enabled", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["userSubjectId"]) -> MetaOapg.properties.userSubjectId: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userSubjectId", "userEmail", "enabled", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        userSubjectId: typing.Union[MetaOapg.properties.userSubjectId, str, ],
