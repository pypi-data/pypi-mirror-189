...
class ErrorModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "errorDetail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "errorDetail", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        errorDetail: typing.Union[MetaOapg.properties.errorDetail, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
