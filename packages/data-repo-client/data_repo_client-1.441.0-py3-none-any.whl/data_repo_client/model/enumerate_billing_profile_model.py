...
class EnumerateBillingProfileModel(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['BillingProfileModel']:
                        return BillingProfileModel
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['BillingProfileModel'], typing.List['BillingProfileModel']],
                ...
                def __getitem__(self, i: int) -> 'BillingProfileModel':
