...
class UpgradeResponseModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["upgradeName", "startTime", "endTime", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["upgradeName"]) -> typing.Union[MetaOapg.properties.upgradeName, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["upgradeName", "startTime", "endTime", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        upgradeName: typing.Union[MetaOapg.properties.upgradeName, str, schemas.Unset] = schemas.unset,
