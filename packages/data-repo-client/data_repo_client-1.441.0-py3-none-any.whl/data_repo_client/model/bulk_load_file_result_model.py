...
class BulkLoadFileResultModel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourcePath", "targetPath", "state", "fileId", "error", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourcePath", "targetPath", "state", "fileId", "error", ], str]):
