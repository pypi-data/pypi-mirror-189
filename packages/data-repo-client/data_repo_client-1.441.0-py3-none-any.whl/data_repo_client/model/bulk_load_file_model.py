...
class BulkLoadFileModel(
    ...
    Describes one file within a bulk file load
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sourcePath", "targetPath", "mimeType", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sourcePath", "targetPath", "mimeType", "description", ], str]):
