...
# body param
SchemaForRequestBodyApplicationJson = TransactionCreateModel


request_body_transaction = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _open_transaction_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transaction.serialize(body, content_type)
...
class OpenTransaction(BaseApi):
    ...
    def open_transaction(
        ...
        return self._open_transaction_oapg(
            body=body,
