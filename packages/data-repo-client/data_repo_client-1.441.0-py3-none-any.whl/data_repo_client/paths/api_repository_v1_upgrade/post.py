...
# body param
SchemaForRequestBodyApplicationJson = UpgradeModel


request_body_upgrade = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _upgrade_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_upgrade.serialize(body, content_type)
