...
# body param
SchemaForRequestBodyApplicationJson = DatasetSchemaUpdateModel


request_body_dataset_schema_update_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_schema_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_dataset_schema_update_model.serialize(body, content_type)
...
class UpdateSchema(BaseApi):
    ...
    def update_schema(
        ...
        return self._update_schema_oapg(
            body=body,
