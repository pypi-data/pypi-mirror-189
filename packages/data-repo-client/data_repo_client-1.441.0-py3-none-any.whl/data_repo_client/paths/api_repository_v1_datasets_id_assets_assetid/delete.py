...
request_path_assetid = api_client.PathParameter(
    name="assetid",
    style=api_client.ParameterStyle.SIMPLE,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _remove_dataset_asset_specifications_oapg(
        self,
...
class RemoveDatasetAssetSpecifications(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def remove_dataset_asset_specifications(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def remove_dataset_asset_specifications(
        ...
        return self._remove_dataset_asset_specifications_oapg(
