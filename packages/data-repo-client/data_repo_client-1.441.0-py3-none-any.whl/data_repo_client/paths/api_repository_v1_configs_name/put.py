...
# body param
SchemaForRequestBodyApplicationJson = ConfigEnableModel


request_body_config_enable = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_fault_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_config_enable.serialize(body, content_type)
