...
# body param
SchemaForRequestBodyApplicationJson = IngestRequestModel


request_body_ingest = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _ingest_dataset_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_ingest.serialize(body, content_type)
...
class IngestDataset(BaseApi):
    ...
    def ingest_dataset(
        ...
        return self._ingest_dataset_oapg(
            body=body,
