...
LoadTagSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'id': typing.Union[IdSchema, str, uuid.UUID, ],
        'loadTag': typing.Union[LoadTagSchema, str, ],
    }
)
...
request_path_load_tag = api_client.PathParameter(
    name="loadTag",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LoadTagSchema,
    required=True,
)
_auth = [
    'googleoauth',
...
SchemaFor200ResponseBodyApplicationJson = BulkLoadHistoryModelList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_load_history_for_load_tag_oapg(
        self,
...
class GetLoadHistoryForLoadTag(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_load_history_for_load_tag(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_load_history_for_load_tag(
        ...
        return self._get_load_history_for_load_tag_oapg(
