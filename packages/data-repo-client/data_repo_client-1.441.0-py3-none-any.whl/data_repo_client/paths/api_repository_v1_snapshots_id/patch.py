...
# body param
SchemaForRequestBodyApplicationJson = SnapshotPatchRequestModel


request_body_snapshot_patch_request_model = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SnapshotSummaryModel
...
class BaseApi(api_client.Api):
    ...
    def _patch_snapshot_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_snapshot_patch_request_model.serialize(body, content_type)
...
class PatchSnapshot(BaseApi):
    ...
    def patch_snapshot(
        ...
        return self._patch_snapshot_oapg(
            body=body,
