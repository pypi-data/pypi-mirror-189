...
SchemaFor200ResponseBodyApplicationJson = SnapshotPreviewModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _lookup_snapshot_preview_by_id_oapg(
        self,
...
class LookupSnapshotPreviewById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def lookup_snapshot_preview_by_id(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def lookup_snapshot_preview_by_id(
        ...
        return self._lookup_snapshot_preview_by_id_oapg(
