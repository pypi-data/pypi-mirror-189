...
# body param
SchemaForRequestBodyApplicationJson = DatasetRequestModel


request_body_dataset = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_dataset_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_dataset.serialize(body, content_type)
