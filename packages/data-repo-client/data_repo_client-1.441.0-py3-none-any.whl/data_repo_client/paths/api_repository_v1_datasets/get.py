...
SchemaFor200ResponseBodyApplicationJson = EnumerateDatasetModel
...
class EnumerateDatasets(BaseApi):
    ...
    def enumerate_datasets(
        ...
        return self._enumerate_datasets_oapg(
