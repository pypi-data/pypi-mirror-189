    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_okta_application_application",
        "cdk_cloudformation_okta_application_application._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_okta_application_application._jsii": [
            "okta-application-application@1.2.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_okta_application_application": [
            "py.typed"
        ]
