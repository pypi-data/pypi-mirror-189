...
class general_map_prop_dialog(wx.Dialog):
    ...
    def __init__(self, parent, bg_layer, grid_layer, fog_layer):
        ...
        self.ctrls[CTRL_GRID_SHOW_LINES].SetValue(grid_layer.line != LINE_NONE)
    ...
    def on_ok(self,evt):
        ...
        if self.ctrls[CTRL_GRID_SHOW_LINES].GetValue():
            ...
            grid_line = LINE_NONE
        self.grid_layer.set_grid(grid_size,
                                 self.ctrls[CTRL_GRID_SNAP].GetValue(),
                                 self.ctrls[CTRL_GRID_COLOR].color,
                                 grid_mode,
                                 grid_line)
        self.fog_layer.set_pixel_size(grid_size)
