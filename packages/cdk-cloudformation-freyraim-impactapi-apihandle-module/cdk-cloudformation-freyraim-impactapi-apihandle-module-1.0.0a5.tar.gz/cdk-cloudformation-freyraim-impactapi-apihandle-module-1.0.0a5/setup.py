    ...
    """
{
    ...
    "packages": [
        "cdk_cloudformation_freyraim_impactapi_apihandle_module",
        "cdk_cloudformation_freyraim_impactapi_apihandle_module._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_freyraim_impactapi_apihandle_module._jsii": [
            "freyraim-impactapi-apihandle-module@1.0.0-alpha.5.jsii.tgz"
        ],
        "cdk_cloudformation_freyraim_impactapi_apihandle_module": [
            "py.typed"
        ]
