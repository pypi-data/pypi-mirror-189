...
def route(path: str, is_public: bool = False, allowed_domains: List[str] = [], allowed_methods: List[str] = ["GET"]):
    """
    Decorator for use in blueprint to define routes. Allows
    for the following syntax to be used:
    ...
    Args:
        path (str): Path to use for the route
