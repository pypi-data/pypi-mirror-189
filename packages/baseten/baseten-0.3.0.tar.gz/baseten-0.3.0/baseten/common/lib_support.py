...
NUMPY_NOT_FOUND_ERRROR_MSG = 'The library was not able to successfully import "numpy" package, check your Python ' \
                             'environment'
H5PY_LIB_ERROR_MSG = 'The library was not able to successfully import "h5py" package, check your Python environment'
...
def build_h5_data_object(feature_data, target_data, metadata, data_temp_directory) -> pathlib.PurePath:
