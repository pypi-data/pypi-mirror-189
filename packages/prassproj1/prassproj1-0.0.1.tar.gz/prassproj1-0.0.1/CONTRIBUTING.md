...
Welcome to `prassproj1` contributor's guide.
...
If you experience bugs or general issues with `prassproj1`, please have a look
...
You can help improve `prassproj1` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`prassproj1` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `prassproj1`'s files. While this mechanism can
...
```
conda create -n prassproj1 python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/prassproj1.git
   cd prassproj1
   ```
...
5. Install [pre-commit]:
   ...
   `prassproj1` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/prassproj1
[issue tracker]: https://github.com/<USERNAME>/prassproj1/issues
