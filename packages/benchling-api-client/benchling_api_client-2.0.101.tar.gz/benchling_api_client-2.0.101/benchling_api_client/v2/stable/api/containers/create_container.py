...
from ...models.create_container_json_body import CreateContainerJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CreateContainerJsonBody,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Container, BadRequestError]]:
    if response.status_code == 201:
        response_201 = Container.from_dict(response.json(), strict=False)
