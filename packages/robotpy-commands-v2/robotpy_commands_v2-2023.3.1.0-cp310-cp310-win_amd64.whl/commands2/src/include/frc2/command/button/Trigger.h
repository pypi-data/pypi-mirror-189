...
class Trigger {
  ...
  */
   ...
   * @return this trigger, so calls can be chained
   */
  Trigger WhileTrue(std::shared_ptr<Command> command);
  ...
  */
   ...
   * @return this trigger, so calls can be chained
   */
  Trigger WhileFalse(std::shared_ptr<Command> command);
  ...
  */
   ...
   * @return this trigger, so calls can be chained
   */
  Trigger ToggleOnTrue(std::shared_ptr<Command> command);
  ...
  */
  ...
  Trigger WhenActive(std::shared_ptr<Command> command);
  ...
  */
  ...
  Trigger WhileActiveContinous(std::shared_ptr<Command> command);
  ...
  */
  ...
  Trigger WhileActiveOnce(std::shared_ptr<Command> command);
  ...
  */
  ...
  Trigger WhenInactive(std::shared_ptr<Command> command);
  ...
  */
  ...
  Trigger ToggleWhenActive(std::shared_ptr<Command> command);
