...
VERSION = "3.18.0a1675372787"
PLUGIN_VERSION = "3.18.0-alpha.1675372787+32f42bea"
    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta {PLUGIN_VERSION}`
                """)
            else:
                raise
...
def readme():
    try:
        ...
        return "okta Pulumi Package - Development Version"
