...
class Up2k(object):
    ...
    def _verify_integrity(self, vol )  :
    ...
    def _set_tagscan(self, cur , need )  :
        if self.args.no_dhash:
            return False
    ...
    def _build_tags_index_2(self, ptop )    :
