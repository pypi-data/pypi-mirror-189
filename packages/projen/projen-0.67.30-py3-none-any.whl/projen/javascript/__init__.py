...
class Eslint(
    ...
    def __init__(
        ...
        *,
        ...
        :param lint_projen_rc_file: (experimental) Projenrc file to lint. Use empty string to disable. Default: PROJEN_RC
    ...
    def add_override(
        ...
        *,
        ...
        :stability: experimental
        '''
        override = EslintOverride(files=files, parser=parser, rules=rules)
...
class EslintOptions:
    ...
    def lint_projen_rc_file(self) -> typing.Optional[builtins.str]:
        '''(experimental) Projenrc file to lint.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"files": "files", "parser": "parser", "rules": "rules"},
)
...
class Jest(
    ...
    def of(cls, project: _Project_57d89203) -> typing.Optional["Jest"]:
        '''(experimental) Returns the singletone Jest component of a project or undefined if there is none.
...
class NodePackage(
    ...
    def render_upgrade_packages_command(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4e26b6d06ed9303c609341ce800baa5957cc767cc9610a496f1fe873a306db5c)
    ...
    def __init__(
        ...
        *,
        ...
        options = PrettierOptions(
            ignore_file=ignore_file, overrides=overrides, settings=settings, yaml=yaml
        )
...
def _typecheckingstub__4e26b6d06ed9303c609341ce800baa5957cc767cc9610a496f1fe873a306db5c(
    exclude: typing.Sequence[builtins.str],
    include: typing.Optional[typing.Sequence[builtins.str]] = None,
) -> None:
    """Type checking stubs"""
