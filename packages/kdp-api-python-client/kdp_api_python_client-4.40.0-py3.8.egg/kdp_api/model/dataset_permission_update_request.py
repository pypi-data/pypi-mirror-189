...
class DatasetPermissionUpdateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, action, dataset_id, group_id, *args, **kwargs):  # noqa: E501
        """DatasetPermissionUpdateRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, action, dataset_id, group_id, *args, **kwargs):  # noqa: E501
        """DatasetPermissionUpdateRequest - a model defined in OpenAPI
