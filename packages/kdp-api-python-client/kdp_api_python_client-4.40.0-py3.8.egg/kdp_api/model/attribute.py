...
class Attribute(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, token, *args, **kwargs):  # noqa: E501
        """Attribute - a model defined in OpenAPI

        Args:
            name (str): attribute name
            token (str): attribute token
        ...
        Keyword Args:
            ...
            id (str): attribute ID. [optional]  # noqa: E501
            description (str): attribute description. [optional]  # noqa: E501
            workspace_id (str): workspace ID. [optional]  # noqa: E501
        """
