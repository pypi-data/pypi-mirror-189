...
class ErrorCode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Enum of error code responses., must be one of ["AccumuloError", "AuthError", "BadRequestError", "DatasourceError", "FileParseError", "ForbiddenError", "HttpClientError", "InternalServerError", "LuceneParseError", "MissingIndexError", "NotFoundError", "NotImplementedError", "RestClientError", "SecurityError", "SqlParseError", "TableNotFoundError", "QueryError", ]  # noqa: E501

        Keyword Args:
            value (str): Enum of error code responses., must be one of ["AccumuloError", "AuthError", "BadRequestError", "DatasourceError", "FileParseError", "ForbiddenError", "HttpClientError", "InternalServerError", "LuceneParseError", "MissingIndexError", "NotFoundError", "NotImplementedError", "RestClientError", "SecurityError", "SqlParseError", "TableNotFoundError", "QueryError", ]  # noqa: E501
