...
class AuthenticationList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AuthenticationList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([Authentication]): list of authentications.  # noqa: E501

        Keyword Args:
            value ([Authentication]): list of authentications.  # noqa: E501
