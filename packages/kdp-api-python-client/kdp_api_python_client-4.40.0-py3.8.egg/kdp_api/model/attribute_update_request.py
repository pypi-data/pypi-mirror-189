...
class AttributeUpdateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, token, *args, **kwargs):  # noqa: E501
        """AttributeUpdateRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, token, *args, **kwargs):  # noqa: E501
        """AttributeUpdateRequest - a model defined in OpenAPI
