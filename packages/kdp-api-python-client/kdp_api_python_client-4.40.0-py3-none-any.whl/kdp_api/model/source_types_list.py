...
class SourceTypesList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SourceTypesList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([SourceTypes]): list of source types.  # noqa: E501

        Keyword Args:
            value ([SourceTypes]): list of source types.  # noqa: E501
