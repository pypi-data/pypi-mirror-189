...
class DatasetPermissionList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DatasetPermissionList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([DatasetPermission]): list of dataset permissions.  # noqa: E501

        Keyword Args:
            value ([DatasetPermission]): list of dataset permissions.  # noqa: E501
