...
class AttributeAssignmentList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AttributeAssignmentList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AttributeAssignment]): list of attribute assignments.  # noqa: E501

        Keyword Args:
            value ([AttributeAssignment]): list of attribute assignments.  # noqa: E501
