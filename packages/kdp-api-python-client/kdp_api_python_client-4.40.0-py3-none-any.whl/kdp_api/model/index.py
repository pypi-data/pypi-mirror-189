...
class Index(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dataset_id, fields, *args, **kwargs):  # noqa: E501
        """Index - a model defined in OpenAPI

        Args:
            dataset_id (str): dataset ID
            fields ([str]): dataset fields
        ...
        Keyword Args:
            ...
            id (str): index ID. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, dataset_id, fields, *args, **kwargs):  # noqa: E501
        """Index - a model defined in OpenAPI
