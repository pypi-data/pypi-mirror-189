...
from kdp_api import rest
from kdp_api.configuration import Configuration
from kdp_api.exceptions import ApiTypeError, ApiValueError, ApiException
from kdp_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/4.40.0/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AbacLabelParsersApi()
        api_instance.get_abac_label_parsers  # this is an instance of the class Endpoint
        api_instance.get_abac_label_parsers()  # this invokes api_instance.get_abac_label_parsers.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_abac_label_parsers.callable or self.callable in this class
