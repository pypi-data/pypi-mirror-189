...
class SegmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_segments_endpoint = _Endpoint(
            settings={
                'response_type': (SegmentPaginator,),
                'auth': [
                    'Bearer'
                ],
        ...
        self.get_segments_id_endpoint = _Endpoint(
            settings={
                'response_type': (Segment,),
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/segments/{id}',
    ...
    def get_segments(
        ...
        **kwargs
        ...
        >>> thread = api.get_segments(dataset_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_segments_id(
        ...
        **kwargs
        ...
        >>> thread = api.get_segments_id(id, async_req=True)
        >>> result = thread.get()

        Args:
            id (str): ID of segment to return
        ...
        kwargs['id'] = \
            id
        return self.get_segments_id_endpoint.call_with_http_info(**kwargs)
