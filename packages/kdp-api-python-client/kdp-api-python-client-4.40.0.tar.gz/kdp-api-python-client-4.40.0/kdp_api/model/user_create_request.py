...
class UserCreateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, email, first_name, last_name, password, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            password (str): authentication password for the new user
        ...
        Keyword Args:
            ...
            workspace_id (str): ID of the KDP workspace that the new user will access. Does not grant permissions to data.. [optional]  # noqa: E501
            role (str): role for the new user. [optional]  # noqa: E501
        """
