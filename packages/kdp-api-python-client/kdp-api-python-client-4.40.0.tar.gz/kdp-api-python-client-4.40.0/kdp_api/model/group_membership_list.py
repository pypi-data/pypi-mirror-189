...
class GroupMembershipList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """GroupMembershipList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([GroupMembership]): list of group memberships.  # noqa: E501

        Keyword Args:
            value ([GroupMembership]): list of group memberships.  # noqa: E501
