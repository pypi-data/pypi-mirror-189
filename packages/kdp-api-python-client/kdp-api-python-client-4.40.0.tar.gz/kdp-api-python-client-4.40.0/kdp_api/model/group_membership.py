...
class GroupMembership(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group_id, user_id, role, *args, **kwargs):  # noqa: E501
        """GroupMembership - a model defined in OpenAPI

        Args:
            group_id (str): group ID
            user_id (str): user ID
            role (str): member role for group
        ...
        Keyword Args:
            ...
            id (str): group membership ID. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_id, user_id, role, *args, **kwargs):  # noqa: E501
        """GroupMembership - a model defined in OpenAPI
