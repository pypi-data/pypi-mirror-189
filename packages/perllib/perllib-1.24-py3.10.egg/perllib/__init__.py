# perllib module for pythonizer, generated by makelib.py on Sun Feb  5 10:17:59 2023
#
...
import sys,os,re,fileinput,subprocess,collections.abc,warnings,inspect,itertools,signal,traceback,io,tempfile,calendar,types,random,dataclasses,builtins,codecs,struct,pprint,functools,argparse,abc
...
EVAL_ERROR = ''
BASETIME = tm_py.time()
_TIE_MAP = {'CLEAR': 'clear','PUSH': 'append','FETCH': '__getitem__','DESTROY': '__del__','STORE': '__setitem__','DELETE': '__delitem__','UNTIE': '__untie__','SCALAR': '__len__','EXISTS': '__contains__','FETCHSIZE': '__len__'}
CHILD_ERROR = 0
_PYTHONIZER_KEYWORDS = {'repr','staticmethod','continue','hasattr','async','ord','subprocess','format','exec','dataclasses','get','list','getattr','isinstance','all','codecs','tm_py','frozenset','id','keys','max','bytes','open','sys','classmethod','math','not','sum','globals','re','locals','insert','assert','sorted','or','traceback','callable','while','object','hex','inspect','print','nonlocal','super','next','break','hash','try','global','os','values','if','with','pdb','finally','upper','any','filter','fcntl','await','breakpoint','perllib','lambda','bytearray','memoryview','pop','glob','del','delattr','dict','enumerate','round','collections.abc','tuple','set','setattr','issubclass','anext','lower','bool','import','warnings','ArrayHash','wantarray','in','str','as','min','zip','type','io','builtins','int','raise','casefold','reversed','chr','close','compile','calendar','dir','class','random','divmod','types','functools','else','pow','help','return','except','update','signal','from','struct','property','tempfile','for','vars','False','slice','ascii','pass','rstrip','itertools','range','is','extend','aiter','copy','True','oct','input','eval','Hash','Array','argparse','stat','and','bin','atexit','None','elif','abs','complex','len','yield','float','fileinput','find','map','getopt','rfind','iter','def'}
TRACEBACK = 0
AUTODIE = 0
