...
class GStreamer(Tarball, Meson):
    def __init__(self):
        Project.__init__(
            ...
            hash="78d21b5469ac93edafc6d8ceb63bc82f6cbbee94d2f866cca6b9252157ee0a09",
...
class GstPluginsGood(Tarball, Meson):
    def __init__(self):
        Project.__init__(
            ...
            hash="582e617271e7f314d1a2211e3e3856ae2e4303c8c0d6114e9c4a5ea5719294b0",
            dependencies=[
                "meson",
                "ninja",
                "gst-plugins-base",
...
class GstPluginsBad(Tarball, Meson):
    def __init__(self):
        Project.__init__(
            ...
            hash="3c9d9300f5f4fb3e3d36009379d1fb6d9ecd79c1a135df742b8a68417dd663a1",
...
class GstPython(Tarball, Meson):
    def __init__(self):
        Project.__init__(
            ...
            hash="6c63ad364ca4617eb2cbb3975ab26c66760eb3c7a6adf5be69f99c11e21ef3a5",
