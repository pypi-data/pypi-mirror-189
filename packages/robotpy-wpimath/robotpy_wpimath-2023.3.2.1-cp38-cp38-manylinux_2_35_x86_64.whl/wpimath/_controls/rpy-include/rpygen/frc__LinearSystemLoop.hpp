...
struct bind_frc__LinearSystemLoop {
        ...
        using StateVector [[maybe_unused]] = typename frc::LinearSystemLoop<States, Inputs, Outputs>::StateVector;
    using InputVector [[maybe_unused]] = typename frc::LinearSystemLoop<States, Inputs, Outputs>::InputVector;
    using OutputVector [[maybe_unused]] = typename frc::LinearSystemLoop<States, Inputs, Outputs>::OutputVector;
...
":param dt:         The nominal timestep.")
      ...
      .def(py::init<LinearSystem<States, Inputs, Outputs>&, LinearQuadraticRegulator<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, std::function<InputVector ( const InputVector & )>, units::second_t>(),
...
"                    that the inputs are voltages.")
      ...
      .def(py::init<LinearQuadraticRegulator<States, Inputs>&, const LinearPlantInversionFeedforward<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, std::function<InputVector ( const InputVector & )>>(),
...
":param clampFunction: The function used to clamp the input vector.")
      ...
      .def("xhat", static_cast<const  StateVector&(frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(
...
":param i: Row of x-hat.")
      ...
      .def("nextR", static_cast<const  StateVector&(frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(
...
":param i: Row of r.")
      ...
      .def("U", static_cast<  InputVector(frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(
...
":param i: Row of u.")
      ...
      .def("setXhat", static_cast<  void(frc::LinearSystemLoop<States, Inputs, Outputs>::*)(const Vectord<States >&)>(
