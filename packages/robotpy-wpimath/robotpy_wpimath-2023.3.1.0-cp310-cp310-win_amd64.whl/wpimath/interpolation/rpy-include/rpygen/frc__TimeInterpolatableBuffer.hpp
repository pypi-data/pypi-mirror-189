...
#include <..\..\_impl\include\frc\interpolation\TimeInterpolatableBuffer.h>
...
"@tparam T The type stored in this buffer.";
  ...
  cls_TimeInterpolatableBuffer
      ...
      py::arg("historySize"), py::arg("func"), release_gil(), py::doc(
...
":param historySize: The history size of the buffer.")
      ...
      .def("addSample", &frc::TimeInterpolatableBuffer<T>::AddSample,
...
":param sample: The sample object.")
      ...
      .def("clear", &frc::TimeInterpolatableBuffer<T>::Clear, release_gil(), py::doc(
    "Clear all old samples.")
  )
    
      .def("sample", &frc::TimeInterpolatableBuffer<T>::Sample,
...
":param time: The time at which to sample the buffer.")
      ...
      .def("getInternalBuffer", &frc::TimeInterpolatableBuffer<T>::GetInternalBuffer, release_gil(), py::doc(
