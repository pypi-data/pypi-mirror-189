...
":param dt: The timestep between calls of calculate().")
      ...
      .def("uff", static_cast<const  InputVector&(frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)() const>(
...
":returns: The row of the calculated feedforward.")
      ...
      .def("R", static_cast<const  StateVector&(frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)() const>(
...
":returns: The row of the current reference vector.")
      ...
      .def("reset", static_cast<  void(frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)(const Vectord<States >&)>(
...
&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::Reset), release_gil(), py::doc(
    "Resets the feedforward with a zero initial state vector.")
      ...
      .def("calculate", static_cast<  InputVector(frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)(const Vectord<States >&)>(
...
":returns: The calculated feedforward.")
      ...
      .def("calculate", static_cast<  InputVector(frc::ControlAffinePlantInversionFeedforward<States, Inputs>::*)(const Vectord<States >&, const Vectord<States >&)>(
&frc::ControlAffinePlantInversionFeedforward<States, Inputs>::Calculate),
