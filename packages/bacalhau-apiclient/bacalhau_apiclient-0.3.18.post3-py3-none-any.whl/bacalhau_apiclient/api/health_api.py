...
class HealthApi(object):
    ...
    def pkgrequesterdebug(self, **kwargs):  # noqa: E501
        """Returns debug information on what the current node is doing.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pkgrequesterdebug(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.pkgrequesterdebug_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.pkgrequesterdebug_with_http_info(**kwargs)  # noqa: E501
            return data

    def pkgrequesterdebug_with_http_info(self, **kwargs):  # noqa: E501
        """Returns debug information on what the current node is doing.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pkgrequesterdebug_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method pkgrequesterdebug" % key
                )
            params[key] = val
        del params['kwargs']
