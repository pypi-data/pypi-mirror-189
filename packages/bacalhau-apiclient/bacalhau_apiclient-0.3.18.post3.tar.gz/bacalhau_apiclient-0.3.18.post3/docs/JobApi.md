...
------------- | ------------- | -------------
[**pkgrequesterevents**](JobApi.md#pkgrequesterevents) | **POST** /requester/events | Returns the events related to the job-id passed in the body payload. Useful for troubleshooting.
[**pkgrequesterlist**](JobApi.md#pkgrequesterlist) | **POST** /requester/list | Simply lists jobs.
[**pkgrequesterlocal_events**](JobApi.md#pkgrequesterlocal_events) | **POST** /requester/local_events | Returns the node&#39;s local events related to the job-id passed in the body payload. Useful for troubleshooting.
[**pkgrequesterresults**](JobApi.md#pkgrequesterresults) | **POST** /requester/results | Returns the results of the job-id specified in the body payload.
[**pkgrequesterstates**](JobApi.md#pkgrequesterstates) | **POST** /requester/states | Returns the state of the job-id specified in the body payload.
[**pkgrequestersubmit**](JobApi.md#pkgrequestersubmit) | **POST** /requester/submit | Submits a new job to the network.


# **pkgrequesterevents**
> EventsResponse pkgrequesterevents(events_request)
...
try:
    # Returns the events related to the job-id passed in the body payload. Useful for troubleshooting.
    api_response = api_instance.pkgrequesterevents(events_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->pkgrequesterevents: %s\n" % e)
```
...
# **pkgrequesterlist**
> ListResponse pkgrequesterlist(list_request)
...
try:
    # Simply lists jobs.
    api_response = api_instance.pkgrequesterlist(list_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->pkgrequesterlist: %s\n" % e)
```
...
# **pkgrequesterlocal_events**
> LocalEventsResponse pkgrequesterlocal_events(local_events_request)
...
try:
    # Returns the node's local events related to the job-id passed in the body payload. Useful for troubleshooting.
    api_response = api_instance.pkgrequesterlocal_events(local_events_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->pkgrequesterlocal_events: %s\n" % e)
```
...
# **pkgrequesterresults**
> ResultsResponse pkgrequesterresults(state_request)
...
try:
    # Returns the results of the job-id specified in the body payload.
    api_response = api_instance.pkgrequesterresults(state_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->pkgrequesterresults: %s\n" % e)
```
...
# **pkgrequesterstates**
> StateResponse pkgrequesterstates(state_request)
...
try:
    # Returns the state of the job-id specified in the body payload.
    api_response = api_instance.pkgrequesterstates(state_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->pkgrequesterstates: %s\n" % e)
```
...
# **pkgrequestersubmit**
> SubmitResponse pkgrequestersubmit(submit_request)
...
try:
    # Submits a new job to the network.
    api_response = api_instance.pkgrequestersubmit(submit_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->pkgrequestersubmit: %s\n" % e)
```
