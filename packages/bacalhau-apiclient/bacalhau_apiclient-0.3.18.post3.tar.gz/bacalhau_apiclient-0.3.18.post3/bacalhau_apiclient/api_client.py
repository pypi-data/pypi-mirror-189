...
import bacalhau_apiclient.models
from bacalhau_apiclient import rest
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'Swagger-Codegen/0.3.18.post3/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bacalhau_apiclient.models, klass)
