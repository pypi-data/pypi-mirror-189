...
class StakedBindData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            admin_staked_amount = schemas.NumberSchema
            __annotations__ = {
                "total_staked_amount": total_staked_amount,
                "self_staked_amount": self_staked_amount,
                "admin_staked_amount": admin_staked_amount,
            }
    
    admin_staked_amount: MetaOapg.properties.admin_staked_amount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["admin_staked_amount"]) -> MetaOapg.properties.admin_staked_amount: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_staked_amount", "self_staked_amount", "admin_staked_amount", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["admin_staked_amount"]) -> MetaOapg.properties.admin_staked_amount: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_staked_amount", "self_staked_amount", "admin_staked_amount", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        admin_staked_amount: typing.Union[MetaOapg.properties.admin_staked_amount, decimal.Decimal, int, float, ],
