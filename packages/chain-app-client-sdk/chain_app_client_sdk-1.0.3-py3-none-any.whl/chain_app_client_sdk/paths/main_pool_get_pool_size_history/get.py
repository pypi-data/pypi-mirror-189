...
SchemaFor200ResponseBodyApplicationJson = PoolSizeHistory
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_main_pool_size_history_oapg(
        self,
...
class GetMainPoolSizeHistory(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_main_pool_size_history(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_main_pool_size_history(
        ...
        return self._get_main_pool_size_history_oapg(
