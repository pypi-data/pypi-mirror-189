...
class UnstakeResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['UnstakeDataResponse']:
                return UnstakeDataResponse
            __annotations__ = {
                "status": status,
                "data": data,
            }
    
    data: 'UnstakeDataResponse'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'UnstakeDataResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'UnstakeDataResponse': ...
