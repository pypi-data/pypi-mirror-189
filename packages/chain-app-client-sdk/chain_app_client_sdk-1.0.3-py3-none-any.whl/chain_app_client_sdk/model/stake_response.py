...
class StakeResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['StakeDataResponse']:
                return StakeDataResponse
            __annotations__ = {
                "status": status,
                "data": data,
            }
    
    data: 'StakeDataResponse'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'StakeDataResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'StakeDataResponse': ...
