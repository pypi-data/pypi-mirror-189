...
class GetClaimableBindResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['GetClaimableBindDataResponse']:
                return GetClaimableBindDataResponse
            __annotations__ = {
                "status": status,
                "data": data,
            }
    
    data: 'GetClaimableBindDataResponse'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'GetClaimableBindDataResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'GetClaimableBindDataResponse': ...
