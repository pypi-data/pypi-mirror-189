...
class StakedBind(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['StakedBindData']:
                return StakedBindData
            __annotations__ = {
                "status": status,
                "data": data,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'StakedBindData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'StakedBindData': ...
