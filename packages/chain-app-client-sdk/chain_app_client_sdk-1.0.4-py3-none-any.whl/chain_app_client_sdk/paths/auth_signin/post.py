...
# body param
SchemaForRequestBodyApplicationJson = SignInUser


request_body_sign_in_user = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _sign_in_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_sign_in_user.serialize(body, content_type)
