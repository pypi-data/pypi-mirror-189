...
# body param
SchemaForRequestBodyApplicationJson = SignUpUser


request_body_sign_up_user = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _sign_up_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_sign_up_user.serialize(body, content_type)
