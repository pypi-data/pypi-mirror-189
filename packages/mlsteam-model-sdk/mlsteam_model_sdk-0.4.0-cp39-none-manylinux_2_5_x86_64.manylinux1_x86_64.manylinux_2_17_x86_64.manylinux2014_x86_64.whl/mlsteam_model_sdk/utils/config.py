...
def get_config_path(check: bool = False) -> Optional[Path]:
    ...
    def _walrus_wrapper_curr_file_0fa83c01db764873ad527d1f638b8c43(expr):
        """Wrapper function for assignment expression."""
        nonlocal curr_file
        curr_file = expr
        return curr_file

    if (_walrus_wrapper_curr_file_0fa83c01db764873ad527d1f638b8c43(curr_dir / CFG_DIR / CFG_FILE)).is_file():
        return curr_file
    ...
    with contextlib.suppress(RuntimeError):
        ...
        def _walrus_wrapper_curr_file_40c46a7cfac3473eaefa0fb76e168823(expr):
            """Wrapper function for assignment expression."""
            nonlocal curr_file
            curr_file = expr
            return curr_file

        if (_walrus_wrapper_curr_file_40c46a7cfac3473eaefa0fb76e168823(Path.home() / CFG_DIR / CFG_FILE)).is_file():
            return curr_file
    ...
    for _dir in curr_dir.parents:
        ...
        def _walrus_wrapper_curr_file_497025d8f412404f8698f08505d75d8f(expr):
            """Wrapper function for assignment expression."""
            nonlocal curr_file
            curr_file = expr
            return curr_file

        if (_walrus_wrapper_curr_file_497025d8f412404f8698f08505d75d8f(_dir / CFG_DIR / CFG_FILE)).is_file():
            return curr_file
