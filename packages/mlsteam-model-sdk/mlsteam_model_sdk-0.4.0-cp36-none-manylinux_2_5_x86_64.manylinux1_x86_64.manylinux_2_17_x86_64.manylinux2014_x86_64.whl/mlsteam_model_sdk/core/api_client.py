...
class ApiClient:
    ...
    def _get_api_endpoint(self) -> str:
        ...
        def _walrus_wrapper_api_endpoint_e2b1da6db57c40c0a0b92bd20548ea9e(expr):
            """Wrapper function for assignment expression."""
            nonlocal api_endpoint
            api_endpoint = expr
            return api_endpoint

        if (_walrus_wrapper_api_endpoint_e2b1da6db57c40c0a0b92bd20548ea9e(get_value(OPTION_API_ENDPOINT))):
            return api_endpoint
    ...
    def prepare_download_model_version(self, puuid, muuid, vuuid, req: Optional[bytes] = None) -> dict:
