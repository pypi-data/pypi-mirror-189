...
> AWS CDK [L1 construct](https://docs.aws.amazon.com/cdk/latest/guide/constructs.html) and data structures for the [AWS CloudFormation Registry](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html) type `Gremlin::Agent::Helm` v1.0.0.
...
This library is auto-generated and published to all supported programming languages by the [cdklabs/cdk-cloudformation](https://github.com/cdklabs/cdk-cloudformation) project based on the API schema published for `Gremlin::Agent::Helm`.
...
class CfnHelm(
    ...
    jsii_type="@cdk-cloudformation/gremlin-agent-helm.CfnHelm",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9c183b3efa8d6419937905883e251c786d667196a3d71dd902a77daec5f4a54c)
...
@jsii.data_type(
    jsii_type="@cdk-cloudformation/gremlin-agent-helm.CfnHelmProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CfnHelmProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__51ecf253e9d743987a0dfbcb5b16f42e8ec77377bade14c0da980bd6edd14b15)
...
@jsii.data_type(
    jsii_type="@cdk-cloudformation/gremlin-agent-helm.CfnHelmPropsVpcConfiguration",
    jsii_struct_bases=[],
...
class CfnHelmPropsVpcConfiguration:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a7eece7cdce8ab6f62440c929757bbcd27e8f9ac36d3ebaeabfbc73ef0593b70)
...
def _typecheckingstub__9c183b3efa8d6419937905883e251c786d667196a3d71dd902a77daec5f4a54c(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    cluster_id: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__51ecf253e9d743987a0dfbcb5b16f42e8ec77377bade14c0da980bd6edd14b15(
    *,
    cluster_id: typing.Optional[builtins.str] = None,
    kube_config: typing.Optional[builtins.str] = None,
    name: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__a7eece7cdce8ab6f62440c929757bbcd27e8f9ac36d3ebaeabfbc73ef0593b70(
    *,
    security_group_ids: typing.Optional[typing.Sequence[builtins.str]] = None,
    subnet_ids: typing.Optional[typing.Sequence[builtins.str]] = None,
) -> None:
