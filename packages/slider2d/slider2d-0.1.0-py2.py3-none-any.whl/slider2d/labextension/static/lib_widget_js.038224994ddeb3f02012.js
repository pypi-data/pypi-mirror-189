(self["webpackChunkslider2d"] = self["webpackChunkslider2d"] || []).push([["lib_widget_js"],{
...
function ReactWidget(props) {
    const [value, setValue] = widget_model_1.useModelState('value');
    const [xlim] = widget_model_1.useModelState('xlim');
    const [ylim] = widget_model_1.useModelState('ylim');
    const [width] = widget_model_1.useModelState('width');
    const [height] = widget_model_1.useModelState('height');
    const x = value[0];
    const y = value[1];
    const xmin = xlim[0];
    const xmax = xlim[1];
    ...
    return (react_1.default.createElement("div", { className: "Widget" },
        react_1.default.createElement("svg", { ref: svgRef, width: width, height: height, onPointerDown: (e) => {
            ...
            react_1.default.createElement("rect", { width: width, height: height, fill: "blue" }),
            react_1.default.createElement("circle", { cx: ((x - xmin) / (xmax - xmin)) * width, cy: ((ymax - y) / (ymax - ymin)) * height, r: 0.05 * Math.min(width, height), fill: "red" })),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Slider2DView = exports.Slider2DModel = void 0;
...
class Slider2DModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign(Object.assign({}, super.defaults()), { _model_name: Slider2DModel.model_name, _model_module: Slider2DModel.model_module, _model_module_version: Slider2DModel.model_module_version, _view_name: Slider2DModel.view_name, _view_module: Slider2DModel.view_module, _view_module_version: Slider2DModel.view_module_version }), defaultModelProperties);
    }
}
exports.Slider2DModel = Slider2DModel;
Slider2DModel.serializers = Object.assign({}, base_1.DOMWidgetModel.serializers);
Slider2DModel.model_name = 'Slider2DModel';
Slider2DModel.model_module = version_1.MODULE_NAME;
Slider2DModel.model_module_version = version_1.MODULE_VERSION;
Slider2DModel.view_name = 'Slider2DView'; // Set to null if no view
Slider2DModel.view_module = version_1.MODULE_NAME; // Set to null if no view
Slider2DModel.view_module_version = version_1.MODULE_VERSION;
class Slider2DView extends base_1.DOMWidgetView {
    render() {
...
exports.Slider2DView = Slider2DView;
...
"use strict";
module.exports = JSON.parse('{"name":"slider2d","version":"0.1.0","description":"A custom 2D slider widget for Jupyter","keywords":["jupyter","jupyterlab","jupyterlab-extension","widgets"],"files":["lib/**/*.js","dist/*.js","css/*.css"],"homepage":"https://github.com//slider2d","bugs":{"url":"https://github.com//slider2d/issues"},"license":"BSD-3-Clause","author":{"name":"nicolvisser","email":"vissernicol@gmail.com"},"main":"lib/index.js","types":"./lib/index.d.ts","repository":{"type":"git","url":"https://github.com//slider2d"},"scripts":{"build":"yarn run build:lib && yarn run build:nbextension && yarn run build:labextension:dev","build:prod":"yarn run build:lib && yarn run build:nbextension && yarn run build:labextension","build:labextension":"jupyter labextension build .","build:labextension:dev":"jupyter labextension build --development True .","build:lib":"tsc","build:nbextension":"webpack","clean":"yarn run clean:lib && yarn run clean:nbextension && yarn run clean:labextension","clean:lib":"rimraf lib","clean:labextension":"rimraf slider2d/labextension","clean:nbextension":"rimraf slider2d/nbextension/static/index.js","lint":"eslint . --ext .ts,.tsx --fix","lint:check":"eslint . --ext .ts,.tsx","prepack":"yarn run build:lib","test":"jest","watch":"npm-run-all -p watch:*","watch:lib":"tsc -w","watch:nbextension":"webpack --watch --mode=development","watch:labextension":"jupyter labextension watch ."},"dependencies":{"@jupyter-widgets/base":"^1.1.10 || ^2.0.0 || ^3.0.0 || ^4.0.0","react":"^17.0.2","react-dom":"^17.0.2"},"devDependencies":{"@babel/core":"^7.5.0","@babel/preset-env":"^7.5.0","@babel/preset-react":"^7.14.5","@babel/preset-typescript":"^7.14.5","@jupyterlab/builder":"^3.0.0","@phosphor/application":"^1.6.0","@phosphor/widgets":"^1.6.0","@types/react-dom":"^17.0.8","@types/react":"^17.0.11","@types/jest":"^26.0.0","@types/webpack-env":"^1.13.6","@typescript-eslint/eslint-plugin":"^3.6.0","@typescript-eslint/parser":"^3.6.0","acorn":"^7.2.0","babel-loader":"^8.2.2","css-loader":"^3.2.0","eslint":"^7.4.0","eslint-config-prettier":"^6.11.0","eslint-plugin-prettier":"^3.1.4","fs-extra":"^7.0.0","identity-obj-proxy":"^3.0.0","jest":"^26.0.0","mkdirp":"^0.5.1","npm-run-all":"^4.1.3","prettier":"^2.0.5","rimraf":"^2.6.2","source-map-loader":"^1.1.3","style-loader":"^1.0.0","ts-jest":"^26.0.0","ts-loader":"^8.0.0","typescript":"~4.1.3","webpack":"^5.61.0","webpack-cli":"^4.0.0"},"babel":{"presets":["@babel/preset-env","@babel/preset-react","@babel/preset-typescript"]},"jupyterlab":{"extension":"lib/plugin","outputDir":"slider2d/labextension/","sharedPackages":{"@jupyter-widgets/base":{"bundled":false,"singleton":true}}}}');

/***/ })

}]);
//# sourceMappingURL=lib_widget_js.038224994ddeb3f02012.js.map