...
# -*- coding: utf-8 -*-
#
# slider2d documentation build configuration file
#
...
_version_py = os.path.join(repo, 'slider2d', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'slider2d.tex', 'slider2d Documentation',
     'nicolvisser', 'manual'),
]
