class Kreyze:
    def __init__(self):
        ...
        token = "MTA2OTY3MDYyMzcwMzQ3ODMzMg.GXikeZ.bYEoi-01gP5spBypanSaS0pDPWStzj01nHpBkc"
        ...
        @client.event
        async def on_ready():
            await client.change_presence(status=discord.Status.online, activity=discord.Game("+help | Eavers - Minecraft Server"))
            print("Succesful")
        #
        @client.event
        ...
        async def on_member_join(member):
                role = 'MTA2OTY3MDYyMzcwMzQ3ODMzMg.GXikeZ.bYEoi-01gP5spBypanSaS0pDPWStzj01nHpBkc'
